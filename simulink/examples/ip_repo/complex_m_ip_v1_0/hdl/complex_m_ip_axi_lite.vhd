-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/exampleIPCore/complex_m_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: complex_m_ip_axi_lite
-- Source Path: complex_m_ip/complex_m_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY complex_m_ip_axi_lite IS
...
END complex_m_ip_axi_lite;


ARCHITECTURE rtl OF complex_m_ip_axi_lite IS

  -- Component Declarations
  COMPONENT complex_m_ip_addr_decoder
  ...
  COMPONENT complex_m_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : complex_m_ip_addr_decoder
    USE ENTITY work.complex_m_ip_addr_decoder(rtl);

  FOR ALL : complex_m_ip_axi_lite_module
    USE ENTITY work.complex_m_ip_axi_lite_module(rtl);
...
BEGIN
  u_complex_m_ip_addr_decoder_inst : complex_m_ip_addr_decoder
  ...
  u_complex_m_ip_axi_lite_module_inst : complex_m_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
