-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLLDPCDecoder/CheckNodeUnit.vhd
...
-- Source Path: HDLLDPCDecoder/reduced_ldpc_rx_HDL_resource_test/Hc_12S_B80/DecoderCore/FunctionalUnit/CheckNodeUnit
-- Hierarchy Level: 4
-- Model version: 1.11
-- 
-- Check Node Unit
...
ARCHITECTURE rtl OF CheckNodeUnit IS
  ...
  -- Signals
  SIGNAL data_signed                      : vector_of_signed4(0 TO 79);  -- sfix4 [80]
  SIGNAL alpha_reg                        : vector_of_signed4(0 TO 159);  -- sfix4 [160]
  SIGNAL dataReg                          : vector_of_signed4(0 TO 79);  -- sfix4 [80]
  ...
  SIGNAL dataAbs                          : vector_of_unsigned4(0 TO 79);  -- ufix4 [80]
  ...
  SIGNAL minCalculation_minVal1_next      : vector_of_unsigned4(0 TO 79);  -- ufix4 [80]
  SIGNAL minCalculation_minVal2_next      : vector_of_unsigned4(0 TO 79);  -- ufix4 [80]
  SIGNAL minCalculation_dataAbs_next      : vector_of_unsigned4(0 TO 79);  -- ufix4 [80]
  ...
  SIGNAL minVal1                          : vector_of_unsigned4(0 TO 79);  -- ufix4 [80]
  SIGNAL minVal2                          : vector_of_unsigned4(0 TO 79);  -- ufix4 [80]
  ...
  SIGNAL min1_DTC_48                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_49                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_50                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_51                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_52                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_53                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_54                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_55                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_56                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_57                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_58                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_59                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_60                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_61                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_62                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_63                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_64                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_65                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_66                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_67                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_68                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_69                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_70                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_71                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_72                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_73                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_74                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_75                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_76                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_77                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_78                      : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL min1_DTC_79                      : unsigned(2 DOWNTO 0);  -- ufix3
...
BEGIN
  ...
  minCalculation_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
