-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLLDPCDecoder/VariableNodeUnit.vhd
...
END VariableNodeUnit;


ARCHITECTURE rtl OF VariableNodeUnit IS

  -- Signals
  SIGNAL data_signed                      : vector_of_signed6(0 TO 79);  -- sfix6 [80]
  SIGNAL alpha_switch_delay               : vector_of_signed6(0 TO 79);  -- sfix6 [80]
  SIGNAL dataD                            : vector_of_signed6(0 TO 79);  -- sfix6 [80]
  SIGNAL beta_signed                      : vector_of_signed4(0 TO 79);  -- sfix4 [80]
  SIGNAL sub_Comp_sub_temp                : vector_of_signed7(0 TO 79);  -- sfix7 [80]
  SIGNAL sub                              : vector_of_signed6(0 TO 79);  -- sfix6 [80]
  SIGNAL dataD1                           : vector_of_signed6(0 TO 79);  -- sfix6 [80]
