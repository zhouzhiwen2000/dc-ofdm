-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLLDPCDecoder/FinalDecision.vhd
...
-- Source Path: HDLLDPCDecoder/reduced_ldpc_rx_HDL_resource_test/Hc_12S_B80/DecoderCore/FinalDecision
-- Hierarchy Level: 3
-- Model version: 1.11
-- 
-- Final Decision
...
ARCHITECTURE rtl OF FinalDecision IS

  -- Signals
  SIGNAL data_signed                      : vector_of_signed6(0 TO 79);  -- sfix6 [80]
  ...
  SIGNAL finalDecision_zCount1            : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL finalDecision_zCount2            : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  SIGNAL finalDecision_zCount1_next       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL finalDecision_zCount2_next       : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  SIGNAL data_1                           : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
...
BEGIN
  ...
  finalDecision_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      finalDecision_enb_dec <= '0';
      finalDecision_count <= to_unsigned(16#1#, 4);
      finalDecision_iterDone <= '0';
      finalDecision_zCount1 <= to_unsigned(16#00#, 7);
      finalDecision_zCount2 <= to_unsigned(16#00#, 7);
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS finalDecision_1_process;

  finalDecision_1_output : PROCESS (data_signed, finalDecision_cntEnb, finalDecision_count, finalDecision_ctrlEnd,
    ...
    VARIABLE zCount1_temp : unsigned(6 DOWNTO 0);
    VARIABLE zCount2_temp : unsigned(6 DOWNTO 0);
  ...
  BEGIN
    ...
    IF reset /= '0' THEN 
      ...
      zCount1_temp := to_unsigned(16#00#, 7);
      zCount2_temp := to_unsigned(16#00#, 7);
      cntEnb_temp := '0';
      endD_temp := '0';
      ctrlEnd_temp := '0';
      starto := '0';
    ...
    IF enb_dec_temp = '1' THEN 
      IF zCount1_temp = to_unsigned(16#50#, 7) THEN 
        zCount1_temp := to_unsigned(16#01#, 7);
        cntEnb_temp := '1';
      ELSE 
        zCount1_temp := zCount1_temp + to_unsigned(16#01#, 7);
        cntEnb_temp := '0';
      END IF;
    ...
    END IF;
    IF endD_temp = '1' THEN 
      IF zCount2_temp = to_unsigned(16#4F#, 7) THEN 
        zCount2_temp := to_unsigned(16#00#, 7);
        ctrlEnd_temp := '1';
        endD_temp := '0';
      ELSE 
        ctrlEnd_temp := '0';
        zCount2_temp := zCount2_temp + to_unsigned(16#01#, 7);
      END IF;
    ELSE 
      ctrlEnd_temp := '0';
    END IF;
  ...
  END PROCESS finalDecision_1_output;
