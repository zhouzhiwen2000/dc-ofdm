-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLHeaderFull/header_full_ip_src_h_crc.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_full_ip_src_h_crc
-- Source Path: HDLHeaderFull/header_full/h_crc
-- Hierarchy Level: 1
-- Model version: 1.18
-- 
-- -------------------------------------------------------------
...
ENTITY header_full_ip_src_h_crc IS
...
END header_full_ip_src_h_crc;


ARCHITECTURE rtl OF header_full_ip_src_h_crc IS

  -- Component Declarations
  COMPONENT header_full_ip_src_General_CRC_Generator_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic;
  ...
  COMPONENT header_full_ip_src_Sample_Control_Bus_Creator
  ...
  FOR ALL : header_full_ip_src_General_CRC_Generator_HDL_Optimized
    USE ENTITY work.header_full_ip_src_General_CRC_Generator_HDL_Optimized(rtl);

  FOR ALL : header_full_ip_src_Sample_Control_Bus_Creator
    USE ENTITY work.header_full_ip_src_Sample_Control_Bus_Creator(rtl);
...
BEGIN
  u_General_CRC_Generator_HDL_Optimized : header_full_ip_src_General_CRC_Generator_HDL_Optimized
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => data_in,
  ...
  u_Sample_Control_Bus_Creator : header_full_ip_src_Sample_Control_Bus_Creator
