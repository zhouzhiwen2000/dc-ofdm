-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLHeaderFull/header_full_ip_src_h_gen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_full_ip_src_h_gen
-- Source Path: HDLHeaderFull/header_full/h_gen
-- Hierarchy Level: 1
-- Model version: 1.18
-- 
-- -------------------------------------------------------------
...
ENTITY header_full_ip_src_h_gen IS
...
END header_full_ip_src_h_gen;


ARCHITECTURE rtl OF header_full_ip_src_h_gen IS

  -- Component Declarations
  COMPONENT header_full_ip_src_valid_to_ctrl
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : header_full_ip_src_valid_to_ctrl
    USE ENTITY work.header_full_ip_src_valid_to_ctrl(rtl);
...
BEGIN
  u_valid_to_ctrl : header_full_ip_src_valid_to_ctrl
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
