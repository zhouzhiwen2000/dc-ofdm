-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLHeaderFull/header_full_ip_src_Calculate_Alpha.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_full_ip_src_Calculate_Alpha
-- Source Path: HDLHeaderFull/header_full/header_fec/Hc_12H_B14/Calculate Alpha
-- Hierarchy Level: 3
-- Model version: 1.18
-- 
-- Calculate Alpha
...
ENTITY header_full_ip_src_Calculate_Alpha IS
...
END header_full_ip_src_Calculate_Alpha;


ARCHITECTURE rtl OF header_full_ip_src_Calculate_Alpha IS

  -- Component Declarations
  COMPONENT header_full_ip_src_BarrelRotator
  ...
  FOR ALL : header_full_ip_src_BarrelRotator
    USE ENTITY work.header_full_ip_src_BarrelRotator(rtl);
...
BEGIN
  u_Barrel_Rotator_Unit : header_full_ip_src_BarrelRotator
    PORT MAP( data => rdData,  -- ufix1 [14]
              shift => std_logic_vector(shiftVal),  -- ufix4
              shiftData => sData  -- ufix1 [14]
              );

  u_Alpha_RAM_singlebit_bank0 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
  ...
  u_Alpha_RAM_singlebit_bank1 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank2 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank3 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank4 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank5 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank6 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank7 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank8 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank9 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank10 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank11 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank12 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Alpha_RAM_singlebit_bank13 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
