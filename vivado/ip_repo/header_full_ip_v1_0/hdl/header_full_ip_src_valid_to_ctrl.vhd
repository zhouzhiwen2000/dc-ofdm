-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLHeaderFull/header_full_ip_src_valid_to_ctrl.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_full_ip_src_valid_to_ctrl
-- Source Path: HDLHeaderFull/header_full/h_gen/valid_to_ctrl
-- Hierarchy Level: 2
-- Model version: 1.18
-- 
-- -------------------------------------------------------------
...
ENTITY header_full_ip_src_valid_to_ctrl IS
...
END header_full_ip_src_valid_to_ctrl;


ARCHITECTURE rtl OF header_full_ip_src_valid_to_ctrl IS

  -- Component Declarations
  COMPONENT header_full_ip_src_Sample_Control_Bus_Creator_block
  ...
  FOR ALL : header_full_ip_src_Sample_Control_Bus_Creator_block
    USE ENTITY work.header_full_ip_src_Sample_Control_Bus_Creator_block(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : header_full_ip_src_Sample_Control_Bus_Creator_block
    PORT MAP( In1 => start,
              In2 => end_rsvd,
              In3 => valid,
