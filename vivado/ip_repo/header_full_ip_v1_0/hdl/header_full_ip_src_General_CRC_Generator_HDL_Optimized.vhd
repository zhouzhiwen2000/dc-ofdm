-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLHeaderFull/header_full_ip_src_General_CRC_Generator_HDL_Optimized.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_full_ip_src_General_CRC_Generator_HDL_Optimized
-- Source Path: HDLHeaderFull/header_full/h_crc/General CRC Generator HDL Optimized
-- Hierarchy Level: 2
-- Model version: 1.18
-- 
...
ENTITY header_full_ip_src_General_CRC_Generator_HDL_Optimized IS
...
END header_full_ip_src_General_CRC_Generator_HDL_Optimized;


ARCHITECTURE rtl OF header_full_ip_src_General_CRC_Generator_HDL_Optimized IS

  -- Component Declarations
  COMPONENT header_full_ip_src_CRCGenControl
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          startIn                         :   IN    std_logic;
  ...
  COMPONENT header_full_ip_src_CRCGenCompute
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : header_full_ip_src_CRCGenControl
    USE ENTITY work.header_full_ip_src_CRCGenControl(rtl);

  FOR ALL : header_full_ip_src_CRCGenCompute
    USE ENTITY work.header_full_ip_src_CRCGenCompute(rtl);
...
BEGIN
  u_Controlsignal_inst : header_full_ip_src_CRCGenControl
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              startIn => startIn_vld,
  ...
  u_ComputeCRC_inst : header_full_ip_src_CRCGenCompute
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              datainReg => datainReg,
