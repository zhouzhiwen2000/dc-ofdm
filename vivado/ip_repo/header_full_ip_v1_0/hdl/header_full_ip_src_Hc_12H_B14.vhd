-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLHeaderFull/header_full_ip_src_Hc_12H_B14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_full_ip_src_Hc_12H_B14
-- Source Path: HDLHeaderFull/header_full/header_fec/Hc_12H_B14
-- Hierarchy Level: 2
-- Model version: 1.18
-- 
-- LDPC Encoder
...
USE work.header_full_ip_src_header_full_pac.ALL;

ENTITY header_full_ip_src_Hc_12H_B14 IS
...
END header_full_ip_src_Hc_12H_B14;


ARCHITECTURE rtl OF header_full_ip_src_Hc_12H_B14 IS

  -- Component Declarations
  COMPONENT header_full_ip_src_SimpleDualPortRAM_singlebit_block
  ...
  COMPONENT header_full_ip_src_Calculate_Alpha
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT header_full_ip_src_Calculate_Parity
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT header_full_ip_src_Final_Output
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    USE ENTITY work.header_full_ip_src_SimpleDualPortRAM_singlebit_block(rtl);

  FOR ALL : header_full_ip_src_Calculate_Alpha
    USE ENTITY work.header_full_ip_src_Calculate_Alpha(rtl);

  FOR ALL : header_full_ip_src_Calculate_Parity
    USE ENTITY work.header_full_ip_src_Calculate_Parity(rtl);

  FOR ALL : header_full_ip_src_Final_Output
    USE ENTITY work.header_full_ip_src_Final_Output(rtl);
...
BEGIN
  u_Input_RAM : header_full_ip_src_SimpleDualPortRAM_singlebit_block
  ...
  u_Input_RAM_1 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_2 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_3 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_4 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_5 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_6 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_7 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_8 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_9 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_10 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_11 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_12 : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_singlebit : header_full_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Calculate_Alpha : header_full_ip_src_Calculate_Alpha
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Calculate_Parity : header_full_ip_src_Calculate_Parity
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
  ...
  u_Final_output : header_full_ip_src_Final_Output
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
