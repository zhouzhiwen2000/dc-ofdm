-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLHeaderFull/header_full_ip_src_h_repetition.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_full_ip_src_h_repetition
-- Source Path: HDLHeaderFull/header_full/h_repetition
-- Hierarchy Level: 1
-- Model version: 1.18
-- 
-- -------------------------------------------------------------
...
ENTITY header_full_ip_src_h_repetition IS
...
END header_full_ip_src_h_repetition;


ARCHITECTURE rtl OF header_full_ip_src_h_repetition IS

  -- Component Declarations
  COMPONENT header_full_ip_src_SimpleDualPortRAM_singlebit
  ...
  COMPONENT header_full_ip_src_Sample_Control_Bus_Creator_block1
  ...
  FOR ALL : header_full_ip_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.header_full_ip_src_SimpleDualPortRAM_singlebit(rtl);

  FOR ALL : header_full_ip_src_Sample_Control_Bus_Creator_block1
    USE ENTITY work.header_full_ip_src_Sample_Control_Bus_Creator_block1(rtl);
...
BEGIN
  u_Simple_Dual_Port_RAM : header_full_ip_src_SimpleDualPortRAM_singlebit
  ...
  u_Sample_Control_Bus_Creator : header_full_ip_src_Sample_Control_Bus_Creator_block1
    PORT MAP( In1 => Delay_out1,
              In2 => Delay4_out1,
              In3 => Switch1_out1,
