-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxPayload/rx_payload_ip_src_p_scrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_payload_ip_src_p_scrambler
-- Source Path: HDLRxPayload/rx_payload_full/p_scrambler
-- Hierarchy Level: 1
-- Model version: 1.67
-- 
-- -------------------------------------------------------------
...
ENTITY rx_payload_ip_src_p_scrambler IS
...
END rx_payload_ip_src_p_scrambler;


ARCHITECTURE rtl OF rx_payload_ip_src_p_scrambler IS

  -- Component Declarations
  COMPONENT rx_payload_ip_src_Sample_Control_Bus_Creator
  ...
  FOR ALL : rx_payload_ip_src_Sample_Control_Bus_Creator
    USE ENTITY work.rx_payload_ip_src_Sample_Control_Bus_Creator(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : rx_payload_ip_src_Sample_Control_Bus_Creator
