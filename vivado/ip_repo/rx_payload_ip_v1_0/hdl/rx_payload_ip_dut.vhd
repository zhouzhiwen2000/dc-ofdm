-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxPayload/rx_payload_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_payload_ip_dut
-- Source Path: rx_payload_ip/rx_payload_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END rx_payload_ip_dut;


ARCHITECTURE rtl OF rx_payload_ip_dut IS

  -- Component Declarations
  COMPONENT rx_payload_ip_src_rx_payload_full
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : rx_payload_ip_src_rx_payload_full
    USE ENTITY work.rx_payload_ip_src_rx_payload_full(rtl);
...
BEGIN
  u_rx_payload_ip_src_rx_payload_full : rx_payload_ip_src_rx_payload_full
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
