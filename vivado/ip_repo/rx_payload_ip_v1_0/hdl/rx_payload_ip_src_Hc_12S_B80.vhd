-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxPayload/rx_payload_ip_src_Hc_12S_B80.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_payload_ip_src_Hc_12S_B80
-- Source Path: HDLRxPayload/rx_payload_full/reduced_ldpc_rx/Hc_12S_B80
-- Hierarchy Level: 2
-- Model version: 1.67
-- 
-- LDPC Decoder
...
ENTITY rx_payload_ip_src_Hc_12S_B80 IS
...
END rx_payload_ip_src_Hc_12S_B80;


ARCHITECTURE rtl OF rx_payload_ip_src_Hc_12S_B80 IS

  -- Component Declarations
  COMPONENT rx_payload_ip_src_CodeParameters
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rx_payload_ip_src_DecoderCore
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rx_payload_ip_src_CodeParameters
    USE ENTITY work.rx_payload_ip_src_CodeParameters(rtl);

  FOR ALL : rx_payload_ip_src_DecoderCore
    USE ENTITY work.rx_payload_ip_src_DecoderCore(rtl);
...
BEGIN
  u_Code_Parameters : rx_payload_ip_src_CodeParameters
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Decoder_Core : rx_payload_ip_src_DecoderCore
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => reset,  -- ufix1
