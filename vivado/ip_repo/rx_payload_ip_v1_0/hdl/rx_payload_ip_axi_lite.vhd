-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxPayload/rx_payload_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_payload_ip_axi_lite
-- Source Path: rx_payload_ip/rx_payload_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY rx_payload_ip_axi_lite IS
...
END rx_payload_ip_axi_lite;


ARCHITECTURE rtl OF rx_payload_ip_axi_lite IS

  -- Component Declarations
  COMPONENT rx_payload_ip_addr_decoder
  ...
  COMPONENT rx_payload_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : rx_payload_ip_addr_decoder
    USE ENTITY work.rx_payload_ip_addr_decoder(rtl);

  FOR ALL : rx_payload_ip_axi_lite_module
    USE ENTITY work.rx_payload_ip_axi_lite_module(rtl);
...
BEGIN
  u_rx_payload_ip_addr_decoder_inst : rx_payload_ip_addr_decoder
  ...
  u_rx_payload_ip_axi_lite_module_inst : rx_payload_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
