-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxPayload/rx_payload_ip_src_valid_to_ctrl.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_payload_ip_src_valid_to_ctrl
-- Source Path: HDLRxPayload/rx_payload_full/remove_tone_mapping/valid_to_ctrl
-- Hierarchy Level: 2
-- Model version: 1.67
-- 
-- -------------------------------------------------------------
...
ENTITY rx_payload_ip_src_valid_to_ctrl IS
...
END rx_payload_ip_src_valid_to_ctrl;


ARCHITECTURE rtl OF rx_payload_ip_src_valid_to_ctrl IS

  -- Component Declarations
  COMPONENT rx_payload_ip_src_Sample_Control_Bus_Creator_block
  ...
  FOR ALL : rx_payload_ip_src_Sample_Control_Bus_Creator_block
    USE ENTITY work.rx_payload_ip_src_Sample_Control_Bus_Creator_block(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : rx_payload_ip_src_Sample_Control_Bus_Creator_block
    PORT MAP( In1 => start,
              In2 => end_rsvd,
              In3 => valid,
