-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxPayload/rx_payload_ip_src_rx_payload_full.vhd
...
-- -------------------------------------------------------------
-- data_out                      ce_out_0      6.4e-08
-- valid_out                     ce_out_0      6.4e-08
-- ready                         ce_out_1      8e-09
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- 
-- Module: rx_payload_ip_src_rx_payload_full
-- Source Path: HDLRxPayload/rx_payload_full
-- Hierarchy Level: 0
-- Model version: 1.67
-- 
-- -------------------------------------------------------------
...
ENTITY rx_payload_ip_src_rx_payload_full IS
...
END rx_payload_ip_src_rx_payload_full;


ARCHITECTURE rtl OF rx_payload_ip_src_rx_payload_full IS

  -- Component Declarations
  COMPONENT rx_payload_ip_src_rx_payload_full_tc
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT rx_payload_ip_src_next_frame_to_ready_rx
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rx_payload_ip_src_remove_tone_mapping
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in                         :   IN    std_logic_vector(3 DOWNTO 0);  -- sfix4_En1
  ...
  COMPONENT rx_payload_ip_src_reduced_ldpc_rx
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in                         :   IN    std_logic_vector(3 DOWNTO 0);  -- sfix4_En1
  ...
  COMPONENT rx_payload_ip_src_p_scrambler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rx_payload_ip_src_rx_payload_full_tc
    USE ENTITY work.rx_payload_ip_src_rx_payload_full_tc(rtl);

  FOR ALL : rx_payload_ip_src_next_frame_to_ready_rx
    USE ENTITY work.rx_payload_ip_src_next_frame_to_ready_rx(rtl);

  FOR ALL : rx_payload_ip_src_remove_tone_mapping
    USE ENTITY work.rx_payload_ip_src_remove_tone_mapping(rtl);

  FOR ALL : rx_payload_ip_src_reduced_ldpc_rx
    USE ENTITY work.rx_payload_ip_src_reduced_ldpc_rx(rtl);

  FOR ALL : rx_payload_ip_src_p_scrambler
    USE ENTITY work.rx_payload_ip_src_p_scrambler(rtl);
...
BEGIN
  ...
  u_rx_payload_full_tc : rx_payload_ip_src_rx_payload_full_tc
    PORT MAP( clk => clk,
              reset_x => reset_x,
  ...
  u_next_frame_to_ready_rx : rx_payload_ip_src_next_frame_to_ready_rx
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_remove_tone_mapping : rx_payload_ip_src_remove_tone_mapping
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data_in => data_in,  -- sfix4_En1
              valid_in => AND_out1,
              newFrame => new_frame_in,
  ...
  u_reduced_ldpc_rx : rx_payload_ip_src_reduced_ldpc_rx
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_p_scrambler : rx_payload_ip_src_p_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data_in => ldpc_out,
