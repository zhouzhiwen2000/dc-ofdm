...
ARCHITECTURE rtl OF full_rx_ip_src_ofdm_separator IS
  ...
  -- Signals
  SIGNAL Delay7_reg                       : std_logic_vector(7 DOWNTO 0);  -- ufix1 [8]
...
BEGIN
  ...
  u_wait_for_header : full_rx_ip_src_wait_for_header
    PORT MAP( clk => clk,
              ...
              header_ready => Delay7_out1,
              valid_payload => Switch2_out1,
              zero_payload => zero_payload,
              data_out_re => wait_for_header_out1_re,  -- sfix16_En12
              data_out_im => wait_for_header_out1_im,  -- sfix16_En12
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        Delay7_reg(0) <= header_ready;
        Delay7_reg(7 DOWNTO 1) <= Delay7_reg(6 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay7_process;

  Delay7_out1 <= Delay7_reg(7);
  ...
  AND_out1 <= Compare_To_Constant_out1 AND header_ready;

  zero_payload <= AND_out1;
