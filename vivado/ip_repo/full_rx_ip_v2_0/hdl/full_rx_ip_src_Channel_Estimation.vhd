...
BEGIN
  ...
  Delay7_out1_re <= Direct_Lookup_Table_n_D_out1_re_2 WHEN enb_1_4_1 = '1' ELSE
      Delay7_bypass_reg_re;
  
  Delay7_out1_im <= Direct_Lookup_Table_n_D_out1_im_2 WHEN enb_1_4_1 = '1' ELSE
  ...
  Constant_out1_1 <= Constant_out1 WHEN enb_1_4_1 = '1' ELSE
