...
ARCHITECTURE rtl OF full_rx_ip_src_Shift_and_cast_to_output_type IS
  ...
  SIGNAL Cout                             : std_logic_vector(33 DOWNTO 0);  -- ufix34
  ...
  SIGNAL Variable_Right_Shift_out1        : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL Variable_Right_Shift_out1_signed : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Variable_Left_Shift_out1         : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL Variable_Left_Shift_out1_signed  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch_out1                      : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Delay1_out1                      : signed(33 DOWNTO 0);  -- sfix34_En30
...
BEGIN
  u_Cast_to_Union_of_Types : full_rx_ip_src_Cast_to_Union_of_Types
    PORT MAP( Xref => std_logic_vector(Constant_out1),  -- sfix16_En12
              Cin => x,  -- sfix32_En30
              Cout => Cout  -- sfix34_En30
              );
  ...
  u_Variable_Right_Shift : full_rx_ip_src_Variable_Right_Shift
    PORT MAP( clk => clk,
              ...
              y => Variable_Right_Shift_out1  -- sfix34_En30
              );
  ...
  u_Variable_Left_Shift : full_rx_ip_src_Variable_Left_Shift
    PORT MAP( clk => clk,
              ...
              y => Variable_Left_Shift_out1  -- sfix34_En30
              );
  ...
  Data_Type_Conversion_out1 <= Delay1_out1(33 DOWNTO 18);
