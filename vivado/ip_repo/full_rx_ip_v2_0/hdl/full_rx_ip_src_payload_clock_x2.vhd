...
ARCHITECTURE rtl OF full_rx_ip_src_payload_clock_x2 IS
  ...
  SIGNAL paralel_dataIn                   : vector_of_std_logic_vector16(0 TO 1);  -- ufix16 [2]
  SIGNAL paralel_dataIn_1                 : vector_of_signed16(0 TO 1);  -- sfix16_En12 [2]
...
BEGIN
  ...
  paralel_dataIn(0) <= data_in(2);
  paralel_dataIn(1) <= data_in(3);

  outputgen: FOR k IN 0 TO 1 GENERATE
    paralel_dataIn_1(k) <= signed(paralel_dataIn(k));
  END GENERATE;

  serial_in_1 <= paralel_dataIn_1;
