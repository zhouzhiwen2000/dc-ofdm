-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_HDL_FIFO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_HDL_FIFO
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_separator/wait_for_header/HDL_FIFO
-- Hierarchy Level: 4
-- Model version: 1.44
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_HDL_FIFO IS
...
END full_rx_ip_src_HDL_FIFO;


ARCHITECTURE rtl OF full_rx_ip_src_HDL_FIFO IS
  ...
  SIGNAL Num                              : unsigned(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL w_waddr_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_waddr_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_const_0_re                     : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_const_0_im                     : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_out_1_re                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_out_1_im                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_out_re                         : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_out_im                         : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_d2_re                          : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL w_d2_im                          : signed(15 DOWNTO 0);  -- sfix16_En12

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_HDL_FIFO_ram : full_rx_ip_src_SimpleDualPortRAM_generic_block
  ...
  fifo_out4 <= '1' WHEN fifo_sample_count = to_unsigned(16#834#, 12) ELSE
      '0';
  ...
  fifo_front_indx_temp <= to_unsigned(16#000#, 12) WHEN rst /= '0' ELSE
      fifo_front_indx + fifo_front_dir WHEN fifo_read_enable = '1' ELSE
      fifo_front_indx;
  
  fifo_front_dir_next <= to_unsigned(16#7CD#, 12) WHEN fifo_front_indx_temp = to_unsigned(16#833#, 12) ELSE
      to_unsigned(16#001#, 12);
  
  fifo_back_indx_temp <= to_unsigned(16#000#, 12) WHEN rst /= '0' ELSE
      fifo_back_indx + fifo_back_dir WHEN fifo_write_enable = '1' ELSE
      fifo_back_indx;
  
  fifo_back_dir_next <= to_unsigned(16#7CD#, 12) WHEN fifo_back_indx_temp = to_unsigned(16#833#, 12) ELSE
      to_unsigned(16#001#, 12);
  
  fifo_sample_count_next <= to_unsigned(16#000#, 12) WHEN rst /= '0' ELSE
      fifo_sample_count + to_unsigned(16#001#, 12) WHEN (fifo_write_enable AND ( NOT fifo_read_enable)) = '1' ELSE
  ...
  w_cz <= '1' WHEN Num > to_unsigned(16#000#, 12) ELSE
      '0';
  ...
  w_const_0_re <= to_signed(16#0000#, 16);
  w_const_0_im <= to_signed(16#0000#, 16);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' AND w_d1 = '1' THEN
        w_d2_re <= w_out_re;
        w_d2_im <= w_out_im;
      END IF;
    END IF;
