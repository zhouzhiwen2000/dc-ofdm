...
ARCHITECTURE rtl OF full_rx_ip_src_ForEach_Real_Divide IS
  ...
  COMPONENT full_rx_ip_src_Divide_by_zero_handler
    PORT( clk                             :   IN    std_logic;
          ...
          yOut                            :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En12
          );
  END COMPONENT;
  ...
  SIGNAL Shift_and_cast_to_output_type_out1_signed : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Divide_by_zero_handler_out1      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Divide_by_zero_handler_out1_signed : signed(15 DOWNTO 0);  -- sfix16_En12
...
BEGIN
  ...
  u_Shift_and_cast_to_output_type : full_rx_ip_src_Shift_and_cast_to_output_type
    PORT MAP( clk => clk,
              ...
              y => Shift_and_cast_to_output_type_out1  -- sfix16_En12
              );
  ...
  u_Divide_by_zero_handler : full_rx_ip_src_Divide_by_zero_handler
    PORT MAP( clk => clk,
              ...
              yOut => Divide_by_zero_handler_out1  -- sfix16_En12
              );
