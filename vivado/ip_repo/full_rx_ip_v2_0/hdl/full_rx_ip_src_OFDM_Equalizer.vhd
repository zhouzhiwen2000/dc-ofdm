...
ARCHITECTURE rtl OF full_rx_ip_src_OFDM_Equalizer IS
  ...
  SIGNAL Delay1_reg_1                     : vector_of_signed63(0 TO 50);  -- sfix63 [51]
...
BEGIN
  ...
  out_rsvd_5 <= out_rsvd_4 WHEN enb_1_4_1 = '1' ELSE
  ...
  Delay15_out1_1 <= Product2_in0_buff_out1 WHEN enb_1_4_1 = '1' ELSE
      Delay15_bypass_reg;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        ...
        Delay1_reg_1(1 TO 50) <= Delay1_reg_1(0 TO 49);
      END IF;
    END IF;
  END PROCESS Delay1_5_process;

  Delay1_out1_4 <= Delay1_reg_1(50);
  ...
  Delay63_out1_1 <= Product2_in0_buff1_out1 WHEN enb_1_4_1 = '1' ELSE
      Delay63_bypass_reg;
