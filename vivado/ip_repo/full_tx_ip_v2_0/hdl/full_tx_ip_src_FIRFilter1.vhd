...
ARCHITECTURE rtl OF full_tx_ip_src_FIRFilter1 IS
  ...
  COMPONENT full_tx_ip_src_Addressable_Delay_Line_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_tx_ip_src_Addressable_Delay_Line_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  FOR ALL : full_tx_ip_src_Addressable_Delay_Line_block5
    USE ENTITY work.full_tx_ip_src_Addressable_Delay_Line_block5(rtl);

  FOR ALL : full_tx_ip_src_Addressable_Delay_Line_block6
    USE ENTITY work.full_tx_ip_src_Addressable_Delay_Line_block6(rtl);
...
BEGIN
  ...
  u_delayLine4 : full_tx_ip_src_Addressable_Delay_Line_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5 : full_tx_ip_src_Addressable_Delay_Line_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6 : full_tx_ip_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7 : full_tx_ip_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8 : full_tx_ip_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9 : full_tx_ip_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0_1 : full_tx_ip_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : full_tx_ip_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : full_tx_ip_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : full_tx_ip_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5_1 : full_tx_ip_src_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6_1 : full_tx_ip_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7_1 : full_tx_ip_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8_1 : full_tx_ip_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9_1 : full_tx_ip_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
