-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_Calculate_Alpha.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_Calculate_Alpha
...
ENTITY full_tx_ip_src_Calculate_Alpha IS
...
END full_tx_ip_src_Calculate_Alpha;


ARCHITECTURE rtl OF full_tx_ip_src_Calculate_Alpha IS

  -- Component Declarations
  COMPONENT full_tx_ip_src_BarrelRotator
  ...
  FOR ALL : full_tx_ip_src_BarrelRotator
    USE ENTITY work.full_tx_ip_src_BarrelRotator(rtl);
...
BEGIN
  u_Barrel_Rotator_Unit : full_tx_ip_src_BarrelRotator
