-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_h_repetition.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_h_repetition
...
ENTITY full_tx_ip_src_h_repetition IS
...
END full_tx_ip_src_h_repetition;


ARCHITECTURE rtl OF full_tx_ip_src_h_repetition IS

  -- Component Declarations
  COMPONENT full_tx_ip_src_SimpleDualPortRAM_singlebit
  ...
  COMPONENT full_tx_ip_src_Sample_Control_Bus_Creator_block2
  ...
  FOR ALL : full_tx_ip_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.full_tx_ip_src_SimpleDualPortRAM_singlebit(rtl);

  FOR ALL : full_tx_ip_src_Sample_Control_Bus_Creator_block2
    USE ENTITY work.full_tx_ip_src_Sample_Control_Bus_Creator_block2(rtl);
  ...
  SIGNAL addrA_1                          : unsigned(8 DOWNTO 0);  -- ufix9
...
BEGIN
  u_Simple_Dual_Port_RAM : full_tx_ip_src_SimpleDualPortRAM_singlebit
    ...
    PORT MAP( clk => clk,
              ...
              wr_en => ctrl_in_valid,
              rd_addr => std_logic_vector(addrA_1),
              dout => Simple_Dual_Port_RAM_out1
              );

  u_Sample_Control_Bus_Creator : full_tx_ip_src_Sample_Control_Bus_Creator_block2
