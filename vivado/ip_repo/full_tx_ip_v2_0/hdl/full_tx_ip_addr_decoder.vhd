-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_addr_decoder
-- Source Path: full_tx_ip/full_tx_ip_axi_lite/full_tx_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_addr_decoder IS
...
END full_tx_ip_addr_decoder;


ARCHITECTURE rtl OF full_tx_ip_addr_decoder IS

  -- Component Declarations
  COMPONENT full_tx_ip_addr_decoder_read
  ...
  COMPONENT full_tx_ip_addr_decoder_write
    PORT( IPCORE_CLK                      :   IN    std_logic;  -- ufix1
          IPCORE_GLOBAL_RESET             :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : full_tx_ip_addr_decoder_read
    USE ENTITY work.full_tx_ip_addr_decoder_read(rtl);

  FOR ALL : full_tx_ip_addr_decoder_write
    USE ENTITY work.full_tx_ip_addr_decoder_write(rtl);
...
BEGIN
  u_full_tx_ip_addr_decoder_read_inst : full_tx_ip_addr_decoder_read
  ...
  u_full_tx_ip_addr_decoder_write_inst : full_tx_ip_addr_decoder_write
    PORT MAP( IPCORE_CLK => IPCORE_CLK,  -- ufix1
              ...
              write_new_frame_in => write_new_frame_in  -- ufix1
              );
