-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_RADIX22FFT_SDF2_6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_RADIX22FFT_SDF2_6
-- Source Path: HDLTx/full_tx/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF2_6
-- Hierarchy Level: 5
-- Model version: 4.102
-- 
-- -------------------------------------------------------------
...
ENTITY full_tx_ip_src_RADIX22FFT_SDF2_6 IS
...
END full_tx_ip_src_RADIX22FFT_SDF2_6;


ARCHITECTURE rtl OF full_tx_ip_src_RADIX22FFT_SDF2_6 IS
  ...
  COMPONENT full_tx_ip_src_SDFCommutator6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_5_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_src_SDFCommutator6
    USE ENTITY work.full_tx_ip_src_SDFCommutator6(rtl);
...
BEGIN
  u_dataMEM_im_0_6 : full_tx_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_6 : full_tx_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_6 : full_tx_ip_src_SDFCommutator6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
