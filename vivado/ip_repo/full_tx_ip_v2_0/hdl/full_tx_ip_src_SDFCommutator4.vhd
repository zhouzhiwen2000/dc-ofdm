-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_SDFCommutator4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_SDFCommutator4
-- Source Path: HDLTx/full_tx/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF2_4/SDFCommutator4
-- Hierarchy Level: 6
-- Model version: 4.102
-- 
-- -------------------------------------------------------------
...
ENTITY full_tx_ip_src_SDFCommutator4 IS
...
END full_tx_ip_src_SDFCommutator4;


ARCHITECTURE rtl OF full_tx_ip_src_SDFCommutator4 IS
  ...
  SIGNAL dout_4_1_re_tmp                  : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout_4_1_im_tmp                  : signed(11 DOWNTO 0);  -- sfix12_En10

BEGIN
  u_dataXMEM_re_0_4 : full_tx_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_4 : full_tx_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
