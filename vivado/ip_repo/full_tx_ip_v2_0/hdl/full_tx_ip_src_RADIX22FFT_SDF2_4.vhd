-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_RADIX22FFT_SDF2_4
...
ENTITY full_tx_ip_src_RADIX22FFT_SDF2_4 IS
...
END full_tx_ip_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF full_tx_ip_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT full_tx_ip_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_src_SDFCommutator4
    USE ENTITY work.full_tx_ip_src_SDFCommutator4(rtl);
...
BEGIN
  u_dataMEM_im_0_4 : full_tx_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_4 : full_tx_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : full_tx_ip_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
