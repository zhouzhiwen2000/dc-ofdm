-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_axi_lite
-- Source Path: full_tx_ip/full_tx_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END full_tx_ip_axi_lite;


ARCHITECTURE rtl OF full_tx_ip_axi_lite IS

  -- Component Declarations
  COMPONENT full_tx_ip_addr_decoder
  ...
  COMPONENT full_tx_ip_axi_lite_module
  ...
  FOR ALL : full_tx_ip_addr_decoder
    USE ENTITY work.full_tx_ip_addr_decoder(rtl);

  FOR ALL : full_tx_ip_axi_lite_module
    USE ENTITY work.full_tx_ip_axi_lite_module(rtl);
...
BEGIN
  u_full_tx_ip_addr_decoder_inst : full_tx_ip_addr_decoder
  ...
  u_full_tx_ip_axi_lite_module_inst : full_tx_ip_axi_lite_module
  ...
  u_full_tx_ip_soft_reset_sync_inst : full_tx_ip_pulse_sync
