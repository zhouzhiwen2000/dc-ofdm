-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_SDFCommutator8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_SDFCommutator8
-- Source Path: HDLTx/full_tx/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF2_8/SDFCommutator8
-- Hierarchy Level: 6
-- Model version: 4.102
-- 
-- -------------------------------------------------------------
...
ENTITY full_tx_ip_src_SDFCommutator8 IS
...
END full_tx_ip_src_SDFCommutator8;


ARCHITECTURE rtl OF full_tx_ip_src_SDFCommutator8 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL xf_im_signed                     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dinf_re_signed                   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dinf_im_signed                   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL btf1_re_signed                   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL btf1_im_signed                   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL btf2_re_signed                   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL btf2_im_signed                   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFCummutator_out_re             : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL SDFCummutator_out_im             : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL SDFCummutator_wrData_im_reg      : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL SDFCummutator_btf1_im_dly        : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL SDFCummutator_btf1_vld_dly       : std_logic;
  SIGNAL SDFCummutator_out_re_next        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFCummutator_out_im_next        : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL wrData_im_tmp                    : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL xData_re                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL xData_im                         : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dout0_re                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout0_im                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL xX_re_signed                     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL xX_im                            : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL xX_im_signed                     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_8_1_re_tmp                  : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout_8_1_im_tmp                  : signed(11 DOWNTO 0);  -- sfix12_En10

BEGIN
  u_dataXMEM_re_0_8 : full_tx_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_8 : full_tx_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        SDFCummutator_out_re <= to_signed(16#000#, 12);
        SDFCummutator_out_im <= to_signed(16#000#, 12);
        SDFCummutator_wrData_re_reg <= to_signed(16#000#, 12);
        SDFCummutator_wrData_im_reg <= to_signed(16#000#, 12);
        SDFCummutator_wrEnb_reg <= '0';
        SDFCummutator_out_vld <= '0';
        SDFCummutator_wrState <= to_unsigned(16#0#, 3);
        SDFCummutator_wrAddr_reg <= '0';
        SDFCummutator_wrXData_re_reg <= to_signed(16#000#, 12);
        SDFCummutator_wrXData_im_reg <= to_signed(16#000#, 12);
        ...
        SDFCummutator_btf1_re_dly <= to_signed(16#000#, 12);
        SDFCummutator_btf1_im_dly <= to_signed(16#000#, 12);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      ...
      WHEN "100" =>
        ...
        END IF;
      WHEN OTHERS => 
        SDFCummutator_wrXData_re_reg_next <= to_signed(16#000#, 12);
        SDFCummutator_wrXData_im_reg_next <= to_signed(16#000#, 12);
        SDFCummutator_xWrAddr_next <= to_unsigned(16#0#, 3);
        SDFCummutator_xRdAddr_next <= to_unsigned(16#0#, 3);
        SDFCummutator_wrxEnb_reg_next <= '0';
        SDFCummutator_XState_next <= to_unsigned(16#0#, 3);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        SDFOutmux_btf2Pipe_re <= to_signed(16#000#, 12);
        SDFOutmux_btf2Pipe_im <= to_signed(16#000#, 12);
