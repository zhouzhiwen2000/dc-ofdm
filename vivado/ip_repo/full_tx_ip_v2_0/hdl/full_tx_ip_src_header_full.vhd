-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_header_full.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_header_full
...
ENTITY full_tx_ip_src_header_full IS
...
END full_tx_ip_src_header_full;


ARCHITECTURE rtl OF full_tx_ip_src_header_full IS

  -- Component Declarations
  COMPONENT full_tx_ip_src_h_gen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_src_h_crc
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_src_h_scrambler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in                         :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_src_header_fec
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in                         :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_src_h_repetition
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in                         :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_src_h_gen
    USE ENTITY work.full_tx_ip_src_h_gen(rtl);

  FOR ALL : full_tx_ip_src_h_crc
    USE ENTITY work.full_tx_ip_src_h_crc(rtl);

  FOR ALL : full_tx_ip_src_h_scrambler
    USE ENTITY work.full_tx_ip_src_h_scrambler(rtl);

  FOR ALL : full_tx_ip_src_header_fec
    USE ENTITY work.full_tx_ip_src_header_fec(rtl);

  FOR ALL : full_tx_ip_src_h_repetition
    USE ENTITY work.full_tx_ip_src_h_repetition(rtl);
...
BEGIN
  ...
  u_h_scrambler : full_tx_ip_src_h_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data_in => h_crc_out1,
  ...
  u_header_fec : full_tx_ip_src_header_fec
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_h_repetition : full_tx_ip_src_h_repetition
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data_in => dataOut,
