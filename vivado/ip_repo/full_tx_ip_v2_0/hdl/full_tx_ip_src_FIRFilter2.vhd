...
ARCHITECTURE rtl OF full_tx_ip_src_FIRFilter2 IS
  ...
  COMPONENT full_tx_ip_src_Addressable_Delay_Line_block7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_src_Addressable_Delay_Line_block8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : full_tx_ip_src_Addressable_Delay_Line_block7
    USE ENTITY work.full_tx_ip_src_Addressable_Delay_Line_block7(rtl);

  FOR ALL : full_tx_ip_src_FilterTapSystolic
    USE ENTITY work.full_tx_ip_src_FilterTapSystolic(rtl);

  FOR ALL : full_tx_ip_src_Addressable_Delay_Line_block8
    USE ENTITY work.full_tx_ip_src_Addressable_Delay_Line_block8(rtl);
...
BEGIN
  ...
  u_delayLine0 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8 : full_tx_ip_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8_1 : full_tx_ip_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
