-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_RADIX22FFT_SDF2_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_RADIX22FFT_SDF2_2
-- Source Path: HDLTx/full_tx/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF2_2
-- Hierarchy Level: 5
-- Model version: 4.102
-- 
-- -------------------------------------------------------------
...
ENTITY full_tx_ip_src_RADIX22FFT_SDF2_2 IS
...
END full_tx_ip_src_RADIX22FFT_SDF2_2;


ARCHITECTURE rtl OF full_tx_ip_src_RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT full_tx_ip_src_SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_src_SDFCommutator2
    USE ENTITY work.full_tx_ip_src_SDFCommutator2(rtl);

  -- Signals
  SIGNAL dout_1_1_re_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout_1_1_im_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dout_2_1_re_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL dout_2_1_im_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_dataMEM_im_0_2 : full_tx_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_2 : full_tx_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : full_tx_ip_src_SDFCommutator2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              ...
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_2_1_re => dout_2_1_re_tmp,  -- sfix12_En10
              dout_2_1_im => dout_2_1_im_tmp,  -- sfix12_En10
