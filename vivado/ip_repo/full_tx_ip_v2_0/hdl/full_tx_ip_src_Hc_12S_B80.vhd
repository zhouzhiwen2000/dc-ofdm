-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_Hc_12S_B80.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_Hc_12S_B80
...
ENTITY full_tx_ip_src_Hc_12S_B80 IS
...
END full_tx_ip_src_Hc_12S_B80;


ARCHITECTURE rtl OF full_tx_ip_src_Hc_12S_B80 IS
  ...
  COMPONENT full_tx_ip_src_Calculate_Alpha_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_src_Calculate_Parity_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT full_tx_ip_src_Final_Output_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : full_tx_ip_src_Calculate_Alpha_block
    USE ENTITY work.full_tx_ip_src_Calculate_Alpha_block(rtl);

  FOR ALL : full_tx_ip_src_Calculate_Parity_block
    USE ENTITY work.full_tx_ip_src_Calculate_Parity_block(rtl);

  FOR ALL : full_tx_ip_src_Final_Output_block
    USE ENTITY work.full_tx_ip_src_Final_Output_block(rtl);
...
BEGIN
  u_Input_RAM : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
  ...
  u_Input_RAM_1 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_2 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_3 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_4 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_5 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_6 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_7 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_8 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_9 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_10 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_11 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_12 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_13 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_14 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_15 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_16 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_17 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_18 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_19 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_20 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_21 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_22 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_23 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_24 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_25 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_26 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_27 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_28 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_29 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_30 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_31 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_32 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_33 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_34 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_35 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_36 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_37 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_38 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_39 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_40 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_41 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_42 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_43 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_44 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_45 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_46 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_47 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_48 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_49 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_50 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_51 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_52 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_53 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_54 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_55 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_56 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_57 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_58 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_59 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_60 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_61 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_62 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_63 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_64 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_65 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_66 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_67 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_68 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_69 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_70 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_71 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_72 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_73 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_74 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_75 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_76 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_77 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_78 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_79 : full_tx_ip_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Calculate_Alpha : full_tx_ip_src_Calculate_Alpha_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Calculate_Parity : full_tx_ip_src_Calculate_Parity_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
  ...
  u_Final_output : full_tx_ip_src_Final_Output_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
