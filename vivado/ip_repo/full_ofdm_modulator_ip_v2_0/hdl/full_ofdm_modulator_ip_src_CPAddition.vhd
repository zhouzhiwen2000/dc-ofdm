-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_CPAddition.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_CPAddition
-- Source Path: 
-- Hierarchy Level: 3
-- Model version: 1.36
-- 
...
ENTITY full_ofdm_modulator_ip_src_CPAddition IS
...
END full_ofdm_modulator_ip_src_CPAddition;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_CPAddition IS
  ...
  SIGNAL obj_CPAdditionObj_dataOutReg_re  : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_dataOutReg_im  : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL obj_CPAdditionObj_dataInReg1_reg_reg_re : vector_of_signed12(0 TO 1);  -- sfix12_En10 [2]
  SIGNAL obj_CPAdditionObj_dataInReg1_reg_reg_im : vector_of_signed12(0 TO 1);  -- sfix12_En10 [2]
  SIGNAL obj_CPAdditionObj_dataInReg1_re  : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_dataInReg1_im  : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL obj_CPAdditionObj_dataVecReg_re  : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_dataVecReg_im  : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL obj_CPAdditionObj_dataVec2_re    : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_dataVec2_im    : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL obj_CPAdditionObj_prevSymb_re    : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_prevSymb_im    : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL obj_CPAdditionObj_prevVecData_re : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_prevVecData_im : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL tmp_re_19                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_19                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_20                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_20                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_21                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_21                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_22                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_22                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_23                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_23                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_24                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_24                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_dataVec1_re    : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_dataVec1_im    : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_25                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_25                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_26                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_26                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_27                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_27                        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_dataOut_reg_reg_re : vector_of_signed12(0 TO 1);  -- sfix12_En10 [2]
  SIGNAL obj_CPAdditionObj_dataOut_reg_reg_im : vector_of_signed12(0 TO 1);  -- sfix12_En10 [2]
  SIGNAL obj_CPAdditionObj_dataOut_re     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_CPAdditionObj_dataOut_im     : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  u_simpleDualPortRam_1 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  obj_CPAdditionObj_dataOutReg_re <= to_signed(16#000#, 12);
  obj_CPAdditionObj_dataOutReg_im <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_CPAdditionObj_dataInReg1_reg_reg_re <= (OTHERS => to_signed(16#000#, 12));
        obj_CPAdditionObj_dataInReg1_reg_reg_im <= (OTHERS => to_signed(16#000#, 12));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        tmp_re <= to_signed(16#000#, 12);
        tmp_im <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
        tmp_re <= tmp_re_2;
        tmp_im <= tmp_im_2;
      END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_CPAdditionObj_dataVecReg_re <= to_signed(16#000#, 12);
        obj_CPAdditionObj_dataVecReg_im <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_CPAdditionObj_dataVec2_re <= to_signed(16#000#, 12);
        obj_CPAdditionObj_dataVec2_im <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_CPAdditionObj_prevSymb_re <= to_signed(16#000#, 12);
        obj_CPAdditionObj_prevSymb_im <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_CPAdditionObj_prevVecData_re <= to_signed(16#000#, 12);
        obj_CPAdditionObj_prevVecData_im <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_CPAdditionObj_dataVec1_re <= to_signed(16#000#, 12);
        obj_CPAdditionObj_dataVec1_im <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_CPAdditionObj_dataOut_reg_reg_re <= (OTHERS => to_signed(16#000#, 12));
        obj_CPAdditionObj_dataOut_reg_reg_im <= (OTHERS => to_signed(16#000#, 12));
      ELSIF enb_1_2_0 = '1' THEN
