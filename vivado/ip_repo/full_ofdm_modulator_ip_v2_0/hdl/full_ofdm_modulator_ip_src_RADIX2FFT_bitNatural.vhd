-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_RADIX2FFT_bitNatural.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_RADIX2FFT_bitNatural
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX2FFT_bitNatural
-- Hierarchy Level: 4
-- Model version: 1.36
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_RADIX2FFT_bitNatural IS
...
END full_ofdm_modulator_ip_src_RADIX2FFT_bitNatural;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_RADIX2FFT_bitNatural IS
  ...
  SIGNAL memOut_im                        : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL memOut_im_signed                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL memOut_re                        : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL memOut_re_signed                 : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dout_re1_tmp                     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout_im1_tmp                     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL startOutW                        : std_logic;
  SIGNAL endOutW                          : std_logic;

BEGIN
  u_dataMEM_im_1 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_1 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        ...
        rdStateMachineBitNatural_doutReReg <= to_signed(16#000#, 12);
        rdStateMachineBitNatural_doutImReg <= to_signed(16#000#, 12);
