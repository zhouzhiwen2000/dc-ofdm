-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_4
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF2_4
-- Hierarchy Level: 4
-- Model version: 1.36
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_4 IS
...
END full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT full_ofdm_modulator_ip_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : full_ofdm_modulator_ip_src_SDFCommutator4
    USE ENTITY work.full_ofdm_modulator_ip_src_SDFCommutator4(rtl);

  -- Signals
  SIGNAL dout_3_1_re_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout_3_1_im_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dout_4_1_re_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL dout_4_1_im_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_dataMEM_im_0_4 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_0_4 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : full_ofdm_modulator_ip_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              ...
              wrAddr => wrAddr,  -- ufix4
              wrEnb => wrEnb,
              dout_4_1_re => dout_4_1_re_tmp,  -- sfix12_En10
              dout_4_1_im => dout_4_1_im_tmp,  -- sfix12_En10
