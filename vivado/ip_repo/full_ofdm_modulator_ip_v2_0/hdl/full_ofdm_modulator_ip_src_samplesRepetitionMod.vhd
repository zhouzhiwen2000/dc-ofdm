-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_samplesRepetitionMod.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_samplesRepetitionMod
-- Source Path: 
-- Hierarchy Level: 3
-- Model version: 1.36
-- 
...
ENTITY full_ofdm_modulator_ip_src_samplesRepetitionMod IS
...
END full_ofdm_modulator_ip_src_samplesRepetitionMod;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_samplesRepetitionMod IS
  ...
  SIGNAL obj_samplesRepetitionObj_dataOutReg_re : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataOutReg_im : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL varargin_1_re_signed             : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL varargin_1_im_signed             : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataInReg_re : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataInReg_im : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re                           : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im                           : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataInReg_re_1 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataInReg_im_1 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataInReg1_re : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataInReg1_im : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_1                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_1                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataInReg1_re_1 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataInReg1_im_1 : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL obj_samplesRepetitionObj_dataOutReg_re_1 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataOutReg_im_1 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_4                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_4                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataOutReg_re_2 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataOutReg_im_2 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataOut_re : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataOut_im : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_re_5                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_im_5                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataOut_re_1 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_samplesRepetitionObj_dataOut_im_1 : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  obj_samplesRepetitionObj_dataOutReg_re <= to_signed(16#000#, 12);
  obj_samplesRepetitionObj_dataOutReg_im <= to_signed(16#000#, 12);

  varargin_1_re_signed <= signed(varargin_1_re);

  varargin_1_im_signed <= signed(varargin_1_im);

  obj_samplesRepetitionObj_dataInReg_re <= to_signed(16#000#, 12);
  obj_samplesRepetitionObj_dataInReg_im <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_samplesRepetitionObj_dataInReg_re_1 <= to_signed(16#000#, 12);
        obj_samplesRepetitionObj_dataInReg_im_1 <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  obj_samplesRepetitionObj_dataInReg1_re <= to_signed(16#000#, 12);
  obj_samplesRepetitionObj_dataInReg1_im <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_samplesRepetitionObj_dataInReg1_re_1 <= to_signed(16#000#, 12);
        obj_samplesRepetitionObj_dataInReg1_im_1 <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  obj_samplesRepetitionObj_dataOutReg_re_1 <= to_signed(16#000#, 12);
  obj_samplesRepetitionObj_dataOutReg_im_1 <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_samplesRepetitionObj_dataOutReg_re_2 <= to_signed(16#000#, 12);
        obj_samplesRepetitionObj_dataOutReg_im_2 <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  obj_samplesRepetitionObj_dataOut_re <= to_signed(16#000#, 12);
  obj_samplesRepetitionObj_dataOut_im <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_samplesRepetitionObj_dataOut_re_1 <= to_signed(16#000#, 12);
        obj_samplesRepetitionObj_dataOut_im_1 <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
