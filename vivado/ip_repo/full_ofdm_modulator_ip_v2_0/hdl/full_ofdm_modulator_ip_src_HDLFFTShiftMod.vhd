-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_HDLFFTShiftMod.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_HDLFFTShiftMod
-- Source Path: 
-- Hierarchy Level: 3
-- Model version: 1.36
-- 
...
ENTITY full_ofdm_modulator_ip_src_HDLFFTShiftMod IS
...
END full_ofdm_modulator_ip_src_HDLFFTShiftMod;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_HDLFFTShiftMod IS
  ...
  SIGNAL tmp                              : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL tmp_4                            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL temp1                            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL p33temp1_cast                    : signed(12 DOWNTO 0);  -- sfix13_En10
  SIGNAL p33temp1_cast_1                  : signed(12 DOWNTO 0);  -- sfix13_En10
  SIGNAL tmp_5                            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_6                            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_HDLFFTShiftModObj_rePart     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_7                            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_HDLFFTShiftModObj_rePart_1   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_8                            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_9                            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL temp2                            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL p32temp2_cast                    : signed(12 DOWNTO 0);  -- sfix13_En10
  SIGNAL p32temp2_cast_1                  : signed(12 DOWNTO 0);  -- sfix13_En10
  SIGNAL tmp_10                           : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_11                           : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_HDLFFTShiftModObj_imPart     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL tmp_12                           : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL obj_HDLFFTShiftModObj_imPart_1   : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL varargout_1_re_tmp               : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL varargout_1_im_tmp               : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  p33temp1_cast <= resize(varargin_1_re_signed, 13);
  p33temp1_cast_1 <=  - (p33temp1_cast);
  temp1 <= p33temp1_cast_1(11 DOWNTO 0);
  ...
  obj_HDLFFTShiftModObj_rePart <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_HDLFFTShiftModObj_rePart_1 <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  p32temp2_cast <= resize(varargin_1_im_signed, 13);
  p32temp2_cast_1 <=  - (p32temp2_cast);
  temp2 <= p32temp2_cast_1(11 DOWNTO 0);
  ...
  obj_HDLFFTShiftModObj_imPart <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_HDLFFTShiftModObj_imPart_1 <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
