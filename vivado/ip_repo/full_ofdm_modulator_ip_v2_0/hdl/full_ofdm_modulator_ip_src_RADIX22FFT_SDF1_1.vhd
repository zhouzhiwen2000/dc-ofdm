-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_1
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF1_1
-- Hierarchy Level: 4
-- Model version: 1.36
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_1 IS
...
END full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_1;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_1 IS
  ...
  COMPONENT full_ofdm_modulator_ip_src_SDFCommutator1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : full_ofdm_modulator_ip_src_SDFCommutator1
    USE ENTITY work.full_ofdm_modulator_ip_src_SDFCommutator1(rtl);

  -- Signals
  SIGNAL din_1_1_re_dly_signed            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dinXTwdl_re                      : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_1_1_im_dly_signed            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dinXTwdl_im                      : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dout_1_1_re_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL dout_1_1_im_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_dataMEM_im_0_1 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_0_1_generic : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 7,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : full_ofdm_modulator_ip_src_SDFCommutator1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              ...
              wrAddr => wrAddr,  -- ufix7
              wrEnb => wrEnb,
              dout_1_1_re => dout_1_1_re_tmp,  -- sfix12_En10
              dout_1_1_im => dout_1_1_im_tmp,  -- sfix12_En10
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        dinXTwdl_re <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        dinXTwdl_im <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
