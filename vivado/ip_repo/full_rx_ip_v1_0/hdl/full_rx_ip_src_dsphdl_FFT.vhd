...
ARCHITECTURE rtl OF full_rx_ip_src_dsphdl_FFT IS
  ...
  COMPONENT full_rx_ip_src_RADIX22FFT_SDF1_1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_1_1_re_dly                  :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          din_1_1_im_dly                  :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          din_1_vld_dly                   :   IN    std_logic;
          rd_1_Addr                       :   IN    std_logic_vector(6 DOWNTO 0);  -- ufix7
          rd_1_Enb                        :   IN    std_logic;
          proc_1_enb                      :   IN    std_logic;
          dout_1_1_re                     :   OUT   std_logic_vector(16 DOWNTO 0);  -- sfix17_En12
          dout_1_1_im                     :   OUT   std_logic_vector(16 DOWNTO 0);  -- sfix17_En12
  ...
  COMPONENT full_rx_ip_src_RADIX22FFT_SDF2_2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_1_1_re                     :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En12
          dout_1_1_im                     :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En12
          dout_1_1_vld                    :   IN    std_logic;
          rd_2_Addr                       :   IN    std_logic_vector(5 DOWNTO 0);  -- ufix6
          rd_2_Enb                        :   IN    std_logic;
          proc_2_enb                      :   IN    std_logic;
          multiply_2_J                    :   IN    std_logic;
          dout_2_1_re                     :   OUT   std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          dout_2_1_im                     :   OUT   std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
  ...
  COMPONENT full_rx_ip_src_RADIX22FFT_SDF1_3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_3_1_re_dly                  :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          din_3_1_im_dly                  :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          ...
          dout_3_1_re                     :   OUT   std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          dout_3_1_im                     :   OUT   std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
  ...
  COMPONENT full_rx_ip_src_RADIX22FFT_SDF2_4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_3_1_re                     :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          dout_3_1_im                     :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          dout_3_1_vld                    :   IN    std_logic;
          rd_4_Addr                       :   IN    std_logic_vector(3 DOWNTO 0);  -- ufix4
          rd_4_Enb                        :   IN    std_logic;
          proc_4_enb                      :   IN    std_logic;
          multiply_4_J                    :   IN    std_logic;
          dout_4_1_re                     :   OUT   std_logic_vector(19 DOWNTO 0);  -- sfix20_En12
          dout_4_1_im                     :   OUT   std_logic_vector(19 DOWNTO 0);  -- sfix20_En12
  ...
  COMPONENT full_rx_ip_src_RADIX22FFT_SDF1_5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_1_re_dly                  :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En12
          din_5_1_im_dly                  :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En12
          ...
          dout_5_1_re                     :   OUT   std_logic_vector(20 DOWNTO 0);  -- sfix21_En12
          dout_5_1_im                     :   OUT   std_logic_vector(20 DOWNTO 0);  -- sfix21_En12
  ...
  COMPONENT full_rx_ip_src_RADIX22FFT_SDF2_6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_5_1_re                     :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En12
          dout_5_1_im                     :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En12
          dout_5_1_vld                    :   IN    std_logic;
          rd_6_Addr                       :   IN    std_logic_vector(1 DOWNTO 0);  -- ufix2
          rd_6_Enb                        :   IN    std_logic;
          proc_6_enb                      :   IN    std_logic;
          multiply_6_J                    :   IN    std_logic;
          dout_6_1_re                     :   OUT   std_logic_vector(21 DOWNTO 0);  -- sfix22_En12
          dout_6_1_im                     :   OUT   std_logic_vector(21 DOWNTO 0);  -- sfix22_En12
  ...
  COMPONENT full_rx_ip_src_RADIX22FFT_SDF1_7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_7_1_re_dly                  :   IN    std_logic_vector(21 DOWNTO 0);  -- sfix22_En12
          din_7_1_im_dly                  :   IN    std_logic_vector(21 DOWNTO 0);  -- sfix22_En12
          ...
          dout_7_1_re                     :   OUT   std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          dout_7_1_im                     :   OUT   std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
  ...
  COMPONENT full_rx_ip_src_RADIX22FFT_SDF2_8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_7_1_re                     :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          dout_7_1_im                     :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          dout_7_1_vld                    :   IN    std_logic;
          rd_8_Addr                       :   IN    std_logic;
          rd_8_Enb                        :   IN    std_logic;
          proc_8_enb                      :   IN    std_logic;
          multiply_8_J                    :   IN    std_logic;
          dout_8_1_re                     :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          dout_8_1_im                     :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
  ...
  COMPONENT full_rx_ip_src_RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_8_1_re                     :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          dout_8_1_im                     :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          dout_8_1_vld                    :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          dout_im1                        :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL din_1_1_re_dly                   : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL intdelay_reg_1                   : vector_of_signed16(0 TO 2);  -- sfix16 [3]
  SIGNAL din_1_1_im_dly                   : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL dout_2_1_re_signed               : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL dout_2_1_im_signed               : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL intdelay_reg_3                   : vector_of_signed18(0 TO 2);  -- sfix18 [3]
  SIGNAL din_3_1_re_dly                   : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL intdelay_reg_4                   : vector_of_signed18(0 TO 2);  -- sfix18 [3]
  SIGNAL din_3_1_im_dly                   : signed(17 DOWNTO 0);  -- sfix18_En12
  ...
  SIGNAL dout_4_1_re_signed               : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL dout_4_1_im_signed               : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL intdelay_reg_6                   : vector_of_signed20(0 TO 2);  -- sfix20 [3]
  SIGNAL din_5_1_re_dly                   : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL intdelay_reg_7                   : vector_of_signed20(0 TO 2);  -- sfix20 [3]
  SIGNAL din_5_1_im_dly                   : signed(19 DOWNTO 0);  -- sfix20_En12
  ...
  SIGNAL dout_6_1_re_signed               : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL dout_6_1_im_signed               : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL intdelay_reg_9                   : vector_of_signed22(0 TO 2);  -- sfix22 [3]
  SIGNAL din_7_1_re_dly                   : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL intdelay_reg_10                  : vector_of_signed22(0 TO 2);  -- sfix22 [3]
  SIGNAL din_7_1_im_dly                   : signed(21 DOWNTO 0);  -- sfix22_En12
...
BEGIN
  ...
  u_SDF1_1_1 : full_rx_ip_src_RADIX22FFT_SDF1_1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_1_1_re_dly => std_logic_vector(din_1_1_re_dly),  -- sfix16_En12
              din_1_1_im_dly => std_logic_vector(din_1_1_im_dly),  -- sfix16_En12
              din_1_vld_dly => din_1_vld_dly,
              rd_1_Addr => rd_1_Addr,  -- ufix7
              rd_1_Enb => rd_1_Enb,
              proc_1_enb => proc_1_enb,
              dout_1_1_re => dout_1_1_re,  -- sfix17_En12
              dout_1_1_im => dout_1_1_im,  -- sfix17_En12
  ...
  u_SDF2_2_1 : full_rx_ip_src_RADIX22FFT_SDF2_2
    PORT MAP( clk => clk,
              ...
              proc_2_enb => proc_2_enb,
              multiply_2_J => multiply_2_J,
              dout_2_1_re => dout_2_1_re,  -- sfix18_En12
              dout_2_1_im => dout_2_1_im,  -- sfix18_En12
  ...
  u_SDF1_3_1 : full_rx_ip_src_RADIX22FFT_SDF1_3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_3_1_re_dly => std_logic_vector(din_3_1_re_dly),  -- sfix18_En12
              din_3_1_im_dly => std_logic_vector(din_3_1_im_dly),  -- sfix18_En12
              ...
              twdl_3_1_im => twdl_3_1_im,  -- sfix16_En14
              proc_3_enb => proc_3_enb,
              dout_3_1_re => dout_3_1_re,  -- sfix19_En12
              dout_3_1_im => dout_3_1_im,  -- sfix19_En12
  ...
  u_SDF2_4_1 : full_rx_ip_src_RADIX22FFT_SDF2_4
    PORT MAP( clk => clk,
              ...
              proc_4_enb => proc_4_enb,
              multiply_4_J => multiply_4_J,
              dout_4_1_re => dout_4_1_re,  -- sfix20_En12
              dout_4_1_im => dout_4_1_im,  -- sfix20_En12
  ...
  u_SDF1_5_1 : full_rx_ip_src_RADIX22FFT_SDF1_5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_5_1_re_dly => std_logic_vector(din_5_1_re_dly),  -- sfix20_En12
              din_5_1_im_dly => std_logic_vector(din_5_1_im_dly),  -- sfix20_En12
              ...
              twdl_5_1_im => twdl_5_1_im,  -- sfix16_En14
              proc_5_enb => proc_5_enb,
              dout_5_1_re => dout_5_1_re,  -- sfix21_En12
              dout_5_1_im => dout_5_1_im,  -- sfix21_En12
  ...
  u_SDF2_6_1 : full_rx_ip_src_RADIX22FFT_SDF2_6
    PORT MAP( clk => clk,
              ...
              proc_6_enb => proc_6_enb,
              multiply_6_J => multiply_6_J,
              dout_6_1_re => dout_6_1_re,  -- sfix22_En12
              dout_6_1_im => dout_6_1_im,  -- sfix22_En12
  ...
  u_SDF1_7_1 : full_rx_ip_src_RADIX22FFT_SDF1_7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_7_1_re_dly => std_logic_vector(din_7_1_re_dly),  -- sfix22_En12
              din_7_1_im_dly => std_logic_vector(din_7_1_im_dly),  -- sfix22_En12
              ...
              twdl_7_1_im => twdl_7_1_im,  -- sfix16_En14
              proc_7_enb => proc_7_enb,
              dout_7_1_re => dout_7_1_re,  -- sfix23_En12
              dout_7_1_im => dout_7_1_im,  -- sfix23_En12
  ...
  u_SDF2_8_1 : full_rx_ip_src_RADIX22FFT_SDF2_8
    PORT MAP( clk => clk,
              ...
              proc_8_enb => proc_8_enb,
              multiply_8_J => multiply_8_J,
              dout_8_1_re => dout_8_1_re,  -- sfix24_En12
              dout_8_1_im => dout_8_1_im,  -- sfix24_En12
  ...
  u_NaturalOrder_Stage : full_rx_ip_src_RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              ...
              dout_8_1_im => dout_8_1_im,  -- sfix24_En12
              dout_8_1_vld => dout_8_1_vld,
              dout_re1 => dout_re1,  -- sfix24_En12
              dout_im1 => dout_im1,  -- sfix24_En12
              dout_vld1 => dout_vld1,
              startOutS => startOutS
              );
  ...
  intdelay_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_5_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_6_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_7_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_8_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_9_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_10_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  intdelay_11_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
