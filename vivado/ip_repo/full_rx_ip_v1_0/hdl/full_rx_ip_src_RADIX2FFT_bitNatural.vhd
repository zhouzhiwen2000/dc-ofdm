-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_RADIX2FFT_bitNatural.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_RADIX2FFT_bitNatural
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX2FFT_bitNatural
-- Hierarchy Level: 5
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_RADIX2FFT_bitNatural IS
...
END full_rx_ip_src_RADIX2FFT_bitNatural;


ARCHITECTURE rtl OF full_rx_ip_src_RADIX2FFT_bitNatural IS
  ...
  SIGNAL memOut_im_signed                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL memOut_re                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL memOut_re_signed                 : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL dout_re1_tmp                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dout_im1_tmp                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL startOutW                        : std_logic;
  SIGNAL endOutW                          : std_logic;

BEGIN
  u_dataMEM_im_1 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataMEM_re_1 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  wrStateMachineBitNatural_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  rdStateMachineBitNatural_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
