...
ARCHITECTURE rtl OF full_rx_ip_src_downshifter IS
  ...
  SIGNAL Gain_mul_temp                    : signed(63 DOWNTO 0);  -- sfix64_En31
...
BEGIN
  ...
  Gain_mul_temp <= to_signed(720575940, 32) * Delay6_out1;
  Gain_out1 <= unsigned(Gain_mul_temp(62 DOWNTO 31)) + ('0' & (Gain_mul_temp(30) AND (( NOT Gain_mul_temp(63)) OR (Gain_mul_temp(29) OR Gain_mul_temp(28) OR Gain_mul_temp(27) OR Gain_mul_temp(26) OR Gain_mul_temp(25) OR Gain_mul_temp(24) OR Gain_mul_temp(23) OR Gain_mul_temp(22) OR Gain_mul_temp(21) OR Gain_mul_temp(20) OR Gain_mul_temp(19) OR Gain_mul_temp(18) OR Gain_mul_temp(17) OR Gain_mul_temp(16) OR Gain_mul_temp(15) OR Gain_mul_temp(14) OR Gain_mul_temp(13) OR Gain_mul_temp(12) OR Gain_mul_temp(11) OR Gain_mul_temp(10) OR Gain_mul_temp(9) OR Gain_mul_temp(8) OR Gain_mul_temp(7) OR Gain_mul_temp(6) OR Gain_mul_temp(5) OR Gain_mul_temp(4) OR Gain_mul_temp(3) OR Gain_mul_temp(2) OR Gain_mul_temp(1) OR Gain_mul_temp(0)))));
