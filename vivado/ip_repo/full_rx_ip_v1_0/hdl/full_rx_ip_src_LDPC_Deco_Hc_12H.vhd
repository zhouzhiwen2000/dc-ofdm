...
ARCHITECTURE rtl OF full_rx_ip_src_LDPC_Deco_Hc_12H IS
  ...
  COMPONENT full_rx_ip_src_CodeParameters
    PORT( clk                             :   IN    std_logic;
          ...
          datacp                          :   OUT   std_logic_vector(7 DOWNTO 0);  -- sfix8
  ...
  SIGNAL dataIn                           : signed(7 DOWNTO 0);  -- int8
  ...
  SIGNAL dataOut_signed                   : signed(7 DOWNTO 0);  -- sfix8
  SIGNAL dataDTC                          : signed(9 DOWNTO 0);  -- sfix10
...
BEGIN
  u_Code_Parameters : full_rx_ip_src_CodeParameters
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => std_logic_vector(dataIn),  -- int8
              start => startIn,
              end_rsvd => endIn,
              valid => validIn,
              reset => reset,  -- ufix1
              datacp => dataOut,  -- sfix8
              validcp => valid,  -- ufix1
  ...
  u_Decoder_Core : full_rx_ip_src_DecoderCore
    PORT MAP( clk => clk,
              ...
              enb => enb,
              reset => reset,  -- ufix1
              data => std_logic_vector(dataDTC),  -- sfix10
              valid => valid,  -- ufix1
              framevalid => frameValid,  -- ufix1
  ...
  dataDTC <= resize(dataOut_signed, 10);
