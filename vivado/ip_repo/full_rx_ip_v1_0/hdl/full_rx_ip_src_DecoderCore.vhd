...
ARCHITECTURE rtl OF full_rx_ip_src_DecoderCore IS
  ...
  COMPONENT full_rx_ip_src_FunctionalUnit
    PORT( clk                             :   IN    std_logic;
          ...
          betaComp3                       :   IN    vector_of_std_logic_vector30(0 TO 13);  -- ufix30 [14]
          ...
          cnuComp3                        :   OUT   vector_of_std_logic_vector30(0 TO 13);  -- ufix30 [14]
  ...
  SIGNAL wrData                           : vector_of_signed18(0 TO 13);  -- sfix18_En12 [14]
  ...
  SIGNAL sData                            : vector_of_std_logic_vector18(0 TO 13);  -- ufix18 [14]
  SIGNAL sData_signed                     : vector_of_signed18(0 TO 13);  -- sfix18_En12 [14]
  ...
  SIGNAL bDecomp3                         : vector_of_std_logic_vector30(0 TO 13);  -- ufix30 [14]
  ...
  SIGNAL cDecomp3                         : vector_of_std_logic_vector30(0 TO 13);  -- ufix30 [14]
  ...
  SIGNAL gamma                            : vector_of_std_logic_vector18(0 TO 13);  -- ufix18 [14]
  SIGNAL gamma_signed                     : vector_of_signed18(0 TO 13);  -- sfix18_En12 [14]
  SIGNAL colData                          : vector_of_signed18(0 TO 13);  -- sfix18_En12 [14]
  SIGNAL sDataIn                          : vector_of_signed18(0 TO 13);  -- sfix18_En12 [14]
  SIGNAL sDataIn_1                        : vector_of_std_logic_vector18(0 TO 13);  -- ufix18 [14]
  SIGNAL validMCNeg                       : std_logic;  -- ufix1
  SIGNAL layerDone                        : std_logic;  -- ufix1
  SIGNAL layerDoneReg                     : std_logic;  -- ufix1
  SIGNAL iterationController_wrData       : vector_of_signed18(0 TO 13);  -- sfix18 [14]
  ...
  SIGNAL iterationController_wrData_next  : vector_of_signed18(0 TO 13);  -- sfix18_En12 [14]
  ...
  SIGNAL colData_1                        : vector_of_std_logic_vector18(0 TO 13);  -- ufix18 [14]
...
BEGIN
  ...
  u_BetaMemory : full_rx_ip_src_CheckNodeRAM
    PORT MAP( clk => clk,
              ...
              bdecomp3Out => cDecomp3,  -- ufix30 [14]
  ...
  u_Barrel_Rotator_Unit : full_rx_ip_src_BarrelRotator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => sDataIn_1,  -- sfix18_En12 [14]
              shift => std_logic_vector(sValIn),  -- ufix4
              shiftData => sData  -- sfix18_En12 [14]
              );
