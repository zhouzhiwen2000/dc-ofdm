-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_CheckNodeUnit.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_CheckNodeUnit
-- Source Path: HDLRx/full_rx/h_rx_full/LDPC_Deco_Hc_12H/DecoderCore/FunctionalUnit/CheckNodeUnit
-- Hierarchy Level: 5
-- Model version: 1.14
-- 
-- Check Node Unit
...
ENTITY full_rx_ip_src_CheckNodeUnit IS
...
END full_rx_ip_src_CheckNodeUnit;


ARCHITECTURE rtl OF full_rx_ip_src_CheckNodeUnit IS
  ...
  -- Signals
  SIGNAL data_signed                      : vector_of_signed8(0 TO 13);  -- sfix8 [14]
  SIGNAL alpha_reg                        : vector_of_signed8(0 TO 27);  -- sfix8 [28]
  SIGNAL dataReg                          : vector_of_signed8(0 TO 13);  -- sfix8 [14]
  ...
  SIGNAL dataAbs                          : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  SIGNAL minCalculation_minVal1           : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  SIGNAL minCalculation_minVal2           : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  SIGNAL minCalculation_dataAbs           : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  ...
  SIGNAL minCalculation_minVal1_next      : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  SIGNAL minCalculation_minVal2_next      : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  SIGNAL minCalculation_dataAbs_next      : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  ...
  SIGNAL minVal1                          : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  SIGNAL minVal2                          : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  ...
  SIGNAL min1_DTC_0                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min2_DTC                         : vector_of_unsigned7(0 TO 13);  -- ufix7 [14]
  SIGNAL min1_DTC_1                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_2                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_3                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_4                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_5                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_6                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_7                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_8                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_9                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_10                      : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_11                      : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_12                      : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min1_DTC_13                      : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL min2_DTC_0                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_1                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_1                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_2                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_2                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_3                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_3                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_4                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_4                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_5                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_5                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_6                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_6                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_7                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_7                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_8                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_8                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_9                  : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_9                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_10                 : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_10                      : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_11                 : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_11                      : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_12                 : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_12                      : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_13                 : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL min2_DTC_13                      : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL betacomp3_arr_14                 : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL betacomp3D                       : vector_of_unsigned14(0 TO 13);  -- ufix14 [14]
...
BEGIN
  ...
  BEGIN
    IF reset_x = '1' THEN
      alpha_reg <= (OTHERS => to_signed(16#00#, 8));
  ...
  abs_rsvd_output : PROCESS (dataReg)
    VARIABLE extend_temp : signed(8 DOWNTO 0);
  BEGIN
    extend_temp := to_signed(16#000#, 9);

    FOR k IN 0 TO 13 LOOP
      IF dataReg(k) < to_signed(16#00#, 8) THEN 
        extend_temp :=  - (resize(dataReg(k), 9));
      ELSE 
        extend_temp := resize(dataReg(k), 9);
      END IF;
      dataAbs(k) <= unsigned(extend_temp(7 DOWNTO 0));
    END LOOP;
  ...
  BEGIN
    IF reset_x = '1' THEN
      ...
      minCalculation_minVal1 <= (OTHERS => to_unsigned(16#7F#, 8));
      minCalculation_minVal2 <= (OTHERS => to_unsigned(16#7F#, 8));
      minCalculation_dataAbs <= (OTHERS => to_unsigned(16#00#, 8));
  ...
  minCalculation_output : PROCESS (countU, dataAbs, dataReg, extReset, minCalculation_countIdx,
    ...
    VARIABLE minVal1_temp : vector_of_unsigned8(0 TO 13);
    VARIABLE minVal2_temp : vector_of_unsigned8(0 TO 13);
  ...
  BEGIN
    ...
    IF extReset /= '0' THEN 
      countIdx_temp := to_unsigned(16#0#, 3);
      minVal1_temp := (OTHERS => to_unsigned(16#7F#, 8));
      minVal2_temp := (OTHERS => to_unsigned(16#7F#, 8));
  ...
  min1_DTC_gen: FOR ii IN 0 TO 13 GENERATE
    ...
    min1_DTC(ii) <= "1111111" WHEN minVal1(ii)(7) /= '0' ELSE
        minVal1(ii)(6 DOWNTO 0);
  ...
  min2_DTC_gen: FOR ii1 IN 0 TO 13 GENERATE
    ...
    min2_DTC(ii1) <= "1111111" WHEN minVal2(ii1)(7) /= '0' ELSE
        minVal2(ii1)(6 DOWNTO 0);
