...
ARCHITECTURE rtl OF full_rx_ip_src_CheckNodeUnit IS
  ...
  -- Signals
  SIGNAL data_signed                      : vector_of_signed16(0 TO 13);  -- sfix16_En12 [14]
  SIGNAL alpha_reg                        : vector_of_signed16(0 TO 27);  -- sfix16 [28]
  SIGNAL dataReg                          : vector_of_signed16(0 TO 13);  -- sfix16_En12 [14]
  ...
  SIGNAL dataAbs                          : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  SIGNAL minCalculation_minVal1           : vector_of_unsigned16(0 TO 13);  -- ufix16 [14]
  SIGNAL minCalculation_minVal2           : vector_of_unsigned16(0 TO 13);  -- ufix16 [14]
  SIGNAL minCalculation_dataAbs           : vector_of_unsigned16(0 TO 13);  -- ufix16 [14]
  ...
  SIGNAL minCalculation_minVal1_next      : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  SIGNAL minCalculation_minVal2_next      : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  SIGNAL minCalculation_dataAbs_next      : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  ...
  SIGNAL minVal1                          : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  SIGNAL minVal2                          : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  ...
  SIGNAL min1_DTC                         : vector_of_unsigned15(0 TO 13);  -- ufix15_En12 [14]
  SIGNAL min1_DTC_0                       : unsigned(14 DOWNTO 0);  -- ufix15_En12
  SIGNAL min2_DTC                         : vector_of_unsigned15(0 TO 13);  -- ufix15_En12 [14]
  ...
  SIGNAL betacomp3D                       : vector_of_unsigned30(0 TO 13);  -- ufix30 [14]
...
BEGIN
  ...
  abs_rsvd_output : PROCESS (dataReg)
    ...
    VARIABLE cast : vector_of_signed17(0 TO 13);
  BEGIN
  ...
  minCalculation_output : PROCESS (countU, dataAbs, dataReg, extReset, minCalculation_countIdx,
    ...
    VARIABLE minVal1_temp : vector_of_unsigned16(0 TO 13);
    VARIABLE minVal2_temp : vector_of_unsigned16(0 TO 13);
