...
BEGIN
  ...
  phase_delay_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      phase_0 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  phase_delay_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      phase_1 <= '1';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  --  step value      = 1
  --  count to value  = 7
  counter_8_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  phase_delay_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      phase_0_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  phase_delay_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      phase_1_1 <= '1';
    ELSIF clk'EVENT AND clk = '1' THEN
