...
ARCHITECTURE rtl OF full_rx_ip_src_Complex4Multiply IS
  ...
  SIGNAL prod1_re                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En26
  SIGNAL prod1_im                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En26
  SIGNAL prod2_re                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En26
  SIGNAL prod2_im                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En26
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(35 DOWNTO 0);  -- sfix36_En26
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(35 DOWNTO 0);  -- sfix36_En26
  SIGNAL Complex4Add_sub_cast             : signed(35 DOWNTO 0);  -- sfix36_En26
  SIGNAL Complex4Add_sub_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En26
  SIGNAL Complex4Add_add_cast             : signed(35 DOWNTO 0);  -- sfix36_En26
  SIGNAL Complex4Add_add_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En26
  SIGNAL mulResFP_re                      : signed(35 DOWNTO 0);  -- sfix36_En26
  SIGNAL mulResFP_im                      : signed(35 DOWNTO 0);  -- sfix36_En26
