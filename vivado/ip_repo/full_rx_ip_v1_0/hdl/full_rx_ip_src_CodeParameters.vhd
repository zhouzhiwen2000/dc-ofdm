-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_CodeParameters.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_CodeParameters
-- Source Path: HDLRx/full_rx/h_rx_full/LDPC_Deco_Hc_12H/CodeParameters
-- Hierarchy Level: 3
-- Model version: 1.14
-- 
-- Code Parameters
...
ENTITY full_rx_ip_src_CodeParameters IS
  PORT( clk                               :   IN    std_logic;
        reset_x                           :   IN    std_logic;
        enb                               :   IN    std_logic;
        data                              :   IN    std_logic_vector(7 DOWNTO 0);  -- sfix8
...
END full_rx_ip_src_CodeParameters;


ARCHITECTURE rtl OF full_rx_ip_src_CodeParameters IS
  ...
  SIGNAL data_signed                      : signed(7 DOWNTO 0);  -- sfix8
  SIGNAL datacp_tmp                       : signed(7 DOWNTO 0);  -- sfix8
...
BEGIN
  ...
  nitero_tmp <= to_unsigned(16#08#, 8);
