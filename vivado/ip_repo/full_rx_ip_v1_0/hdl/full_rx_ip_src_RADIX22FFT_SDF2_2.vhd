...
ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT full_rx_ip_src_SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          ...
          enb_1_2_0                       :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          xf_im                           :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          dinf_im                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          btf1_im                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          btf2_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          btf2_im                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          btfout_vld                      :   IN    std_logic;
          syncReset                       :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          wrData_im                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
  ...
  -- Signals
  SIGNAL dout_1_1_re_signed               : signed(14 DOWNTO 0);  -- sfix15_En12
  SIGNAL din_re                           : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL dout_1_1_im_signed               : signed(14 DOWNTO 0);  -- sfix15_En12
  SIGNAL din_im                           : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL btf2_im                          : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL btf2_re                          : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL btf1_im                          : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL btf1_re                          : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL dinf_im                          : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL dinf_re                          : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL xf_im                            : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL x_im_signed                      : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL x_im_dly                         : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL wrData_re                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL x_re                             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL x_re_signed                      : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL x_re_dly                         : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(15 DOWNTO 0);  -- sfix16_En12
...
BEGIN
  ...
  u_SDFCOMMUTATOR_2 : full_rx_ip_src_SDFCommutator2
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix16_En12
              xf_im => std_logic_vector(xf_im),  -- sfix16_En12
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix16_En12
              dinf_im => std_logic_vector(dinf_im),  -- sfix16_En12
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix16_En12
              btf1_im => std_logic_vector(btf1_im),  -- sfix16_En12
              btf2_re => std_logic_vector(btf2_re),  -- sfix16_En12
              btf2_im => std_logic_vector(btf2_im),  -- sfix16_En12
              btfout_vld => btfout_vld,
              syncReset => syncReset,
              wrData_re => wrData_re,  -- sfix16_En12
              wrData_im => wrData_im,  -- sfix16_En12
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_2_1_re => dout_2_1_re_tmp,  -- sfix16_En12
              dout_2_1_im => dout_2_1_im_tmp,  -- sfix16_En12
              dout_2_1_vld => dout_2_1_vld
              );

  dout_1_1_re_signed <= signed(dout_1_1_re);

  din_re <= resize(dout_1_1_re_signed, 16);

  dout_1_1_im_signed <= signed(dout_1_1_im);

  din_im <= resize(dout_1_1_im_signed, 16);
