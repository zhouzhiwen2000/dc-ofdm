-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_RADIX22FFT_SDF2_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_RADIX22FFT_SDF2_2
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF2_2
-- Hierarchy Level: 5
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_RADIX22FFT_SDF2_2 IS
...
END full_rx_ip_src_RADIX22FFT_SDF2_2;


ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT full_rx_ip_src_SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          xf_im                           :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          dinf_im                         :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          btf1_im                         :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          btf2_re                         :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          btf2_im                         :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
          wrData_im                       :   OUT   std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
  ...
  FOR ALL : full_rx_ip_src_SDFCommutator2
    USE ENTITY work.full_rx_ip_src_SDFCommutator2(rtl);

  -- Signals
  SIGNAL dout_1_1_re_signed               : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL din_re                           : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL dout_1_1_im_signed               : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL din_im                           : signed(17 DOWNTO 0);  -- sfix18_En12
  ...
  SIGNAL btf2_im                          : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL btf2_re                          : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL btf1_im                          : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL btf1_re                          : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL dinf_im                          : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL dinf_re                          : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL xf_im                            : signed(17 DOWNTO 0);  -- sfix18_En12
  ...
  SIGNAL x_im_signed                      : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL x_im_dly                         : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL wrData_re                        : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL x_re                             : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL x_re_signed                      : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL x_re_dly                         : signed(17 DOWNTO 0);  -- sfix18_En12
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(17 DOWNTO 0);  -- sfix18_En12
...
BEGIN
  u_dataMEM_im_0_2 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataMEM_re_0_2 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 18
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : full_rx_ip_src_SDFCommutator2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_1_1_vld => dout_1_1_vld,
              xf_re => std_logic_vector(xf_re),  -- sfix18_En12
              xf_im => std_logic_vector(xf_im),  -- sfix18_En12
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix18_En12
              dinf_im => std_logic_vector(dinf_im),  -- sfix18_En12
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix18_En12
              btf1_im => std_logic_vector(btf1_im),  -- sfix18_En12
              btf2_re => std_logic_vector(btf2_re),  -- sfix18_En12
              btf2_im => std_logic_vector(btf2_im),  -- sfix18_En12
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix18_En12
              wrData_im => wrData_im,  -- sfix18_En12
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_2_1_re => dout_2_1_re_tmp,  -- sfix18_En12
              dout_2_1_im => dout_2_1_im_tmp,  -- sfix18_En12
