-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_remove_tone_mapping.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_remove_tone_mapping
...
ENTITY full_rx_ip_src_remove_tone_mapping IS
...
END full_rx_ip_src_remove_tone_mapping;


ARCHITECTURE rtl OF full_rx_ip_src_remove_tone_mapping IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_valid_to_ctrl
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_valid_to_ctrl
    USE ENTITY work.full_rx_ip_src_valid_to_ctrl(rtl);
...
BEGIN
  u_valid_to_ctrl : full_rx_ip_src_valid_to_ctrl
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              validIn => valid_out,
