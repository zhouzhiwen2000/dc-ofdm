-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_SDFCommutator6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_SDFCommutator6
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF2_6/SDFCommutator6
-- Hierarchy Level: 6
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_SDFCommutator6 IS
...
END full_rx_ip_src_SDFCommutator6;


ARCHITECTURE rtl OF full_rx_ip_src_SDFCommutator6 IS
  ...
  SIGNAL dout_6_1_re_tmp                  : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL dout_6_1_im_tmp                  : signed(21 DOWNTO 0);  -- sfix22_En12

BEGIN
  u_dataXMEM_re_0_6 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataXMEM_im_0_6 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 22
                 )
    PORT MAP( clk => clk,
