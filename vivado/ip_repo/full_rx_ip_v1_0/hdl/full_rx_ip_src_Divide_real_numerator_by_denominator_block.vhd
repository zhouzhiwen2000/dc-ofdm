-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_Divide_real_numerator_by_denominator_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_Divide_real_numerator_by_denominator_block
...
ENTITY full_rx_ip_src_Divide_real_numerator_by_denominator_block IS
...
END full_rx_ip_src_Divide_real_numerator_by_denominator_block;


ARCHITECTURE rtl OF full_rx_ip_src_Divide_real_numerator_by_denominator_block IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_normalizedCORDICDivide_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
  ...
  FOR ALL : full_rx_ip_src_normalizedCORDICDivide_block
    USE ENTITY work.full_rx_ip_src_normalizedCORDICDivide_block(rtl);
...
BEGIN
  u_normalizedCORDICDivide : full_rx_ip_src_normalizedCORDICDivide_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              num => num,  -- sfix18_En16
