...
ARCHITECTURE rtl OF full_rx_ip_src_Complex4Multiply_block1 IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL din_re_reg                       : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL din_im_signed                    : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL din_im_reg                       : signed(22 DOWNTO 0);  -- sfix23_En12
  ...
  SIGNAL prod1_re                         : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En26
  SIGNAL prod1_im                         : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En26
  SIGNAL prod2_re                         : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En26
  SIGNAL prod2_im                         : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En26
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL Complex4Add_sub_cast             : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL Complex4Add_sub_cast_1           : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL Complex4Add_add_cast             : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL Complex4Add_add_cast_1           : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL mulResFP_re                      : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL mulResFP_im                      : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL dinXTwdl_7_1_vld_1               : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL dinXTwdl_im_tmp                  : signed(22 DOWNTO 0);  -- sfix23_En12
...
BEGIN
  ...
  -- Complex4Add
  Complex4Add_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
