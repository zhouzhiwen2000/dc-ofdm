...
BEGIN
  ...
  outsel_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  AccPhaseRegister_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  AccOffsetRegister_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  -- Output register
  OutputRegister_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  -- validOut register
  validOut_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      validOut <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
