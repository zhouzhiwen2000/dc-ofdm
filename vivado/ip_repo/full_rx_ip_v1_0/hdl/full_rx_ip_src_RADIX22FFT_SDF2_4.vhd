...
ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF2_4 IS
  ...
  -- Signals
  SIGNAL dout_3_1_re_signed               : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL din_re                           : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL dout_3_1_im_signed               : signed(16 DOWNTO 0);  -- sfix17_En12
  ...
  SIGNAL dout_4_1_re_tmp                  : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL dout_4_1_im_tmp                  : std_logic_vector(17 DOWNTO 0);  -- ufix18
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : full_rx_ip_src_SDFCommutator4
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix4
              wrEnb => wrEnb,
              dout_4_1_re => dout_4_1_re_tmp,  -- sfix18_En12
              dout_4_1_im => dout_4_1_im_tmp,  -- sfix18_En12
              dout_4_1_vld => dout_4_1_vld
              );

  dout_3_1_re_signed <= signed(dout_3_1_re);

  din_re <= resize(dout_3_1_re_signed, 18);

  dout_3_1_im_signed <= signed(dout_3_1_im);

  din_im <= resize(dout_3_1_im_signed, 18);
