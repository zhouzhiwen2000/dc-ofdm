-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_RADIX22FFT_SDF2_4
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF2_4
-- Hierarchy Level: 5
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_RADIX22FFT_SDF2_4 IS
...
END full_rx_ip_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT full_rx_ip_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_SDFCommutator4
    USE ENTITY work.full_rx_ip_src_SDFCommutator4(rtl);

  -- Signals
  SIGNAL dout_3_1_re_signed               : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL din_re                           : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL dout_3_1_im_signed               : signed(18 DOWNTO 0);  -- sfix19_En12
...
BEGIN
  u_dataMEM_im_0_4 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataMEM_re_0_4 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : full_rx_ip_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              ...
              wrAddr => wrAddr,  -- ufix4
              wrEnb => wrEnb,
              dout_4_1_re => dout_4_1_re_tmp,  -- sfix20_En12
              dout_4_1_im => dout_4_1_im_tmp,  -- sfix20_En12
