...
BEGIN
  ...
  datainput_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      datainReg <= '0';
  ...
  dataOut_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      dataOut <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  startOut_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      startOut <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  endout_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      endOut <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  validout_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      validOut <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
