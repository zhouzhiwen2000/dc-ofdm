...
ARCHITECTURE rtl OF full_rx_ip_src_WaveformGen IS
  ...
  -- Signals
  SIGNAL phaseIdx_unsigned                : unsigned(11 DOWNTO 0);  -- ufix12_E13
  SIGNAL phaseIdxReg                      : unsigned(11 DOWNTO 0);  -- ufix12_E13
  ...
  SIGNAL lutoutcos_signed                 : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL lutoutsin                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL lutoutsin_signed                 : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL lutselcos                        : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL octantVal                        : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL fullcosmag                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL uminus_cast                      : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL uminus_cast_1                    : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL inverseCos                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL cosout                           : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL sineSignSelRegComp_reg           : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  SIGNAL sineSignSelReg                   : std_logic;  -- ufix1
  SIGNAL lutselsin                        : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL fullsinmag                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL uminus_cast_2                    : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL uminus_cast_3                    : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL inverseSin                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL sinout                           : signed(15 DOWNTO 0);  -- sfix16_En12
...
BEGIN
  u_Cos_Wave_inst : full_rx_ip_src_CosLookUpTableGen
    PORT MAP( clk => clk,
              ...
              lutCosine => lutoutcos  -- sfix16_En12
              );
  ...
  u_Sin_Wave_inst : full_rx_ip_src_SinLookUpTableGen
    PORT MAP( clk => clk,
              ...
              enb => enb,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix9
              lutSine => lutoutsin  -- sfix16_En12
              );

  phaseIdx_unsigned <= unsigned(phaseIdx);

  phaseIdxRegister_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  signSelRegComp_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  sin45SelRegComp_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  lutSelRegComp_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  octantVal <= to_signed(16#0B50#, 16);
  ...
  sineSignSelRegComp_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
