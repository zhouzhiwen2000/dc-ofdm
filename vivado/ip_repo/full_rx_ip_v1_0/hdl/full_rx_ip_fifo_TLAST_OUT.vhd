-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_fifo_TLAST_OUT
-- Source Path: full_rx_ip/full_rx_ip_axi4_stream_master/full_rx_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_rx_ip_fifo_TLAST_OUT IS
...
END full_rx_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF full_rx_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT full_rx_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : full_rx_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.full_rx_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_full_rx_ip_fifo_TLAST_OUT_classic_ram_singlebit : full_rx_ip_SimpleDualPortRAM_singlebit
  ...
  Q_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      cache_valid <= '0';
  ...
  Q_reg_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      fifo_valid <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Q_reg_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      out_valid <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  cache_data_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      cache_data <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  out_data_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Out_rsvd <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
