...
ARCHITECTURE rtl OF full_rx_ip_src_full_rx IS
  ...
  COMPONENT full_rx_ip_src_LDPC_shared
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_LDPC_shared
    USE ENTITY work.full_rx_ip_src_LDPC_shared(rtl);
  ...
  SIGNAL data_in_signed                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Data_Type_Conversion3_out1       : signed(13 DOWNTO 0);  -- sfix14_En13
...
BEGIN
  ...
  u_LDPC_shared : full_rx_ip_src_LDPC_shared
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_rx_demodulator_full : full_rx_ip_src_rx_demodulator_full
    PORT MAP( clk => clk,
              ...
              enb => enb,
              enb_1_2_1 => enb_1_2_1,
              data_in => std_logic_vector(Data_Type_Conversion3_out1),  -- sfix14_En13
  ...
  Data_Type_Conversion3_out1 <= data_in_signed(15 DOWNTO 2);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_8_0 = '1' THEN
        Rate_Transition4_out1 <= header_ready;
      END IF;
    END IF;
