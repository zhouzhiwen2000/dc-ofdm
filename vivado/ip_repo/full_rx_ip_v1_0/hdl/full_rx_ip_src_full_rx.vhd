...
-- -------------------------------------------------------------
-- data_out                      ce_out        8e-08
-- valid_out                     ce_out        8e-08
-- reg0                          ce_out        8e-08
-- reg1                          ce_out        8e-08
-- reg2                          ce_out        8e-08
-- reg3                          ce_out        8e-08
-- end_rsvd                      ce_out        8e-08
-- err                           ce_out        8e-08
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF full_rx_ip_src_full_rx IS
  ...
  SIGNAL h_rx_full_out12                  : std_logic;
...
BEGIN
  ...
  Rate_Transition9_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      From7_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_8_0 = '1' THEN
        From7_out1 <= h_rx_full_out12;
      END IF;
    END IF;
  ...
  Rate_Transition1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Rate_Transition51_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Rate_Transition81_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
