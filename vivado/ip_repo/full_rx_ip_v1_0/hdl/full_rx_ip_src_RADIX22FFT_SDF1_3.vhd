...
ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF1_3 IS
  ...
  -- Signals
  SIGNAL din_3_1_re_dly_signed            : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL din_re                           : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL din_3_1_im_dly_signed            : signed(17 DOWNTO 0);  -- sfix18_En12
...
BEGIN
  ...
  u_SDFCOMMUTATOR_3 : full_rx_ip_src_SDFCommutator3
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix5
              wrEnb => wrEnb,
              dout_3_1_re => dout_3_1_re_tmp,  -- sfix19_En12
              dout_3_1_im => dout_3_1_im_tmp,  -- sfix19_En12
