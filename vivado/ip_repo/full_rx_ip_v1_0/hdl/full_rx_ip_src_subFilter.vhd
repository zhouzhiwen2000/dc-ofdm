...
ARCHITECTURE rtl OF full_rx_ip_src_subFilter IS
  ...
  SIGNAL ZERO_OUT                         : signed(30 DOWNTO 0);  -- sfix31_En28
  ...
  SIGNAL dout_cast                        : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL muxOut                           : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL dout_1_re_tmp                    : signed(30 DOWNTO 0);  -- sfix31_En28
...
BEGIN
  ...
  u_FilterTap_11 : full_rx_ip_src_FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              ...
              coefIn_0 => coefIn(10),  -- sfix14_En14
  ...
  u_FilterTap_12 : full_rx_ip_src_FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              ...
              coefIn_0 => coefIn(11),  -- sfix14_En14
  ...
  u_FilterTap_13 : full_rx_ip_src_FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              ...
              coefIn_0 => coefIn(12),  -- sfix14_En14
  ...
  ZERO_OUT <= to_signed(16#00000000#, 31);
  ...
  dout_cast <= tapout_signed_12(30 DOWNTO 0);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        dout_1_re_tmp <= to_signed(16#00000000#, 31);
      ELSIF enb = '1' THEN
        IF softReset = '1' THEN
          dout_1_re_tmp <= to_signed(16#00000000#, 31);
        ELSE 
