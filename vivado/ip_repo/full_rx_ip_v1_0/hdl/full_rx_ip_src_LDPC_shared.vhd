-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_LDPC_shared.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_LDPC_shared
...
ENTITY full_rx_ip_src_LDPC_shared IS
...
END full_rx_ip_src_LDPC_shared;


ARCHITECTURE rtl OF full_rx_ip_src_LDPC_shared IS
  ...
  COMPONENT full_rx_ip_src_LDPC_Decoder
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_rx_ip_src_Sample_Control_Bus_Creator1
    PORT( In1                             :   IN    std_logic;
          In2                             :   IN    std_logic;
          In3                             :   IN    std_logic;
          Out1_start                      :   OUT   std_logic;
  ...
  COMPONENT full_rx_ip_src_Sample_Control_Bus_Creator2
    PORT( In1                             :   IN    std_logic;
          In3                             :   IN    std_logic;
          Out1_start                      :   OUT   std_logic;
          Out1_valid                      :   OUT   std_logic
  ...
  FOR ALL : full_rx_ip_src_LDPC_Decoder
    USE ENTITY work.full_rx_ip_src_LDPC_Decoder(rtl);

  FOR ALL : full_rx_ip_src_Sample_Control_Bus_Creator1
    USE ENTITY work.full_rx_ip_src_Sample_Control_Bus_Creator1(rtl);

  FOR ALL : full_rx_ip_src_Sample_Control_Bus_Creator2
    USE ENTITY work.full_rx_ip_src_Sample_Control_Bus_Creator2(rtl);
...
BEGIN
  ...
  u_LDPC_Decoder : full_rx_ip_src_LDPC_Decoder
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Sample_Control_Bus_Creator1 : full_rx_ip_src_Sample_Control_Bus_Creator1
  ...
  u_Sample_Control_Bus_Creator2 : full_rx_ip_src_Sample_Control_Bus_Creator2
