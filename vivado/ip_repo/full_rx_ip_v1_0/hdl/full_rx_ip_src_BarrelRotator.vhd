...
ARCHITECTURE rtl OF full_rx_ip_src_BarrelRotator IS
  ...
  SIGNAL data_0                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_1                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_1                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_2                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_3                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_3                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_1                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_4                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_5                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_5                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_6                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_7                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_7                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_5                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_1                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_8                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_9                           : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_9                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_10                          : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_11                          : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_11                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_9                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_12                          : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL data_13                          : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_13                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_13                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_9                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_1                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_2                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_4                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_2                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_6                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_8                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_6                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_2                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_10                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_12                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_10                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage1_14                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_14                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_10                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_2                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_3                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_7                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_3                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_11                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_11                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_3                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_4                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_8                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_4                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage2_12                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_12                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_4                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_5                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_13                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_5                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_6                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_14                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_6                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_7                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_7                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage3_8                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_8                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_9                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_10                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_11                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_12                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_13                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL dout_stage4_14                   : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL sDataReg                         : vector_of_signed10(0 TO 13);  -- sfix10 [14]
  SIGNAL shiftData_tmp                    : vector_of_signed10(0 TO 13);  -- sfix10 [14]
...
BEGIN
  ...
  BEGIN
    IF reset_x = '1' THEN
      shiftData_tmp <= (OTHERS => to_signed(16#000#, 10));
