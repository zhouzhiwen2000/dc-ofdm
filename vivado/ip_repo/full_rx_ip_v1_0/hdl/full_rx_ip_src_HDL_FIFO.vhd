...
-- Source Path: HDLRx/full_rx/rx_demodulator_full/HDL_FIFO
-- Hierarchy Level: 2
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
BEGIN
  ...
  u_HDL_FIFO_ram_generic : full_rx_ip_src_SimpleDualPortRAM_generic_block
  ...
  fifo_front_indx_temp <= to_unsigned(16#0000#, 13) WHEN rst /= '0' ELSE
  ...
  fifo_back_indx_temp <= to_unsigned(16#0000#, 13) WHEN rst /= '0' ELSE
  ...
  fifo_sample_count_next <= to_unsigned(16#0000#, 14) WHEN rst /= '0' ELSE
      fifo_sample_count + to_unsigned(16#0001#, 14) WHEN (fifo_write_enable AND ( NOT fifo_read_enable)) = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' AND w_d1 = '1' THEN
        w_d2_re <= w_out_re;
        w_d2_im <= w_out_im;
      END IF;
    END IF;
