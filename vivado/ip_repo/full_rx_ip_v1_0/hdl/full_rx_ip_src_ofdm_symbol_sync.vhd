...
ARCHITECTURE rtl OF full_rx_ip_src_ofdm_symbol_sync IS
  ...
  COMPONENT full_rx_ip_src_SimpleDualPortRAM_singlebit
  ...
  COMPONENT full_rx_ip_src_phase_offset_calculator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.full_rx_ip_src_SimpleDualPortRAM_singlebit(rtl);
  ...
  FOR ALL : full_rx_ip_src_phase_offset_calculator
    USE ENTITY work.full_rx_ip_src_phase_offset_calculator(rtl);
...
BEGIN
  ...
  u_ShiftRegisterRAM_singlebit : full_rx_ip_src_SimpleDualPortRAM_singlebit
  ...
  u_phase_offset_calculator : full_rx_ip_src_phase_offset_calculator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              peak_sync => find_peak_out2,
