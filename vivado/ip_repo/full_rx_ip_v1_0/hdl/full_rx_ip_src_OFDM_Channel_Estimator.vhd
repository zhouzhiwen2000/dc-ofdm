-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_OFDM_Channel_Estimator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_OFDM_Channel_Estimator
...
ENTITY full_rx_ip_src_OFDM_Channel_Estimator IS
...
END full_rx_ip_src_OFDM_Channel_Estimator;


ARCHITECTURE rtl OF full_rx_ip_src_OFDM_Channel_Estimator IS
  ...
  SIGNAL In1_re_signed                    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL In1_im_signed                    : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL Product_Re_AC                    : signed(39 DOWNTO 0);  -- sfix40_En24
  SIGNAL Product_Re_AC_1                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Product_Re_BD                    : signed(39 DOWNTO 0);  -- sfix40_En24
  SIGNAL Product_Re_BD_1                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL mulOutput                        : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Product_Im_AD                    : signed(39 DOWNTO 0);  -- sfix40_En24
  SIGNAL Product_Im_AD_1                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Product_Im_BC                    : signed(39 DOWNTO 0);  -- sfix40_En24
  SIGNAL Product_Im_BC_1                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL mulOutput_1                      : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL Delay6_reg_re                    : vector_of_signed24(0 TO 2);  -- sfix24_En12 [3]
  SIGNAL Delay6_reg_im                    : vector_of_signed24(0 TO 2);  -- sfix24_En12 [3]
  ...
  SIGNAL Constant_out1_re_1               : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Constant_out1_im_1               : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Constant_out1_dtc_re             : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Constant_out1_dtc_im             : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL Constant2_out1_re                : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Constant2_out1_im                : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL dataOut_re_1                     : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL dataOut_im_1                     : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Delay4_out1_re                   : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Delay4_out1_im                   : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Switch_out1_re_1                 : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Switch_out1_im_1                 : signed(24 DOWNTO 0);  -- sfix25_En12
  ...
  SIGNAL Constant1_out1_re_1              : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Constant1_out1_im_1              : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Accumulator_RAM_out1_im          : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL Accumulator_RAM_out1_im_signed   : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Add_out1_im_1                    : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Add_out1_re_1                    : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Accumulator_RAM_out1_re          : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL Accumulator_RAM_out1_re_signed   : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Switch7_out1_re                  : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Switch7_out1_im                  : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Delay1_reg_re_1                  : vector_of_signed25(0 TO 1);  -- sfix25_En12 [2]
  SIGNAL Delay1_reg_im_1                  : vector_of_signed25(0 TO 1);  -- sfix25_En12 [2]
  SIGNAL Delay1_out1_re_1                 : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Delay1_out1_im_1                 : signed(24 DOWNTO 0);  -- sfix25_En12
  ...
  SIGNAL Product1_Re                      : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Product1_Re_1                    : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Product1_cast_1                  : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Product1_mul_temp_1              : signed(42 DOWNTO 0);  -- sfix43_En28
  SIGNAL Product1_Im                      : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Product1_Im_1                    : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Delay3_out1_re                   : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Delay3_out1_im                   : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Delay3_out1_dtc_re               : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Delay3_out1_dtc_im               : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch_out1_re_2                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch_out1_im_2                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch_out1_re_3                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch_out1_im_3                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Delay4_reg_re                    : vector_of_signed24(0 TO 5);  -- sfix24_En12 [6]
  SIGNAL Delay4_reg_im                    : vector_of_signed24(0 TO 5);  -- sfix24_En12 [6]
  SIGNAL Delay4_out1_re_1                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Delay4_out1_im_1                 : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL Data1Out_re                      : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Data1Out_im                      : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Data2Out_re                      : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Data2Out_im                      : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL intermediateBuff_re              : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL intermediateBuff_im              : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL interInp1_re                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL interInp1_im                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL interInp2_re                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL interInp2_im                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL posOfFirstHighRefBuff_next       : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL intermediateBuff_next_re         : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL intermediateBuff_next_im         : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL interInp1_next_re                : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL interInp1_next_im                : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL interInp2_next_re                : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL interInp2_next_im                : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL Constant4_out1_re                : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Constant4_out1_im                : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch3_out1_re                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch3_out1_im                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Delay2_reg_re                    : vector_of_signed24(0 TO 5);  -- sfix24_En12 [6]
  SIGNAL Delay2_reg_im                    : vector_of_signed24(0 TO 5);  -- sfix24_En12 [6]
  SIGNAL Delay2_out1_re_1                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Delay2_out1_im_1                 : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL Constant3_out1_re                : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Constant3_out1_im                : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch5_out1_re                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch5_out1_im                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Delay4_reg_re_1                  : vector_of_signed24(0 TO 5);  -- sfix24_En12 [6]
  SIGNAL Delay4_reg_im_1                  : vector_of_signed24(0 TO 5);  -- sfix24_En12 [6]
  SIGNAL Delay4_out1_re_2                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Delay4_out1_im_2                 : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL Delay4_reg_re_2                  : vector_of_signed24(0 TO 1);  -- sfix24_En12 [2]
  SIGNAL Delay4_reg_im_2                  : vector_of_signed24(0 TO 1);  -- sfix24_En12 [2]
  SIGNAL Delay4_out1_re_3                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Delay4_out1_im_3                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Product_cast                     : signed(4 DOWNTO 0);  -- sfix5
  SIGNAL Product_mul_temp                 : signed(28 DOWNTO 0);  -- sfix29_En12
  SIGNAL Product_cast_1                   : signed(4 DOWNTO 0);  -- sfix5
  SIGNAL Product_mul_temp_1               : signed(28 DOWNTO 0);  -- sfix29_En12
  SIGNAL Product_out1_re                  : signed(27 DOWNTO 0);  -- sfix28_En12
  SIGNAL Product_out1_im                  : signed(27 DOWNTO 0);  -- sfix28_En12
  SIGNAL Delay7_out1_re                   : signed(27 DOWNTO 0);  -- sfix28_En12
  SIGNAL Delay7_out1_im                   : signed(27 DOWNTO 0);  -- sfix28_En12
  ...
  SIGNAL Product1_mul_temp_2              : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Product1_cast_3                  : signed(5 DOWNTO 0);  -- sfix6
  SIGNAL Product1_mul_temp_3              : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Product1_out1_re                 : signed(28 DOWNTO 0);  -- sfix29_En12
  SIGNAL Product1_out1_im                 : signed(28 DOWNTO 0);  -- sfix29_En12
  SIGNAL Delay8_out1_re                   : signed(28 DOWNTO 0);  -- sfix29_En12
  SIGNAL Delay8_out1_im                   : signed(28 DOWNTO 0);  -- sfix29_En12
  SIGNAL Add_add_cast                     : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Add_add_cast_1                   : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Add_add_cast_2                   : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Add_add_cast_3                   : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Add_out1_re_2                    : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Add_out1_im_2                    : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Delay_reg_re_1                   : vector_of_signed30(0 TO 1);  -- sfix30_En12 [2]
  SIGNAL Delay_reg_im_1                   : vector_of_signed30(0 TO 1);  -- sfix30_En12 [2]
  SIGNAL Delay_out1_re_1                  : signed(29 DOWNTO 0);  -- sfix30_En12
  SIGNAL Delay_out1_im_1                  : signed(29 DOWNTO 0);  -- sfix30_En12
  ...
  SIGNAL Product2_mul_temp                : signed(47 DOWNTO 0);  -- sfix48_En28
  SIGNAL Product2_cast_1                  : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Product2_mul_temp_1              : signed(47 DOWNTO 0);  -- sfix48_En28
  SIGNAL Product2_out1_re                 : signed(46 DOWNTO 0);  -- sfix47_En28
  SIGNAL Product2_out1_im                 : signed(46 DOWNTO 0);  -- sfix47_En28
  SIGNAL Delay1_out1_re_2                 : signed(46 DOWNTO 0);  -- sfix47_En28
  SIGNAL Delay1_out1_im_2                 : signed(46 DOWNTO 0);  -- sfix47_En28
  SIGNAL dataOut_re_2                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dataOut_im_2                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch6_out1_re                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch6_out1_im                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch_out1_re_4                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Switch_out1_im_4                 : signed(23 DOWNTO 0);  -- sfix24_En12
...
BEGIN
  ...
  u_Accumulator_RAM : full_rx_ip_src_SimpleDualPortRAM_generic_block2
  ...
  u_Counter_RAM : full_rx_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 4
                 )
    PORT MAP( clk => clk,
  ...
  Product_Re_AC_1 <= Product_Re_AC(35 DOWNTO 12);

  Product_Re_BD <= Delay_out1_im * Delay1_out1_im;

  Product_Re_BD_1 <= Product_Re_BD(35 DOWNTO 12);

  mulOutput <= Product_Re_AC_1 - Product_Re_BD_1;

  Product_Im_AD <= Delay_out1_re * Delay1_out1_im;

  Product_Im_AD_1 <= Product_Im_AD(35 DOWNTO 12);

  Product_Im_BC <= Delay_out1_im * Delay1_out1_re;

  Product_Im_BC_1 <= Product_Im_BC(35 DOWNTO 12);
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay2_out1_re <= to_signed(16#000000#, 24);
      Delay2_out1_im <= to_signed(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  whdlmod_c97_NumSCPerSym_Generator_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  SubScCount_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  AvgSymbCount_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  ScCountDelay_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  dataDelay1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      dataDelay1_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  dataDelay_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      dataDelay_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Constant_out1_re_1 <= to_signed(16#0000000#, 25);
  Constant_out1_im_1 <= to_signed(16#0000000#, 25);

  Constant_out1_dtc_re <= Constant_out1_re_1(23 DOWNTO 0);
  Constant_out1_dtc_im <= Constant_out1_im_1(23 DOWNTO 0);

  out_rsvd_5 <= reset_out1;
  ...
  Constant2_out1_re <= to_signed(16#0000000#, 25);
  Constant2_out1_im <= to_signed(16#0000000#, 25);

  -- double(numOFDMSymToBeAvg)-1; %
  -- Embedded FI
  dataOut_re_1 <= resize(Switch_out1_re, 25);
  dataOut_im_1 <= resize(Switch_out1_im, 25);

  Delay4_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay4_out1_re <= to_signed(16#0000000#, 25);
      Delay4_out1_im <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  Constant1_out1_re_1 <= to_signed(16#0000000#, 25);
  Constant1_out1_im_1 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay1_reg_re_1 <= (OTHERS => to_signed(16#0000000#, 25));
      Delay1_reg_im_1 <= (OTHERS => to_signed(16#0000000#, 25));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  Product1_Re <= Product1_mul_temp(41 DOWNTO 0);

  Product1_Re_1 <= Product1_Re(40 DOWNTO 16);

  Product1_cast_1 <= signed(resize(Delay2_out1_3, 18));
  Product1_mul_temp_1 <= Delay1_out1_im_1 * Product1_cast_1;
  Product1_Im <= Product1_mul_temp_1(41 DOWNTO 0);

  Product1_Im_1 <= Product1_Im(40 DOWNTO 16);
  ...
  Delay3_out1_dtc_re <= Delay3_out1_re(23 DOWNTO 0);
  Delay3_out1_dtc_im <= Delay3_out1_im(23 DOWNTO 0);
  ...
  Delay9_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  numSCPS_Counter_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  whdlmod_c99_NumSCPerSym_Generator_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay9_4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay9_out1_4 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Delay1_6_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay2_6_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  first_bin_flag_indicator_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  InterpPointsSampCount_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  whdlmod_c102_InitExtrapData_Generator_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      posOfFirstHighRefBuff <= to_unsigned(16#000#, 10);
      intermediateBuff_re <= to_signed(16#000000#, 24);
      intermediateBuff_im <= to_signed(16#000000#, 24);
      interInp1_re <= to_signed(16#000000#, 24);
      interInp1_im <= to_signed(16#000000#, 24);
      interInp2_re <= to_signed(16#000000#, 24);
      interInp2_im <= to_signed(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  whdlmod_c102_InitExtrapData_Generator_output : PROCESS (Logical_Operator1_out1_1, Logical_Operator3_out1_2, Logical_Operator5_out1_3,
    ...
    VARIABLE tmpInterBuff_re : signed(23 DOWNTO 0);
    VARIABLE tmpInterBuff_im : signed(23 DOWNTO 0);
  ...
  HDL_Counter_ctrl_delay_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  binary_counter_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  binary_counter1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  whdlmod_c104_FinExtrapCtrl_Generator_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  numSCPSOutCounter_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay1_7_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Constant4_out1_re <= to_signed(16#000000#, 24);
  Constant4_out1_im <= to_signed(16#000000#, 24);
  ...
  Delay2_7_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  binary_counter2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay1_8_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Constant3_out1_re <= to_signed(16#000000#, 24);
  Constant3_out1_im <= to_signed(16#000000#, 24);
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay4_reg_re_1 <= (OTHERS => to_signed(16#000000#, 24));
      Delay4_reg_im_1 <= (OTHERS => to_signed(16#000000#, 24));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  down_counter_ctrl_delay_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  down_counter_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay4_reg_re_2 <= (OTHERS => to_signed(16#000000#, 24));
      Delay4_reg_im_2 <= (OTHERS => to_signed(16#000000#, 24));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  up_counter_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Product1_out1_re <= Product1_mul_temp_2(28 DOWNTO 0);
  Product1_cast_3 <= signed(resize(Delay6_out1, 6));
  Product1_mul_temp_3 <= Delay5_out1_im * Product1_cast_3;
  Product1_out1_im <= Product1_mul_temp_3(28 DOWNTO 0);

  Delay8_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay8_out1_re <= to_signed(16#00000000#, 29);
      Delay8_out1_im <= to_signed(16#00000000#, 29);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  Add_add_cast <= resize(Delay7_out1_re, 30);
  Add_add_cast_1 <= resize(Delay8_out1_re, 30);
  Add_out1_re_2 <= Add_add_cast + Add_add_cast_1;
  Add_add_cast_2 <= resize(Delay7_out1_im, 30);
  Add_add_cast_3 <= resize(Delay8_out1_im, 30);
  Add_out1_im_2 <= Add_add_cast_2 + Add_add_cast_3;

  Delay_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay_reg_re_1 <= (OTHERS => to_signed(16#00000000#, 30));
      Delay_reg_im_1 <= (OTHERS => to_signed(16#00000000#, 30));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  Delay2_8_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Product2_out1_re <= Product2_mul_temp(46 DOWNTO 0);
  Product2_cast_1 <= signed(resize(Delay2_out1_6, 18));
  Product2_mul_temp_1 <= Delay_out1_im_1 * Product2_cast_1;
  Product2_out1_im <= Product2_mul_temp_1(46 DOWNTO 0);

  Delay1_9_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay1_out1_re_2 <= to_signed(0, 47);
      Delay1_out1_im_2 <= to_signed(0, 47);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  dataOut_re_2 <= X"7FFFFF" WHEN ((Delay1_out1_re_2(46) = '0') AND (Delay1_out1_re_2(45 DOWNTO 39) /= "0000000")) OR ((Delay1_out1_re_2(46) = '0') AND (Delay1_out1_re_2(39 DOWNTO 16) = X"7FFFFF")) ELSE
      X"800000" WHEN (Delay1_out1_re_2(46) = '1') AND (Delay1_out1_re_2(45 DOWNTO 39) /= "1111111") ELSE
      Delay1_out1_re_2(39 DOWNTO 16) + ('0' & Delay1_out1_re_2(15));
  
  dataOut_im_2 <= X"7FFFFF" WHEN ((Delay1_out1_im_2(46) = '0') AND (Delay1_out1_im_2(45 DOWNTO 39) /= "0000000")) OR ((Delay1_out1_im_2(46) = '0') AND (Delay1_out1_im_2(39 DOWNTO 16) = X"7FFFFF")) ELSE
      X"800000" WHEN (Delay1_out1_im_2(46) = '1') AND (Delay1_out1_im_2(45 DOWNTO 39) /= "1111111") ELSE
      Delay1_out1_im_2(39 DOWNTO 16) + ('0' & Delay1_out1_im_2(15));
  ...
  Delay1_10_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay9_5_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay9_out1_5 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Delay1_11_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
