-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_ForEach_Real_Divide.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_ForEach_Real_Divide
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_separator/Real Divide HDL Optimized/ForEach - Real Divide
-- Hierarchy Level: 4
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_ForEach_Real_Divide IS
...
END full_rx_ip_src_ForEach_Real_Divide;


ARCHITECTURE rtl OF full_rx_ip_src_ForEach_Real_Divide IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_Upcast_Wordlength
  ...
  COMPONENT full_rx_ip_src_Normalize_numerator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_rx_ip_src_MATLAB_Function
    PORT( num                             :   IN    std_logic_vector(24 DOWNTO 0);  -- sfix25_En23
          t_num                           :   IN    std_logic_vector(31 DOWNTO 0);  -- int32
          num_out                         :   OUT   std_logic_vector(24 DOWNTO 0);  -- sfix25_En23
          t_num_out                       :   OUT   std_logic_vector(32 DOWNTO 0)  -- sfix33
          );
  END COMPONENT;

  COMPONENT full_rx_ip_src_Normalize_denominator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          u                               :   IN    std_logic_vector(24 DOWNTO 0);  -- sfix25_En8
          validIn                         :   IN    std_logic;
          x                               :   OUT   std_logic_vector(24 DOWNTO 0);  -- sfix25_En23
          e                               :   OUT   std_logic_vector(31 DOWNTO 0);  -- int32
          isNegative                      :   OUT   std_logic;
  ...
  COMPONENT full_rx_ip_src_Divide_real_numerator_by_denominator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_rx_ip_src_Shift_and_cast_to_output_type
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_rx_ip_src_Divide_by_zero_handler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_Upcast_Wordlength
    USE ENTITY work.full_rx_ip_src_Upcast_Wordlength(rtl);

  FOR ALL : full_rx_ip_src_Normalize_numerator
    USE ENTITY work.full_rx_ip_src_Normalize_numerator(rtl);

  FOR ALL : full_rx_ip_src_MATLAB_Function
    USE ENTITY work.full_rx_ip_src_MATLAB_Function(rtl);

  FOR ALL : full_rx_ip_src_Normalize_denominator
    USE ENTITY work.full_rx_ip_src_Normalize_denominator(rtl);

  FOR ALL : full_rx_ip_src_Divide_real_numerator_by_denominator
    USE ENTITY work.full_rx_ip_src_Divide_real_numerator_by_denominator(rtl);

  FOR ALL : full_rx_ip_src_Shift_and_cast_to_output_type
    USE ENTITY work.full_rx_ip_src_Shift_and_cast_to_output_type(rtl);

  FOR ALL : full_rx_ip_src_Divide_by_zero_handler
    USE ENTITY work.full_rx_ip_src_Divide_by_zero_handler(rtl);

  -- Signals
  SIGNAL u                                : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL v                                : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL v_signed                         : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL Delay14_out1                     : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL Delay15_out1                     : std_logic;
  SIGNAL x                                : std_logic_vector(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL Delay25_out1                     : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL Delay26_out1                     : signed(31 DOWNTO 0);  -- int32
  SIGNAL num_out                          : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL t_num_out                        : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL num_out_signed                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL t_num_out_signed                 : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL u_signed                         : signed(24 DOWNTO 0);  -- sfix25_En8
  SIGNAL Delay4_out1                      : signed(24 DOWNTO 0);  -- sfix25_En8
  SIGNAL x_1                              : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL e_1                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL isNegative_1                     : std_logic;
  SIGNAL validOut                         : std_logic;
  SIGNAL x_signed_1                       : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL e_signed_1                       : signed(31 DOWNTO 0);  -- int32
  SIGNAL Delay16_out1                     : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL Delay17_out1                     : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL Delay9_reg                       : vector_of_signed25(0 TO 1);  -- sfix25 [2]
  SIGNAL Delay9_out1                      : signed(24 DOWNTO 0);  -- sfix25_En23
  ...
  SIGNAL y_1                              : std_logic_vector(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL y_signed                         : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL Unit_Delay_Enabled_Synchronous_out1 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL Unit_Delay_Enabled_Synchronous_ectrl : signed(24 DOWNTO 0);  -- sfix25_En23
  ...
  SIGNAL Shift_and_cast_to_output_type_out1_signed : signed(15 DOWNTO 0);  -- int16
  SIGNAL Divide_by_zero_handler_out1      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Divide_by_zero_handler_out1_signed : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch_out1                      : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay1_out1                      : signed(15 DOWNTO 0);  -- int16

BEGIN
  u_Upcast_Wordlength : full_rx_ip_src_Upcast_Wordlength
    PORT MAP( x => den,  -- uint16
              y => num,  -- ufix24
              u => u,  -- sfix25_En8
              v => v  -- sfix25
              );

  u_Normalize_numerator : full_rx_ip_src_Normalize_numerator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              u => std_logic_vector(Delay14_out1),  -- sfix25
  ...
  u_MATLAB_Function : full_rx_ip_src_MATLAB_Function
    PORT MAP( num => std_logic_vector(Delay25_out1),  -- sfix25_En23
              t_num => std_logic_vector(Delay26_out1),  -- int32
              num_out => num_out,  -- sfix25_En23
              t_num_out => t_num_out  -- sfix33
              );

  u_Normalize_denominator : full_rx_ip_src_Normalize_denominator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              u => std_logic_vector(Delay4_out1),  -- sfix25_En8
              validIn => Delay15_out1,
              x => x_1,  -- sfix25_En23
              e => e_1,  -- int32
  ...
  u_Divide_real_numerator_by_denominator : full_rx_ip_src_Divide_real_numerator_by_denominator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              num => std_logic_vector(Delay16_out1),  -- sfix25_En23
              tNum => std_logic_vector(Delay17_out1),  -- sfix33
              den => std_logic_vector(Delay9_out1),  -- sfix25_En23
  ...
  u_Shift_and_cast_to_output_type : full_rx_ip_src_Shift_and_cast_to_output_type
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              x => std_logic_vector(Unit_Delay_Enabled_Synchronous_out1),  -- sfix25_En23
              shiftValue => std_logic_vector(Unit_Delay_Enabled_Synchronous1_out1),  -- sfix34
              y => Shift_and_cast_to_output_type_out1  -- int16
              );

  u_Divide_by_zero_handler : full_rx_ip_src_Divide_by_zero_handler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              yIn => std_logic_vector(Unit_Delay_Enabled_Synchronous_out1),  -- sfix25_En23
              yOut => Divide_by_zero_handler_out1  -- int16
              );
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay14_out1 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay25_out1 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay16_out1 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay9_reg <= (OTHERS => to_signed(16#0000000#, 25));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  Unit_Delay_Enabled_Synchronous2_ectrl <= Unit_Delay_Enabled_Synchronous2_out1 WHEN validOut_1 = '0' ELSE
      isDenZeroOut;
  ...
  Unit_Delay_Enabled_Synchronous_ectrl <= Unit_Delay_Enabled_Synchronous_out1 WHEN validOut_1 = '0' ELSE
      y_signed;
  ...
  Unit_Delay_Enabled_Synchronous1_ectrl <= Unit_Delay_Enabled_Synchronous1_out1 WHEN validOut_1 = '0' ELSE
      t_signed;
