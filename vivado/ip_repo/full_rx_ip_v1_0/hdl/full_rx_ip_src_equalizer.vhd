...
ARCHITECTURE rtl OF full_rx_ip_src_equalizer IS
  ...
  SIGNAL Delay10_reg                      : vector_of_signed24(0 TO 1);  -- sfix24 [2]
  SIGNAL Delay10_out1                     : signed(23 DOWNTO 0);  -- sfix24_En20
  ...
  SIGNAL Delay9_reg                       : vector_of_signed24(0 TO 1);  -- sfix24 [2]
  SIGNAL Delay9_out1                      : signed(23 DOWNTO 0);  -- sfix24_En20
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay10_reg <= (OTHERS => to_signed(16#000000#, 24));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay9_reg <= (OTHERS => to_signed(16#000000#, 24));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  Add_add_cast <= resize(Delay10_out1, 25);
  Add_add_cast_1 <= resize(Delay9_out1, 25);
