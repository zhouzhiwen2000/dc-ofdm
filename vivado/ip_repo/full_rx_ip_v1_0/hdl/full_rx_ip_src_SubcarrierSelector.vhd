-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_SubcarrierSelector.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_SubcarrierSelector
-- Source Path: 
-- Hierarchy Level: 4
-- Model version: 1.14
-- 
...
ENTITY full_rx_ip_src_SubcarrierSelector IS
...
END full_rx_ip_src_SubcarrierSelector;


ARCHITECTURE rtl OF full_rx_ip_src_SubcarrierSelector IS
  ...
  SIGNAL obj_SubcarrierSelectorObj_dataOut_re : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataOut_im : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL obj_SubcarrierSelectorObj_dataIn_re : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataIn_im : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL tmp_re                           : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL tmp_im                           : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataIn_re_1 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataIn_im_1 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataOut_re_1 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataOut_im_1 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataOut_re_2 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataOut_im_2 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataOut_re_3 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL obj_SubcarrierSelectorObj_dataOut_im_3 : signed(23 DOWNTO 0);  -- sfix24_En12
...
BEGIN
  ...
  tmp <= varargout_2_1 WHEN obj_SubcarrierSelectorObj_resetSig = '0' ELSE
      obj_SubcarrierSelectorObj_validIn;

  obj_SubcarrierSelectorObj_validIn_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  obj_SubcarrierSelectorObj_FFTLength_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  tmp_6 <= tmp_5 WHEN obj_SubcarrierSelectorObj_resetSig = '0' ELSE
      obj_SubcarrierSelectorObj_vecStepCount_1;

  obj_SubcarrierSelectorObj_vecStepCount_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  tmp_7 <= obj_SubcarrierSelectorObj_numLGSC WHEN obj_SubcarrierSelectorObj_resetSig = '0' ELSE
      obj_SubcarrierSelectorObj_numLGSC_1;

  obj_SubcarrierSelectorObj_numLGSC_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  tmp_12 <= tmp_11 WHEN obj_SubcarrierSelectorObj_resetSig = '0' ELSE
      obj_SubcarrierSelectorObj_FFTMinusRG;

  obj_SubcarrierSelectorObj_FFTMinusRG_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  tmp_re <= varargin_1_re_signed WHEN obj_SubcarrierSelectorObj_resetSig = '0' ELSE
      obj_SubcarrierSelectorObj_dataIn_re;
  
  tmp_im <= varargin_1_im_signed WHEN obj_SubcarrierSelectorObj_resetSig = '0' ELSE
      obj_SubcarrierSelectorObj_dataIn_im;

  obj_SubcarrierSelectorObj_dataIn_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  obj_SubcarrierSelectorObj_dataOut_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  tmp_19 <= tmp_18 WHEN obj_SubcarrierSelectorObj_resetSig = '0' ELSE
      obj_SubcarrierSelectorObj_validOut_3;

  obj_SubcarrierSelectorObj_validOut_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
