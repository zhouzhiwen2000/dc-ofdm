...
ARCHITECTURE rtl OF full_rx_ip_src_SDFCommutator2 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL xf_im_signed                     : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL dinf_re_signed                   : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL dinf_im_signed                   : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL btf1_re_signed                   : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL btf1_im_signed                   : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL btf2_re_signed                   : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL btf2_im_signed                   : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL SDFCummutator_out_im_next        : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL wrData_re_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL wrData_im_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL wrAddr_tmp                       : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL xData_re                         : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL xData_im                         : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL dout0_re                         : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL dout0_im                         : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL xX_re_signed                     : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL xX_im                            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL xX_im_signed                     : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_2_1_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL dout_2_1_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En12
