...
ARCHITECTURE rtl OF full_rx_ip_src_HDLFFTShift IS
  ...
  SIGNAL tmp                              : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL tmp_4                            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL yfi                              : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL p31yfi_cast                      : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL p31yfi_cast_1                    : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL tmp_5                            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL tmp_6                            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL obj_FFTShiftTDObj_rePart         : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL tmp_7                            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL obj_FFTShiftTDObj_rePart_1       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL tmp_8                            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL tmp_9                            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL yfi_1                            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL p30yfi_cast                      : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL p30yfi_cast_1                    : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL tmp_10                           : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL tmp_11                           : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL obj_FFTShiftTDObj_imPart         : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL tmp_12                           : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL obj_FFTShiftTDObj_imPart_1       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL varargout_1_re_tmp               : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL varargout_1_im_tmp               : signed(15 DOWNTO 0);  -- sfix16_En12
...
BEGIN
  ...
  obj_FFTShiftTDObj_count_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  obj_FFTShiftTDObj_rePart_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  obj_FFTShiftTDObj_imPart_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  tmp_13 <= varargout_2_1 WHEN obj_FFTShiftTDObj_resetSig = '0' ELSE
      obj_FFTShiftTDObj_validOut;

  obj_FFTShiftTDObj_validOut_reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
