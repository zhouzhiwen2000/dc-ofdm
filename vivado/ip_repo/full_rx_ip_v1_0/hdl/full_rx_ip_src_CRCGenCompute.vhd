-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_CRCGenCompute.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_CRCGenCompute
-- Source Path: HDLRx/full_rx/h_rx_full/h_crc_rx/General CRC Syndrome Detector HDL Optimized/CRCGenerator/CRCGenCompute
-- Hierarchy Level: 5
-- Model version: 1.14
-- 
...
ENTITY full_rx_ip_src_CRCGenCompute IS
...
END full_rx_ip_src_CRCGenCompute;


ARCHITECTURE rtl OF full_rx_ip_src_CRCGenCompute IS
...
BEGIN
  ...
  validin_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      dvalidin <= '0';
  ...
  checksum_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  -- 1
  outputchecksum_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
