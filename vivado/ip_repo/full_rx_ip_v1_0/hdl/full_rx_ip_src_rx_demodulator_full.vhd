...
ARCHITECTURE rtl OF full_rx_ip_src_rx_demodulator_full IS
  ...
  COMPONENT full_rx_ip_src_4QAM_demod
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  FOR ALL : full_rx_ip_src_4QAM_demod
    USE ENTITY work.full_rx_ip_src_4QAM_demod(rtl);
  ...
  SIGNAL ofdm_demod_out1_re_signed        : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL ofdm_demod_out1_im_signed        : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  u_constellation_descrambler : full_rx_ip_src_constellation_descrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => std_logic_vector(Delay6_out1_re),  -- sfix12_En10
              data_in_im => std_logic_vector(Delay6_out1_im),  -- sfix12_En10
  ...
  u_4QAM_demod : full_rx_ip_src_4QAM_demod
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
