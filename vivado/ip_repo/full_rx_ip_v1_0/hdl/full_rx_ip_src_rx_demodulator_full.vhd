...
ARCHITECTURE rtl OF full_rx_ip_src_rx_demodulator_full IS
  ...
  SIGNAL payloadNumOFDMSymbols            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL ofdm_separator_out1_re_signed    : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL ofdm_separator_out1_im_signed    : signed(15 DOWNTO 0);  -- sfix16_En12
...
BEGIN
  ...
  u_ofdm_separator : full_rx_ip_src_ofdm_separator
    PORT MAP( clk => clk,
              ...
              payload_num_ofdm_symbols => payloadNumOFDMSymbols  -- sfix17
              );
  ...
  u_HDL_FIFO : full_rx_ip_src_HDL_FIFO
    PORT MAP( clk => clk,
              ...
              Push => Delay13_out1,
              Pop => AND_out1,
              rst => rising_edge_detector1_out1,
  ...
  u_ofdm_demod : full_rx_ip_src_ofdm_demod
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => std_logic_vector(Switch_out1_re),  -- sfix16_En12
              data_in_im => std_logic_vector(Switch_out1_im),  -- sfix16_En12
              valid_in => ofdm_valid,
              cp_len => cp_len,  -- uint8
  ...
  Rate_Transition_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  ofdm_separator_out1_re_signed <= signed(ofdm_separator_out1_re);

  ofdm_separator_out1_im_signed <= signed(ofdm_separator_out1_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
        Delay12_out1_re <= ofdm_separator_out1_re_signed;
        Delay12_out1_im <= ofdm_separator_out1_im_signed;
      END IF;
    END IF;
  ...
  Switch_out1_re <= ofdm_separator_out1_re_signed WHEN Delay14_out1 = '0' ELSE
      HDL_FIFO_out1_re_signed;
  
  Switch_out1_im <= ofdm_separator_out1_im_signed WHEN Delay14_out1 = '0' ELSE
      HDL_FIFO_out1_im_signed;

  Logical_Operator1_out1 <= valid_header_1 OR (Delay14_out1 OR valid_channel);
