-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_axi_lite
-- Source Path: full_rx_ip/full_rx_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END full_rx_ip_axi_lite;


ARCHITECTURE rtl OF full_rx_ip_axi_lite IS

  -- Component Declarations
  COMPONENT full_rx_ip_addr_decoder
  ...
  COMPONENT full_rx_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : full_rx_ip_addr_decoder
    USE ENTITY work.full_rx_ip_addr_decoder(rtl);

  FOR ALL : full_rx_ip_axi_lite_module
    USE ENTITY work.full_rx_ip_axi_lite_module(rtl);
...
BEGIN
  u_full_rx_ip_addr_decoder_inst : full_rx_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_reg0 => read_reg0,  -- ufix32
              read_reg1 => read_reg1,  -- ufix32
              read_reg2 => read_reg2,  -- ufix32
              read_reg3 => read_reg3,  -- ufix32
              read_end => read_end,  -- ufix1
              read_err => read_err,  -- ufix1
  ...
  u_full_rx_ip_axi_lite_module_inst : full_rx_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
