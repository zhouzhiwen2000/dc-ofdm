-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_Divide_by_zero_handler_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_Divide_by_zero_handler_block1
...
ENTITY full_rx_ip_src_Divide_by_zero_handler_block1 IS
...
END full_rx_ip_src_Divide_by_zero_handler_block1;


ARCHITECTURE rtl OF full_rx_ip_src_Divide_by_zero_handler_block1 IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_Compare_To_Zero_block1
  ...
  FOR ALL : full_rx_ip_src_Compare_To_Zero_block1
    USE ENTITY work.full_rx_ip_src_Compare_To_Zero_block1(rtl);
...
BEGIN
  u_Compare_To_Zero : full_rx_ip_src_Compare_To_Zero_block1
