...
ARCHITECTURE rtl OF full_rx_ip_src_h_rx_full IS
  ...
  -- Signals
  SIGNAL h_remove_repetition_out1         : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL h_remove_repetition_out1_signed  : signed(15 DOWNTO 0);  -- sfix16_En12
...
BEGIN
  u_h_remove_repetition : full_rx_ip_src_h_remove_repetition
    PORT MAP( clk => clk,
              ...
              start_in => start_in,
              data_out => h_remove_repetition_out1,  -- sfix16_En12
  ...
  u_LDPC_Deco_Hc_12H : full_rx_ip_src_LDPC_Deco_Hc_12H
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              in0 => std_logic_vector(Delay1_out1),  -- sfix16_En12
  ...
  Rate_Transition_out1 <= h_crc_rx_out3 WHEN enb_1_8_1 = '1' ELSE
