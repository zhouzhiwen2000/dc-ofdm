...
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_symbol_sync/frequency_offset_calculator/HDL_CMA_core/Quadrant_Mapper
-- Hierarchy Level: 4
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF full_rx_ip_src_Quadrant_Mapper IS
  ...
  SIGNAL abs1_y                           : signed(33 DOWNTO 0);  -- sfix34_En24
  SIGNAL abs1_cast                        : signed(33 DOWNTO 0);  -- sfix34_En24
...
BEGIN
  ...
  DelayxAbs_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  abs1_cast <= resize(yin_signed, 34);
  
  abs1_y <=  - (abs1_cast) WHEN yin_signed < to_signed(0, 33) ELSE
      resize(yin_signed, 34);
  yAbs <= abs1_y(32 DOWNTO 0);

  DelayyAbs_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delayin2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delayin1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
