...
ARCHITECTURE rtl OF full_rx_ip_src_OFDM_Demodulator IS
  ...
  -- Signals
  SIGNAL data_re_signed                   : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL data_im_signed                   : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_dataReadyDelay_re            : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_dataReadyDelay_im            : signed(13 DOWNTO 0);  -- sfix14_En12
  ...
  SIGNAL varargout_1_re                   : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL varargout_1_im                   : std_logic_vector(13 DOWNTO 0);  -- ufix14
  ...
  SIGNAL varargout_1_re_3                 : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL varargout_1_im_3                 : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL varargout_2_3                    : std_logic;
  SIGNAL varargout_3_2                    : std_logic;
  SIGNAL varargout_1_re_signed            : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL varargout_1_im_signed            : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL obj_dataDelay1_re                : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL obj_dataDelay1_im                : signed(21 DOWNTO 0);  -- sfix22_En12
  ...
  SIGNAL varargout_1_re_4                 : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL varargout_1_im_4                 : std_logic_vector(21 DOWNTO 0);  -- ufix22
  ...
  SIGNAL varargout_1_re_5                 : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL varargout_1_im_5                 : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL varargout_2_5                    : std_logic;
  SIGNAL varargout_1_re_signed_1          : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL varargout_1_im_signed_1          : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL obj_dataOut_re                   : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL obj_dataOut_im                   : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL tmp_re                           : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL tmp_im                           : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL obj_dataOut_re_1                 : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL obj_dataOut_im_1                 : signed(21 DOWNTO 0);  -- sfix22_En12
...
BEGIN
  u_CPRemoval_stage1 : full_rx_ip_src_CPRemoval_stage1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              varargin_1_re => std_logic_vector(obj_dataReadyDelay_re),  -- sfix14_En12
              varargin_1_im => std_logic_vector(obj_dataReadyDelay_im),  -- sfix14_En12
              ...
              varargin_8 => reset,
              varargout_1_re => varargout_1_re,  -- sfix14_En12
              varargout_1_im => varargout_1_im,  -- sfix14_En12
  ...
  u_SamplesRepetition : full_rx_ip_src_SamplesRepetition
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              varargin_1_re => varargout_1_re,  -- sfix14_En12
              varargin_1_im => varargout_1_im,  -- sfix14_En12
              varargin_2 => varargout_2,
              varargin_3 => varargout_3,  -- ufix10
              varargin_4 => varargout_5,  -- ufix10
              varargin_5 => varargout_6,  -- ufix10
              varargin_6 => reset,
              varargout_1_re => varargout_1_re_1,  -- sfix14_En12
              varargout_1_im => varargout_1_im_1,  -- sfix14_En12
  ...
  u_HDLFFTShift : full_rx_ip_src_HDLFFTShift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              varargin_1_re => varargout_1_re_1,  -- sfix14_En12
              varargin_1_im => varargout_1_im_1,  -- sfix14_En12
              varargin_2 => varargout_2_1,
              varargin_3 => reset,
              varargout_1_re => varargout_1_re_2,  -- sfix14_En12
              varargout_1_im => varargout_1_im_2,  -- sfix14_En12
  ...
  u_dsphdl_FFT : full_rx_ip_src_dsphdl_FFT
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dataIn_re => varargout_1_re_2,  -- sfix14_En12
              dataIn_im => varargout_1_im_2,  -- sfix14_En12
              validIn => varargout_2_2,
              syncReset => reset,
              dataOut_re => varargout_1_re_3,  -- sfix22_En12
              dataOut_im => varargout_1_im_3,  -- sfix22_En12
  ...
  u_DownSampler : full_rx_ip_src_DownSampler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              varargin_1_re => std_logic_vector(obj_dataDelay1_re),  -- sfix22_En12
              varargin_1_im => std_logic_vector(obj_dataDelay1_im),  -- sfix22_En12
              ...
              varargin_6 => reset,
              varargout_1_re => varargout_1_re_4,  -- sfix22_En12
              varargout_1_im => varargout_1_im_4,  -- sfix22_En12
  ...
  u_SubcarrierSelector : full_rx_ip_src_SubcarrierSelector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              varargin_1_re => varargout_1_re_4,  -- sfix22_En12
              varargin_1_im => varargout_1_im_4,  -- sfix22_En12
              varargin_2 => varargout_2_4,
              varargin_3 => varargout_3_3,  -- ufix10
              varargin_4 => varargout_4_1,  -- ufix10
              varargin_5 => varargout_5_2,  -- ufix10
              varargin_6 => reset,
              varargout_1_re => varargout_1_re_5,  -- sfix22_En12
              varargout_1_im => varargout_1_im_5,  -- sfix22_En12
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_dataReadyDelay_re <= to_signed(16#0000#, 14);
        obj_dataReadyDelay_im <= to_signed(16#0000#, 14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_dataDelay1_re <= to_signed(16#000000#, 22);
        obj_dataDelay1_im <= to_signed(16#000000#, 22);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  p172_output : PROCESS (obj_FFTReg_1, obj_fftInFFTDelayBal, sel_2_1, tmp_68)
  BEGIN
    s_4 <= obj_FFTReg_1;
    IF sel_2_1 = '1' THEN 
  ...
  p176_output : PROCESS (obj_LGrdInFFTDelayBal, obj_LGrdReg_1, sel_2_3, tmp_81)
  BEGIN
    s_6 <= obj_LGrdReg_1;
    IF sel_2_3 = '1' THEN 
  ...
  p180_output : PROCESS (obj_RGrdInFFTDelayBal, obj_RGrdReg_1, sel_2_5, tmp_90)
  BEGIN
    s_7 <= obj_RGrdReg_1;
    IF sel_2_5 = '1' THEN 
  ...
  obj_dataOut_re <= to_signed(16#000000#, 22);
  obj_dataOut_im <= to_signed(16#000000#, 22);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_dataOut_re_1 <= to_signed(16#000000#, 22);
        obj_dataOut_im_1 <= to_signed(16#000000#, 22);
      ELSIF enb_1_2_0 = '1' THEN
