...
BEGIN
  ...
  p176_output : PROCESS (obj_FFTReg_1, obj_fftInFFTDelayBal, sel_2_1, tmp_68)
  BEGIN
    s_4 <= obj_FFTReg_1;
    IF sel_2_1 = '1' THEN 
  ...
  p180_output : PROCESS (obj_LGrdInFFTDelayBal, obj_LGrdReg_1, sel_2_3, tmp_81)
  BEGIN
    s_6 <= obj_LGrdReg_1;
    IF sel_2_3 = '1' THEN 
  ...
  p172_output : PROCESS (obj_RGrdInFFTDelayBal, obj_RGrdReg_1, sel_2_5, tmp_90)
  BEGIN
    s_7 <= obj_RGrdReg_1;
    IF sel_2_5 = '1' THEN 
