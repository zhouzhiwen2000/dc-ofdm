-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_phase_offset_calculator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_phase_offset_calculator
...
ENTITY full_rx_ip_src_phase_offset_calculator IS
...
END full_rx_ip_src_phase_offset_calculator;


ARCHITECTURE rtl OF full_rx_ip_src_phase_offset_calculator IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_HDL_CMA_core
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_HDL_CMA_core
    USE ENTITY work.full_rx_ip_src_HDL_CMA_core(rtl);
...
BEGIN
  u_Complex_to_Magnitude_Angle : full_rx_ip_src_HDL_CMA_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
