-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_positiveRealNormalizer_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_positiveRealNormalizer_block2
...
ENTITY full_rx_ip_src_positiveRealNormalizer_block2 IS
...
END full_rx_ip_src_positiveRealNormalizer_block2;


ARCHITECTURE rtl OF full_rx_ip_src_positiveRealNormalizer_block2 IS

  -- Signals
  SIGNAL u_signed                         : signed(31 DOWNTO 0);  -- sfix32_En24
  SIGNAL x_tmp                            : signed(31 DOWNTO 0);  -- sfix32_En30
  ...
  SIGNAL xReg                             : vector_of_unsigned32(0 TO 5);  -- ufix32 [6]
  ...
  SIGNAL xReg_next                        : vector_of_unsigned32(0 TO 5);  -- ufix32 [6]
  SIGNAL isNegativeReg_next               : std_logic_vector(5 DOWNTO 0);  -- boolean [6]

BEGIN
  u_signed <= signed(u);

  embreciprocals_c3_sbsVIBiFDvR5izna7lSUKTB_positiveRealNormalize_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      validReg <= (OTHERS => '0');
      tReg <= (OTHERS => to_unsigned(16#00#, 5));
      xReg <= (OTHERS => to_unsigned(0, 32));
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS embreciprocals_c3_sbsVIBiFDvR5izna7lSUKTB_positiveRealNormalize_process;

  embreciprocals_c3_sbsVIBiFDvR5izna7lSUKTB_positiveRealNormalize_output : PROCESS (isNegativeReg, tReg, u_signed, validIn, validReg, xReg)
    VARIABLE u1 : signed(31 DOWNTO 0);
    VARIABLE isNegative1 : std_logic;
    VARIABLE a : unsigned(31 DOWNTO 0);
    VARIABLE c : unsigned(31 DOWNTO 0);
    VARIABLE xfi_stripped : unsigned(31 DOWNTO 0);
    VARIABLE yfi_trivial_scaling : signed(31 DOWNTO 0);
    VARIABLE a_0 : unsigned(31 DOWNTO 0);
    VARIABLE c_0 : unsigned(31 DOWNTO 0);
    VARIABLE a_1 : unsigned(31 DOWNTO 0);
    VARIABLE c_1 : unsigned(31 DOWNTO 0);
    VARIABLE a_2 : unsigned(31 DOWNTO 0);
    VARIABLE c_2 : unsigned(31 DOWNTO 0);
    VARIABLE a_3 : unsigned(31 DOWNTO 0);
    VARIABLE c_3 : unsigned(31 DOWNTO 0);
    VARIABLE a_4 : unsigned(31 DOWNTO 0);
    VARIABLE c_4 : unsigned(31 DOWNTO 0);
    VARIABLE cast : signed(32 DOWNTO 0);
    VARIABLE cast_0 : signed(32 DOWNTO 0);
    VARIABLE sub_cast : signed(31 DOWNTO 0);
  BEGIN
    c_4 := to_unsigned(0, 32);
    c_3 := to_unsigned(0, 32);
    c_2 := to_unsigned(0, 32);
    c_1 := to_unsigned(0, 32);
    c_0 := to_unsigned(0, 32);
    a_4 := to_unsigned(0, 32);
    a_3 := to_unsigned(0, 32);
    a_2 := to_unsigned(0, 32);
    a_1 := to_unsigned(0, 32);
    a_0 := to_unsigned(0, 32);
    ...
    u1 := u_signed;
    IF u_signed < to_signed(0, 32) THEN 
      isNegative1 := '1';
    ELSE 
      isNegative1 := '0';
    END IF;
    IF isNegative1 = '1' THEN 
      cast := resize(u_signed, 33);
      cast_0 :=  - (cast);
    ...
    IF (xReg(4) AND unsigned'(X"80000000")) = to_unsigned(0, 32) THEN 
    ...
    ELSE 
      ...
      xReg_next(5) <= xReg(4);
    END IF;
    IF (xReg(3) AND unsigned'(X"C0000000")) = to_unsigned(0, 32) THEN 
    ...
    ELSE 
      ...
      xReg_next(4) <= xReg(3);
    END IF;
    IF (xReg(2) AND unsigned'(X"F0000000")) = to_unsigned(0, 32) THEN 
    ...
    ELSE 
      ...
      xReg_next(3) <= xReg(2);
    END IF;
    IF (xReg(1) AND unsigned'(X"FF000000")) = to_unsigned(0, 32) THEN 
    ...
    ELSE 
      ...
      xReg_next(2) <= xReg(1);
    END IF;
    IF (xReg(0) AND unsigned'(X"FFFF0000")) = to_unsigned(0, 32) THEN 
    ...
    validOut <= validReg(5);
  END PROCESS embreciprocals_c3_sbsVIBiFDvR5izna7lSUKTB_positiveRealNormalize_output;
