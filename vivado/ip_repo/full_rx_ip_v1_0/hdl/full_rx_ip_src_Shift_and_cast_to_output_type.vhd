...
ARCHITECTURE rtl OF full_rx_ip_src_Shift_and_cast_to_output_type IS
  ...
  SIGNAL Cout                             : std_logic_vector(38 DOWNTO 0);  -- ufix39
  ...
  SIGNAL Variable_Right_Shift_out1        : std_logic_vector(38 DOWNTO 0);  -- ufix39
  SIGNAL Variable_Right_Shift_out1_signed : signed(38 DOWNTO 0);  -- sfix39_En23
  SIGNAL Variable_Left_Shift_out1         : std_logic_vector(38 DOWNTO 0);  -- ufix39
  SIGNAL Variable_Left_Shift_out1_signed  : signed(38 DOWNTO 0);  -- sfix39_En23
  SIGNAL Switch_out1                      : signed(38 DOWNTO 0);  -- sfix39_En23
  SIGNAL Delay1_out1                      : signed(38 DOWNTO 0);  -- sfix39_En23
  SIGNAL Data_Type_Conversion_out1        : signed(15 DOWNTO 0);  -- int16

BEGIN
  u_Cast_to_Union_of_Types : full_rx_ip_src_Cast_to_Union_of_Types
    PORT MAP( Xref => std_logic_vector(Constant_out1),  -- int16
              Cin => x,  -- sfix25_En23
              Cout => Cout  -- sfix39_En23
              );
  ...
  u_Variable_Right_Shift : full_rx_ip_src_Variable_Right_Shift
    PORT MAP( clk => clk,
              ...
              y => Variable_Right_Shift_out1  -- sfix39_En23
              );
  ...
  u_Variable_Left_Shift : full_rx_ip_src_Variable_Left_Shift
    PORT MAP( clk => clk,
              ...
              y => Variable_Left_Shift_out1  -- sfix39_En23
              );
  ...
  Data_Type_Conversion_out1 <= Delay1_out1(38 DOWNTO 23);
