-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_valid_to_ctrl.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_valid_to_ctrl
...
ENTITY full_rx_ip_src_valid_to_ctrl IS
...
END full_rx_ip_src_valid_to_ctrl;


ARCHITECTURE rtl OF full_rx_ip_src_valid_to_ctrl IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_Sample_Control_Bus_Creator_block3
  ...
  FOR ALL : full_rx_ip_src_Sample_Control_Bus_Creator_block3
    USE ENTITY work.full_rx_ip_src_Sample_Control_Bus_Creator_block3(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : full_rx_ip_src_Sample_Control_Bus_Creator_block3
    PORT MAP( In1 => start,
              In2 => end_rsvd,
              In3 => valid,
