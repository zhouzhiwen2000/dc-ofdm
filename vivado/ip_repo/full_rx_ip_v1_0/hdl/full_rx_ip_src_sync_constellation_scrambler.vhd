-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_sync_constellation_scrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_sync_constellation_scrambler
-- Source Path: HDLRx/full_rx/rx_demodulator_full/constellation_descrambler/sync_constellation_scrambler
-- Hierarchy Level: 3
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_sync_constellation_scrambler IS
...
END full_rx_ip_src_sync_constellation_scrambler;


ARCHITECTURE rtl OF full_rx_ip_src_sync_constellation_scrambler IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_Synchronous_constellation_scrambler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          valid_in                        :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_Synchronous_constellation_scrambler
    USE ENTITY work.full_rx_ip_src_Synchronous_constellation_scrambler(rtl);
...
BEGIN
  u_Synchronous_constellation_scrambler : full_rx_ip_src_Synchronous_constellation_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              valid_in => valid_in_1,
  ...
  Rate_Transition41_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      valid_in_1 <= '0';
  ...
  Rate_Transition31_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      init_1 <= (OTHERS => '0');
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Rate_Transition21_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      new_ofdm_symbol_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Rate_Transition1_bypass_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Rate_Transition_bypass_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
