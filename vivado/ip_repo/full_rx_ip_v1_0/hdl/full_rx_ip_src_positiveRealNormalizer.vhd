...
ARCHITECTURE rtl OF full_rx_ip_src_positiveRealNormalizer IS
  ...
  -- Signals
  SIGNAL u_signed                         : signed(24 DOWNTO 0);  -- sfix25
...
BEGIN
  ...
  embreciprocals_c3_s14mscxAahtiBqnXaktE2fE_positiveRealNormalize_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      validReg <= (OTHERS => '0');
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS embreciprocals_c3_s14mscxAahtiBqnXaktE2fE_positiveRealNormalize_process;

  embreciprocals_c3_s14mscxAahtiBqnXaktE2fE_positiveRealNormalize_output : PROCESS (isNegativeReg, tReg, u_signed, validIn, validReg, xReg)
    ...
    VARIABLE t_0 : signed(25 DOWNTO 0);
  ...
  BEGIN
    ...
    IF isNegative1 = '1' THEN 
      t_0 :=  - (resize(u_signed, 26));
      IF (t_0(25) = '0') AND (t_0(24) /= '0') THEN 
        u1 := "0111111111111111111111111";
      ELSIF (t_0(25) = '1') AND (t_0(24) /= '1') THEN 
    ...
    validOut <= validReg(5);
  END PROCESS embreciprocals_c3_s14mscxAahtiBqnXaktE2fE_positiveRealNormalize_output;
