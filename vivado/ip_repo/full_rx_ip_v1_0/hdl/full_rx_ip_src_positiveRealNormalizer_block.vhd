...
BEGIN
  ...
  embreciprocals_c3_szUwl4UaRWSwHB6ziXbSTrD_positiveRealNormalize_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      validReg <= (OTHERS => '0');
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS embreciprocals_c3_szUwl4UaRWSwHB6ziXbSTrD_positiveRealNormalize_process;

  embreciprocals_c3_szUwl4UaRWSwHB6ziXbSTrD_positiveRealNormalize_output : PROCESS (isNegativeReg, tReg, u_signed, validIn, validReg, xReg)
  ...
  BEGIN
    ...
    validOut <= validReg(5);
  END PROCESS embreciprocals_c3_szUwl4UaRWSwHB6ziXbSTrD_positiveRealNormalize_output;
