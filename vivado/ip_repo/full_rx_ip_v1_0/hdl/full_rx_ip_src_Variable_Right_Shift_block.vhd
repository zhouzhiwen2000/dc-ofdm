...
ENTITY full_rx_ip_src_Variable_Right_Shift_block IS
  PORT( clk                               :   IN    std_logic;
        ...
        x                                 :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En30
        rightShift                        :   IN    std_logic_vector(31 DOWNTO 0);  -- int32
        y                                 :   OUT   std_logic_vector(33 DOWNTO 0)  -- sfix34_En30
        );
...
ARCHITECTURE rtl OF full_rx_ip_src_Variable_Right_Shift_block IS
  ...
  SIGNAL x_signed                         : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Bit_Shift_out1                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch1_out1                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Bit_Shift1_out1                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch2_out1                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Bit_Shift2_out1                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch3_out1                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Bit_Shift3_out1                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch4_out1                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Delay_out1                       : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Bit_Shift4_out1                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch5_out1                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Bit_Shift5_out1                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch6_out1                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Bit_Shift6_out1                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch7_out1                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Bit_Shift7_out1                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL Switch8_out1                     : signed(33 DOWNTO 0);  -- sfix34_En30
...
BEGIN
  ...
  Bit_Shift5_out1 <= SHIFT_RIGHT(Switch5_out1, 32);

  
  Switch6_out1 <= Switch5_out1 WHEN Delay2_out1 = '0' ELSE
      Bit_Shift5_out1;

  Bit_Shift6_out1 <= SHIFT_RIGHT(Switch6_out1, 33);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= SHIFT_RIGHT(Switch7_out1, 33);
