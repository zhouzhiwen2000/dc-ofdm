...
BEGIN
  ...
  reg_reg0_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_reg1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_reg2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_reg3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_end_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      read_reg_end <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reg_err_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      read_reg_err <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reg_packet_size_axi4_stream_master_1_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
