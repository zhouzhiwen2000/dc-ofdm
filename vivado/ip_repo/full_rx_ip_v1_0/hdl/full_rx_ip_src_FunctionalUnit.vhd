...
ARCHITECTURE rtl OF full_rx_ip_src_FunctionalUnit IS
  ...
  COMPONENT full_rx_ip_src_VariableNodeUnit
    PORT( clk                             :   IN    std_logic;
          ...
          reset                           :   IN    std_logic;  -- ufix1
          alpha                           :   OUT   vector_of_std_logic_vector18(0 TO 13);  -- sfix18_En12 [14]
          valid_1                         :   OUT   std_logic  -- ufix1
          );
  END COMPONENT;
  ...
  COMPONENT full_rx_ip_src_CheckNodeUnit
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data                            :   IN    vector_of_std_logic_vector16(0 TO 13);  -- sfix16_En12 [14]
          valid                           :   IN    std_logic;  -- ufix1
          count                           :   IN    std_logic_vector(2 DOWNTO 0);  -- ufix3
          reset                           :   IN    std_logic;  -- ufix1
          cnuDecomp1                      :   OUT   vector_of_std_logic_vector7(0 TO 13);  -- ufix7 [14]
          cnuDecomp2                      :   OUT   vector_of_std_logic_vector4(0 TO 13);  -- ufix4 [14]
          cnuDecomp3                      :   OUT   vector_of_std_logic_vector30(0 TO 13);  -- ufix30 [14]
          cnuvalid                        :   OUT   std_logic  -- ufix1
          );
  END COMPONENT;
  ...
  -- Signals
  SIGNAL beta                             : vector_of_std_logic_vector16(0 TO 13);  -- ufix16 [14]
  SIGNAL betaValid_1                      : std_logic;  -- ufix1
  SIGNAL alpha                            : vector_of_std_logic_vector18(0 TO 13);  -- ufix18 [14]
  SIGNAL alphaValid                       : std_logic;  -- ufix1
  SIGNAL alpha_signed                     : vector_of_signed18(0 TO 13);  -- sfix18_En12 [14]
  SIGNAL alphaDTC                         : vector_of_signed16(0 TO 13);  -- sfix16_En12 [14]
  SIGNAL alphaDTC_1                       : vector_of_std_logic_vector16(0 TO 13);  -- ufix16 [14]
  ...
  SIGNAL cnuDecomp3                       : vector_of_std_logic_vector30(0 TO 13);  -- ufix30 [14]
  ...
  SIGNAL alphaD                           : vector_of_std_logic_vector18(0 TO 13);  -- ufix18 [14]
  SIGNAL beta_1                           : vector_of_std_logic_vector16(0 TO 13);  -- ufix16 [14]
  SIGNAL rdValidReg                       : std_logic;  -- ufix1
  SIGNAL gamma_tmp                        : vector_of_std_logic_vector18(0 TO 13);  -- ufix18 [14]
...
BEGIN
  u_Beta_Decompress_Unit_1 : full_rx_ip_src_BetaDecompress_1
    PORT MAP( clk => clk,
              ...
              betacomp3 => betaComp3,  -- ufix30 [14]
              validin => betaValid,  -- ufix1
              count => count,  -- ufix3
              reset => reset,  -- ufix1
              beta => beta,  -- sfix16_En12 [14]
  ...
  u_Variable_Node_Unit : full_rx_ip_src_VariableNodeUnit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => data,  -- sfix18_En12 [14]
              beta => beta,  -- sfix16_En12 [14]
              valid => valid,  -- ufix1
              valid_beta => betaValid_1,  -- ufix1
              reset => reset,  -- ufix1
              alpha => alpha,  -- sfix18_En12 [14]
  ...
  u_Beta_Decompress_Unit_2 : full_rx_ip_src_BetaDecompress_2
    PORT MAP( clk => clk,
              ...
              betacomp3 => cnuDecomp3,  -- ufix30 [14]
              validin => cnuValid_1,  -- ufix1
              count => count,  -- ufix3
              reset => reset,  -- ufix1
              beta => beta_1  -- sfix16_En12 [14]
              );

  u_Aposteriori_Node_Unit : full_rx_ip_src_AposterioriUnit
    PORT MAP( alpha => alphaD,  -- sfix18_En12 [14]
              beta => beta_1,  -- sfix16_En12 [14]
              valid => rdValidReg,  -- ufix1
              gamma => gamma_tmp,  -- sfix18_En12 [14]
