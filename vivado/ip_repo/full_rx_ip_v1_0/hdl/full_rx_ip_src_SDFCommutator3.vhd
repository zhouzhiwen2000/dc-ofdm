-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_SDFCommutator3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_SDFCommutator3
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF1_3/SDFCommutator3
-- Hierarchy Level: 6
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_SDFCommutator3 IS
...
END full_rx_ip_src_SDFCommutator3;


ARCHITECTURE rtl OF full_rx_ip_src_SDFCommutator3 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL xf_im_signed                     : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL dinXTwdlf_re_signed              : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL dinXTwdlf_im_signed              : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL btf1_re_signed                   : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL btf1_im_signed                   : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL btf2_re_signed                   : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL btf2_im_signed                   : signed(18 DOWNTO 0);  -- sfix19_En12
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL SDFCummutator_out_im_next        : signed(18 DOWNTO 0);  -- sfix19_En12
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(18 DOWNTO 0);  -- sfix19_En12
  ...
  SIGNAL wrData_re_tmp                    : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL wrData_im_tmp                    : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL wrAddr_tmp                       : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL xData_re                         : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL xData_im                         : signed(18 DOWNTO 0);  -- sfix19_En12
  ...
  SIGNAL dout0_re                         : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL dout0_im                         : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(18 DOWNTO 0);  -- ufix19
  SIGNAL xX_re_signed                     : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL xX_im                            : std_logic_vector(18 DOWNTO 0);  -- ufix19
  SIGNAL xX_im_signed                     : signed(18 DOWNTO 0);  -- sfix19_En12
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_3_1_re_tmp                  : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL dout_3_1_im_tmp                  : signed(18 DOWNTO 0);  -- sfix19_En12

BEGIN
  u_dataXMEM_re_0_3 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataXMEM_im_0_3 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
