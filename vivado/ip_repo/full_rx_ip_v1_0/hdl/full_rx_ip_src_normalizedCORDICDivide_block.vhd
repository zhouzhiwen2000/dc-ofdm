...
BEGIN
  ...
  embreciprocals_c21_s7qIldOY3WQmoL4yzYGas0C_normalizedCORDICDivi_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS embreciprocals_c21_s7qIldOY3WQmoL4yzYGas0C_normalizedCORDICDivi_process;

  embreciprocals_c21_s7qIldOY3WQmoL4yzYGas0C_normalizedCORDICDivi_output : PROCESS (den_signed, isDenNegative, isDenZeroReg, isNegativeReg, isNumNegative,
  ...
  END PROCESS embreciprocals_c21_s7qIldOY3WQmoL4yzYGas0C_normalizedCORDICDivi_output;
