-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_fifo_data_OUT
-- Source Path: full_rx_ip/full_rx_ip_axi4_stream_master/full_rx_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_rx_ip_fifo_data_OUT IS
...
END full_rx_ip_fifo_data_OUT;


ARCHITECTURE rtl OF full_rx_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT full_rx_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : full_rx_ip_SimpleDualPortRAM_generic
    USE ENTITY work.full_rx_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_full_rx_ip_fifo_data_OUT_classic_ram_generic : full_rx_ip_SimpleDualPortRAM_generic
