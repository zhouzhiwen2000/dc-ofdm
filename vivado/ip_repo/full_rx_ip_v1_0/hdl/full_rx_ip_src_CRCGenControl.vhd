...
BEGIN
  eofin_delay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      deofin <= '0';
  ...
  counter_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  counter_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  counter_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      cnt1out <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  tprocessMsg_delay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      dtprocessMsg <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  sof_delay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  counter_4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  counter_5_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  eofout_delay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      dteofout <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  validin_unitdelay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      udvalidin <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  tvalidout_delay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
