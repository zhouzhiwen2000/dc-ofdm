...
ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF1_1 IS
  ...
  -- Signals
  SIGNAL din_1_1_re_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL din_re                           : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL dinXTwdl_re                      : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL din_1_1_im_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL din_im                           : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL dinXTwdl_im                      : signed(16 DOWNTO 0);  -- sfix17_En12
...
BEGIN
  ...
  u_dataMEM_re_0_1 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 7,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : full_rx_ip_src_SDFCommutator1
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix7
              wrEnb => wrEnb,
              dout_1_1_re => dout_1_1_re_tmp,  -- sfix17_En12
              dout_1_1_im => dout_1_1_im_tmp,  -- sfix17_En12
