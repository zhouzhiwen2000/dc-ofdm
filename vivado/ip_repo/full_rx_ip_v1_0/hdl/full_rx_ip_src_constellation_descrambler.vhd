...
ARCHITECTURE rtl OF full_rx_ip_src_constellation_descrambler IS
  ...
  SIGNAL s1                               : std_logic;
  SIGNAL s2                               : std_logic;
  SIGNAL data_out_re_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL data_out_im_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  ...
  u_rotate_90 : full_rx_ip_src_rotate_90_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => data_in_re,  -- sfix24_En12
              data_in_im => data_in_im,  -- sfix24_En12
              valid_in => valid,
              s1_in => s1,
              s2_in => s2,
              data_out_re => data_out_re_tmp,  -- sfix24_En12
              data_out_im => data_out_im_tmp,  -- sfix24_En12
