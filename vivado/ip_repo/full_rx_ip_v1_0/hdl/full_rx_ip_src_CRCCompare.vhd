...
BEGIN
  ...
  outputCRC_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      outputCRC_1 <= '0';
  ...
  dataout_delay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  -- startOut
  startout_delay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  validout_delay_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  totalErr_register_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
