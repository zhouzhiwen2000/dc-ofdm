...
ARCHITECTURE rtl OF full_rx_ip_src_calculate_R IS
  ...
  SIGNAL Delay12_reg                      : vector_of_signed28(0 TO 1);  -- sfix28 [2]
  SIGNAL Delay12_out1                     : signed(27 DOWNTO 0);  -- sfix28_En24
  ...
  SIGNAL Delay11_reg                      : vector_of_signed28(0 TO 1);  -- sfix28 [2]
  SIGNAL Delay11_out1                     : signed(27 DOWNTO 0);  -- sfix28_En24
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay12_reg <= (OTHERS => to_signed(16#0000000#, 28));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay11_reg <= (OTHERS => to_signed(16#0000000#, 28));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  Add1_add_cast <= resize(Delay12_out1, 29);
  Add1_add_cast_1 <= resize(Delay11_out1, 29);
