...
BEGIN
  ...
  C1_lowered_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      C1_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  C2_lowered_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      C2_out1 <= '1';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  C3_lowered_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      C3_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  C4_lowered_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      C4_out1 <= '1';
    ELSIF clk'EVENT AND clk = '1' THEN
