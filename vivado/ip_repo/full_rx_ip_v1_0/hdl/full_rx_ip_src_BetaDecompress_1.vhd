-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_BetaDecompress_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_BetaDecompress_1
-- Source Path: HDLRx/full_rx/h_rx_full/LDPC_Deco_Hc_12H/DecoderCore/FunctionalUnit/BetaDecompress_1
-- Hierarchy Level: 5
-- Model version: 1.100
-- 
...
ENTITY full_rx_ip_src_BetaDecompress_1 IS
...
END full_rx_ip_src_BetaDecompress_1;


ARCHITECTURE rtl OF full_rx_ip_src_BetaDecompress_1 IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_BetaCalculation_1
  ...
  FOR ALL : full_rx_ip_src_BetaCalculation_1
    USE ENTITY work.full_rx_ip_src_BetaCalculation_1(rtl);
  ...
  SIGNAL betacomp3_unsigned               : vector_of_unsigned30(0 TO 13);  -- ufix30 [14]
  ...
  SIGNAL min1_dtc                         : vector_of_unsigned15(0 TO 13);  -- ufix15 [14]
  SIGNAL sMin1                            : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  SIGNAL sMin1_1                          : vector_of_std_logic_vector16(0 TO 13);  -- ufix16 [14]
  SIGNAL min2_dtc                         : vector_of_unsigned15(0 TO 13);  -- ufix15 [14]
  SIGNAL sMin2                            : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  SIGNAL sMin2_1                          : vector_of_std_logic_vector16(0 TO 13);  -- ufix16 [14]
  SIGNAL betaReg                          : vector_of_std_logic_vector16(0 TO 13);  -- ufix16 [14]
  SIGNAL betaReg_signed                   : vector_of_signed16(0 TO 13);  -- sfix16_En12 [14]
  SIGNAL beta_tmp                         : vector_of_signed16(0 TO 13);  -- sfix16_En12 [14]

BEGIN
  u_BetaCalUnit : full_rx_ip_src_BetaCalculation_1
    PORT MAP( signs => signs,  -- ufix1 [14]
              prodsign => prodsign,  -- ufix1 [14]
              minidx => min_index_1,  -- ufix3 [14]
              min1 => sMin1_1,  -- ufix16_En12 [14]
              min2 => sMin2_1,  -- ufix16_En12 [14]
              count => std_logic_vector(countVal),  -- ufix3
              beta => betaReg  -- sfix16_En12 [14]
              );
