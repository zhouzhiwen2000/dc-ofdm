-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_Hc_12S_B80.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_Hc_12S_B80
-- Source Path: HDLRx/full_rx/rx_payload_full/reduced_ldpc_rx/Hc_12S_B80
-- Hierarchy Level: 3
-- Model version: 1.101
-- 
-- LDPC Decoder
...
ENTITY full_rx_ip_src_Hc_12S_B80 IS
...
END full_rx_ip_src_Hc_12S_B80;


ARCHITECTURE rtl OF full_rx_ip_src_Hc_12S_B80 IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_CodeParameters_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_rx_ip_src_DecoderCore_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_CodeParameters_block
    USE ENTITY work.full_rx_ip_src_CodeParameters_block(rtl);

  FOR ALL : full_rx_ip_src_DecoderCore_block
    USE ENTITY work.full_rx_ip_src_DecoderCore_block(rtl);
...
BEGIN
  u_Code_Parameters : full_rx_ip_src_CodeParameters_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Decoder_Core : full_rx_ip_src_DecoderCore_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => reset,  -- ufix1
