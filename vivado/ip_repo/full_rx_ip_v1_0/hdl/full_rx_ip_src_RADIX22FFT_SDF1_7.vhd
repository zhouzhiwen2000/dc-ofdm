...
ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF1_7 IS
  ...
  COMPONENT full_rx_ip_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_re                          :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          din_im                          :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          din_7_vld_dly                   :   IN    std_logic;
          twdl_7_1_re                     :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          twdl_7_1_im                     :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          dinXTwdl_re                     :   OUT   std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          dinXTwdl_im                     :   OUT   std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          dinXTwdl_7_1_vld                :   OUT   std_logic
          );
  END COMPONENT;
  ...
  COMPONENT full_rx_ip_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          ...
          enb_1_2_0                       :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          xf_im                           :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          dinXTwdlf_im                    :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          btf1_im                         :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          btf2_re                         :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          btf2_im                         :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
          wrData_im                       :   OUT   std_logic_vector(22 DOWNTO 0);  -- sfix23_En12
  ...
  -- Signals
  SIGNAL din_7_1_re_dly_signed            : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL din_re                           : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL din_7_1_im_dly_signed            : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL din_im                           : signed(22 DOWNTO 0);  -- sfix23_En12
  ...
  SIGNAL dinXTwdl_re_signed               : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL dinXTwdl_im_signed               : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL btf2_re                          : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL btf1_im                          : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL btf1_re                          : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL dinXTwdlf_im                     : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL dinXTwdlf_re                     : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL xf_im                            : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL wrData_im                        : std_logic_vector(22 DOWNTO 0);  -- ufix23
  SIGNAL wrData_im_signed                 : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL wrData_re                        : std_logic_vector(22 DOWNTO 0);  -- ufix23
  SIGNAL wrData_re_signed                 : signed(22 DOWNTO 0);  -- sfix23_En12
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL x_re                             : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL x_im                             : signed(22 DOWNTO 0);  -- sfix23_En12
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_add_cast      : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL xf_re                            : signed(22 DOWNTO 0);  -- sfix23_En12
...
BEGIN
  u_MUL4 : full_rx_ip_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_re => std_logic_vector(din_re),  -- sfix23_En12
              din_im => std_logic_vector(din_im),  -- sfix23_En12
              din_7_vld_dly => din_7_vld_dly,
              twdl_7_1_re => twdl_7_1_re,  -- sfix16_En14
              twdl_7_1_im => twdl_7_1_im,  -- sfix16_En14
              dinXTwdl_re => dinXTwdl_re,  -- sfix23_En12
              dinXTwdl_im => dinXTwdl_im,  -- sfix23_En12
  ...
  u_SDFCOMMUTATOR_7 : full_rx_ip_src_SDFCommutator7
    PORT MAP( clk => clk,
              ...
              enb_1_2_0 => enb_1_2_0,
              din_7_vld_dly => din_7_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix23_En12
              xf_im => std_logic_vector(xf_im),  -- sfix23_En12
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix23_En12
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix23_En12
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix23_En12
              btf1_im => std_logic_vector(btf1_im),  -- sfix23_En12
              btf2_re => std_logic_vector(btf2_re),  -- sfix23_En12
              btf2_im => std_logic_vector(btf2_im),  -- sfix23_En12
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix23_En12
              wrData_im => wrData_im,  -- sfix23_En12
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_7_1_re => dout_7_1_re_tmp,  -- sfix23_En12
              dout_7_1_im => dout_7_1_im_tmp,  -- sfix23_En12
  ...
  -- twoLocationReg_0
  twoLocationReg_0_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  -- Radix22ButterflyG1
  Radix22ButterflyG1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
