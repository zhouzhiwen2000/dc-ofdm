-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_RADIX22FFT_SDF1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_RADIX22FFT_SDF1_7
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF1_7
-- Hierarchy Level: 5
-- Model version: 1.104
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_RADIX22FFT_SDF1_7 IS
...
END full_rx_ip_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF1_7 IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_rx_ip_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_Complex4Multiply_block1
    USE ENTITY work.full_rx_ip_src_Complex4Multiply_block1(rtl);

  FOR ALL : full_rx_ip_src_SDFCommutator7
    USE ENTITY work.full_rx_ip_src_SDFCommutator7(rtl);
...
BEGIN
  u_MUL4 : full_rx_ip_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SDFCOMMUTATOR_7 : full_rx_ip_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_7_vld_dly => din_7_vld_dly,
