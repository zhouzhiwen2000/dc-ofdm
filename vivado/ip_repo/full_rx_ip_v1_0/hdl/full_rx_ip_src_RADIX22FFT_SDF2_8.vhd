-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_RADIX22FFT_SDF2_8
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF2_8
-- Hierarchy Level: 5
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_RADIX22FFT_SDF2_8 IS
...
END full_rx_ip_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF2_8 IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          xf_im                           :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          dinf_im                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          btf1_im                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          btf2_re                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          btf2_im                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
          wrData_im                       :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En12
  ...
  FOR ALL : full_rx_ip_src_SDFCommutator8
    USE ENTITY work.full_rx_ip_src_SDFCommutator8(rtl);

  -- Signals
  SIGNAL dout_7_1_re_signed               : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL din_re                           : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dout_7_1_im_signed               : signed(22 DOWNTO 0);  -- sfix23_En12
  SIGNAL din_im                           : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL saveEnb                          : std_logic;
  SIGNAL dinVld                           : std_logic;
  SIGNAL din_re_dly1                      : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btfin_re                         : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL din_im_dly1                      : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btfin_im                         : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL btf2_im                          : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btf2_re                          : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btf1_im                          : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btf1_re                          : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dinf_im                          : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dinf_re                          : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL xf_im                            : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL x_im                             : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL x_im_dly                         : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL wrData_im                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL wrData_im_signed                 : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL wrData_re                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL wrData_re_signed                 : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL x_re                             : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL x_re_dly                         : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(23 DOWNTO 0);  -- sfix24_En12
...
BEGIN
  u_SDFCOMMUTATOR_8 : full_rx_ip_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_7_1_vld => dout_7_1_vld,
              xf_re => std_logic_vector(xf_re),  -- sfix24_En12
              xf_im => std_logic_vector(xf_im),  -- sfix24_En12
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix24_En12
              dinf_im => std_logic_vector(dinf_im),  -- sfix24_En12
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix24_En12
              btf1_im => std_logic_vector(btf1_im),  -- sfix24_En12
              btf2_re => std_logic_vector(btf2_re),  -- sfix24_En12
              btf2_im => std_logic_vector(btf2_im),  -- sfix24_En12
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix24_En12
              wrData_im => wrData_im,  -- sfix24_En12
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_8_1_re => dout_8_1_re_tmp,  -- sfix24_En12
              dout_8_1_im => dout_8_1_im_tmp,  -- sfix24_En12
  ...
  -- Radix22ButterflyG2
  Radix22ButterflyG2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
