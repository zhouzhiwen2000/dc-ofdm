...
BEGIN
  ...
  Rate_Transition_out1 <= start WHEN enb_1_8_1 = '1' ELSE
      Rate_Transition_bypass_reg;

  valid <= ctrl_in_valid;

  Deserializer1D_contl_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Deserializer1D_innerRegComp_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Deserializer1D_deserInnerOut <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND Deserializer1D_innerRegCtrolEn = '1' THEN
  ...
  Deserializer1D_OutRegComp_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Deserializer1D_OutRegComp_reg <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF Deserializer1D_outBypassEn = '1' AND enb = '1' THEN
  ...
  Deserializer1D_tapDelayComp_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Deserializer1D_innerRegComp_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Deserializer1D_OutRegComp_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Unit_Delay3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Unit_Delay7_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Unit_Delay8_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Unit_Delay9_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Unit_Delay10_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Unit_Delay11_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Unit_Delay11_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
