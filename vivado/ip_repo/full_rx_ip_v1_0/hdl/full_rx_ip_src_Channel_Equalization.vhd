...
ARCHITECTURE rtl OF full_rx_ip_src_Channel_Equalization IS
  ...
  COMPONENT full_rx_ip_src_equalizer
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  FOR ALL : full_rx_ip_src_equalizer
    USE ENTITY work.full_rx_ip_src_equalizer(rtl);
...
BEGIN
  ...
  u_Channel_Estimates_Store_RAM : full_rx_ip_src_SimpleDualPortRAM_generic_block2
  ...
  u_equalizer : full_rx_ip_src_equalizer
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
