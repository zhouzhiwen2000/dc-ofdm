...
ARCHITECTURE rtl OF full_rx_ip_src_calculate_P IS
  ...
  COMPONENT full_rx_ip_src_complex_multiplier1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          in_a_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : full_rx_ip_src_complex_multiplier1
    USE ENTITY work.full_rx_ip_src_complex_multiplier1(rtl);
...
BEGIN
  ...
  u_complex_multiplier1 : full_rx_ip_src_complex_multiplier1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
