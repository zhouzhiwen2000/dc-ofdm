...
ARCHITECTURE rtl OF full_rx_ip_src_calculate_P IS
  ...
  COMPONENT full_rx_ip_src_complex_multiplier_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_rx_ip_src_complex_multiplier_block
    USE ENTITY work.full_rx_ip_src_complex_multiplier_block(rtl);
  ...
  SIGNAL Delay16_reg_re                   : vector_of_signed31(0 TO 1);  -- sfix31_En24 [2]
  SIGNAL Delay16_reg_im                   : vector_of_signed31(0 TO 1);  -- sfix31_En24 [2]
  SIGNAL Delay16_out1_re                  : signed(30 DOWNTO 0);  -- sfix31_En24
  SIGNAL Delay16_out1_im                  : signed(30 DOWNTO 0);  -- sfix31_En24
  SIGNAL Delay3_reg_re                    : vector_of_signed31(0 TO 1);  -- sfix31_En24 [2]
  SIGNAL Delay3_reg_im                    : vector_of_signed31(0 TO 1);  -- sfix31_En24 [2]
  SIGNAL Delay3_out1_re                   : signed(30 DOWNTO 0);  -- sfix31_En24
  SIGNAL Delay3_out1_im                   : signed(30 DOWNTO 0);  -- sfix31_En24
...
BEGIN
  ...
  u_complex_multiplier : full_rx_ip_src_complex_multiplier_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay16_reg_re <= (OTHERS => to_signed(16#00000000#, 31));
        Delay16_reg_im <= (OTHERS => to_signed(16#00000000#, 31));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay3_reg_re <= (OTHERS => to_signed(16#00000000#, 31));
        Delay3_reg_im <= (OTHERS => to_signed(16#00000000#, 31));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1_re <= to_signed(16#00000000#, 31);
        Delay4_out1_im <= to_signed(16#00000000#, 31);
      ELSIF enb_1_2_0 = '1' THEN
