...
BEGIN
  ...
  --  step value      = 1
  --  count to value  = 7
  multirate_counter_master_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  multirate_int_delay_port_tready_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  --  initial value   = 0
  --  step value      = 1
  tlast_counter_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
