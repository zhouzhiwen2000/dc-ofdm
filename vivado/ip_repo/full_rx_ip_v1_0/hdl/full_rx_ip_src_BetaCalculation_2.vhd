-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_BetaCalculation_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_BetaCalculation_2
-- Source Path: HDLRx/full_rx/h_rx_full/LDPC_Deco_Hc_12H/DecoderCore/FunctionalUnit/BetaDecompress_2/BetaCalculation_2
-- Hierarchy Level: 6
-- Model version: 1.100
-- 
...
ENTITY full_rx_ip_src_BetaCalculation_2 IS
  PORT( signs                             :   IN    std_logic_vector(13 DOWNTO 0);  -- ufix1 [14]
        ...
        min1                              :   IN    vector_of_std_logic_vector16(0 TO 13);  -- ufix16_En12 [14]
        min2                              :   IN    vector_of_std_logic_vector16(0 TO 13);  -- ufix16_En12 [14]
        count                             :   IN    std_logic_vector(2 DOWNTO 0);  -- ufix3
        beta                              :   OUT   vector_of_std_logic_vector16(0 TO 13)  -- sfix16_En12 [14]
        );
END full_rx_ip_src_BetaCalculation_2;


ARCHITECTURE rtl OF full_rx_ip_src_BetaCalculation_2 IS
  ...
  SIGNAL mag                              : vector_of_unsigned16(0 TO 13);  -- ufix16_En12 [14]
  SIGNAL mag_dtc                          : vector_of_signed16(0 TO 13);  -- sfix16_En12 [14]
  SIGNAL uminusComp_cast                  : vector_of_signed17(0 TO 13);  -- sfix17_En12 [14]
  SIGNAL uminusComp_cast_1                : vector_of_signed17(0 TO 13);  -- sfix17_En12 [14]
  SIGNAL smag                             : vector_of_signed16(0 TO 13);  -- sfix16_En12 [14]
  ...
  SIGNAL betaD                            : vector_of_signed16(0 TO 13);  -- sfix16_En12 [14]
