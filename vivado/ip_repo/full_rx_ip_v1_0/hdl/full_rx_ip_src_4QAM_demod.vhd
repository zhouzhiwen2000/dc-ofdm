...
BEGIN
  ...
  convert_with_rounding_out1_gen: FOR ii IN 0 TO 1 GENERATE
    convert_with_rounding_out1(ii) <= Delay3_out1(ii)(12 DOWNTO 9) + ('0' & (Delay3_out1(ii)(8) AND (( NOT Delay3_out1(ii)(15)) OR (Delay3_out1(ii)(7) OR Delay3_out1(ii)(6) OR Delay3_out1(ii)(5) OR Delay3_out1(ii)(4) OR Delay3_out1(ii)(3) OR Delay3_out1(ii)(2) OR Delay3_out1(ii)(1) OR Delay3_out1(ii)(0)))));
