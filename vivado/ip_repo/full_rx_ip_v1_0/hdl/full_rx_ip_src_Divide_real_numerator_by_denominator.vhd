-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_Divide_real_numerator_by_denominator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_Divide_real_numerator_by_denominator
...
ENTITY full_rx_ip_src_Divide_real_numerator_by_denominator IS
...
END full_rx_ip_src_Divide_real_numerator_by_denominator;


ARCHITECTURE rtl OF full_rx_ip_src_Divide_real_numerator_by_denominator IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_normalizedCORDICDivide
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
  ...
  FOR ALL : full_rx_ip_src_normalizedCORDICDivide
    USE ENTITY work.full_rx_ip_src_normalizedCORDICDivide(rtl);
...
BEGIN
  u_normalizedCORDICDivide : full_rx_ip_src_normalizedCORDICDivide
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              num => num,  -- sfix18_En16
