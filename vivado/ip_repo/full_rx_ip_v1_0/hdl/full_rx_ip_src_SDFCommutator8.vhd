-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_SDFCommutator8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_SDFCommutator8
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF2_8/SDFCommutator8
-- Hierarchy Level: 6
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_SDFCommutator8 IS
...
END full_rx_ip_src_SDFCommutator8;


ARCHITECTURE rtl OF full_rx_ip_src_SDFCommutator8 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL xf_im_signed                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dinf_re_signed                   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dinf_im_signed                   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btf1_re_signed                   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btf1_im_signed                   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btf2_re_signed                   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL btf2_im_signed                   : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL SDFCummutator_out_im_next        : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL wrData_im_tmp                    : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL xData_re                         : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL xData_im                         : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL dout0_re                         : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dout0_im                         : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL xX_re_signed                     : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL xX_im                            : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL xX_im_signed                     : signed(23 DOWNTO 0);  -- sfix24_En12
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_8_1_re_tmp                  : signed(23 DOWNTO 0);  -- sfix24_En12
  SIGNAL dout_8_1_im_tmp                  : signed(23 DOWNTO 0);  -- sfix24_En12

BEGIN
  u_dataXMEM_re_0_8 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataXMEM_im_0_8 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  -- SDFCummutator
  SDFCummutator_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  -- SDFOutmux
  SDFOutmux_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
