-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_RADIX22FFT_CTRL1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_RADIX22FFT_CTRL1_1
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_CTRL1_1
-- Hierarchy Level: 5
-- Model version: 1.14
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_RADIX22FFT_CTRL1_1 IS
...
END full_rx_ip_src_RADIX22FFT_CTRL1_1;


ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_CTRL1_1 IS
...
BEGIN
  -- SDFController
  SDFController_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
