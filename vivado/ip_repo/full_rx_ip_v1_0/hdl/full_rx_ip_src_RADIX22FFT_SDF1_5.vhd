-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/full_rx_ip_src_RADIX22FFT_SDF1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_rx_ip_src_RADIX22FFT_SDF1_5
-- Source Path: HDLRx/full_rx/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF1_5
-- Hierarchy Level: 5
-- Model version: 1.104
-- 
-- -------------------------------------------------------------
...
ENTITY full_rx_ip_src_RADIX22FFT_SDF1_5 IS
...
END full_rx_ip_src_RADIX22FFT_SDF1_5;


ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF1_5 IS

  -- Component Declarations
  COMPONENT full_rx_ip_src_Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_rx_ip_src_SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          xf_im                           :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          dinXTwdlf_im                    :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          btf1_im                         :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          btf2_re                         :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          btf2_im                         :   IN    std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          btf_vld                         :   IN    std_logic;
          syncReset                       :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
          wrData_im                       :   OUT   std_logic_vector(18 DOWNTO 0);  -- sfix19_En12
  ...
  FOR ALL : full_rx_ip_src_Complex4Multiply_block
    USE ENTITY work.full_rx_ip_src_Complex4Multiply_block(rtl);
  ...
  FOR ALL : full_rx_ip_src_SDFCommutator5
    USE ENTITY work.full_rx_ip_src_SDFCommutator5(rtl);

  -- Signals
  SIGNAL din_5_1_re_dly_signed            : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL din_re                           : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL din_5_1_im_dly_signed            : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL din_im                           : signed(18 DOWNTO 0);  -- sfix19_En12
  ...
  SIGNAL dinXTwdl_re_signed               : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL dinXTwdl_im_signed               : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL btf2_re                          : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL btf1_im                          : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL btf1_re                          : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL dinXTwdlf_im                     : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL dinXTwdlf_re                     : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL xf_im                            : signed(18 DOWNTO 0);  -- sfix19_En12
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_add_cast      : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL xf_re                            : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinxTwdlf_vld                    : std_logic;
  SIGNAL btf_vld                          : std_logic;
  SIGNAL dout_5_1_re_tmp                  : std_logic_vector(18 DOWNTO 0);  -- ufix19
  SIGNAL dout_5_1_im_tmp                  : std_logic_vector(18 DOWNTO 0);  -- ufix19

BEGIN
  u_MUL4 : full_rx_ip_src_Complex4Multiply_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_re => std_logic_vector(din_re),  -- sfix19_En12
              din_im => std_logic_vector(din_im),  -- sfix19_En12
              din_5_vld_dly => din_5_vld_dly,
              twdl_5_1_re => twdl_5_1_re,  -- sfix14_En12
              twdl_5_1_im => twdl_5_1_im,  -- sfix14_En12
              syncReset => syncReset,
              dinXTwdl_re => dinXTwdl_re,  -- sfix19_En12
              dinXTwdl_im => dinXTwdl_im,  -- sfix19_En12
              dinXTwdl_5_1_vld => dinXTwdl_5_1_vld_1
              );

  u_dataMEM_im_0_5 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataMEM_re_0_5 : full_rx_ip_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_5 : full_rx_ip_src_SDFCommutator5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_5_vld_dly => din_5_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix19_En12
              xf_im => std_logic_vector(xf_im),  -- sfix19_En12
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix19_En12
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix19_En12
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix19_En12
              btf1_im => std_logic_vector(btf1_im),  -- sfix19_En12
              btf2_re => std_logic_vector(btf2_re),  -- sfix19_En12
              btf2_im => std_logic_vector(btf2_im),  -- sfix19_En12
              btf_vld => btf_vld,
              syncReset => syncReset,
              wrData_re => wrData_re,  -- sfix19_En12
              wrData_im => wrData_im,  -- sfix19_En12
              wrAddr => wrAddr,  -- ufix3
              wrEnb => wrEnb,
              dout_5_1_re => dout_5_1_re_tmp,  -- sfix19_En12
              dout_5_1_im => dout_5_1_im_tmp,  -- sfix19_En12
              dout_5_1_vld => dout_5_1_vld
              );

  din_5_1_re_dly_signed <= signed(din_5_1_re_dly);

  din_re <= resize(din_5_1_re_dly_signed, 19);

  din_5_1_im_dly_signed <= signed(din_5_1_im_dly);

  din_im <= resize(din_5_1_im_dly_signed, 19);
