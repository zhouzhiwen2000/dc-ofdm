...
ARCHITECTURE rtl OF full_rx_ip_src_RADIX22FFT_SDF1_5 IS
  ...
  -- Signals
  SIGNAL din_5_1_re_dly_signed            : signed(19 DOWNTO 0);  -- sfix20_En12
  SIGNAL din_re                           : signed(20 DOWNTO 0);  -- sfix21_En12
  SIGNAL din_5_1_im_dly_signed            : signed(19 DOWNTO 0);  -- sfix20_En12
...
BEGIN
  ...
  u_SDFCOMMUTATOR_5 : full_rx_ip_src_SDFCommutator5
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix3
              wrEnb => wrEnb,
              dout_5_1_re => dout_5_1_re_tmp,  -- sfix21_En12
              dout_5_1_im => dout_5_1_im_tmp,  -- sfix21_En12
