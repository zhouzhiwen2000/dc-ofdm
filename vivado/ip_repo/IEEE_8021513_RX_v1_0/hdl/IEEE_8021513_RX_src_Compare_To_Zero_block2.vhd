-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_Compare_To_Zero_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_Compare_To_Zero_block2
...
ENTITY IEEE_8021513_RX_src_Compare_To_Zero_block2 IS
  PORT( u                                 :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
        y                                 :   OUT   std_logic
        );
END IEEE_8021513_RX_src_Compare_To_Zero_block2;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_Compare_To_Zero_block2 IS
