-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_h_crc_rx.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_h_crc_rx
...
ENTITY IEEE_8021513_RX_src_h_crc_rx IS
...
END IEEE_8021513_RX_src_h_crc_rx;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_h_crc_rx IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Sample_Control_Bus_Creator_block
  ...
  FOR ALL : IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized
    USE ENTITY work.IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized(rtl);

  FOR ALL : IEEE_8021513_RX_src_Sample_Control_Bus_Creator_block
    USE ENTITY work.IEEE_8021513_RX_src_Sample_Control_Bus_Creator_block(rtl);
...
BEGIN
  u_General_CRC_Syndrome_Detector_HDL_Optimized : IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => data_in,
  ...
  u_Sample_Control_Bus_Creator : IEEE_8021513_RX_src_Sample_Control_Bus_Creator_block
