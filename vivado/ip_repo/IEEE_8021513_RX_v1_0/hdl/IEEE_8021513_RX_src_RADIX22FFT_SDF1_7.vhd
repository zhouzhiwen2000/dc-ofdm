-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_RADIX22FFT_SDF1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_RADIX22FFT_SDF1_7
...
ENTITY IEEE_8021513_RX_src_RADIX22FFT_SDF1_7 IS
...
END IEEE_8021513_RX_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_RADIX22FFT_SDF1_7 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_Complex4Multiply_block1
    USE ENTITY work.IEEE_8021513_RX_src_Complex4Multiply_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_SDFCommutator7
    USE ENTITY work.IEEE_8021513_RX_src_SDFCommutator7(rtl);
...
BEGIN
  u_MUL4 : IEEE_8021513_RX_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SDFCOMMUTATOR_7 : IEEE_8021513_RX_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_7_vld_dly => din_7_vld_dly,
