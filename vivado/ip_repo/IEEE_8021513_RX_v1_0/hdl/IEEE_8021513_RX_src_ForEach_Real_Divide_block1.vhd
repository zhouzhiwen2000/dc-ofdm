-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_ForEach_Real_Divide_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_ForEach_Real_Divide_block1
...
ENTITY IEEE_8021513_RX_src_ForEach_Real_Divide_block1 IS
...
END IEEE_8021513_RX_src_ForEach_Real_Divide_block1;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_ForEach_Real_Divide_block1 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_Upcast_Wordlength_block1
  ...
  COMPONENT IEEE_8021513_RX_src_Normalize_numerator_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_MATLAB_Function_block1
  ...
  COMPONENT IEEE_8021513_RX_src_Normalize_denominator_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          u                               :   IN    std_logic_vector(24 DOWNTO 0);  -- sfix25_En10
  ...
  COMPONENT IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Shift_and_cast_to_output_type_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Divide_by_zero_handler_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_Upcast_Wordlength_block1
    USE ENTITY work.IEEE_8021513_RX_src_Upcast_Wordlength_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_Normalize_numerator_block1
    USE ENTITY work.IEEE_8021513_RX_src_Normalize_numerator_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_MATLAB_Function_block1
    USE ENTITY work.IEEE_8021513_RX_src_MATLAB_Function_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_Normalize_denominator_block1
    USE ENTITY work.IEEE_8021513_RX_src_Normalize_denominator_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1
    USE ENTITY work.IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_Shift_and_cast_to_output_type_block1
    USE ENTITY work.IEEE_8021513_RX_src_Shift_and_cast_to_output_type_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_Divide_by_zero_handler_block1
    USE ENTITY work.IEEE_8021513_RX_src_Divide_by_zero_handler_block1(rtl);

  -- Signals
  SIGNAL u                                : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL v                                : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL v_signed                         : signed(24 DOWNTO 0);  -- sfix25_En10
  SIGNAL Delay14_out1                     : signed(24 DOWNTO 0);  -- sfix25_En10
  ...
  SIGNAL Delay4_out1                      : signed(24 DOWNTO 0);  -- sfix25_En10
...
BEGIN
  u_Upcast_Wordlength : IEEE_8021513_RX_src_Upcast_Wordlength_block1
    PORT MAP( x => den,  -- ufix24_En10
              y => num,  -- ufix24_En10
              u => u,  -- sfix25_En10
              v => v  -- sfix25_En10
              );

  u_Normalize_numerator : IEEE_8021513_RX_src_Normalize_numerator_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              u => std_logic_vector(Delay14_out1),  -- sfix25_En10
  ...
  u_MATLAB_Function : IEEE_8021513_RX_src_MATLAB_Function_block1
  ...
  u_Normalize_denominator : IEEE_8021513_RX_src_Normalize_denominator_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              u => std_logic_vector(Delay4_out1),  -- sfix25_En10
              validIn => Delay15_out1,
              x => x_1,  -- sfix25_En23
              e => e_1,  -- int32
  ...
  u_Divide_real_numerator_by_denominator : IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Shift_and_cast_to_output_type : IEEE_8021513_RX_src_Shift_and_cast_to_output_type_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Divide_by_zero_handler : IEEE_8021513_RX_src_Divide_by_zero_handler_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
