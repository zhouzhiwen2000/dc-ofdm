-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_channel_estimation_and_equalization.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_channel_estimation_and_equalization
...
ENTITY IEEE_8021513_RX_src_channel_estimation_and_equalization IS
...
END IEEE_8021513_RX_src_channel_estimation_and_equalization;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_channel_estimation_and_equalization IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_Channel_Estimation
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
  ...
  COMPONENT IEEE_8021513_RX_src_Channel_Equalization
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
  ...
  FOR ALL : IEEE_8021513_RX_src_Channel_Estimation
    USE ENTITY work.IEEE_8021513_RX_src_Channel_Estimation(rtl);

  FOR ALL : IEEE_8021513_RX_src_Channel_Equalization
    USE ENTITY work.IEEE_8021513_RX_src_Channel_Equalization(rtl);

  -- Signals
  SIGNAL data_in_re_signed                : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL data_in_im_signed                : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay1_out1_re                   : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay1_out1_im                   : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay21_reg_re                   : vector_of_signed18(0 TO 1);  -- sfix18_En12 [2]
  SIGNAL Delay21_reg_im                   : vector_of_signed18(0 TO 1);  -- sfix18_En12 [2]
  SIGNAL Delay21_out1_re                  : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay21_out1_im                  : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay10_out1_re                  : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay10_out1_im                  : signed(17 DOWNTO 0);  -- sfix18_En12
  ...
  SIGNAL channelEstimates_re              : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL channelEstimates_im              : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL channelEstimatesValid            : std_logic;
  SIGNAL channelEstimates_re_signed       : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL channelEstimates_im_signed       : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay13_out1_re                  : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay13_out1_im                  : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay14_out1                     : std_logic;
  SIGNAL Channel_Equalization_out1_re     : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL Channel_Equalization_out1_im     : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL Channel_Equalization_out2        : std_logic;
  SIGNAL Channel_Equalization_out1_re_signed : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Channel_Equalization_out1_im_signed : signed(17 DOWNTO 0);  -- sfix18_En12
...
BEGIN
  ...
  u_Channel_Estimation : IEEE_8021513_RX_src_Channel_Estimation
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => std_logic_vector(Delay1_out1_re),  -- sfix18_En12
              data_in_im => std_logic_vector(Delay1_out1_im),  -- sfix18_En12
              valid_in => Delay2_out1,
              reset => reset,
              channel_estimate_re => channelEstimates_re,  -- sfix18_En12
              channel_estimate_im => channelEstimates_im,  -- sfix18_En12
              valid_estimate => channelEstimatesValid
              );

  u_Channel_Equalization : IEEE_8021513_RX_src_Channel_Equalization
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => std_logic_vector(Delay10_out1_re),  -- sfix18_En12
              data_in_im => std_logic_vector(Delay10_out1_im),  -- sfix18_En12
              valid_data => Delay11_out1,
              channel_estimate_in_re => std_logic_vector(Delay13_out1_re),  -- sfix18_En12
              channel_estimate_in_im => std_logic_vector(Delay13_out1_im),  -- sfix18_En12
              valid_channel_estimate => Delay14_out1,
              data_out_re => Channel_Equalization_out1_re,  -- sfix18_En12
              data_out_im => Channel_Equalization_out1_im,  -- sfix18_En12
