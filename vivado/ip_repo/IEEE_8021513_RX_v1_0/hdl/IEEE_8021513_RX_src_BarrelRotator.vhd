-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_BarrelRotator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_BarrelRotator
-- Source Path: HDLRx/full_rx/LDPC_shared/LDPC Decoder/DecoderCore/BarrelRotator
-- Hierarchy Level: 4
-- Model version: 1.138
-- 
-- Barrel Rotator Unit
...
ENTITY IEEE_8021513_RX_src_BarrelRotator IS
...
END IEEE_8021513_RX_src_BarrelRotator;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_BarrelRotator IS
  ...
  SIGNAL sDataReg                         : vector_of_signed6(0 TO 13);  -- sfix6_En1 [14]
  SIGNAL shiftData_tmp                    : vector_of_signed6(0 TO 13);  -- sfix6_En1 [14]
