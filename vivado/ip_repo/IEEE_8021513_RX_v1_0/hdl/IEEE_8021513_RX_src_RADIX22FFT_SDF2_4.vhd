-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_RADIX22FFT_SDF2_4
...
ENTITY IEEE_8021513_RX_src_RADIX22FFT_SDF2_4 IS
...
END IEEE_8021513_RX_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT IEEE_8021513_RX_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_SDFCommutator4
    USE ENTITY work.IEEE_8021513_RX_src_SDFCommutator4(rtl);
...
BEGIN
  u_dataMEM_im_0_4 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataMEM_re_0_4 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : IEEE_8021513_RX_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
