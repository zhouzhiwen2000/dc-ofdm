-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_NCO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_NCO
...
ENTITY IEEE_8021513_RX_src_NCO IS
...
END IEEE_8021513_RX_src_NCO;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_NCO IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_WaveformGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_WaveformGen
    USE ENTITY work.IEEE_8021513_RX_src_WaveformGen(rtl);
...
BEGIN
  u_Wave_inst : IEEE_8021513_RX_src_WaveformGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
