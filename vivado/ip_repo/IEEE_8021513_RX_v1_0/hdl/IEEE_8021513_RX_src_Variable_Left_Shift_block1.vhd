-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_Variable_Left_Shift_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_Variable_Left_Shift_block1
...
ENTITY IEEE_8021513_RX_src_Variable_Left_Shift_block1 IS
...
END IEEE_8021513_RX_src_Variable_Left_Shift_block1;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_Variable_Left_Shift_block1 IS
...
BEGIN
  ...
  Bit_Shift5_out1 <= to_signed(16#0000000#, 25);
  ...
  Bit_Shift6_out1 <= to_signed(16#0000000#, 25);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= to_signed(16#0000000#, 25);
