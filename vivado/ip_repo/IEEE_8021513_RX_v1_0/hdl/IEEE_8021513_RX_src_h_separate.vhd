-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_h_separate.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_h_separate
...
ENTITY IEEE_8021513_RX_src_h_separate IS
...
END IEEE_8021513_RX_src_h_separate;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_h_separate IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant
    PORT( u                               :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant1
    PORT( u                               :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant2
    PORT( u                               :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant3
    PORT( u                               :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant4
    PORT( u                               :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant5
    PORT( u                               :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant6
    PORT( u                               :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_rising_edge_detector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant1
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant1(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant2
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant2(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant3
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant3(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant4
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant4(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant5
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant5(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant6
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant6(rtl);

  FOR ALL : IEEE_8021513_RX_src_rising_edge_detector
    USE ENTITY work.IEEE_8021513_RX_src_rising_edge_detector(rtl);
...
BEGIN
  u_Compare_To_Constant : IEEE_8021513_RX_src_Compare_To_Constant
    PORT MAP( u => std_logic_vector(count),  -- ufix5
              y => Compare_To_Constant_out1
              );

  u_Compare_To_Constant1 : IEEE_8021513_RX_src_Compare_To_Constant1
    PORT MAP( u => std_logic_vector(count),  -- ufix5
              y => Compare_To_Constant1_out1
              );

  u_Compare_To_Constant2 : IEEE_8021513_RX_src_Compare_To_Constant2
    PORT MAP( u => std_logic_vector(count),  -- ufix5
              y => Compare_To_Constant2_out1
              );

  u_Compare_To_Constant3 : IEEE_8021513_RX_src_Compare_To_Constant3
    PORT MAP( u => std_logic_vector(count),  -- ufix5
              y => Compare_To_Constant3_out1
              );

  u_Compare_To_Constant4 : IEEE_8021513_RX_src_Compare_To_Constant4
    PORT MAP( u => std_logic_vector(count),  -- ufix5
              y => Compare_To_Constant4_out1
              );

  u_Compare_To_Constant5 : IEEE_8021513_RX_src_Compare_To_Constant5
    PORT MAP( u => std_logic_vector(count),  -- ufix5
              y => Compare_To_Constant5_out1
              );

  u_Compare_To_Constant6 : IEEE_8021513_RX_src_Compare_To_Constant6
    PORT MAP( u => std_logic_vector(count),  -- ufix5
              y => Compare_To_Constant6_out1
              );

  u_rising_edge_detector : IEEE_8021513_RX_src_rising_edge_detector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
              In_rsvd => Switch11_out1,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay2_out1 <= '0';
      ELSIF enb_1_8_0 = '1' THEN
        Delay2_out1 <= rising_edge_detector_out1;
      END IF;
    END IF;
