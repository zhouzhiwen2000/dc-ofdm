-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_CheckNodeUnit.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_CheckNodeUnit
-- Source Path: HDLRx/full_rx/LDPC_shared/LDPC Decoder/DecoderCore/FunctionalUnit/CheckNodeUnit
-- Hierarchy Level: 5
-- Model version: 1.138
-- 
-- Check Node Unit
...
ENTITY IEEE_8021513_RX_src_CheckNodeUnit IS
...
END IEEE_8021513_RX_src_CheckNodeUnit;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_CheckNodeUnit IS
  ...
  -- Signals
  SIGNAL data_signed                      : vector_of_signed4(0 TO 13);  -- sfix4_En1 [14]
  SIGNAL alpha_reg                        : vector_of_signed4(0 TO 27);  -- sfix4 [28]
  SIGNAL dataReg                          : vector_of_signed4(0 TO 13);  -- sfix4_En1 [14]
  ...
  SIGNAL dataAbs                          : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  ...
  SIGNAL minCalculation_minVal1_next      : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  SIGNAL minCalculation_minVal2_next      : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  SIGNAL minCalculation_dataAbs_next      : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  ...
  SIGNAL minVal1                          : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  SIGNAL minVal2                          : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  ...
  SIGNAL min1_DTC                         : vector_of_unsigned3(0 TO 13);  -- ufix3_En1 [14]
  SIGNAL min1_DTC_0                       : unsigned(2 DOWNTO 0);  -- ufix3_En1
  SIGNAL min2_DTC                         : vector_of_unsigned3(0 TO 13);  -- ufix3_En1 [14]
...
BEGIN
  ...
  abs_rsvd_output : PROCESS (dataReg)
    ...
    VARIABLE cast : vector_of_signed5(0 TO 13);
  BEGIN
  ...
  minCalculation_output : PROCESS (countU, dataAbs, dataReg, extReset, minCalculation_countIdx,
    ...
    VARIABLE cast1 : vector_of_signed32(0 TO 13);
  BEGIN
    signVal := '0';
