-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_LDPC_Decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_LDPC_Decoder
-- Source Path: HDLRx/full_rx/LDPC_shared/LDPC Decoder
-- Hierarchy Level: 2
-- Model version: 1.129
-- 
-- LDPC Decoder
...
ENTITY IEEE_8021513_RX_src_LDPC_Decoder IS
...
END IEEE_8021513_RX_src_LDPC_Decoder;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_LDPC_Decoder IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_CodeParameters
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_DecoderCore
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_CodeParameters
    USE ENTITY work.IEEE_8021513_RX_src_CodeParameters(rtl);

  FOR ALL : IEEE_8021513_RX_src_DecoderCore
    USE ENTITY work.IEEE_8021513_RX_src_DecoderCore(rtl);

  -- Signals
  SIGNAL sofVld                           : std_logic;
  SIGNAL in0_signed                       : signed(3 DOWNTO 0);  -- sfix4_En1
  SIGNAL dataIn                           : signed(3 DOWNTO 0);  -- sfix4_En1
  ...
  SIGNAL dataOut_signed                   : signed(3 DOWNTO 0);  -- sfix4_En1
  SIGNAL dataDTC                          : signed(5 DOWNTO 0);  -- sfix6_En1
...
BEGIN
  u_Code_Parameters : IEEE_8021513_RX_src_CodeParameters
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => std_logic_vector(dataIn),  -- sfix4_En1
              start => startIn,
              end_rsvd => endIn,
              valid => validIn,
              reset => reset,  -- ufix1
              datacp => dataOut,  -- sfix4_En1
              validcp => valid,  -- ufix1
  ...
  u_Decoder_Core : IEEE_8021513_RX_src_DecoderCore
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => reset,  -- ufix1
              data => std_logic_vector(dataDTC),  -- sfix6_En1
              valid => valid,  -- ufix1
              framevalid => frameValid,  -- ufix1
