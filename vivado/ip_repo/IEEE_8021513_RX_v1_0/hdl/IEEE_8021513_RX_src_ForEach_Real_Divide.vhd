-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_ForEach_Real_Divide.vhd
...
ENTITY IEEE_8021513_RX_src_ForEach_Real_Divide IS
...
END IEEE_8021513_RX_src_ForEach_Real_Divide;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_ForEach_Real_Divide IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_Upcast_Wordlength
  ...
  COMPONENT IEEE_8021513_RX_src_Normalize_numerator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_MATLAB_Function
  ...
  COMPONENT IEEE_8021513_RX_src_Normalize_denominator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          u                               :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
  ...
  COMPONENT IEEE_8021513_RX_src_Divide_real_numerator_by_denominator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Shift_and_cast_to_output_type
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Divide_by_zero_handler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_Upcast_Wordlength
    USE ENTITY work.IEEE_8021513_RX_src_Upcast_Wordlength(rtl);

  FOR ALL : IEEE_8021513_RX_src_Normalize_numerator
    USE ENTITY work.IEEE_8021513_RX_src_Normalize_numerator(rtl);

  FOR ALL : IEEE_8021513_RX_src_MATLAB_Function
    USE ENTITY work.IEEE_8021513_RX_src_MATLAB_Function(rtl);

  FOR ALL : IEEE_8021513_RX_src_Normalize_denominator
    USE ENTITY work.IEEE_8021513_RX_src_Normalize_denominator(rtl);

  FOR ALL : IEEE_8021513_RX_src_Divide_real_numerator_by_denominator
    USE ENTITY work.IEEE_8021513_RX_src_Divide_real_numerator_by_denominator(rtl);

  FOR ALL : IEEE_8021513_RX_src_Shift_and_cast_to_output_type
    USE ENTITY work.IEEE_8021513_RX_src_Shift_and_cast_to_output_type(rtl);

  FOR ALL : IEEE_8021513_RX_src_Divide_by_zero_handler
    USE ENTITY work.IEEE_8021513_RX_src_Divide_by_zero_handler(rtl);
...
BEGIN
  u_Upcast_Wordlength : IEEE_8021513_RX_src_Upcast_Wordlength
  ...
  u_Normalize_numerator : IEEE_8021513_RX_src_Normalize_numerator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_MATLAB_Function : IEEE_8021513_RX_src_MATLAB_Function
  ...
  u_Normalize_denominator : IEEE_8021513_RX_src_Normalize_denominator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Divide_real_numerator_by_denominator : IEEE_8021513_RX_src_Divide_real_numerator_by_denominator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Shift_and_cast_to_output_type : IEEE_8021513_RX_src_Shift_and_cast_to_output_type
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Divide_by_zero_handler : IEEE_8021513_RX_src_Divide_by_zero_handler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
