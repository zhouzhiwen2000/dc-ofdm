-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_decimator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_decimator
...
ENTITY IEEE_8021513_RX_src_decimator IS
...
END IEEE_8021513_RX_src_decimator;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_decimator IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_rising_edge_detector_block4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_FIR_Decimator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_rising_edge_detector_block4
    USE ENTITY work.IEEE_8021513_RX_src_rising_edge_detector_block4(rtl);

  FOR ALL : IEEE_8021513_RX_src_FIR_Decimator
    USE ENTITY work.IEEE_8021513_RX_src_FIR_Decimator(rtl);
  ...
  SIGNAL Delay3_reg                       : std_logic_vector(59 DOWNTO 0);  -- ufix1 [60]
...
BEGIN
  ...
  u_rising_edge_detector : IEEE_8021513_RX_src_rising_edge_detector_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => valid_in,
  ...
  u_FIR_Decimator : IEEE_8021513_RX_src_FIR_Decimator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay3_reg(59 DOWNTO 1) <= Delay3_reg(58 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay3_process;

  Delay3_out1 <= Delay3_reg(59);
