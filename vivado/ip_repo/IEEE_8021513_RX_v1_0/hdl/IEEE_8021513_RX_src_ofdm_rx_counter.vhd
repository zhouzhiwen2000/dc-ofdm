-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_ofdm_rx_counter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_ofdm_rx_counter
...
ENTITY IEEE_8021513_RX_src_ofdm_rx_counter IS
...
END IEEE_8021513_RX_src_ofdm_rx_counter;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_ofdm_rx_counter IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_rising_edge_detector1_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_falling_edge_detector1_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          in_rsvd                         :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_rising_edge_detector1_block
    USE ENTITY work.IEEE_8021513_RX_src_rising_edge_detector1_block(rtl);

  FOR ALL : IEEE_8021513_RX_src_falling_edge_detector1_block
    USE ENTITY work.IEEE_8021513_RX_src_falling_edge_detector1_block(rtl);
...
BEGIN
  ...
  u_rising_edge_detector1 : IEEE_8021513_RX_src_rising_edge_detector1_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              In_rsvd => rst,
  ...
  u_falling_edge_detector1 : IEEE_8021513_RX_src_falling_edge_detector1_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              in_rsvd => valid,
