-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_RADIX22FFT_SDF2_8
...
ENTITY IEEE_8021513_RX_src_RADIX22FFT_SDF2_8 IS
...
END IEEE_8021513_RX_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_RADIX22FFT_SDF2_8 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_SDFCommutator8
    USE ENTITY work.IEEE_8021513_RX_src_SDFCommutator8(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_8 : IEEE_8021513_RX_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
