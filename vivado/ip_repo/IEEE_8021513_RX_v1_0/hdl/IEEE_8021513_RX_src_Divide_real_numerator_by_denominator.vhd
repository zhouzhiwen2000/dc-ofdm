-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_Divide_real_numerator_by_denominator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_Divide_real_numerator_by_denominator
...
ENTITY IEEE_8021513_RX_src_Divide_real_numerator_by_denominator IS
...
END IEEE_8021513_RX_src_Divide_real_numerator_by_denominator;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_Divide_real_numerator_by_denominator IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_normalizedCORDICDivide
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
  ...
  FOR ALL : IEEE_8021513_RX_src_normalizedCORDICDivide
    USE ENTITY work.IEEE_8021513_RX_src_normalizedCORDICDivide(rtl);
...
BEGIN
  u_normalizedCORDICDivide : IEEE_8021513_RX_src_normalizedCORDICDivide
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              num => num,  -- sfix18_En16
