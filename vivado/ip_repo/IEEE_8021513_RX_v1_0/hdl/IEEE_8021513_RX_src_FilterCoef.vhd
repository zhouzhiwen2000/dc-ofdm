-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_FilterCoef.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_FilterCoef
...
ENTITY IEEE_8021513_RX_src_FilterCoef IS
  PORT( clk                               :   IN    std_logic;
        reset_x                           :   IN    std_logic;
        enb                               :   IN    std_logic;
        validIn                           :   IN    std_logic;
        softReset                         :   IN    std_logic;
        CoefOut                           :   OUT   vector_of_std_logic_vector16(0 TO 18)  -- sfix16_En16 [19]
        );
END IEEE_8021513_RX_src_FilterCoef;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_FilterCoef IS

  -- Constants
  CONSTANT Coef_table_table_data          : vector_of_signed16(0 TO 1) := 
    (to_signed(-16#019A#, 16), to_signed(-16#008A#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_2        : vector_of_signed16(0 TO 1) := 
    (to_signed(16#0115#, 16), to_signed(-16#0123#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_4        : vector_of_signed16(0 TO 1) := 
    (to_signed(-16#00E9#, 16), to_signed(16#01FE#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_6        : vector_of_signed16(0 TO 1) := 
    (to_signed(16#0013#, 16), to_signed(-16#035D#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_8        : vector_of_signed16(0 TO 1) := 
    (to_signed(16#01C1#, 16), to_signed(16#0510#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_10       : vector_of_signed16(0 TO 1) := 
    (to_signed(-16#0519#, 16), to_signed(-16#06E4#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_12       : vector_of_signed16(0 TO 1) := 
    (to_signed(16#0B1A#, 16), to_signed(16#08A5#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_14       : vector_of_signed16(0 TO 1) := 
    (to_signed(-16#17D1#, 16), to_signed(-16#0A1A#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_16       : vector_of_signed16(0 TO 1) := 
    (to_signed(16#5055#, 16), to_signed(16#0B11#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_18       : vector_of_signed16(0 TO 1) := 
    (to_signed(16#5055#, 16), to_signed(16#7499#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_20       : vector_of_signed16(0 TO 1) := 
    (to_signed(-16#17D1#, 16), to_signed(16#0B11#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_22       : vector_of_signed16(0 TO 1) := 
    (to_signed(16#0B1A#, 16), to_signed(-16#0A1A#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_24       : vector_of_signed16(0 TO 1) := 
    (to_signed(-16#0519#, 16), to_signed(16#08A5#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_26       : vector_of_signed16(0 TO 1) := 
    (to_signed(16#01C1#, 16), to_signed(-16#06E4#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_28       : vector_of_signed16(0 TO 1) := 
    (to_signed(16#0013#, 16), to_signed(16#0510#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_30       : vector_of_signed16(0 TO 1) := 
    (to_signed(-16#00E9#, 16), to_signed(-16#035D#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_32       : vector_of_signed16(0 TO 1) := 
    (to_signed(16#0115#, 16), to_signed(16#01FE#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_34       : vector_of_signed16(0 TO 1) := 
    (to_signed(-16#019A#, 16), to_signed(-16#0123#, 16));  -- sfix16 [2]
  CONSTANT Coef_table_table_data_36       : vector_of_signed16(0 TO 1) := 
    (to_signed(16#0000#, 16), to_signed(-16#008A#, 16));  -- sfix16 [2]
  ...
  SIGNAL CoefOut_tmp                      : vector_of_signed16(0 TO 18);  -- sfix16_En16 [19]
