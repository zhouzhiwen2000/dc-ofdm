-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_BetaDecompress_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_BetaDecompress_2
-- Source Path: HDLRx/full_rx/LDPC_shared/LDPC Decoder/DecoderCore/FunctionalUnit/BetaDecompress_2
-- Hierarchy Level: 5
-- Model version: 1.129
-- 
...
ENTITY IEEE_8021513_RX_src_BetaDecompress_2 IS
...
END IEEE_8021513_RX_src_BetaDecompress_2;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_BetaDecompress_2 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_BetaCalculation_2
  ...
  FOR ALL : IEEE_8021513_RX_src_BetaCalculation_2
    USE ENTITY work.IEEE_8021513_RX_src_BetaCalculation_2(rtl);
  ...
  SIGNAL betacomp3_unsigned               : vector_of_unsigned6(0 TO 13);  -- ufix6 [14]
  ...
  SIGNAL sMin1                            : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  SIGNAL sMin1_1                          : vector_of_std_logic_vector4(0 TO 13);  -- ufix4 [14]
  SIGNAL min2_dtc                         : vector_of_unsigned3(0 TO 13);  -- ufix3 [14]
  SIGNAL sMin2                            : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  SIGNAL sMin2_1                          : vector_of_std_logic_vector4(0 TO 13);  -- ufix4 [14]
  SIGNAL betaReg                          : vector_of_std_logic_vector4(0 TO 13);  -- ufix4 [14]
  SIGNAL betaReg_signed                   : vector_of_signed4(0 TO 13);  -- sfix4_En1 [14]
  SIGNAL beta_tmp                         : vector_of_signed4(0 TO 13);  -- sfix4_En1 [14]

BEGIN
  u_BetaCalUnit : IEEE_8021513_RX_src_BetaCalculation_2
    PORT MAP( signs => signs,  -- ufix1 [14]
              prodsign => prodsign,  -- ufix1 [14]
              minidx => min_index_1,  -- ufix3 [14]
              min1 => sMin1_1,  -- ufix4_En1 [14]
              min2 => sMin2_1,  -- ufix4_En1 [14]
              count => std_logic_vector(countVal),  -- ufix3
              beta => betaReg  -- sfix4_En1 [14]
              );
