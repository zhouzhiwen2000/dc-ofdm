-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_Shift_and_cast_to_output_type.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_Shift_and_cast_to_output_type
...
ENTITY IEEE_8021513_RX_src_Shift_and_cast_to_output_type IS
...
END IEEE_8021513_RX_src_Shift_and_cast_to_output_type;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_Shift_and_cast_to_output_type IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_Cast_to_Union_of_Types
  ...
  COMPONENT IEEE_8021513_RX_src_Variable_Right_Shift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Variable_Left_Shift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          x                               :   IN    std_logic_vector(21 DOWNTO 0);  -- sfix22_En16
  ...
  FOR ALL : IEEE_8021513_RX_src_Cast_to_Union_of_Types
    USE ENTITY work.IEEE_8021513_RX_src_Cast_to_Union_of_Types(rtl);

  FOR ALL : IEEE_8021513_RX_src_Variable_Right_Shift
    USE ENTITY work.IEEE_8021513_RX_src_Variable_Right_Shift(rtl);

  FOR ALL : IEEE_8021513_RX_src_Variable_Left_Shift
    USE ENTITY work.IEEE_8021513_RX_src_Variable_Left_Shift(rtl);
...
BEGIN
  u_Cast_to_Union_of_Types : IEEE_8021513_RX_src_Cast_to_Union_of_Types
    PORT MAP( Xref => std_logic_vector(Constant_out1),  -- sfix18_En12
              Cin => x,  -- sfix18_En16
              Cout => Cout  -- sfix22_En16
              );

  u_Variable_Right_Shift : IEEE_8021513_RX_src_Variable_Right_Shift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              x => Cout,  -- sfix22_En16
  ...
  u_Variable_Left_Shift : IEEE_8021513_RX_src_Variable_Left_Shift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              x => Cout,  -- sfix22_En16
