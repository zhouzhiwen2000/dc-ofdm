-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_HDL_FIFO_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_HDL_FIFO_block
...
ENTITY IEEE_8021513_RX_src_HDL_FIFO_block IS
...
END IEEE_8021513_RX_src_HDL_FIFO_block;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_HDL_FIFO_block IS
  ...
  SIGNAL w_waddr_re                       : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL w_waddr_im                       : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL w_waddr_re_signed                : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_waddr_im_signed                : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_const_0_re                     : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_const_0_im                     : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_out_1_re                       : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_out_1_im                       : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_out_re                         : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_out_im                         : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_d2_re                          : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL w_d2_im                          : signed(17 DOWNTO 0);  -- sfix18_En12

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_HDL_FIFO_ram : IEEE_8021513_RX_src_SimpleDualPortRAM_generic_block2
  ...
  w_const_0_re <= to_signed(16#00000#, 18);
  w_const_0_im <= to_signed(16#00000#, 18);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        w_d2_re <= to_signed(16#00000#, 18);
        w_d2_im <= to_signed(16#00000#, 18);
