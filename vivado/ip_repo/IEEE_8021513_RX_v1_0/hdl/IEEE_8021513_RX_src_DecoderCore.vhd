-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_DecoderCore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_DecoderCore
-- Source Path: HDLRx/full_rx/LDPC_shared/LDPC Decoder/DecoderCore
-- Hierarchy Level: 3
-- Model version: 1.138
-- 
-- Decoder Core
...
ENTITY IEEE_8021513_RX_src_DecoderCore IS
...
END IEEE_8021513_RX_src_DecoderCore;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_DecoderCore IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_SimpleDualPortRAM_generic
  ...
  COMPONENT IEEE_8021513_RX_src_CheckNodeRAM
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_BarrelRotator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data                            :   IN    vector_of_std_logic_vector6(0 TO 13);  -- sfix6_En1 [14]
          shift                           :   IN    std_logic_vector(3 DOWNTO 0);  -- ufix4
          shiftData                       :   OUT   vector_of_std_logic_vector6(0 TO 13)  -- sfix6_En1 [14]
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_FunctionalUnit
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
          ...
          betaComp3                       :   IN    vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
          ...
          cnuComp3                        :   OUT   vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
          cnuValid                        :   OUT   std_logic;  -- ufix1
          rdAddr                          :   OUT   std_logic_vector(2 DOWNTO 0)  -- ufix3
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_FinalDecision
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    USE ENTITY work.IEEE_8021513_RX_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : IEEE_8021513_RX_src_CheckNodeRAM
    USE ENTITY work.IEEE_8021513_RX_src_CheckNodeRAM(rtl);

  FOR ALL : IEEE_8021513_RX_src_BarrelRotator
    USE ENTITY work.IEEE_8021513_RX_src_BarrelRotator(rtl);

  FOR ALL : IEEE_8021513_RX_src_FunctionalUnit
    USE ENTITY work.IEEE_8021513_RX_src_FunctionalUnit(rtl);

  FOR ALL : IEEE_8021513_RX_src_FinalDecision
    USE ENTITY work.IEEE_8021513_RX_src_FinalDecision(rtl);
  ...
  SIGNAL wrData                           : vector_of_signed6(0 TO 13);  -- sfix6_En1 [14]
  ...
  SIGNAL sData                            : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  SIGNAL sData_signed                     : vector_of_signed6(0 TO 13);  -- sfix6_En1 [14]
  ...
  SIGNAL bDecomp3                         : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  ...
  SIGNAL cDecomp3                         : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  ...
  SIGNAL gamma                            : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  SIGNAL gamma_signed                     : vector_of_signed6(0 TO 13);  -- sfix6_En1 [14]
  SIGNAL colData                          : vector_of_signed6(0 TO 13);  -- sfix6_En1 [14]
  SIGNAL sDataIn                          : vector_of_signed6(0 TO 13);  -- sfix6_En1 [14]
  SIGNAL sDataIn_1                        : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  SIGNAL validMCNeg                       : std_logic;  -- ufix1
  SIGNAL layerDone                        : std_logic;  -- ufix1
  SIGNAL layerDoneReg                     : std_logic;  -- ufix1
  SIGNAL iterationController_wrData       : vector_of_signed6(0 TO 13);  -- sfix6 [14]
  ...
  SIGNAL iterationController_wrData_next  : vector_of_signed6(0 TO 13);  -- sfix6_En1 [14]
  ...
  SIGNAL colData_1                        : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
...
BEGIN
  u_Variable_Node_RAM : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
  ...
  u_Variable_Node_RAM_1 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_2 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_3 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_4 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_5 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_6 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_7 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_8 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_9 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_10 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_11 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_12 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_BetaMemory : IEEE_8021513_RX_src_CheckNodeRAM
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              bdecomp1 => bDecomp1,  -- ufix7 [14]
              bdecomp2 => bDecomp2,  -- ufix4 [14]
              bdecomp3 => bDecomp3,  -- ufix6 [14]
              ...
              bdecomp3Out => cDecomp3,  -- ufix6 [14]
              bvalidOut => cValid  -- ufix1
              );

  u_Barrel_Rotator_Unit : IEEE_8021513_RX_src_BarrelRotator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => sDataIn_1,  -- sfix6_En1 [14]
              shift => std_logic_vector(sValIn),  -- ufix4
              shiftData => sData  -- sfix6_En1 [14]
              );

  u_FunctionalUnit : IEEE_8021513_RX_src_FunctionalUnit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => intReset,  -- ufix1
              data => sData,  -- sfix6_En1 [14]
              valid => rdValidReg1,  -- ufix1
              count => std_logic_vector(countIdx),  -- ufix3
              betaComp1 => cDecomp1,  -- ufix7 [14]
              betaComp2 => cDecomp2,  -- ufix4 [14]
              betaComp3 => cDecomp3,  -- ufix6 [14]
              betaValid => cValid,  -- ufix1
              gamma => gamma,  -- sfix6_En1 [14]
              valid_1 => gammaValid,  -- ufix1
              cnuComp1 => bDecomp1,  -- ufix7 [14]
              cnuComp2 => bDecomp2,  -- ufix4 [14]
              cnuComp3 => bDecomp3,  -- ufix6 [14]
              cnuValid => bValid,  -- ufix1
              rdAddr => yIndexTmp  -- ufix3
              );

  u_Variable_Node_RAM_generic : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Final_Decision : IEEE_8021513_RX_src_FinalDecision
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => intReset,  -- ufix1
              data => colData_1,  -- sfix6_En1 [14]
