-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_rx_payload_full.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_rx_payload_full
...
ENTITY IEEE_8021513_RX_src_rx_payload_full IS
...
END IEEE_8021513_RX_src_rx_payload_full;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_rx_payload_full IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_p_scrambler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Compare_To_Zero_block2
    PORT( u                               :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_data_words_in_payload
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          psdu_size                       :   IN    std_logic_vector(23 DOWNTO 0);  -- ufix1 [24]
  ...
  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant_block3
    PORT( u                               :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_rising_edge_detector_block9
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_next_frame_to_ready_rx
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_remove_tone_mapping
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in                         :   IN    std_logic_vector(3 DOWNTO 0);  -- sfix4_En1
  ...
  FOR ALL : IEEE_8021513_RX_src_p_scrambler
    USE ENTITY work.IEEE_8021513_RX_src_p_scrambler(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Zero_block2
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Zero_block2(rtl);

  FOR ALL : IEEE_8021513_RX_src_data_words_in_payload
    USE ENTITY work.IEEE_8021513_RX_src_data_words_in_payload(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant_block3
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant_block3(rtl);

  FOR ALL : IEEE_8021513_RX_src_rising_edge_detector_block9
    USE ENTITY work.IEEE_8021513_RX_src_rising_edge_detector_block9(rtl);

  FOR ALL : IEEE_8021513_RX_src_next_frame_to_ready_rx
    USE ENTITY work.IEEE_8021513_RX_src_next_frame_to_ready_rx(rtl);

  FOR ALL : IEEE_8021513_RX_src_remove_tone_mapping
    USE ENTITY work.IEEE_8021513_RX_src_remove_tone_mapping(rtl);
...
BEGIN
  ...
  u_p_scrambler : IEEE_8021513_RX_src_p_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data_in => ldpc_out,
  ...
  u_Compare_To_Zero : IEEE_8021513_RX_src_Compare_To_Zero_block2
    PORT MAP( u => std_logic_vector(HDL_Counter_out1),  -- uint32
              y => Compare_To_Zero_out1
              );

  u_data_words_in_payload : IEEE_8021513_RX_src_data_words_in_payload
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Compare_To_Constant : IEEE_8021513_RX_src_Compare_To_Constant_block3
    PORT MAP( u => std_logic_vector(HDL_Counter_out1),  -- uint32
              y => Compare_To_Constant_out1
              );

  u_rising_edge_detector : IEEE_8021513_RX_src_rising_edge_detector_block9
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
              In_rsvd => AND1_out1,
  ...
  u_next_frame_to_ready_rx : IEEE_8021513_RX_src_next_frame_to_ready_rx
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_remove_tone_mapping : IEEE_8021513_RX_src_remove_tone_mapping
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
