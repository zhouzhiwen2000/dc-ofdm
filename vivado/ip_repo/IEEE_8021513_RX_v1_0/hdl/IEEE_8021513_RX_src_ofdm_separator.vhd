-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_ofdm_separator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_ofdm_separator
...
ENTITY IEEE_8021513_RX_src_ofdm_separator IS
...
END IEEE_8021513_RX_src_ofdm_separator;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_ofdm_separator IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_rising_edge_detector_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_psdu_size_to_payload_len
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant_block
    PORT( u                               :   IN    std_logic_vector(23 DOWNTO 0);  -- ufix24
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_Compare_To_Constant1_block
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- uint16
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT IEEE_8021513_RX_src_falling_edge_detector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          in_rsvd                         :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_wait_for_header
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : IEEE_8021513_RX_src_rising_edge_detector_block6
    USE ENTITY work.IEEE_8021513_RX_src_rising_edge_detector_block6(rtl);

  FOR ALL : IEEE_8021513_RX_src_psdu_size_to_payload_len
    USE ENTITY work.IEEE_8021513_RX_src_psdu_size_to_payload_len(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant_block
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant_block(rtl);

  FOR ALL : IEEE_8021513_RX_src_Compare_To_Constant1_block
    USE ENTITY work.IEEE_8021513_RX_src_Compare_To_Constant1_block(rtl);

  FOR ALL : IEEE_8021513_RX_src_falling_edge_detector
    USE ENTITY work.IEEE_8021513_RX_src_falling_edge_detector(rtl);

  FOR ALL : IEEE_8021513_RX_src_wait_for_header
    USE ENTITY work.IEEE_8021513_RX_src_wait_for_header(rtl);
...
BEGIN
  ...
  u_rising_edge_detector : IEEE_8021513_RX_src_rising_edge_detector_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              In_rsvd => peak,
  ...
  u_psdu_size_to_payload_len : IEEE_8021513_RX_src_psdu_size_to_payload_len
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Compare_To_Constant : IEEE_8021513_RX_src_Compare_To_Constant_block
    PORT MAP( u => std_logic_vector(y),  -- ufix24
              y => Compare_To_Constant_out1
              );

  u_Compare_To_Constant1 : IEEE_8021513_RX_src_Compare_To_Constant1_block
    PORT MAP( u => psdu_size_to_payload_len_out1,  -- uint16
              y => Compare_To_Constant1_out1
              );

  u_falling_edge_detector : IEEE_8021513_RX_src_falling_edge_detector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_wait_for_header : IEEE_8021513_RX_src_wait_for_header
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
