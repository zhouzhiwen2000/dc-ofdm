-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_equalizer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_equalizer
...
ENTITY IEEE_8021513_RX_src_equalizer IS
...
END IEEE_8021513_RX_src_equalizer;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_equalizer IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_complex_multiplier
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Real_Divide_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_Real_Divide_HDL_Optimized1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En12
  ...
  FOR ALL : IEEE_8021513_RX_src_complex_multiplier
    USE ENTITY work.IEEE_8021513_RX_src_complex_multiplier(rtl);

  FOR ALL : IEEE_8021513_RX_src_Real_Divide_HDL_Optimized
    USE ENTITY work.IEEE_8021513_RX_src_Real_Divide_HDL_Optimized(rtl);

  FOR ALL : IEEE_8021513_RX_src_Real_Divide_HDL_Optimized1
    USE ENTITY work.IEEE_8021513_RX_src_Real_Divide_HDL_Optimized1(rtl);
...
BEGIN
  u_complex_multiplier : IEEE_8021513_RX_src_complex_multiplier
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Real_Divide_HDL_Optimized : IEEE_8021513_RX_src_Real_Divide_HDL_Optimized
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Real_Divide_HDL_Optimized1 : IEEE_8021513_RX_src_Real_Divide_HDL_Optimized1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
