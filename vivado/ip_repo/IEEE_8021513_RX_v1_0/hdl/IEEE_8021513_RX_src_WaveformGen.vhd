-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_WaveformGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_WaveformGen
...
ENTITY IEEE_8021513_RX_src_WaveformGen IS
...
END IEEE_8021513_RX_src_WaveformGen;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_WaveformGen IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_CosLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_SinLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(8 DOWNTO 0);  -- ufix9
  ...
  FOR ALL : IEEE_8021513_RX_src_CosLookUpTableGen
    USE ENTITY work.IEEE_8021513_RX_src_CosLookUpTableGen(rtl);

  FOR ALL : IEEE_8021513_RX_src_SinLookUpTableGen
    USE ENTITY work.IEEE_8021513_RX_src_SinLookUpTableGen(rtl);
...
BEGIN
  u_Cos_Wave_inst : IEEE_8021513_RX_src_CosLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Sin_Wave_inst : IEEE_8021513_RX_src_SinLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix9
