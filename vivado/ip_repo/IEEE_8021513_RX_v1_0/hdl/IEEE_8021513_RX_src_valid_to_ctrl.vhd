-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_valid_to_ctrl.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_valid_to_ctrl
-- Source Path: HDLRx/full_rx/rx_payload_full/remove_tone_mapping/valid_to_ctrl
-- Hierarchy Level: 3
-- Model version: 1.138
-- 
-- -------------------------------------------------------------
...
ENTITY IEEE_8021513_RX_src_valid_to_ctrl IS
...
END IEEE_8021513_RX_src_valid_to_ctrl;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_valid_to_ctrl IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_Sample_Control_Bus_Creator_block4
  ...
  FOR ALL : IEEE_8021513_RX_src_Sample_Control_Bus_Creator_block4
    USE ENTITY work.IEEE_8021513_RX_src_Sample_Control_Bus_Creator_block4(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : IEEE_8021513_RX_src_Sample_Control_Bus_Creator_block4
    PORT MAP( In1 => start,
              In2 => end_rsvd,
              In3 => valid,
