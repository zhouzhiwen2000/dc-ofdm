-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_BetaCalculation_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_BetaCalculation_2
-- Source Path: HDLRx/full_rx/LDPC_shared/LDPC Decoder/DecoderCore/FunctionalUnit/BetaDecompress_2/BetaCalculation_2
-- Hierarchy Level: 6
-- Model version: 1.138
-- 
...
ENTITY IEEE_8021513_RX_src_BetaCalculation_2 IS
  PORT( signs                             :   IN    std_logic_vector(13 DOWNTO 0);  -- ufix1 [14]
        ...
        min1                              :   IN    vector_of_std_logic_vector4(0 TO 13);  -- ufix4_En1 [14]
        min2                              :   IN    vector_of_std_logic_vector4(0 TO 13);  -- ufix4_En1 [14]
        count                             :   IN    std_logic_vector(2 DOWNTO 0);  -- ufix3
        beta                              :   OUT   vector_of_std_logic_vector4(0 TO 13)  -- sfix4_En1 [14]
        );
END IEEE_8021513_RX_src_BetaCalculation_2;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_BetaCalculation_2 IS
  ...
  SIGNAL mag                              : vector_of_unsigned4(0 TO 13);  -- ufix4_En1 [14]
  SIGNAL mag_dtc                          : vector_of_signed4(0 TO 13);  -- sfix4_En1 [14]
  SIGNAL uminusComp_cast                  : vector_of_signed5(0 TO 13);  -- sfix5_En1 [14]
  SIGNAL uminusComp_cast_1                : vector_of_signed5(0 TO 13);  -- sfix5_En1 [14]
  SIGNAL smag                             : vector_of_signed4(0 TO 13);  -- sfix4_En1 [14]
  ...
  SIGNAL betaD                            : vector_of_signed4(0 TO 13);  -- sfix4_En1 [14]
