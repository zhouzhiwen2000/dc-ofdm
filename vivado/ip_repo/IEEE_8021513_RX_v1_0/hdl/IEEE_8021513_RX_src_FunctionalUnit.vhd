-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_FunctionalUnit.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_FunctionalUnit
-- Source Path: HDLRx/full_rx/LDPC_shared/LDPC Decoder/DecoderCore/FunctionalUnit
-- Hierarchy Level: 4
-- Model version: 1.129
-- 
-- Functional_Unit
...
ENTITY IEEE_8021513_RX_src_FunctionalUnit IS
...
END IEEE_8021513_RX_src_FunctionalUnit;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_FunctionalUnit IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_BetaDecompress_1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          betacomp1                       :   IN    vector_of_std_logic_vector7(0 TO 13);  -- ufix7 [14]
  ...
  COMPONENT IEEE_8021513_RX_src_VariableNodeUnit
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data                            :   IN    vector_of_std_logic_vector6(0 TO 13);  -- sfix6_En1 [14]
  ...
  COMPONENT IEEE_8021513_RX_src_CheckNodeUnit
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data                            :   IN    vector_of_std_logic_vector4(0 TO 13);  -- sfix4_En1 [14]
          valid                           :   IN    std_logic;  -- ufix1
          count                           :   IN    std_logic_vector(2 DOWNTO 0);  -- ufix3
          reset                           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT IEEE_8021513_RX_src_BetaDecompress_2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          betacomp1                       :   IN    vector_of_std_logic_vector7(0 TO 13);  -- ufix7 [14]
  ...
  COMPONENT IEEE_8021513_RX_src_AposterioriUnit
  ...
  FOR ALL : IEEE_8021513_RX_src_BetaDecompress_1
    USE ENTITY work.IEEE_8021513_RX_src_BetaDecompress_1(rtl);

  FOR ALL : IEEE_8021513_RX_src_VariableNodeUnit
    USE ENTITY work.IEEE_8021513_RX_src_VariableNodeUnit(rtl);

  FOR ALL : IEEE_8021513_RX_src_CheckNodeUnit
    USE ENTITY work.IEEE_8021513_RX_src_CheckNodeUnit(rtl);

  FOR ALL : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    USE ENTITY work.IEEE_8021513_RX_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : IEEE_8021513_RX_src_BetaDecompress_2
    USE ENTITY work.IEEE_8021513_RX_src_BetaDecompress_2(rtl);

  FOR ALL : IEEE_8021513_RX_src_AposterioriUnit
    USE ENTITY work.IEEE_8021513_RX_src_AposterioriUnit(rtl);
  ...
  SIGNAL alphaDTC                         : vector_of_signed4(0 TO 13);  -- sfix4_En1 [14]
...
BEGIN
  u_Beta_Decompress_Unit_1 : IEEE_8021513_RX_src_BetaDecompress_1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              count => count,  -- ufix3
              reset => reset,  -- ufix1
              beta => beta,  -- sfix4_En1 [14]
              valid => betaValid_1  -- ufix1
              );

  u_Variable_Node_Unit : IEEE_8021513_RX_src_VariableNodeUnit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => data,  -- sfix6_En1 [14]
              beta => beta,  -- sfix4_En1 [14]
              valid => valid,  -- ufix1
              valid_beta => betaValid_1,  -- ufix1
              reset => reset,  -- ufix1
              alpha => alpha,  -- sfix6_En1 [14]
              valid_1 => alphaValid  -- ufix1
              );

  u_Check_Node_Unit : IEEE_8021513_RX_src_CheckNodeUnit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => alphaDTC_1,  -- sfix4_En1 [14]
  ...
  u_alphaDelay_generic_bank0 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
  ...
  u_alphaDelay_generic_bank1 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank2 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank3 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank4 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank5 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank6 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank7 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank8 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank9 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank10 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank11 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank12 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank13 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Beta_Decompress_Unit_2 : IEEE_8021513_RX_src_BetaDecompress_2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              count => count,  -- ufix3
              reset => reset,  -- ufix1
              beta => beta_1  -- sfix4_En1 [14]
              );

  u_Aposteriori_Node_Unit : IEEE_8021513_RX_src_AposterioriUnit
    PORT MAP( alpha => alphaD,  -- sfix6_En1 [14]
              beta => beta_1,  -- sfix4_En1 [14]
              valid => rdValidReg,  -- ufix1
              gamma => gamma_tmp,  -- sfix6_En1 [14]
