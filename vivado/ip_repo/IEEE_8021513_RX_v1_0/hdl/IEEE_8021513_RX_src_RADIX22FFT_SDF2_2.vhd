-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_RADIX22FFT_SDF2_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_RADIX22FFT_SDF2_2
...
ENTITY IEEE_8021513_RX_src_RADIX22FFT_SDF2_2 IS
...
END IEEE_8021513_RX_src_RADIX22FFT_SDF2_2;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT IEEE_8021513_RX_src_SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_SDFCommutator2
    USE ENTITY work.IEEE_8021513_RX_src_SDFCommutator2(rtl);
...
BEGIN
  u_dataMEM_im_0_2 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic_block3
  ...
  u_dataMEM_re_0_2 : IEEE_8021513_RX_src_SimpleDualPortRAM_generic_block3
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 18
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : IEEE_8021513_RX_src_SDFCommutator2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
