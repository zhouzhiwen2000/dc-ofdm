-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_CRCGenerator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_CRCGenerator
...
ENTITY IEEE_8021513_RX_src_CRCGenerator IS
...
END IEEE_8021513_RX_src_CRCGenerator;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_CRCGenerator IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_CRCGenControl
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          startIn                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT IEEE_8021513_RX_src_CRCGenCompute
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_CRCGenControl
    USE ENTITY work.IEEE_8021513_RX_src_CRCGenControl(rtl);

  FOR ALL : IEEE_8021513_RX_src_CRCGenCompute
    USE ENTITY work.IEEE_8021513_RX_src_CRCGenCompute(rtl);
...
BEGIN
  u_Controlsignal_inst : IEEE_8021513_RX_src_CRCGenControl
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_ComputeCRC_inst : IEEE_8021513_RX_src_CRCGenCompute
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
