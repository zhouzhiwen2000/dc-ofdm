-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1
...
ENTITY IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1 IS
...
END IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_Divide_real_numerator_by_denominator_block1 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_normalizedCORDICDivide_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(24 DOWNTO 0);  -- sfix25_En23
  ...
  FOR ALL : IEEE_8021513_RX_src_normalizedCORDICDivide_block1
    USE ENTITY work.IEEE_8021513_RX_src_normalizedCORDICDivide_block1(rtl);
...
BEGIN
  u_normalizedCORDICDivide : IEEE_8021513_RX_src_normalizedCORDICDivide_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              num => num,  -- sfix25_En23
