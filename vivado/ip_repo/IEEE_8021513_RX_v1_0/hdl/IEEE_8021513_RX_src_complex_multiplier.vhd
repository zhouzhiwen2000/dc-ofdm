-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_complex_multiplier.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_complex_multiplier
...
ENTITY IEEE_8021513_RX_src_complex_multiplier IS
...
END IEEE_8021513_RX_src_complex_multiplier;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_complex_multiplier IS

  -- Signals
  SIGNAL in_b_re_signed                   : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL in_b_im_signed                   : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay2_out1                      : signed(17 DOWNTO 0);  -- sfix18_En12
  ...
  SIGNAL Delay5_reg                       : vector_of_signed19(0 TO 1);  -- sfix19 [2]
  SIGNAL Delay5_out1                      : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL in_a_re_signed                   : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL in_a_im_signed                   : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Delay_out1                       : signed(17 DOWNTO 0);  -- sfix18_En12
  ...
  SIGNAL Subtract1_sub_cast               : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL Subtract1_sub_cast_1             : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL Subtract1_out1                   : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL Delay4_reg                       : vector_of_signed19(0 TO 1);  -- sfix19 [2]
  SIGNAL Delay4_out1                      : signed(18 DOWNTO 0);  -- sfix19_En12
  SIGNAL Delay9_reg                       : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  SIGNAL Delay9_out1                      : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Product_out1                     : signed(36 DOWNTO 0);  -- sfix37_En24
  SIGNAL Delay8_reg                       : vector_of_signed37(0 TO 1);  -- sfix37 [2]
  SIGNAL Delay8_out1                      : signed(36 DOWNTO 0);  -- sfix37_En24
  SIGNAL Add1_add_cast                    : signed(37 DOWNTO 0);  -- sfix38_En24
  SIGNAL Add1_add_cast_1                  : signed(37 DOWNTO 0);  -- sfix38_En24
  SIGNAL Add1_out1                        : signed(37 DOWNTO 0);  -- sfix38_En24
  ...
  SIGNAL Delay14_reg                      : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  SIGNAL Delay14_out1                     : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL Product2_out1                    : signed(36 DOWNTO 0);  -- sfix37_En24
  SIGNAL Delay13_reg                      : vector_of_signed37(0 TO 1);  -- sfix37 [2]
  SIGNAL Delay13_out1                     : signed(36 DOWNTO 0);  -- sfix37_En24
  SIGNAL Add2_add_cast                    : signed(37 DOWNTO 0);  -- sfix38_En24
  SIGNAL Add2_add_cast_1                  : signed(37 DOWNTO 0);  -- sfix38_En24
  SIGNAL Add2_out1                        : signed(37 DOWNTO 0);  -- sfix38_En24
  SIGNAL Delay10_out1_re                  : signed(37 DOWNTO 0);  -- sfix38_En24
  SIGNAL Delay10_out1_im                  : signed(37 DOWNTO 0);  -- sfix38_En24
...
BEGIN
  ...
  Subtract_sub_cast <= resize(Delay2_out1, 19);
  Subtract_sub_cast_1 <= resize(Delay3_out1, 19);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay5_reg <= (OTHERS => to_signed(16#00000#, 19));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  Subtract1_sub_cast <= resize(Delay_out1, 19);
  Subtract1_sub_cast_1 <= resize(Delay1_out1, 19);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_reg <= (OTHERS => to_signed(16#00000#, 19));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay8_reg <= (OTHERS => to_signed(0, 37));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  Add1_add_cast <= resize(Delay11_out1, 38);
  Add1_add_cast_1 <= resize(Delay8_out1, 38);
  Add1_out1 <= Add1_add_cast + Add1_add_cast_1;

  Add_add_cast <= resize(Delay2_out1, 19);
  Add_add_cast_1 <= resize(Delay3_out1, 19);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay14_reg <= (OTHERS => to_signed(16#00000#, 18));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay13_reg <= (OTHERS => to_signed(0, 37));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  Add2_add_cast <= resize(Delay8_out1, 38);
  Add2_add_cast_1 <= resize(Delay13_out1, 38);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay10_out1_re <= to_signed(0, 38);
        Delay10_out1_im <= to_signed(0, 38);
      ELSIF enb_1_2_0 = '1' THEN
