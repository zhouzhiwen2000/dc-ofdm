-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized
...
ENTITY IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized IS
...
END IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_General_CRC_Syndrome_Detector_HDL_Optimized IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_CRCGenerator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_CRCCompare
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_CRCGenerator
    USE ENTITY work.IEEE_8021513_RX_src_CRCGenerator(rtl);

  FOR ALL : IEEE_8021513_RX_src_CRCCompare
    USE ENTITY work.IEEE_8021513_RX_src_CRCCompare(rtl);
...
BEGIN
  -- HDL CRC Generator
  u_HDLCRCGen_inst : IEEE_8021513_RX_src_CRCGenerator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  -- Checksum Comparison
  u_ChecksumCompare_inst : IEEE_8021513_RX_src_CRCCompare
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
