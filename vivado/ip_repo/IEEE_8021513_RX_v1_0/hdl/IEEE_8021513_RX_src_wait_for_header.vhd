-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_wait_for_header.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_wait_for_header
...
ENTITY IEEE_8021513_RX_src_wait_for_header IS
...
END IEEE_8021513_RX_src_wait_for_header;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_wait_for_header IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_rising_edge_detector1_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_HDL_FIFO_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_rising_edge_detector_block7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_rising_edge_detector1_block1
    USE ENTITY work.IEEE_8021513_RX_src_rising_edge_detector1_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_HDL_FIFO_block1
    USE ENTITY work.IEEE_8021513_RX_src_HDL_FIFO_block1(rtl);

  FOR ALL : IEEE_8021513_RX_src_rising_edge_detector_block7
    USE ENTITY work.IEEE_8021513_RX_src_rising_edge_detector_block7(rtl);
...
BEGIN
  ...
  u_rising_edge_detector1 : IEEE_8021513_RX_src_rising_edge_detector1_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_HDL_FIFO : IEEE_8021513_RX_src_HDL_FIFO_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_rising_edge_detector : IEEE_8021513_RX_src_rising_edge_detector_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
