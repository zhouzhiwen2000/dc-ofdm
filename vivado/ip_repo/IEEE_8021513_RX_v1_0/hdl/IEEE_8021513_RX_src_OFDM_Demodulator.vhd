-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_OFDM_Demodulator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_OFDM_Demodulator
...
ENTITY IEEE_8021513_RX_src_OFDM_Demodulator IS
...
END IEEE_8021513_RX_src_OFDM_Demodulator;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_OFDM_Demodulator IS

  -- Component Declarations
  COMPONENT IEEE_8021513_RX_src_CPRemoval_stage1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_SamplesRepetition
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_RX_src_HDLFFTShift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_RX_src_dsphdl_FFT
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_DownSampler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_RX_src_SubcarrierSelector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En14
  ...
  FOR ALL : IEEE_8021513_RX_src_CPRemoval_stage1
    USE ENTITY work.IEEE_8021513_RX_src_CPRemoval_stage1(rtl);

  FOR ALL : IEEE_8021513_RX_src_SamplesRepetition
    USE ENTITY work.IEEE_8021513_RX_src_SamplesRepetition(rtl);

  FOR ALL : IEEE_8021513_RX_src_HDLFFTShift
    USE ENTITY work.IEEE_8021513_RX_src_HDLFFTShift(rtl);

  FOR ALL : IEEE_8021513_RX_src_dsphdl_FFT
    USE ENTITY work.IEEE_8021513_RX_src_dsphdl_FFT(rtl);

  FOR ALL : IEEE_8021513_RX_src_DownSampler
    USE ENTITY work.IEEE_8021513_RX_src_DownSampler(rtl);

  FOR ALL : IEEE_8021513_RX_src_SubcarrierSelector
    USE ENTITY work.IEEE_8021513_RX_src_SubcarrierSelector(rtl);
...
BEGIN
  u_CPRemoval_stage1 : IEEE_8021513_RX_src_CPRemoval_stage1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SamplesRepetition : IEEE_8021513_RX_src_SamplesRepetition
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_HDLFFTShift : IEEE_8021513_RX_src_HDLFFTShift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dsphdl_FFT : IEEE_8021513_RX_src_dsphdl_FFT
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_DownSampler : IEEE_8021513_RX_src_DownSampler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SubcarrierSelector : IEEE_8021513_RX_src_SubcarrierSelector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
