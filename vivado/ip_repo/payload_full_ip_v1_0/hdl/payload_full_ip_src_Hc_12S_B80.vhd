-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLPayloadFull/payload_full_ip_src_Hc_12S_B80.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: payload_full_ip_src_Hc_12S_B80
-- Source Path: HDLPayloadFull/payload_full/reduced_ldpc/Hc_12S-B80
-- Hierarchy Level: 2
-- Model version: 1.46
-- 
-- LDPC Encoder
...
ENTITY payload_full_ip_src_Hc_12S_B80 IS
...
END payload_full_ip_src_Hc_12S_B80;


ARCHITECTURE rtl OF payload_full_ip_src_Hc_12S_B80 IS

  -- Component Declarations
  COMPONENT payload_full_ip_src_SimpleDualPortRAM_singlebit
  ...
  COMPONENT payload_full_ip_src_Calculate_Alpha
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT payload_full_ip_src_Calculate_Parity
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT payload_full_ip_src_Final_Output
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : payload_full_ip_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.payload_full_ip_src_SimpleDualPortRAM_singlebit(rtl);

  FOR ALL : payload_full_ip_src_Calculate_Alpha
    USE ENTITY work.payload_full_ip_src_Calculate_Alpha(rtl);

  FOR ALL : payload_full_ip_src_Calculate_Parity
    USE ENTITY work.payload_full_ip_src_Calculate_Parity(rtl);

  FOR ALL : payload_full_ip_src_Final_Output
    USE ENTITY work.payload_full_ip_src_Final_Output(rtl);
...
BEGIN
  u_Input_RAM : payload_full_ip_src_SimpleDualPortRAM_singlebit
  ...
  u_Input_RAM_1 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_2 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_3 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_4 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_5 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_6 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_7 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_8 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_9 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_10 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_11 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_12 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_13 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_14 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_15 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_16 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_17 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_18 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_19 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_20 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_21 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_22 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_23 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_24 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_25 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_26 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_27 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_28 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_29 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_30 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_31 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_32 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_33 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_34 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_35 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_36 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_37 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_38 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_39 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_40 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_41 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_42 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_43 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_44 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_45 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_46 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_47 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_48 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_49 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_50 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_51 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_52 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_53 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_54 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_55 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_56 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_57 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_58 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_59 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_60 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_61 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_62 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_63 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_64 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_65 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_66 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_67 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_68 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_69 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_70 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_71 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_72 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_73 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_74 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_75 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_76 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_77 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_78 : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_singlebit : payload_full_ip_src_SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Calculate_Alpha : payload_full_ip_src_Calculate_Alpha
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Calculate_Parity : payload_full_ip_src_Calculate_Parity
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
  ...
  u_Final_output : payload_full_ip_src_Final_Output
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
