-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLPayloadFull/payload_full_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: payload_full_ip_axi_lite
-- Source Path: payload_full_ip/payload_full_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY payload_full_ip_axi_lite IS
...
END payload_full_ip_axi_lite;


ARCHITECTURE rtl OF payload_full_ip_axi_lite IS

  -- Component Declarations
  COMPONENT payload_full_ip_addr_decoder
  ...
  COMPONENT payload_full_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : payload_full_ip_addr_decoder
    USE ENTITY work.payload_full_ip_addr_decoder(rtl);

  FOR ALL : payload_full_ip_axi_lite_module
    USE ENTITY work.payload_full_ip_axi_lite_module(rtl);
...
BEGIN
  u_payload_full_ip_addr_decoder_inst : payload_full_ip_addr_decoder
  ...
  u_payload_full_ip_axi_lite_module_inst : payload_full_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
