-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLPayloadFull/payload_full_ip_src_reduced_ldpc.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: payload_full_ip_src_reduced_ldpc
-- Source Path: HDLPayloadFull/payload_full/reduced_ldpc
-- Hierarchy Level: 1
-- Model version: 1.46
-- 
-- -------------------------------------------------------------
...
ENTITY payload_full_ip_src_reduced_ldpc IS
...
END payload_full_ip_src_reduced_ldpc;


ARCHITECTURE rtl OF payload_full_ip_src_reduced_ldpc IS

  -- Component Declarations
  COMPONENT payload_full_ip_src_Hc_12S_B80
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    std_logic;
  ...
  FOR ALL : payload_full_ip_src_Hc_12S_B80
    USE ENTITY work.payload_full_ip_src_Hc_12S_B80(rtl);
...
BEGIN
  u_Hc_12S_B80 : payload_full_ip_src_Hc_12S_B80
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              in0 => data_in,
