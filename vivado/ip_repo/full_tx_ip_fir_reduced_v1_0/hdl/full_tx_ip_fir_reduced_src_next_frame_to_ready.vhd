-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_next_frame_to_ready.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_next_frame_to_ready
...
ENTITY full_tx_ip_fir_reduced_src_next_frame_to_ready IS
...
END full_tx_ip_fir_reduced_src_next_frame_to_ready;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_next_frame_to_ready IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_rising_edge_detector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_rising_edge_detector
    USE ENTITY work.full_tx_ip_fir_reduced_src_rising_edge_detector(rtl);
...
BEGIN
  ...
  u_rising_edge_detector : full_tx_ip_fir_reduced_src_rising_edge_detector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
              In_rsvd => next_frame,
