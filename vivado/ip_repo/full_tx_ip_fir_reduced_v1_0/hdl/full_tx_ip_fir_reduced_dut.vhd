-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_dut
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_dut IS
...
END full_tx_ip_fir_reduced_dut;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_dut IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_full_tx
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_full_tx
    USE ENTITY work.full_tx_ip_fir_reduced_src_full_tx(rtl);
...
BEGIN
  u_full_tx_ip_fir_reduced_src_full_tx : full_tx_ip_fir_reduced_src_full_tx
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
