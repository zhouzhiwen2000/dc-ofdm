-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_3
-- Source Path: HDLTx/full_tx/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF1_3
-- Hierarchy Level: 5
-- Model version: 4.90
-- 
-- -------------------------------------------------------------
...
ENTITY full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_3 IS
...
END full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_3;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_3 IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_Complex4Multiply
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_3_1_re_dly                  :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_SDFCommutator3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Complex4Multiply
    USE ENTITY work.full_tx_ip_fir_reduced_src_Complex4Multiply(rtl);
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_SDFCommutator3
    USE ENTITY work.full_tx_ip_fir_reduced_src_SDFCommutator3(rtl);
...
BEGIN
  u_MUL4 : full_tx_ip_fir_reduced_src_Complex4Multiply
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dataMEM_im_0_3 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_3 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_3 : full_tx_ip_fir_reduced_src_SDFCommutator3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_3_vld_dly => din_3_vld_dly,
