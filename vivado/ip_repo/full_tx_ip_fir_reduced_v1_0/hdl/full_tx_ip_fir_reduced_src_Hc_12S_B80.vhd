-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_Hc_12S_B80.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_Hc_12S_B80
...
ENTITY full_tx_ip_fir_reduced_src_Hc_12S_B80 IS
...
END full_tx_ip_fir_reduced_src_Hc_12S_B80;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_Hc_12S_B80 IS
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Calculate_Alpha_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Calculate_Parity_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Final_Output_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Calculate_Alpha_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_Calculate_Alpha_block(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Calculate_Parity_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_Calculate_Parity_block(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Final_Output_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_Final_Output_block(rtl);
  ...
  SIGNAL wrEnbReg                         : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
  SIGNAL wrAddrReg                        : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL wrDataReg                        : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
  ...
  SIGNAL dataRAM                          : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
  SIGNAL alpha                            : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
  SIGNAL alphaValid                       : std_logic;  -- ufix1
  SIGNAL alphaAddr                        : std_logic_vector(3 DOWNTO 0);  -- ufix4
  SIGNAL parity1                          : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
  SIGNAL parity                           : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
  ...
  SIGNAL inputController_wrData           : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
  SIGNAL inputController_wrAddr           : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL inputController_wrEnb            : std_logic_vector(79 DOWNTO 0);  -- boolean [80]
  ...
  SIGNAL inputController_idxCount         : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  SIGNAL inputController_jdxCount         : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL inputController_rdCount          : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL inputController_wrData_next      : std_logic_vector(79 DOWNTO 0);  -- ufix1 [80]
  SIGNAL inputController_wrAddr_next      : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL inputController_wrEnb_next       : std_logic_vector(79 DOWNTO 0);  -- boolean [80]
  ...
  SIGNAL inputController_idxCount_next    : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  SIGNAL inputController_jdxCount_next    : unsigned(6 DOWNTO 0);  -- ufix7
...
BEGIN
  u_Input_RAM : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    ...
    PORT MAP( clk => clk,
              ...
              dout => dataRAM(79)  -- ufix1
              );

  u_Input_RAM_1 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(78)  -- ufix1
              );

  u_Input_RAM_2 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(77)  -- ufix1
              );

  u_Input_RAM_3 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(76)  -- ufix1
              );

  u_Input_RAM_4 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(75)  -- ufix1
              );

  u_Input_RAM_5 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(74)  -- ufix1
              );

  u_Input_RAM_6 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(73)  -- ufix1
              );

  u_Input_RAM_7 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(72)  -- ufix1
              );

  u_Input_RAM_8 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(71)  -- ufix1
              );

  u_Input_RAM_9 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(70)  -- ufix1
              );

  u_Input_RAM_10 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(69)  -- ufix1
              );

  u_Input_RAM_11 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(68)  -- ufix1
              );

  u_Input_RAM_12 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(67)  -- ufix1
              );

  u_Input_RAM_13 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(66)  -- ufix1
              );

  u_Input_RAM_14 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(65)  -- ufix1
              );

  u_Input_RAM_15 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(64)  -- ufix1
              );

  u_Input_RAM_16 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(63)  -- ufix1
              );

  u_Input_RAM_17 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(62)  -- ufix1
              );

  u_Input_RAM_18 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(61)  -- ufix1
              );

  u_Input_RAM_19 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(60)  -- ufix1
              );

  u_Input_RAM_20 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(59)  -- ufix1
              );

  u_Input_RAM_21 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(58)  -- ufix1
              );

  u_Input_RAM_22 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(57)  -- ufix1
              );

  u_Input_RAM_23 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(56)  -- ufix1
              );

  u_Input_RAM_24 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(55)  -- ufix1
              );

  u_Input_RAM_25 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(54)  -- ufix1
              );

  u_Input_RAM_26 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(53)  -- ufix1
              );

  u_Input_RAM_27 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(52)  -- ufix1
              );

  u_Input_RAM_28 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(51)  -- ufix1
              );

  u_Input_RAM_29 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(50)  -- ufix1
              );

  u_Input_RAM_30 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(49)  -- ufix1
              );

  u_Input_RAM_31 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(48)  -- ufix1
              );

  u_Input_RAM_32 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(47)  -- ufix1
              );

  u_Input_RAM_33 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(46)  -- ufix1
              );

  u_Input_RAM_34 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(45)  -- ufix1
              );

  u_Input_RAM_35 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(44)  -- ufix1
              );

  u_Input_RAM_36 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(43)  -- ufix1
              );

  u_Input_RAM_37 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(42)  -- ufix1
              );

  u_Input_RAM_38 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(41)  -- ufix1
              );

  u_Input_RAM_39 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(40)  -- ufix1
              );

  u_Input_RAM_40 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(39)  -- ufix1
              );

  u_Input_RAM_41 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(38)  -- ufix1
              );

  u_Input_RAM_42 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(37)  -- ufix1
              );

  u_Input_RAM_43 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(36)  -- ufix1
              );

  u_Input_RAM_44 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(35)  -- ufix1
              );

  u_Input_RAM_45 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(34)  -- ufix1
              );

  u_Input_RAM_46 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(33)  -- ufix1
              );

  u_Input_RAM_47 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(32)  -- ufix1
              );

  u_Input_RAM_48 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(31)  -- ufix1
              );

  u_Input_RAM_49 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(30)  -- ufix1
              );

  u_Input_RAM_50 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(29)  -- ufix1
              );

  u_Input_RAM_51 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(28)  -- ufix1
              );

  u_Input_RAM_52 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(27)  -- ufix1
              );

  u_Input_RAM_53 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(26)  -- ufix1
              );

  u_Input_RAM_54 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(25)  -- ufix1
              );

  u_Input_RAM_55 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(24)  -- ufix1
              );

  u_Input_RAM_56 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(23)  -- ufix1
              );

  u_Input_RAM_57 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(22)  -- ufix1
              );

  u_Input_RAM_58 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(21)  -- ufix1
              );

  u_Input_RAM_59 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(20)  -- ufix1
              );

  u_Input_RAM_60 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(19)  -- ufix1
              );

  u_Input_RAM_61 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(18)  -- ufix1
              );

  u_Input_RAM_62 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(17)  -- ufix1
              );

  u_Input_RAM_63 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(16)  -- ufix1
              );

  u_Input_RAM_64 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(15)  -- ufix1
              );

  u_Input_RAM_65 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
              ...
              rd_addr => std_logic_vector(rdAddrTmp),
              dout => dataRAM(14)  -- ufix1
              );

  u_Input_RAM_66 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_67 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_68 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_69 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_70 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_71 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_72 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_73 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_74 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_75 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_76 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_77 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_78 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Input_RAM_79 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Calculate_Alpha : full_tx_ip_fir_reduced_src_Calculate_Alpha_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => dataRAM,  -- ufix1 [80]
              reset => extReset,  -- ufix1
              encEnable => encEnbReg,  -- ufix1
              alpha => alpha,  -- ufix1 [80]
              alphaValid => alphaValid,  -- ufix1
              alphaAddr => alphaAddr,  -- ufix4
              columnVal => colVal,  -- ufix5
              parity1 => parity1  -- ufix1 [80]
              );

  u_Calculate_Parity : full_tx_ip_fir_reduced_src_Calculate_Parity_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
              ...
              alphaAddr => alphaAddr,  -- ufix4
              parity1 => parity1,  -- ufix1 [80]
              parityOut => parity,  -- ufix1 [80]
              parityValid => parityValid,  -- ufix1
              parityAddr => parityAddr  -- ufix4
              );

  u_Final_output : full_tx_ip_fir_reduced_src_Final_Output_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
              inputData => dataRAM,  -- ufix1 [80]
              inputValid => rdValidReg,  -- ufix1
              parity => parity,  -- ufix1 [80]
              parityAddr => parityAddr,  -- ufix4
              parityValid => parityValid,  -- ufix1
              dataOut => dataO,
  ...
  maxCount <= to_unsigned(16#003BF#, 20);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        ...
        inputController_idxCount <= to_unsigned(16#00#, 7);
        ...
        inputController_jdxCount <= to_unsigned(16#00#, 7);
  ...
  BEGIN
    ...
    IF reset = '1' THEN 
      ...
      inputController_idxCount_next <= to_unsigned(16#00#, 7);
    ...
    ELSE 
      ...
      IF (inputController_frameValid AND inputController_validReg) = '1' THEN 
        ...
        FOR idx IN 0 TO 79 LOOP
          cast(idx) := unsigned(to_signed(idx, 32)(6 DOWNTO 0));
        ...
        IF inputController_idxCount = to_unsigned(16#4F#, 7) THEN 
          inputController_idxCount_next <= to_unsigned(16#00#, 7);
          inputController_wrCount_next <= inputController_wrCount + to_unsigned(16#01#, 5);
        ELSE 
          inputController_idxCount_next <= inputController_idxCount + to_unsigned(16#01#, 7);
        END IF;
      ELSE 
        inputController_wrData_next <= (OTHERS => '0');
        inputController_wrEnb_next <= (OTHERS => '0');
    ...
    IF reset = '1' THEN 
      ...
      inputController_jdxCount_next <= to_unsigned(16#00#, 7);
    ELSE 
      IF startRead /= '0' THEN 
        inRead_temp := '1';
      END IF;
      IF inRead_temp = '1' THEN 
        ...
        ELSE 
          ...
          inputController_rdAddr_next <= inputController_rdCount;
        END IF;
        IF inputController_jdxCount = to_unsigned(16#4F#, 7) THEN 
          inputController_jdxCount_next <= to_unsigned(16#00#, 7);
          inputController_rdCount_next <= inputController_rdCount + to_unsigned(16#01#, 5);
        ELSE 
          inputController_jdxCount_next <= inputController_jdxCount + to_unsigned(16#01#, 7);
        END IF;
      END IF;
    END IF;
