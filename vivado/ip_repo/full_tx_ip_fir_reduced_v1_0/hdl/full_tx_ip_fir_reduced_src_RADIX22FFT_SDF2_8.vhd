-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_RADIX22FFT_SDF2_8
...
ENTITY full_tx_ip_fir_reduced_src_RADIX22FFT_SDF2_8 IS
...
END full_tx_ip_fir_reduced_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_RADIX22FFT_SDF2_8 IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_SDFCommutator8
    USE ENTITY work.full_tx_ip_fir_reduced_src_SDFCommutator8(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_8 : full_tx_ip_fir_reduced_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
