-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_axi_lite_module
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi_lite/full_tx_ip_fir_reduced_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_axi_lite_module IS
...
END full_tx_ip_fir_reduced_axi_lite_module;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_axi_lite_module IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_write_data_sync
  ...
  FOR ALL : full_tx_ip_fir_reduced_write_data_sync
    USE ENTITY work.full_tx_ip_fir_reduced_write_data_sync(rtl);
...
BEGIN
  u_full_tx_ip_fir_reduced_write_data_sync_inst : full_tx_ip_fir_reduced_write_data_sync
