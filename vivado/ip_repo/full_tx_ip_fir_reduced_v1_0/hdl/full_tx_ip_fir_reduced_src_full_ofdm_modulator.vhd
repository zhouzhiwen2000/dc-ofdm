-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_full_ofdm_modulator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_full_ofdm_modulator
...
ENTITY full_tx_ip_fir_reduced_src_full_ofdm_modulator IS
...
END full_tx_ip_fir_reduced_src_full_ofdm_modulator;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_full_ofdm_modulator IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_sync_constellation_scrambler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb_1_2_1                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in                         :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  COMPONENT full_tx_ip_fir_reduced_src_ofdm_modulator_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_interpolator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_rising_edge_detector_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_frequency_upshift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_sync_constellation_scrambler
    USE ENTITY work.full_tx_ip_fir_reduced_src_sync_constellation_scrambler(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler
    USE ENTITY work.full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_ofdm_modulator_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_ofdm_modulator_block(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_interpolator
    USE ENTITY work.full_tx_ip_fir_reduced_src_interpolator(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_rising_edge_detector_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_rising_edge_detector_block(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_frequency_upshift
    USE ENTITY work.full_tx_ip_fir_reduced_src_frequency_upshift(rtl);
...
BEGIN
  u_sync_constellation_scrambler : full_tx_ip_fir_reduced_src_sync_constellation_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb_1_2_1 => enb_1_2_1,
  ...
  u_enabled_qam_and_scrambler : full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_ofdm_modulator : full_tx_ip_fir_reduced_src_ofdm_modulator_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_interpolator : full_tx_ip_fir_reduced_src_interpolator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb => enb,
  ...
  u_rising_edge_detector : full_tx_ip_fir_reduced_src_rising_edge_detector_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_frequency_upshift : full_tx_ip_fir_reduced_src_frequency_upshift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
