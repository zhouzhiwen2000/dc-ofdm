-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_Compare_To_Zero1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_Compare_To_Zero1
...
ENTITY full_tx_ip_fir_reduced_src_Compare_To_Zero1 IS
  PORT( u                                 :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
        y                                 :   OUT   std_logic
        );
END full_tx_ip_fir_reduced_src_Compare_To_Zero1;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_Compare_To_Zero1 IS
