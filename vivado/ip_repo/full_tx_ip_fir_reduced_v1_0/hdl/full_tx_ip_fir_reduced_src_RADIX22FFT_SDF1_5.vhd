-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_5
...
ENTITY full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_5 IS
...
END full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_5;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_5 IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_1_re_dly                  :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  COMPONENT full_tx_ip_fir_reduced_src_SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Complex4Multiply_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_Complex4Multiply_block(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    USE ENTITY work.full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_SDFCommutator5
    USE ENTITY work.full_tx_ip_fir_reduced_src_SDFCommutator5(rtl);
...
BEGIN
  u_MUL4 : full_tx_ip_fir_reduced_src_Complex4Multiply_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dataMEM_im_0_5 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_5 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_5 : full_tx_ip_fir_reduced_src_SDFCommutator5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_5_vld_dly => din_5_vld_dly,
