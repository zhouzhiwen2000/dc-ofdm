-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_frequency_upshift.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_frequency_upshift
...
ENTITY full_tx_ip_fir_reduced_src_frequency_upshift IS
...
END full_tx_ip_fir_reduced_src_frequency_upshift;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_frequency_upshift IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_NCO
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Mixer
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_NCO
    USE ENTITY work.full_tx_ip_fir_reduced_src_NCO(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Mixer
    USE ENTITY work.full_tx_ip_fir_reduced_src_Mixer(rtl);
...
BEGIN
  u_NCO : full_tx_ip_fir_reduced_src_NCO
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              resetPhase => reset,
  ...
  u_Mixer : full_tx_ip_fir_reduced_src_Mixer
    PORT MAP( clk => clk,
              enb => enb,
