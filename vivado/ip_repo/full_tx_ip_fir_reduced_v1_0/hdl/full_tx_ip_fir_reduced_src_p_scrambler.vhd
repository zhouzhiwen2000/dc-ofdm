-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_p_scrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_p_scrambler
...
ENTITY full_tx_ip_fir_reduced_src_p_scrambler IS
...
END full_tx_ip_fir_reduced_src_p_scrambler;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_p_scrambler IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_Sample_Control_Bus_Creator_block6
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Sample_Control_Bus_Creator_block6
    USE ENTITY work.full_tx_ip_fir_reduced_src_Sample_Control_Bus_Creator_block6(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : full_tx_ip_fir_reduced_src_Sample_Control_Bus_Creator_block6
