-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_axi4_stream_slave
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_axi4_stream_slave IS
...
END full_tx_ip_fir_reduced_axi4_stream_slave;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_fifo_TLAST
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_fifo_data
    USE ENTITY work.full_tx_ip_fir_reduced_fifo_data(rtl);

  FOR ALL : full_tx_ip_fir_reduced_fifo_TLAST
    USE ENTITY work.full_tx_ip_fir_reduced_fifo_TLAST(rtl);
...
BEGIN
  u_full_tx_ip_fir_reduced_fifo_data_inst : full_tx_ip_fir_reduced_fifo_data
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_full_tx_ip_fir_reduced_fifo_TLAST_inst : full_tx_ip_fir_reduced_fifo_TLAST
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
