-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_samplesRepetitionMod.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_samplesRepetitionMod
-- Source Path: 
-- Hierarchy Level: 4
-- Model version: 4.90
-- 
...
ENTITY full_tx_ip_fir_reduced_src_samplesRepetitionMod IS
...
END full_tx_ip_fir_reduced_src_samplesRepetitionMod;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_samplesRepetitionMod IS
...
BEGIN
  ...
  u_simpleDualPortRam_1 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
