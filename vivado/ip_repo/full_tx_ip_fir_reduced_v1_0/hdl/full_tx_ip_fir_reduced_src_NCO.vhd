-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_NCO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_NCO
...
ENTITY full_tx_ip_fir_reduced_src_NCO IS
...
END full_tx_ip_fir_reduced_src_NCO;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_NCO IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_WaveformGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_WaveformGen
    USE ENTITY work.full_tx_ip_fir_reduced_src_WaveformGen(rtl);
...
BEGIN
  u_Wave_inst : full_tx_ip_fir_reduced_src_WaveformGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
