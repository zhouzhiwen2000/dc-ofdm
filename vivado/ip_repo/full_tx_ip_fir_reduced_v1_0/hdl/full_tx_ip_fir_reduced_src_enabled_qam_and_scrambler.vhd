-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler
...
ENTITY full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler IS
...
END full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_enabled_qam_and_scrambler IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_qam_mod
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in                         :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  COMPONENT full_tx_ip_fir_reduced_src_constellation_scrambler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_qam_mod
    USE ENTITY work.full_tx_ip_fir_reduced_src_qam_mod(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_constellation_scrambler
    USE ENTITY work.full_tx_ip_fir_reduced_src_constellation_scrambler(rtl);
...
BEGIN
  u_qam_mod : full_tx_ip_fir_reduced_src_qam_mod
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_constellation_scrambler : full_tx_ip_fir_reduced_src_constellation_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
