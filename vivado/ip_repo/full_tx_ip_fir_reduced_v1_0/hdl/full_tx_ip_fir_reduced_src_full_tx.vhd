-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_full_tx.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_full_tx
...
ENTITY full_tx_ip_fir_reduced_src_full_tx IS
...
END full_tx_ip_fir_reduced_src_full_tx;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_full_tx IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_full_tx_tc
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_reg_to_variable
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_preamble_gen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_channel_gen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb_1_2_1                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_new_frame_rate_conversion
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_header_full
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_new_frame_rate_conversion1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          enb_1_8_1                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_payload_full
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_clock_crossing
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
          enb_1_2_1                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_store_frame_in_ram
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_full_ofdm_modulator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb_1_2_1                       :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_full_tx_tc
    USE ENTITY work.full_tx_ip_fir_reduced_src_full_tx_tc(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_reg_to_variable
    USE ENTITY work.full_tx_ip_fir_reduced_src_reg_to_variable(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_preamble_gen
    USE ENTITY work.full_tx_ip_fir_reduced_src_preamble_gen(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_channel_gen
    USE ENTITY work.full_tx_ip_fir_reduced_src_channel_gen(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_new_frame_rate_conversion
    USE ENTITY work.full_tx_ip_fir_reduced_src_new_frame_rate_conversion(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_header_full
    USE ENTITY work.full_tx_ip_fir_reduced_src_header_full(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_new_frame_rate_conversion1
    USE ENTITY work.full_tx_ip_fir_reduced_src_new_frame_rate_conversion1(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_payload_full
    USE ENTITY work.full_tx_ip_fir_reduced_src_payload_full(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_clock_crossing
    USE ENTITY work.full_tx_ip_fir_reduced_src_clock_crossing(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_store_frame_in_ram
    USE ENTITY work.full_tx_ip_fir_reduced_src_store_frame_in_ram(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_full_ofdm_modulator
    USE ENTITY work.full_tx_ip_fir_reduced_src_full_ofdm_modulator(rtl);
  ...
  SIGNAL len_in_ofdm_symbols              : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_full_tx_tc : full_tx_ip_fir_reduced_src_full_tx_tc
    PORT MAP( clk => clk,
              reset_x => reset_x,
  ...
  u_reg_to_variable : full_tx_ip_fir_reduced_src_reg_to_variable
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
  ...
  u_preamble_gen : full_tx_ip_fir_reduced_src_preamble_gen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb_1_2_1 => enb_1_2_1,
  ...
  u_channel_gen : full_tx_ip_fir_reduced_src_channel_gen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb_1_2_1 => enb_1_2_1,
  ...
  u_new_frame_rate_conversion : full_tx_ip_fir_reduced_src_new_frame_rate_conversion
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb_1_8_1 => enb_1_8_1,
  ...
  u_header_full : full_tx_ip_fir_reduced_src_header_full
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
              enb => enb,
  ...
  u_new_frame_rate_conversion1 : full_tx_ip_fir_reduced_src_new_frame_rate_conversion1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              enb_1_8_1 => enb_1_8_1,
  ...
  u_payload_full : full_tx_ip_fir_reduced_src_payload_full
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
              enb => enb,
              ...
              len_in_ofdm_symbols => len_in_ofdm_symbols,  -- uint16
              bits_per_subcarrier => bits_per_subcarrier  -- ufix4
              );

  u_clock_crossing : full_tx_ip_fir_reduced_src_clock_crossing
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
              enb_1_2_1 => enb_1_2_1,
              ...
              payload_len_in => len_in_ofdm_symbols,  -- uint16
  ...
  u_store_frame_in_ram : full_tx_ip_fir_reduced_src_store_frame_in_ram
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_full_ofdm_modulator : full_tx_ip_fir_reduced_src_full_ofdm_modulator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb_1_2_1 => enb_1_2_1,
