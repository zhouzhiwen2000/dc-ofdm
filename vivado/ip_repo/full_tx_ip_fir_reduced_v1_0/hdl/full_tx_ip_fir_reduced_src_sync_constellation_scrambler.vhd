-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_sync_constellation_scrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_sync_constellation_scrambler
...
ENTITY full_tx_ip_fir_reduced_src_sync_constellation_scrambler IS
...
END full_tx_ip_fir_reduced_src_sync_constellation_scrambler;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_sync_constellation_scrambler IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_Synchronous_constellation_scrambler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          valid_in                        :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Synchronous_constellation_scrambler
    USE ENTITY work.full_tx_ip_fir_reduced_src_Synchronous_constellation_scrambler(rtl);
...
BEGIN
  u_Synchronous_constellation_scrambler : full_tx_ip_fir_reduced_src_Synchronous_constellation_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              valid_in => valid_in_1,
