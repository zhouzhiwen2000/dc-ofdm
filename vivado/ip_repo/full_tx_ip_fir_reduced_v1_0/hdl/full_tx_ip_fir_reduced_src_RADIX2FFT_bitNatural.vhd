-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_RADIX2FFT_bitNatural.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_RADIX2FFT_bitNatural
...
ENTITY full_tx_ip_fir_reduced_src_RADIX2FFT_bitNatural IS
...
END full_tx_ip_fir_reduced_src_RADIX2FFT_bitNatural;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_RADIX2FFT_bitNatural IS
...
BEGIN
  u_dataMEM_im_1 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_1 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
