-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_write_data_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_write_data_sync
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi_lite/full_tx_ip_fir_reduced_axi_lite_module/full_tx_ip_fir_reduced_write_data_sync
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_write_data_sync IS
...
END full_tx_ip_fir_reduced_write_data_sync;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_write_data_sync IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_write_sync_receive_clk
  ...
  FOR ALL : full_tx_ip_fir_reduced_write_sync_receive_clk
    USE ENTITY work.full_tx_ip_fir_reduced_write_sync_receive_clk(rtl);
...
BEGIN
  u_full_tx_ip_fir_reduced_write_sync_receive_clk_inst : full_tx_ip_fir_reduced_write_sync_receive_clk
