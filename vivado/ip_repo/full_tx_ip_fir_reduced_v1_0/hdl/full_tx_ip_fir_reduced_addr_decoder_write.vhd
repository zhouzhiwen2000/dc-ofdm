-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_addr_decoder_write.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_addr_decoder_write
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi_lite/full_tx_ip_fir_reduced_addr_decoder/full_tx_ip_fir_reduced_addr_decoder_write
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_addr_decoder_write IS
...
END full_tx_ip_fir_reduced_addr_decoder_write;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_addr_decoder_write IS
