-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_valid_frame.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_valid_frame
...
ENTITY full_tx_ip_fir_reduced_src_valid_frame IS
...
END full_tx_ip_fir_reduced_src_valid_frame;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_valid_frame IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_Compare_To_Zero1
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Compare_To_Zero1
    USE ENTITY work.full_tx_ip_fir_reduced_src_Compare_To_Zero1(rtl);
...
BEGIN
  u_Compare_To_Zero1 : full_tx_ip_fir_reduced_src_Compare_To_Zero1
