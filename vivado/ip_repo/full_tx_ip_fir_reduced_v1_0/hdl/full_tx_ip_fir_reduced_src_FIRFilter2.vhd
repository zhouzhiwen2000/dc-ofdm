-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_FIRFilter2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_FIRFilter2
...
ENTITY full_tx_ip_fir_reduced_src_FIRFilter2 IS
...
END full_tx_ip_fir_reduced_src_FIRFilter2;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_FIRFilter2 IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_FirRdyLogic_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_FirRdyLogic_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_FirRdyLogic_block(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_FilterTapSystolic
    USE ENTITY work.full_tx_ip_fir_reduced_src_FilterTapSystolic(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_FilterTapSystolic_block(rtl);
  ...
  SIGNAL accDataOut                       : signed(30 DOWNTO 0);  -- sfix31_En28
  ...
  SIGNAL delayLineEnd8deadOut             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL sumIn                            : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL sumOut                           : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_0                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_1                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_2                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_3                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_4                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_5                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_6                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_7                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_7_signed                  : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL sumOutReg_1                      : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL accDataOut_1                     : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL accSwitchOut                     : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL accAdderOut                      : signed(30 DOWNTO 0);  -- sfix31_En28
  ...
  SIGNAL accDataOut_3                     : signed(30 DOWNTO 0);  -- sfix31_En28
  ...
  SIGNAL delayLineEnd8deadOut_1           : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL sumIn_1                          : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL sumOut_8                         : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_0_1                       : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_1_1                       : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_2_1                       : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_3_1                       : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_4_1                       : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_5_1                       : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_6_1                       : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_7_1                       : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL sumOut_7_signed_1                : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL sumOutReg_3                      : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL accDataOut_4                     : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL accSwitchOut_1                   : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL accAdderOut_1                    : signed(30 DOWNTO 0);  -- sfix31_En28
...
BEGIN
  u_firRdyLogic : full_tx_ip_fir_reduced_src_FirRdyLogic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterTap0 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut0,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP0_1),  -- sfix16_En14
              sumIn => std_logic_vector(sumIn),  -- sfix31_En28
              sumOut => sumOut  -- sfix31_En28
              );

  u_filterTap1 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP1_1),  -- sfix16_En14
              sumIn => sumOut,  -- sfix31_En28
              sumOut => sumOut_0  -- sfix31_En28
              );

  u_filterTap2 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut2,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP2_1),  -- sfix16_En14
              sumIn => sumOut_0,  -- sfix31_En28
              sumOut => sumOut_1  -- sfix31_En28
              );

  u_filterTap3 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut3,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP3_1),  -- sfix16_En14
              sumIn => sumOut_1,  -- sfix31_En28
              sumOut => sumOut_2  -- sfix31_En28
              );

  u_filterTap4 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut4,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP4_1),  -- sfix16_En14
              sumIn => sumOut_2,  -- sfix31_En28
              sumOut => sumOut_3  -- sfix31_En28
              );

  u_filterTap5 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut5,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP5_1),  -- sfix16_En14
              sumIn => sumOut_3,  -- sfix31_En28
              sumOut => sumOut_4  -- sfix31_En28
              );

  u_filterTap6 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut6,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP6_1),  -- sfix16_En14
              sumIn => sumOut_4,  -- sfix31_En28
              sumOut => sumOut_5  -- sfix31_En28
              );

  u_filterTap7 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut7,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP7_1),  -- sfix16_En14
              sumIn => sumOut_5,  -- sfix31_En28
              sumOut => sumOut_6  -- sfix31_En28
              );

  u_filterTap8 : full_tx_ip_fir_reduced_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut8,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP8_1),  -- sfix16_En14
              sumIn => sumOut_6,  -- sfix31_En28
              sumOut => sumOut_7  -- sfix31_En28
              );

  u_delayLine0_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterTap0_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut0_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP0_3),  -- sfix16_En14
              sumIn => std_logic_vector(sumIn_1),  -- sfix31_En28
              sumOut => sumOut_8  -- sfix31_En28
              );

  u_filterTap1_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut1_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP1_3),  -- sfix16_En14
              sumIn => sumOut_8,  -- sfix31_En28
              sumOut => sumOut_0_1  -- sfix31_En28
              );

  u_filterTap2_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut2_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP2_3),  -- sfix16_En14
              sumIn => sumOut_0_1,  -- sfix31_En28
              sumOut => sumOut_1_1  -- sfix31_En28
              );

  u_filterTap3_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut3_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP3_3),  -- sfix16_En14
              sumIn => sumOut_1_1,  -- sfix31_En28
              sumOut => sumOut_2_1  -- sfix31_En28
              );

  u_filterTap4_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut4_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP4_3),  -- sfix16_En14
              sumIn => sumOut_2_1,  -- sfix31_En28
              sumOut => sumOut_3_1  -- sfix31_En28
              );

  u_filterTap5_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut5_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP5_3),  -- sfix16_En14
              sumIn => sumOut_3_1,  -- sfix31_En28
              sumOut => sumOut_4_1  -- sfix31_En28
              );

  u_filterTap6_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut6_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP6_3),  -- sfix16_En14
              sumIn => sumOut_4_1,  -- sfix31_En28
              sumOut => sumOut_5_1  -- sfix31_En28
              );

  u_filterTap7_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut7_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP7_3),  -- sfix16_En14
              sumIn => sumOut_5_1,  -- sfix31_En28
              sumOut => sumOut_6_1  -- sfix31_En28
              );

  u_filterTap8_1 : full_tx_ip_fir_reduced_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut8_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP8_3),  -- sfix16_En14
              sumIn => sumOut_6_1,  -- sfix31_En28
              sumOut => sumOut_7_1  -- sfix31_En28
              );
  ...
  accDataOut <= to_signed(16#00000000#, 31);
  ...
  BEGIN
    CASE rdAddr8 IS
      WHEN '0' =>
        coeffTableOut8 <= to_signed(-16#0055#, 16);
      WHEN '1' =>
  ...
  BEGIN
    CASE rdAddr7 IS
      WHEN '0' =>
        coeffTableOut7 <= to_signed(-16#00D3#, 16);
      WHEN '1' =>
        coeffTableOut7 <= to_signed(16#0083#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr6 IS
      WHEN '0' =>
        coeffTableOut6 <= to_signed(-16#0195#, 16);
      WHEN '1' =>
        coeffTableOut6 <= to_signed(16#0131#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr5 IS
      WHEN '0' =>
        coeffTableOut5 <= to_signed(-16#0240#, 16);
      WHEN '1' =>
        coeffTableOut5 <= to_signed(16#01F2#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4 <= to_signed(16#3D7B#, 16);
      WHEN '1' =>
        coeffTableOut4 <= to_signed(16#0273#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3 <= to_signed(-16#0240#, 16);
      WHEN '1' =>
        coeffTableOut3 <= to_signed(16#0273#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2 <= to_signed(-16#0195#, 16);
      WHEN '1' =>
        coeffTableOut2 <= to_signed(16#01F2#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1 <= to_signed(-16#00D3#, 16);
      WHEN '1' =>
        coeffTableOut1 <= to_signed(16#0131#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0 <= to_signed(-16#0055#, 16);
      WHEN '1' =>
        coeffTableOut0 <= to_signed(16#0083#, 16);
      WHEN OTHERS => 
  ...
  sumIn <= to_signed(16#00000000#, 31);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        sumOutReg_1 <= to_signed(16#00000000#, 31);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        accDataOut_1 <= to_signed(16#00000000#, 31);
      ELSIF enb = '1' THEN
  ...
  accDataOut_3 <= to_signed(16#00000000#, 31);
  ...
  BEGIN
    CASE rdAddr8 IS
      WHEN '0' =>
        coeffTableOut8_1 <= to_signed(-16#0055#, 16);
      WHEN '1' =>
  ...
  BEGIN
    CASE rdAddr7 IS
      WHEN '0' =>
        coeffTableOut7_1 <= to_signed(-16#00D3#, 16);
      WHEN '1' =>
        coeffTableOut7_1 <= to_signed(16#0083#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr6 IS
      WHEN '0' =>
        coeffTableOut6_1 <= to_signed(-16#0195#, 16);
      WHEN '1' =>
        coeffTableOut6_1 <= to_signed(16#0131#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr5 IS
      WHEN '0' =>
        coeffTableOut5_1 <= to_signed(-16#0240#, 16);
      WHEN '1' =>
        coeffTableOut5_1 <= to_signed(16#01F2#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4_1 <= to_signed(16#3D7B#, 16);
      WHEN '1' =>
        coeffTableOut4_1 <= to_signed(16#0273#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3_1 <= to_signed(-16#0240#, 16);
      WHEN '1' =>
        coeffTableOut3_1 <= to_signed(16#0273#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2_1 <= to_signed(-16#0195#, 16);
      WHEN '1' =>
        coeffTableOut2_1 <= to_signed(16#01F2#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1_1 <= to_signed(-16#00D3#, 16);
      WHEN '1' =>
        coeffTableOut1_1 <= to_signed(16#0131#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0_1 <= to_signed(-16#0055#, 16);
      WHEN '1' =>
        coeffTableOut0_1 <= to_signed(16#0083#, 16);
      WHEN OTHERS => 
  ...
  sumIn_1 <= to_signed(16#00000000#, 31);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        sumOutReg_3 <= to_signed(16#00000000#, 31);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        accDataOut_4 <= to_signed(16#00000000#, 31);
      ELSIF enb = '1' THEN
