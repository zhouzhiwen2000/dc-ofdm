-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced
-- Source Path: full_tx_ip_fir_reduced
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced IS
...
END full_tx_ip_fir_reduced;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_reset_sync
  ...
  COMPONENT full_tx_ip_fir_reduced_axi_lite
  ...
  COMPONENT full_tx_ip_fir_reduced_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
  ...
  COMPONENT full_tx_ip_fir_reduced_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  FOR ALL : full_tx_ip_fir_reduced_reset_sync
    USE ENTITY work.full_tx_ip_fir_reduced_reset_sync(rtl);

  FOR ALL : full_tx_ip_fir_reduced_axi_lite
    USE ENTITY work.full_tx_ip_fir_reduced_axi_lite(rtl);

  FOR ALL : full_tx_ip_fir_reduced_dut
    USE ENTITY work.full_tx_ip_fir_reduced_dut(rtl);

  FOR ALL : full_tx_ip_fir_reduced_axi4_stream_slave
    USE ENTITY work.full_tx_ip_fir_reduced_axi4_stream_slave(rtl);
...
BEGIN
  u_full_tx_ip_fir_reduced_reset_sync_inst : full_tx_ip_fir_reduced_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset_x
              );

  u_full_tx_ip_fir_reduced_axi_lite_inst : full_tx_ip_fir_reduced_axi_lite
  ...
  u_full_tx_ip_fir_reduced_dut_inst : full_tx_ip_fir_reduced_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
  ...
  u_full_tx_ip_fir_reduced_axi4_stream_slave_inst : full_tx_ip_fir_reduced_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
              enb => const_1_1,
  ...
  u_full_tx_ip_fir_reduced_fpga_data_capture : fpga_data_capture
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              data_out => data_out_sig,  -- sfix16_En14
              valid_out => valid_out_sig,  -- ufix1
  ...
  ip_timestamp <= unsigned'(X"8F88B448");
