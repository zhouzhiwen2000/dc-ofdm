-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_FirRdyLogic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_FirRdyLogic
...
ENTITY full_tx_ip_fir_reduced_src_FirRdyLogic IS
...
END full_tx_ip_fir_reduced_src_FirRdyLogic;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_FirRdyLogic IS

  -- Signals
  SIGNAL dinSwitch_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dinSwitch_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL coeff_re_signed                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL coeff_im_signed                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL syncReset                        : std_logic;
  SIGNAL firRdy_xdin_re                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL firRdy_xdin_im                   : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL firRdy_xcoeffin_re               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL firRdy_xcoeffin_im               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL firRdy_xdin_next_re              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL firRdy_xdin_next_im              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL firRdy_xcoeffin_next_re          : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL firRdy_xcoeffin_next_im          : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL readySM                          : std_logic;
  SIGNAL dinSM_re_tmp                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dinSM_im_tmp                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL coeffS_re                        : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL coeffS_im                        : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        ...
        firRdy_xdinVld <= '0';
        firRdy_xcoeffin_re <= to_signed(16#0000#, 16);
        firRdy_xcoeffin_im <= to_signed(16#0000#, 16);
        firRdy_readyReg <= '1';
        firRdy_count <= '0';
      ELSIF enb = '1' THEN
