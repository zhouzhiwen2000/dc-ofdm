-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_fifo_data
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi4_stream_slave/full_tx_ip_fir_reduced_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_fifo_data IS
...
END full_tx_ip_fir_reduced_fifo_data;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_fifo_data IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_SimpleDualPortRAM_generic
  ...
  FOR ALL : full_tx_ip_fir_reduced_SimpleDualPortRAM_generic
    USE ENTITY work.full_tx_ip_fir_reduced_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_full_tx_ip_fir_reduced_fifo_data_classic_ram_generic : full_tx_ip_fir_reduced_SimpleDualPortRAM_generic
