-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_SDFCommutator7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_SDFCommutator7
...
ENTITY full_tx_ip_fir_reduced_src_SDFCommutator7 IS
...
END full_tx_ip_fir_reduced_src_SDFCommutator7;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_SDFCommutator7 IS
  ...
  SIGNAL dout_7_1_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_7_1_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14

BEGIN
  u_dataXMEM_re_0_7 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_7 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
