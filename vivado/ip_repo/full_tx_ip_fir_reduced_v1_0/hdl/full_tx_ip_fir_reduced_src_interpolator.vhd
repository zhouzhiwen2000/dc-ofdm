-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_interpolator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_interpolator
...
ENTITY full_tx_ip_fir_reduced_src_interpolator IS
...
END full_tx_ip_fir_reduced_src_interpolator;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_interpolator IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_FIR_Interpolator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_falling_edge_detector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_FIR_Interpolator
    USE ENTITY work.full_tx_ip_fir_reduced_src_FIR_Interpolator(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_falling_edge_detector
    USE ENTITY work.full_tx_ip_fir_reduced_src_falling_edge_detector(rtl);
...
BEGIN
  u_FIR_Interpolator : full_tx_ip_fir_reduced_src_FIR_Interpolator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_falling_edge_detector : full_tx_ip_fir_reduced_src_falling_edge_detector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
