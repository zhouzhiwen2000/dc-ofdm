-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_pulse_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_pulse_sync
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi_lite/full_tx_ip_fir_reduced_pulse_sync
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_pulse_sync IS
...
END full_tx_ip_fir_reduced_pulse_sync;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_pulse_sync IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_sync_receive_clk
  ...
  FOR ALL : full_tx_ip_fir_reduced_sync_receive_clk
    USE ENTITY work.full_tx_ip_fir_reduced_sync_receive_clk(rtl);
...
BEGIN
  u_full_tx_ip_fir_reduced_sync_receive_clk_inst : full_tx_ip_fir_reduced_sync_receive_clk
