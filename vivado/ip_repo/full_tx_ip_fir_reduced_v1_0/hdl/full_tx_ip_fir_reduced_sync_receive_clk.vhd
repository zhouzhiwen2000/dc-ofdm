-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_sync_receive_clk.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_sync_receive_clk
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi_lite/full_tx_ip_fir_reduced_pulse_sync/full_tx_ip_fir_reduced_sync_receive_clk
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_sync_receive_clk IS
...
END full_tx_ip_fir_reduced_sync_receive_clk;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_sync_receive_clk IS
