-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_SDFCommutator6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_SDFCommutator6
...
ENTITY full_tx_ip_fir_reduced_src_SDFCommutator6 IS
...
END full_tx_ip_fir_reduced_src_SDFCommutator6;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_SDFCommutator6 IS
...
BEGIN
  u_dataXMEM_re_0_6 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_6 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
