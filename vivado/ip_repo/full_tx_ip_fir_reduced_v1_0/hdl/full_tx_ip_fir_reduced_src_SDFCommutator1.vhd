-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_SDFCommutator1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_SDFCommutator1
...
ENTITY full_tx_ip_fir_reduced_src_SDFCommutator1 IS
...
END full_tx_ip_fir_reduced_src_SDFCommutator1;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_SDFCommutator1 IS
...
BEGIN
  u_dataXMEM_re_0_1 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_1 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
