-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_1
...
ENTITY full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_1 IS
...
END full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_1;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_1 IS
  ...
  COMPONENT full_tx_ip_fir_reduced_src_SDFCommutator1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_SDFCommutator1
    USE ENTITY work.full_tx_ip_fir_reduced_src_SDFCommutator1(rtl);
...
BEGIN
  u_dataMEM_im_0_1 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_1 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 7,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : full_tx_ip_fir_reduced_src_SDFCommutator1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
