-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_tone_mapping.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_tone_mapping
...
ENTITY full_tx_ip_fir_reduced_src_tone_mapping IS
...
END full_tx_ip_fir_reduced_src_tone_mapping;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_tone_mapping IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_Compare_To_Constant
    PORT( u                               :   IN    std_logic_vector(25 DOWNTO 0);  -- ufix26
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT full_tx_ip_fir_reduced_src_Sample_Control_Bus_Creator_block4
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Compare_To_Constant
    USE ENTITY work.full_tx_ip_fir_reduced_src_Compare_To_Constant(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Sample_Control_Bus_Creator_block4
    USE ENTITY work.full_tx_ip_fir_reduced_src_Sample_Control_Bus_Creator_block4(rtl);
...
BEGIN
  u_Compare_To_Constant : full_tx_ip_fir_reduced_src_Compare_To_Constant
    PORT MAP( u => std_logic_vector(Subtract_out1),  -- ufix26
              y => Compare_To_Constant_out1
              );

  u_Sample_Control_Bus_Creator : full_tx_ip_fir_reduced_src_Sample_Control_Bus_Creator_block4
  ...
  Gain_out1 <= resize(to_unsigned(16#C2#, 8) * Data_Type_Conversion_out1, 10);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay9_out1 <= len_in_ofdm_symbols_unsigned;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        count_hit <= to_unsigned(16#0000000#, 26);
      ELSIF enb = '1' THEN
        count_hit <= Product1_out1;
      END IF;
    END IF;
