-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_7
...
ENTITY full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_7 IS
...
END full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_RADIX22FFT_SDF1_7 IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_7_1_re_dly                  :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Complex4Multiply_block1
    USE ENTITY work.full_tx_ip_fir_reduced_src_Complex4Multiply_block1(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_SDFCommutator7
    USE ENTITY work.full_tx_ip_fir_reduced_src_SDFCommutator7(rtl);
  ...
  SIGNAL dout_7_1_re_tmp                  : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_7_1_im_tmp                  : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_MUL4 : full_tx_ip_fir_reduced_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SDFCOMMUTATOR_7 : full_tx_ip_fir_reduced_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_7_vld_dly => din_7_vld_dly,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_7_1_re => dout_7_1_re_tmp,  -- sfix16_En14
              dout_7_1_im => dout_7_1_im_tmp,  -- sfix16_En14
