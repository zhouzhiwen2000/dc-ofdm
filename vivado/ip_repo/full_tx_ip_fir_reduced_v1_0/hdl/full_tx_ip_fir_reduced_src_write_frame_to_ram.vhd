-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_write_frame_to_ram.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_write_frame_to_ram
...
ENTITY full_tx_ip_fir_reduced_src_write_frame_to_ram IS
...
END full_tx_ip_fir_reduced_src_write_frame_to_ram;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_write_frame_to_ram IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_ram_formatting
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_ram_formatting
    USE ENTITY work.full_tx_ip_fir_reduced_src_ram_formatting(rtl);
...
BEGIN
  u_ram_formatting : full_tx_ip_fir_reduced_src_ram_formatting
