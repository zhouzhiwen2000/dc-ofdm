-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_new_frame_rate_conversion.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_new_frame_rate_conversion
-- Source Path: HDLTx/full_tx/new_frame_rate_conversion
-- Hierarchy Level: 1
-- Model version: 4.90
-- 
-- -------------------------------------------------------------
...
ENTITY full_tx_ip_fir_reduced_src_new_frame_rate_conversion IS
...
END full_tx_ip_fir_reduced_src_new_frame_rate_conversion;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_new_frame_rate_conversion IS
...
BEGIN
  -- Description:
  -- This block "extends" the "end" signal 4 clock cycles, to ensure that the "end" signal can be sampled by the rate 
  -- transition block
  ...
  Logical_Operator_out1 <= Delay4_out1 OR (Delay3_out1 OR (end_rsvd OR Delay2_out1));
