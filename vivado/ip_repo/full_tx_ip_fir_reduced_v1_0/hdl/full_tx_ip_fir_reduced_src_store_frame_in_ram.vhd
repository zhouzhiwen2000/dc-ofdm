-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_store_frame_in_ram.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_store_frame_in_ram
...
ENTITY full_tx_ip_fir_reduced_src_store_frame_in_ram IS
...
END full_tx_ip_fir_reduced_src_store_frame_in_ram;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_store_frame_in_ram IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_write_frame_to_ram
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          preamble                        :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_read_frame_from_ram
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_RAM
    PORT( clk                             :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_write_frame_to_ram
    USE ENTITY work.full_tx_ip_fir_reduced_src_write_frame_to_ram(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_read_frame_from_ram
    USE ENTITY work.full_tx_ip_fir_reduced_src_read_frame_from_ram(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_RAM
    USE ENTITY work.full_tx_ip_fir_reduced_src_RAM(rtl);
...
BEGIN
  u_write_frame_to_ram : full_tx_ip_fir_reduced_src_write_frame_to_ram
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              preamble => preamble,
  ...
  u_read_frame_from_ram : full_tx_ip_fir_reduced_src_read_frame_from_ram
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_RAM : full_tx_ip_fir_reduced_src_RAM
    PORT MAP( clk => clk,
              enb_1_2_0 => enb_1_2_0,
