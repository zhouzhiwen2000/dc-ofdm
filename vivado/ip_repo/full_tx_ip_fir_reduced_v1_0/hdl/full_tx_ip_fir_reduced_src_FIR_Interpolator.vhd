-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_FIR_Interpolator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_FIR_Interpolator
...
ENTITY full_tx_ip_fir_reduced_src_FIR_Interpolator IS
...
END full_tx_ip_fir_reduced_src_FIR_Interpolator;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_FIR_Interpolator IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_FIRFilter2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_FIRFilter1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_FIRFilter2
    USE ENTITY work.full_tx_ip_fir_reduced_src_FIRFilter2(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_FIRFilter1
    USE ENTITY work.full_tx_ip_fir_reduced_src_FIRFilter1(rtl);
  ...
  SIGNAL dataZero_re                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dataZero_im                      : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL FIROutput1_re_signed             : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL FIROutput1_im_signed             : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL intdelay_reg_re                  : vector_of_signed16(0 TO 2);  -- sfix16_En14 [3]
  SIGNAL intdelay_reg_im                  : vector_of_signed16(0 TO 2);  -- sfix16_En14 [3]
  SIGNAL FIROutputCastDBP1_re             : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL FIROutputCastDBP1_im             : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL FIROutputCastDB1_re              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL FIROutputCastDB1_im              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL FIROutput2_re_signed             : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL FIROutput2_im_signed             : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL FIROutputCastDB2_re              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL FIROutputCastDB2_im              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dataSelect_re                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dataSelect_im                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dataOut_re_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dataOut_im_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En14

BEGIN
  u_filterInstantiation : full_tx_ip_fir_reduced_src_FIRFilter2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              validIn => validIn,
              dataOut_re => FIROutput2_re,  -- sfix16_En14
              dataOut_im => FIROutput2_im,  -- sfix16_En14
              validOut => FIRValid2
              );

  u_filterInstantiation_1 : full_tx_ip_fir_reduced_src_FIRFilter1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn_re => dataIn_re,  -- sfix16_En14
              dataIn_im => dataIn_im,  -- sfix16_En14
              validIn => validIn,
              dataOut_re => FIROutput1_re,  -- sfix16_En14
              dataOut_im => FIROutput1_im,  -- sfix16_En14
              validOut => FIRValid1
              );
  ...
  dataZero_re <= to_signed(16#0000#, 16);
  dataZero_im <= to_signed(16#0000#, 16);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        FIROutputCastDB1_re <= to_signed(16#0000#, 16);
        FIROutputCastDB1_im <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        IF syncReset = '1' THEN
          FIROutputCastDB1_re <= to_signed(16#0000#, 16);
          FIROutputCastDB1_im <= to_signed(16#0000#, 16);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        FIROutputCastDB2_re <= to_signed(16#0000#, 16);
        FIROutputCastDB2_im <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        IF syncReset = '1' THEN
          FIROutputCastDB2_re <= to_signed(16#0000#, 16);
          FIROutputCastDB2_im <= to_signed(16#0000#, 16);
