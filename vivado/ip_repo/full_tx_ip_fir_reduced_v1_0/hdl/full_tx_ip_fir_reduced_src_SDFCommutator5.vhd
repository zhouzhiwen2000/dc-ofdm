-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_SDFCommutator5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_SDFCommutator5
...
ENTITY full_tx_ip_fir_reduced_src_SDFCommutator5 IS
...
END full_tx_ip_fir_reduced_src_SDFCommutator5;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_SDFCommutator5 IS
...
BEGIN
  u_dataXMEM_re_0_5 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_5 : full_tx_ip_fir_reduced_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
