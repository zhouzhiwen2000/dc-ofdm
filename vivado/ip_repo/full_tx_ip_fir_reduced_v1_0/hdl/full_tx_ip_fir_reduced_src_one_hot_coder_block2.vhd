-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_one_hot_coder_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_one_hot_coder_block2
...
ENTITY full_tx_ip_fir_reduced_src_one_hot_coder_block2 IS
  PORT( channel_valid                     :   IN    std_logic;
        header_valid                      :   IN    std_logic;
        payload_valid                     :   IN    std_logic;
        data_select                       :   OUT   std_logic_vector(1 DOWNTO 0)  -- ufix2
        );
END full_tx_ip_fir_reduced_src_one_hot_coder_block2;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_one_hot_coder_block2 IS
