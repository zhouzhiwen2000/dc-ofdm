-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_fifo_TLAST.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_fifo_TLAST
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi4_stream_slave/full_tx_ip_fir_reduced_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_fifo_TLAST IS
...
END full_tx_ip_fir_reduced_fifo_TLAST;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_fifo_TLAST IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : full_tx_ip_fir_reduced_SimpleDualPortRAM_singlebit
    USE ENTITY work.full_tx_ip_fir_reduced_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_full_tx_ip_fir_reduced_fifo_TLAST_classic_ram_singlebit : full_tx_ip_fir_reduced_SimpleDualPortRAM_singlebit
