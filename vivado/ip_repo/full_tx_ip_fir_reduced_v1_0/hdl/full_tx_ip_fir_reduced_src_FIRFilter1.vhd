-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_FIRFilter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_FIRFilter1
...
ENTITY full_tx_ip_fir_reduced_src_FIRFilter1 IS
...
END full_tx_ip_fir_reduced_src_FIRFilter1;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_FIRFilter1 IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_FirRdyLogic
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_FirRdyLogic
    USE ENTITY work.full_tx_ip_fir_reduced_src_FirRdyLogic(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block1
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block1(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block2
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block2(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd
    USE ENTITY work.full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block3
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block3(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block4
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block4(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block5
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block5(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block6
    USE ENTITY work.full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block6(rtl);

  FOR ALL : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd_block(rtl);
  ...
  SIGNAL delayLineEnd9deadOut             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL sumOut_3_signed                  : signed(31 DOWNTO 0);  -- sfix32_En28
  ...
  SIGNAL delayLineEnd9deadOut_1           : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL sumOut_3_signed_1                : signed(31 DOWNTO 0);  -- sfix32_En28
...
BEGIN
  u_firRdyLogic : full_tx_ip_fir_reduced_src_FirRdyLogic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              rdAddr => rdAddr1,  -- ufix1
              delayLineEnd => delayLineEnd9deadOut,  -- sfix16_En14
              dataOut => delayLineDataOut9  -- sfix16_En14
              );

  u_filterTap0 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap2 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap3 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap4 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_delayLine0_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9_1 : full_tx_ip_fir_reduced_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              validIn => delayLineShiftEn1_1,
              rdAddr => rdAddr1,  -- ufix1
              delayLineEnd => delayLineEnd9deadOut_1,  -- sfix16_En14
              dataOut => delayLineDataOut9_1  -- sfix16_En14
              );

  u_filterTap0_1 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1_1 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap2_1 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap3_1 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap4_1 : full_tx_ip_fir_reduced_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4 <= to_signed(16#285F#, 16);
      WHEN '1' =>
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3 <= to_signed(16#066F#, 16);
      WHEN '1' =>
        coeffTableOut3 <= to_signed(-16#0C7E#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2 <= to_signed(16#01FF#, 16);
      WHEN '1' =>
        coeffTableOut2 <= to_signed(-16#039E#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1 <= to_signed(16#0070#, 16);
      WHEN '1' =>
        coeffTableOut1 <= to_signed(-16#0104#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr0_1 IS
      ...
      WHEN '1' =>
        coeffTableOut0 <= to_signed(-16#0024#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4_1 <= to_signed(16#285F#, 16);
      WHEN '1' =>
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3_1 <= to_signed(16#066F#, 16);
      WHEN '1' =>
        coeffTableOut3_1 <= to_signed(-16#0C7E#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2_1 <= to_signed(16#01FF#, 16);
      WHEN '1' =>
        coeffTableOut2_1 <= to_signed(-16#039E#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1_1 <= to_signed(16#0070#, 16);
      WHEN '1' =>
        coeffTableOut1_1 <= to_signed(-16#0104#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0_1 <= to_signed(-16#0020#, 16);
      WHEN '1' =>
        coeffTableOut0_1 <= to_signed(-16#0024#, 16);
      WHEN OTHERS => 
