-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_addr_decoder_read.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_addr_decoder_read
-- Source Path: full_tx_ip_fir_reduced/full_tx_ip_fir_reduced_axi_lite/full_tx_ip_fir_reduced_addr_decoder/full_tx_ip_fir_reduced_addr_decoder_read
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_fir_reduced_addr_decoder_read IS
...
END full_tx_ip_fir_reduced_addr_decoder_read;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_addr_decoder_read IS
  ...
  COMPONENT full_tx_ip_fir_reduced_addr_decoder_read_registers
    PORT( IPCORE_CLK                      :   IN    std_logic;  -- ufix1
          IPCORE_RESET                    :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : full_tx_ip_fir_reduced_addr_decoder_read_registers
    USE ENTITY work.full_tx_ip_fir_reduced_addr_decoder_read_registers(rtl);
...
BEGIN
  u_full_tx_ip_fir_reduced_rd_enable_sync_inst : full_tx_ip_fir_reduced_pulse_sync
  ...
  u_full_tx_ip_fir_reduced_addr_decoder_read_registers_inst : full_tx_ip_fir_reduced_addr_decoder_read_registers
