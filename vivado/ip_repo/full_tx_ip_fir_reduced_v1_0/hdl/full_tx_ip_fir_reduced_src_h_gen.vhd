-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_h_gen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_h_gen
...
ENTITY full_tx_ip_fir_reduced_src_h_gen IS
...
END full_tx_ip_fir_reduced_src_h_gen;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_h_gen IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_valid_to_ctrl_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_valid_to_ctrl_block
    USE ENTITY work.full_tx_ip_fir_reduced_src_valid_to_ctrl_block(rtl);
...
BEGIN
  u_valid_to_ctrl : full_tx_ip_fir_reduced_src_valid_to_ctrl_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
