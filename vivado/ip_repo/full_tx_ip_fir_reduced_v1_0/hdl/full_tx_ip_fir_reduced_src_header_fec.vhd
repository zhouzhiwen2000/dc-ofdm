-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_header_fec.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_fir_reduced_src_header_fec
...
ENTITY full_tx_ip_fir_reduced_src_header_fec IS
...
END full_tx_ip_fir_reduced_src_header_fec;


ARCHITECTURE rtl OF full_tx_ip_fir_reduced_src_header_fec IS

  -- Component Declarations
  COMPONENT full_tx_ip_fir_reduced_src_Hc_12H_B14
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_fir_reduced_src_Hc_12H_B14
    USE ENTITY work.full_tx_ip_fir_reduced_src_Hc_12H_B14(rtl);
...
BEGIN
  u_Hc_12H_B14 : full_tx_ip_fir_reduced_src_Hc_12H_B14
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              in0 => data_in,
