-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_fir_reduced_src_full_tx_pac.vhd
...
PACKAGE full_tx_ip_fir_reduced_src_full_tx_pac IS
...
END full_tx_ip_fir_reduced_src_full_tx_pac;
