...
ARCHITECTURE rtl OF full_tx_ip_src_frequency_upshift IS
  ...
  SIGNAL delayMatch3_reg                  : std_logic_vector(5 DOWNTO 0);  -- ufix1 [6]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        delayMatch3_reg(5 DOWNTO 1) <= delayMatch3_reg(4 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch3_process;

  stateControl_1 <= delayMatch3_reg(5);
  ...
  stateControl_6 <= delayMatch2_reg(5);
  ...
  stateControl_8 <= delayMatch1_reg(5);
