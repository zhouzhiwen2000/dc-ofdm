-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_clock_crossing.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_clock_crossing
...
ENTITY full_tx_ip_src_clock_crossing IS
...
END full_tx_ip_src_clock_crossing;


ARCHITECTURE rtl OF full_tx_ip_src_clock_crossing IS
  ...
  SIGNAL payload_len_in_unsigned          : unsigned(28 DOWNTO 0);  -- ufix29
  SIGNAL Rate_Transition11_bypass_reg     : unsigned(28 DOWNTO 0);  -- ufix29
  SIGNAL Rate_Transition1_out1            : unsigned(28 DOWNTO 0);  -- ufix29
  ...
  SIGNAL cp_len_in_1                      : std_logic_vector(2 DOWNTO 0);  -- boolean [3]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' AND Deserializer1D1_tapDelayEn_1 = '1' THEN
        Deserializer1D1_tapout <= payload_in_1;
      END IF;
    END IF;
  ...
  Deserializer1D1_muxOut(1) <= payload_in_1;
  ...
  Rate_Transition11_bypass_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Rate_Transition11_bypass_reg <= to_unsigned(16#00000000#, 29);
      ELSIF enb_1_2_1 = '1' THEN
        Rate_Transition11_bypass_reg <= payload_len_in_unsigned;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        cp_len_in_1 <= (OTHERS => '0');
      ELSIF enb_1_8_0 = '1' THEN
        cp_len_in_1 <= cp_len_in;
      END IF;
    END IF;
