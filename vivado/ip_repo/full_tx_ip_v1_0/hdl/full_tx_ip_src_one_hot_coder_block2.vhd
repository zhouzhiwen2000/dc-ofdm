-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_one_hot_coder_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_one_hot_coder_block2
-- Source Path: HDLTx/full_tx/read_frame_from_ram/init_selector/one_hot_coder
-- Hierarchy Level: 3
-- Model version: 4.75
-- 
-- -------------------------------------------------------------
...
ENTITY full_tx_ip_src_one_hot_coder_block2 IS
  PORT( preamble                          :   IN    std_logic;
        channel                           :   IN    std_logic;
        header                            :   IN    std_logic;
        cp_select                         :   OUT   std_logic_vector(1 DOWNTO 0)  -- ufix2
        );
END full_tx_ip_src_one_hot_coder_block2;


ARCHITECTURE rtl OF full_tx_ip_src_one_hot_coder_block2 IS
