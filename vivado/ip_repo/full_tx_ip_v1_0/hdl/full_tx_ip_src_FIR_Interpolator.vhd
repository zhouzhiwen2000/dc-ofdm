-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_FIR_Interpolator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_FIR_Interpolator
...
ENTITY full_tx_ip_src_FIR_Interpolator IS
...
END full_tx_ip_src_FIR_Interpolator;


ARCHITECTURE rtl OF full_tx_ip_src_FIR_Interpolator IS

  -- Component Declarations
  COMPONENT full_tx_ip_src_FIRFilter2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_ip_src_FIRFilter1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : full_tx_ip_src_FIRFilter2
    USE ENTITY work.full_tx_ip_src_FIRFilter2(rtl);

  FOR ALL : full_tx_ip_src_FIRFilter1
    USE ENTITY work.full_tx_ip_src_FIRFilter1(rtl);
  ...
  SIGNAL intdelay_reg_re                  : vector_of_signed16(0 TO 14);  -- sfix16_En14 [15]
  SIGNAL intdelay_reg_im                  : vector_of_signed16(0 TO 14);  -- sfix16_En14 [15]
...
BEGIN
  u_filterInstantiation : full_tx_ip_src_FIRFilter2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterInstantiation_1 : full_tx_ip_src_FIRFilter1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn_re => dataIn_re,  -- sfix16_En14
  ...
  ValidPipeline1 <= intdelay_reg(14);
  ...
  FIROutputCastDBP1_re <= intdelay_reg_re(14);
  FIROutputCastDBP1_im <= intdelay_reg_im(14);
