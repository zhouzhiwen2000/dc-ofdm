-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_addr_decoder_read_registers.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_addr_decoder_read_registers
-- Source Path: full_tx_ip/full_tx_ip_axi_lite/full_tx_ip_addr_decoder/full_tx_ip_addr_decoder_read/full_tx_ip_addr_decoder_read_registers
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY full_tx_ip_addr_decoder_read_registers IS
...
END full_tx_ip_addr_decoder_read_registers;


ARCHITECTURE rtl OF full_tx_ip_addr_decoder_read_registers IS
