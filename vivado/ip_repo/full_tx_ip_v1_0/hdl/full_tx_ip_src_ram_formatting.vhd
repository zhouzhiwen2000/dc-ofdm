...
-- Source Path: HDLTx/full_tx/write_frame_to_ram/ram_formatting
-- Hierarchy Level: 2
-- Model version: 4.75
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF full_tx_ip_src_ram_formatting IS
  ...
  SIGNAL delayMatch_reg                   : vector_of_unsigned12(0 TO 2);  -- ufix12 [3]
  ...
  SIGNAL delayMatch1_reg                  : vector_of_unsigned12(0 TO 2);  -- ufix12 [3]
  ...
  SIGNAL y_4                              : unsigned(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL delayMatch2_reg                  : vector_of_unsigned12(0 TO 2);  -- ufix12 [3]
  SIGNAL y_5                              : unsigned(11 DOWNTO 0);  -- ufix12
  SIGNAL payload_1                        : std_logic;
  SIGNAL y_6                              : unsigned(11 DOWNTO 0);  -- ufix12
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        delayMatch_reg <= (OTHERS => to_unsigned(16#000#, 12));
  ...
  y_2 <= unsigned'(Constant13_out1 & Constant21_out1 & Constant20_out1 & Constant19_out1 & Constant18_out1 & Constant17_out1 & Constant16_out1 & Constant15_out1 & Constant14_out1 & Constant12_out1 & Constant11_out1 & channel);

  delayMatch1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        delayMatch1_reg <= (OTHERS => to_unsigned(16#000#, 12));
      ELSIF enb_1_2_0 = '1' THEN
        delayMatch1_reg(0) <= y_2;
        delayMatch1_reg(1 TO 2) <= delayMatch1_reg(0 TO 1);
      END IF;
    END IF;
  END PROCESS delayMatch1_process;

  y_3 <= delayMatch1_reg(2);
  ...
  y_4 <= unsigned'(Constant24_out1 & Constant32_out1 & Constant31_out1 & Constant30_out1 & Constant29_out1 & Constant28_out1 & Constant27_out1 & Constant26_out1 & Constant25_out1 & Constant23_out1 & header_0 & header_1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        delayMatch2_reg <= (OTHERS => to_unsigned(16#000#, 12));
      ELSIF enb_1_2_0 = '1' THEN
        delayMatch2_reg(0) <= y_4;
        delayMatch2_reg(1 TO 2) <= delayMatch2_reg(0 TO 1);
      END IF;
    END IF;
  END PROCESS delayMatch2_process;

  y_5 <= delayMatch2_reg(2);

  payload_1 <= payload(1);

  y_6 <= unsigned'(Constant64_out1 & Constant72_out1 & Constant71_out1 & Constant70_out1 & Constant69_out1 & Constant68_out1 & Constant67_out1 & Constant66_out1 & Constant65_out1 & Constant56_out1 & payload_0 & payload_1);

  
  Multiport_Switch_out1 <= y_1 WHEN data_select_unsigned = to_unsigned(16#0#, 2) ELSE
      y_3 WHEN data_select_unsigned = to_unsigned(16#1#, 2) ELSE
      y_5 WHEN data_select_unsigned = to_unsigned(16#2#, 2) ELSE
      y_6;
