-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_valid_to_ctrl_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_valid_to_ctrl_block
...
ENTITY full_tx_ip_src_valid_to_ctrl_block IS
...
END full_tx_ip_src_valid_to_ctrl_block;


ARCHITECTURE rtl OF full_tx_ip_src_valid_to_ctrl_block IS

  -- Component Declarations
  COMPONENT full_tx_ip_src_Sample_Control_Bus_Creator_block1
  ...
  FOR ALL : full_tx_ip_src_Sample_Control_Bus_Creator_block1
    USE ENTITY work.full_tx_ip_src_Sample_Control_Bus_Creator_block1(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : full_tx_ip_src_Sample_Control_Bus_Creator_block1
    PORT MAP( In1 => start,
              In2 => end_rsvd,
              In3 => valid,
