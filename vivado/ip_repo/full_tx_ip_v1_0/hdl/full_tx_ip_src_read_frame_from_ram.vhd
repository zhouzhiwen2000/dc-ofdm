-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_read_frame_from_ram.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_read_frame_from_ram
-- Source Path: HDLTx/full_tx/read_frame_from_ram
-- Hierarchy Level: 1
-- Model version: 4.75
-- 
-- -------------------------------------------------------------
...
ENTITY full_tx_ip_src_read_frame_from_ram IS
...
END full_tx_ip_src_read_frame_from_ram;


ARCHITECTURE rtl OF full_tx_ip_src_read_frame_from_ram IS

  -- Component Declarations
  COMPONENT full_tx_ip_src_valid_frame
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_src_bits_selector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_ip_src_init_selector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(15 DOWNTO 0);  -- uint16
  ...
  COMPONENT full_tx_ip_src_cp_len_creator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(15 DOWNTO 0);  -- uint16
  ...
  FOR ALL : full_tx_ip_src_valid_frame
    USE ENTITY work.full_tx_ip_src_valid_frame(rtl);

  FOR ALL : full_tx_ip_src_bits_selector
    USE ENTITY work.full_tx_ip_src_bits_selector(rtl);

  FOR ALL : full_tx_ip_src_init_selector
    USE ENTITY work.full_tx_ip_src_init_selector(rtl);

  FOR ALL : full_tx_ip_src_cp_len_creator
    USE ENTITY work.full_tx_ip_src_cp_len_creator(rtl);

  -- Signals
  SIGNAL enb_1_2_0_gated                  : std_logic;
  SIGNAL ready                            : std_logic;
  SIGNAL ram_size_unsigned                : unsigned(37 DOWNTO 0);  -- ufix38
...
BEGIN
  u_valid_frame : full_tx_ip_src_valid_frame
    PORT MAP( clk => clk,
              reset_x => reset_x,
  ...
  u_bits_selector : full_tx_ip_src_bits_selector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0_gated,
  ...
  u_init_selector : full_tx_ip_src_init_selector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0_gated,
              rd_addr => std_logic_vector(rd_addr_1),  -- uint16
  ...
  u_cp_len_creator : full_tx_ip_src_cp_len_creator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0_gated,
              rd_addr => std_logic_vector(rd_addr_1),  -- uint16
  ...
  enb_1_2_0_gated <= ready AND enb_1_2_0;
  ...
  Relational_Operator1_out1 <= '1' WHEN ram_size_unsigned = resize(rd_addr_tmp, 38) ELSE
      '0';
