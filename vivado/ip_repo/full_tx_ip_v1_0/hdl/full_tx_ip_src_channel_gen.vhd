-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_ip_src_channel_gen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_ip_src_channel_gen
...
ENTITY full_tx_ip_src_channel_gen IS
...
END full_tx_ip_src_channel_gen;


ARCHITECTURE rtl OF full_tx_ip_src_channel_gen IS

  -- Component Declarations
  COMPONENT full_tx_ip_src_valid_to_ctrl
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_tx_ip_src_valid_to_ctrl
    USE ENTITY work.full_tx_ip_src_valid_to_ctrl(rtl);
...
BEGIN
  u_valid_to_ctrl : full_tx_ip_src_valid_to_ctrl
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  need_to_wrap <= '1' WHEN HDL_Counter_out1 = to_unsigned(16#1E9#, 9) ELSE
      '0';
