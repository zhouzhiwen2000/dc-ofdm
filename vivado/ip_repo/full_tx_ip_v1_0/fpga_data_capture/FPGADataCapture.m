...
% 
%  Step method syntax
% [Capture_Window,Trigger_Position,data_out,valid_out]=step(dco) connects to the FPGA, and read data from the FPGA.
% 
...
methods
    function obj = FPGADataCapture
        ...
        obj.setDataType('data_out',numerictype(1,16,14));
        obj.setDataType('valid_out','boolean');
...
properties (Nontunable, Constant)
    ...
    SamplesPerFrame = 128
    BitWidth = [32   1  16   1]
    SignalNames = {'Capture_Window','Trigger_Position','data_out','valid_out'}
    ...
    Version = '1.2'
    % Timestamp
    TimeStamp = '30-Jun-2024 19:39:22'
end
