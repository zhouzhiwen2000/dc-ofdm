-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLDecimator/decimator_ip_src_FilterCoef.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: decimator_ip_src_FilterCoef
-- Source Path: HDLDecimator/decimator/FIR Decimator/FilterBank/FilterCoef
-- Hierarchy Level: 3
-- Model version: 1.40
-- 
-- -------------------------------------------------------------
...
ENTITY decimator_ip_src_FilterCoef IS
...
END decimator_ip_src_FilterCoef;


ARCHITECTURE rtl OF decimator_ip_src_FilterCoef IS

  -- Constants
  CONSTANT Coef_table_table_data          : vector_of_signed12(0 TO 1) := 
    (to_signed(16#010#, 12), to_signed(16#00C#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_2        : vector_of_signed12(0 TO 1) := 
    (to_signed(-16#020#, 12), to_signed(-16#010#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_4        : vector_of_signed12(0 TO 1) := 
    (to_signed(16#040#, 12), to_signed(16#019#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_6        : vector_of_signed12(0 TO 1) := 
    (to_signed(-16#073#, 12), to_signed(-16#022#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_8        : vector_of_signed12(0 TO 1) := 
    (to_signed(16#0CE#, 12), to_signed(16#02B#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_10       : vector_of_signed12(0 TO 1) := 
    (to_signed(-16#18F#, 12), to_signed(-16#032#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_12       : vector_of_signed12(0 TO 1) := 
    (to_signed(16#50C#, 12), to_signed(16#037#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_14       : vector_of_signed12(0 TO 1) := 
    (to_signed(16#50C#, 12), to_signed(16#7C7#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_16       : vector_of_signed12(0 TO 1) := 
    (to_signed(-16#18F#, 12), to_signed(16#037#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_18       : vector_of_signed12(0 TO 1) := 
    (to_signed(16#0CE#, 12), to_signed(-16#032#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_20       : vector_of_signed12(0 TO 1) := 
    (to_signed(-16#073#, 12), to_signed(16#02B#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_22       : vector_of_signed12(0 TO 1) := 
    (to_signed(16#040#, 12), to_signed(-16#022#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_24       : vector_of_signed12(0 TO 1) := 
    (to_signed(-16#020#, 12), to_signed(16#019#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_26       : vector_of_signed12(0 TO 1) := 
    (to_signed(16#010#, 12), to_signed(-16#010#, 12));  -- sfix12 [2]
  CONSTANT Coef_table_table_data_28       : vector_of_signed12(0 TO 1) := 
    (to_signed(16#000#, 12), to_signed(16#00C#, 12));  -- sfix12 [2]
  ...
  SIGNAL CoefData                         : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg                          : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_1                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_1                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_1                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_2                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_2                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_2                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_3                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_3                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_3                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_4                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_4                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_4                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_5                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_5                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_5                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_6                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_6                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_6                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_7                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_7                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_7                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_8                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_8                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_8                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_9                : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_9                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_9                        : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_10               : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_10                      : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_10                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_11               : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_11                      : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_11                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_12               : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_12                      : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_12                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_13               : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_13                      : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_13                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL Coef_table_cast_14               : signed(31 DOWNTO 0);  -- int32
  SIGNAL CoefData_14                      : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefReg_14                       : signed(11 DOWNTO 0);  -- sfix12_En12
  SIGNAL CoefOut_tmp                      : vector_of_signed12(0 TO 14);  -- sfix12_En12 [15]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        CoefReg_10 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        CoefReg_11 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        CoefReg_12 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        CoefReg_13 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        CoefReg_14 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  outputgen: FOR k IN 0 TO 14 GENERATE
