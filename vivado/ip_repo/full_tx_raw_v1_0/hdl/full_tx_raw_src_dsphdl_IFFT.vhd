-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_dsphdl_IFFT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_dsphdl_IFFT
...
ENTITY full_tx_raw_src_dsphdl_IFFT IS
...
END full_tx_raw_src_dsphdl_IFFT;


ARCHITECTURE rtl OF full_tx_raw_src_dsphdl_IFFT IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_RADIX22FFT_CTRL1_1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_SDF1_1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_CTRL1_2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_SDF2_2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_TWDLROM_3_1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_CTRL1_3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_SDF1_3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_CTRL1_4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_SDF2_4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_TWDLROM_5_1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_CTRL1_5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_SDF1_5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_CTRL1_6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_SDF2_6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_TWDLROM_7_1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_CTRL1_7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_SDF1_7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_CTRL1_8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX22FFT_SDF2_8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_tx_raw_src_RADIX22FFT_CTRL1_1
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_CTRL1_1(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_SDF1_1
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_SDF1_1(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_CTRL1_2
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_CTRL1_2(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_SDF2_2
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_SDF2_2(rtl);

  FOR ALL : full_tx_raw_src_TWDLROM_3_1
    USE ENTITY work.full_tx_raw_src_TWDLROM_3_1(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_CTRL1_3
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_CTRL1_3(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_SDF1_3
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_SDF1_3(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_CTRL1_4
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_CTRL1_4(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_SDF2_4
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_SDF2_4(rtl);

  FOR ALL : full_tx_raw_src_TWDLROM_5_1
    USE ENTITY work.full_tx_raw_src_TWDLROM_5_1(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_CTRL1_5
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_CTRL1_5(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_SDF1_5
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_SDF1_5(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_CTRL1_6
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_CTRL1_6(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_SDF2_6
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_SDF2_6(rtl);

  FOR ALL : full_tx_raw_src_TWDLROM_7_1
    USE ENTITY work.full_tx_raw_src_TWDLROM_7_1(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_CTRL1_7
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_CTRL1_7(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_SDF1_7
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_SDF1_7(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_CTRL1_8
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_CTRL1_8(rtl);

  FOR ALL : full_tx_raw_src_RADIX22FFT_SDF2_8
    USE ENTITY work.full_tx_raw_src_RADIX22FFT_SDF2_8(rtl);

  FOR ALL : full_tx_raw_src_RADIX2FFT_bitNatural
    USE ENTITY work.full_tx_raw_src_RADIX2FFT_bitNatural(rtl);
...
BEGIN
  u_CTRL1_1_1 : full_tx_raw_src_RADIX22FFT_CTRL1_1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SDF1_1_1 : full_tx_raw_src_RADIX22FFT_SDF1_1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_CTRL2_2_1 : full_tx_raw_src_RADIX22FFT_CTRL1_2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : full_tx_raw_src_RADIX22FFT_SDF2_2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_1_1_re => dout_1_1_re,  -- sfix16_En14
  ...
  u_twdlROM_3_1 : full_tx_raw_src_TWDLROM_3_1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_2_1_vld => dout_2_1_vld,
  ...
  u_CTRL1_3_1 : full_tx_raw_src_RADIX22FFT_CTRL1_3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SDF1_3_1 : full_tx_raw_src_RADIX22FFT_SDF1_3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_CTRL2_4_1 : full_tx_raw_src_RADIX22FFT_CTRL1_4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : full_tx_raw_src_RADIX22FFT_SDF2_4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_3_1_re => dout_3_1_re,  -- sfix16_En14
  ...
  u_twdlROM_5_1 : full_tx_raw_src_TWDLROM_5_1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_4_1_vld => dout_4_1_vld,
  ...
  u_CTRL1_5_1 : full_tx_raw_src_RADIX22FFT_CTRL1_5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SDF1_5_1 : full_tx_raw_src_RADIX22FFT_SDF1_5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_CTRL2_6_1 : full_tx_raw_src_RADIX22FFT_CTRL1_6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : full_tx_raw_src_RADIX22FFT_SDF2_6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_5_1_re => dout_5_1_re,  -- sfix16_En14
  ...
  u_twdlROM_7_1 : full_tx_raw_src_TWDLROM_7_1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_6_1_vld => dout_6_1_vld,
  ...
  u_CTRL1_7_1 : full_tx_raw_src_RADIX22FFT_CTRL1_7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SDF1_7_1 : full_tx_raw_src_RADIX22FFT_SDF1_7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_CTRL2_8_1 : full_tx_raw_src_RADIX22FFT_CTRL1_8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_7_1_vld => dout_7_1_vld,
  ...
  u_SDF2_8_1 : full_tx_raw_src_RADIX22FFT_SDF2_8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_7_1_re => dout_7_1_re,  -- sfix16_En14
  ...
  u_NaturalOrder_Stage : full_tx_raw_src_RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dout_8_1_re => dout_8_1_re,  -- sfix16_En14
