-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_Final_Output_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_Final_Output_block
...
ENTITY full_tx_raw_src_Final_Output_block IS
...
END full_tx_raw_src_Final_Output_block;


ARCHITECTURE rtl OF full_tx_raw_src_Final_Output_block IS
...
BEGIN
  u_Parity_RAM_singlebit_bank79 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
  ...
  u_Parity_RAM_singlebit_bank78 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank77 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank76 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank75 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank74 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank73 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank72 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank71 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank70 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank69 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank68 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank67 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank66 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank65 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank64 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank63 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank62 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank61 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank60 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank59 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank58 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank57 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank56 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank55 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank54 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank53 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank52 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank51 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank50 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank49 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank48 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank47 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank46 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank45 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank44 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank43 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank42 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank41 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank40 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank39 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank38 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank37 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank36 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank35 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank34 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank33 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank32 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank31 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank30 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank29 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank28 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank27 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank26 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank25 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank24 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank23 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank22 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank21 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank20 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank19 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank18 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank17 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank16 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank15 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank14 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank13 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank12 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank11 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank10 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank9 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank8 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank7 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank6 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank5 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank4 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank3 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank2 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank1 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Parity_RAM_singlebit_bank0 : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
