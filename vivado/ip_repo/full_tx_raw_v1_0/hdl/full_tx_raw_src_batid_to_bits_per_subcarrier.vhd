-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_batid_to_bits_per_subcarrier.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_batid_to_bits_per_subcarrier
...
ENTITY full_tx_raw_src_batid_to_bits_per_subcarrier IS
  PORT( bat_id                            :   IN    std_logic_vector(4 DOWNTO 0);  -- boolean [5]
        bits_per_subcarrier               :   OUT   std_logic_vector(3 DOWNTO 0)  -- ufix4
        );
END full_tx_raw_src_batid_to_bits_per_subcarrier;


ARCHITECTURE rtl OF full_tx_raw_src_batid_to_bits_per_subcarrier IS
