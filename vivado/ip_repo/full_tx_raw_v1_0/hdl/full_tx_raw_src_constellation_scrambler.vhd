-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_constellation_scrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_constellation_scrambler
...
ENTITY full_tx_raw_src_constellation_scrambler IS
...
END full_tx_raw_src_constellation_scrambler;


ARCHITECTURE rtl OF full_tx_raw_src_constellation_scrambler IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_rotate
  ...
  FOR ALL : full_tx_raw_src_rotate
    USE ENTITY work.full_tx_raw_src_rotate(rtl);
...
BEGIN
  u_rotate : full_tx_raw_src_rotate
    PORT MAP( s2 => s2,
              s1 => s1,
