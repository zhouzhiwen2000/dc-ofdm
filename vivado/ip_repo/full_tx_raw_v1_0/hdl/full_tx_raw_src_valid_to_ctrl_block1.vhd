-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_valid_to_ctrl_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_valid_to_ctrl_block1
...
ENTITY full_tx_raw_src_valid_to_ctrl_block1 IS
...
END full_tx_raw_src_valid_to_ctrl_block1;


ARCHITECTURE rtl OF full_tx_raw_src_valid_to_ctrl_block1 IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_Sample_Control_Bus_Creator_block5
  ...
  FOR ALL : full_tx_raw_src_Sample_Control_Bus_Creator_block5
    USE ENTITY work.full_tx_raw_src_Sample_Control_Bus_Creator_block5(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : full_tx_raw_src_Sample_Control_Bus_Creator_block5
    PORT MAP( In1 => start,
              In2 => end_rsvd,
              In3 => valid,
