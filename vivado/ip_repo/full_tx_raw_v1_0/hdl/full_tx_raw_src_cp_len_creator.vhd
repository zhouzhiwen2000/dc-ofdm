-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_cp_len_creator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_cp_len_creator
...
ENTITY full_tx_raw_src_cp_len_creator IS
...
END full_tx_raw_src_cp_len_creator;


ARCHITECTURE rtl OF full_tx_raw_src_cp_len_creator IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_Compare_To_Constant_block1
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- uint16
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT full_tx_raw_src_Compare_To_Constant1_block
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- uint16
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT full_tx_raw_src_Compare_To_Constant2_block
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- uint16
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT full_tx_raw_src_one_hot_coder_block
  ...
  FOR ALL : full_tx_raw_src_Compare_To_Constant_block1
    USE ENTITY work.full_tx_raw_src_Compare_To_Constant_block1(rtl);

  FOR ALL : full_tx_raw_src_Compare_To_Constant1_block
    USE ENTITY work.full_tx_raw_src_Compare_To_Constant1_block(rtl);

  FOR ALL : full_tx_raw_src_Compare_To_Constant2_block
    USE ENTITY work.full_tx_raw_src_Compare_To_Constant2_block(rtl);

  FOR ALL : full_tx_raw_src_one_hot_coder_block
    USE ENTITY work.full_tx_raw_src_one_hot_coder_block(rtl);
...
BEGIN
  u_Compare_To_Constant : full_tx_raw_src_Compare_To_Constant_block1
    PORT MAP( u => rd_addr,  -- uint16
              y => Compare_To_Constant_out1
              );

  u_Compare_To_Constant1 : full_tx_raw_src_Compare_To_Constant1_block
    PORT MAP( u => rd_addr,  -- uint16
              y => Compare_To_Constant1_out1
              );

  u_Compare_To_Constant2 : full_tx_raw_src_Compare_To_Constant2_block
    PORT MAP( u => rd_addr,  -- uint16
              y => Compare_To_Constant2_out1
              );

  u_one_hot_coder : full_tx_raw_src_one_hot_coder_block
