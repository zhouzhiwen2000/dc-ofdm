-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_ofdm_modulator_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_ofdm_modulator_block
...
ENTITY full_tx_raw_src_ofdm_modulator_block IS
...
END full_tx_raw_src_ofdm_modulator_block;


ARCHITECTURE rtl OF full_tx_raw_src_ofdm_modulator_block IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_OFDM_Modulator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : full_tx_raw_src_OFDM_Modulator
    USE ENTITY work.full_tx_raw_src_OFDM_Modulator(rtl);
...
BEGIN
  u_OFDM_Modulator : full_tx_raw_src_OFDM_Modulator
    PORT MAP( clk => clk,
              reset_x => reset_x,
