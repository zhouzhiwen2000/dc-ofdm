-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_one_hot_coder_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_one_hot_coder_block
...
ENTITY full_tx_raw_src_one_hot_coder_block IS
  PORT( preamble                          :   IN    std_logic;
        channel                           :   IN    std_logic;
        header                            :   IN    std_logic;
        cp_select                         :   OUT   std_logic_vector(1 DOWNTO 0)  -- ufix2
        );
END full_tx_raw_src_one_hot_coder_block;


ARCHITECTURE rtl OF full_tx_raw_src_one_hot_coder_block IS
