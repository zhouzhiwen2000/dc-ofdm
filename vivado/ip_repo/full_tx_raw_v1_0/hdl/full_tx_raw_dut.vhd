-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_dut
-- Source Path: full_tx_raw/full_tx_raw_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF full_tx_raw_dut IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_full_tx
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_raw_src_full_tx
    USE ENTITY work.full_tx_raw_src_full_tx(rtl);
...
BEGIN
  u_full_tx_raw_src_full_tx : full_tx_raw_src_full_tx
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
