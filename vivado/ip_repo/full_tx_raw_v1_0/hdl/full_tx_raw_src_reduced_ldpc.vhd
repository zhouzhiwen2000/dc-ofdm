-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_reduced_ldpc.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_reduced_ldpc
...
ENTITY full_tx_raw_src_reduced_ldpc IS
...
END full_tx_raw_src_reduced_ldpc;


ARCHITECTURE rtl OF full_tx_raw_src_reduced_ldpc IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_Hc_12S_B80
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_raw_src_Hc_12S_B80
    USE ENTITY work.full_tx_raw_src_Hc_12S_B80(rtl);
...
BEGIN
  u_Hc_12S_B80 : full_tx_raw_src_Hc_12S_B80
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              in0 => data_in,
