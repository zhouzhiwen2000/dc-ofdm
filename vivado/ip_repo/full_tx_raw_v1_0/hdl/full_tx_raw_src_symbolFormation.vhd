-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_symbolFormation.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_symbolFormation
-- Source Path: 
-- Hierarchy Level: 4
-- Model version: 4.99
-- 
...
ENTITY full_tx_raw_src_symbolFormation IS
...
END full_tx_raw_src_symbolFormation;


ARCHITECTURE rtl OF full_tx_raw_src_symbolFormation IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_SimpleDualPortRAM_generic_block
  ...
  FOR ALL : full_tx_raw_src_SimpleDualPortRAM_generic_block
    USE ENTITY work.full_tx_raw_src_SimpleDualPortRAM_generic_block(rtl);
...
BEGIN
  u_simpleDualPortRam : full_tx_raw_src_SimpleDualPortRAM_generic_block
  ...
  u_simpleDualPortRam_generic : full_tx_raw_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
