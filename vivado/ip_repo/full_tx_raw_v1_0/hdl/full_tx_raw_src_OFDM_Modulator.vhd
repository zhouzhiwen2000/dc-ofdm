-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_OFDM_Modulator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_OFDM_Modulator
...
ENTITY full_tx_raw_src_OFDM_Modulator IS
...
END full_tx_raw_src_OFDM_Modulator;


ARCHITECTURE rtl OF full_tx_raw_src_OFDM_Modulator IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_symbolFormation
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_samplesRepetitionMod
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_dsphdl_IFFT
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_DownSamplerMod
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_HDLFFTShiftMod
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_CPAddition
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : full_tx_raw_src_symbolFormation
    USE ENTITY work.full_tx_raw_src_symbolFormation(rtl);

  FOR ALL : full_tx_raw_src_samplesRepetitionMod
    USE ENTITY work.full_tx_raw_src_samplesRepetitionMod(rtl);

  FOR ALL : full_tx_raw_src_dsphdl_IFFT
    USE ENTITY work.full_tx_raw_src_dsphdl_IFFT(rtl);

  FOR ALL : full_tx_raw_src_DownSamplerMod
    USE ENTITY work.full_tx_raw_src_DownSamplerMod(rtl);

  FOR ALL : full_tx_raw_src_HDLFFTShiftMod
    USE ENTITY work.full_tx_raw_src_HDLFFTShiftMod(rtl);

  FOR ALL : full_tx_raw_src_CPAddition
    USE ENTITY work.full_tx_raw_src_CPAddition(rtl);
...
BEGIN
  u_symbolFormation : full_tx_raw_src_symbolFormation
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_samplesRepetitionMod : full_tx_raw_src_samplesRepetitionMod
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dsphdl_IFFT : full_tx_raw_src_dsphdl_IFFT
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_DownSamplerMod : full_tx_raw_src_DownSamplerMod
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_HDLFFTShiftMod : full_tx_raw_src_HDLFFTShiftMod
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_CPAddition : full_tx_raw_src_CPAddition
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  p51_output : PROCESS (obj_FFTReg, obj_fftInFFTDelayBal, sel_2_1, tmp_52)
  BEGIN
    s_5 <= obj_FFTReg;
    IF sel_2_1 = '1' THEN 
  ...
  p55_output : PROCESS (obj_cpInFFTDelayBal, obj_cpReg, sel_2_3, tmp_61)
  BEGIN
    s_7 <= obj_cpReg;
    IF sel_2_3 = '1' THEN 
