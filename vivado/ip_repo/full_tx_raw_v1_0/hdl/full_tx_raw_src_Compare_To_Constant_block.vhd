-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_Compare_To_Constant_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_Compare_To_Constant_block
...
ENTITY full_tx_raw_src_Compare_To_Constant_block IS
  PORT( u                                 :   IN    std_logic_vector(15 DOWNTO 0);  -- uint16
        y                                 :   OUT   std_logic
        );
END full_tx_raw_src_Compare_To_Constant_block;


ARCHITECTURE rtl OF full_tx_raw_src_Compare_To_Constant_block IS
