-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_General_CRC_Generator_HDL_Optimized.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_General_CRC_Generator_HDL_Optimized
...
ENTITY full_tx_raw_src_General_CRC_Generator_HDL_Optimized IS
...
END full_tx_raw_src_General_CRC_Generator_HDL_Optimized;


ARCHITECTURE rtl OF full_tx_raw_src_General_CRC_Generator_HDL_Optimized IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_CRCGenControl
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          startIn                         :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_CRCGenCompute
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_raw_src_CRCGenControl
    USE ENTITY work.full_tx_raw_src_CRCGenControl(rtl);

  FOR ALL : full_tx_raw_src_CRCGenCompute
    USE ENTITY work.full_tx_raw_src_CRCGenCompute(rtl);
...
BEGIN
  u_Controlsignal_inst : full_tx_raw_src_CRCGenControl
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              startIn => startIn_vld,
  ...
  u_ComputeCRC_inst : full_tx_raw_src_CRCGenCompute
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              datainReg => datainReg,
