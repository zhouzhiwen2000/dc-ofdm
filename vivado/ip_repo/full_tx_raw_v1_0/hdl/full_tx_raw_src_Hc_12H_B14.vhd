-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_Hc_12H_B14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_Hc_12H_B14
...
ENTITY full_tx_raw_src_Hc_12H_B14 IS
...
END full_tx_raw_src_Hc_12H_B14;


ARCHITECTURE rtl OF full_tx_raw_src_Hc_12H_B14 IS
  ...
  COMPONENT full_tx_raw_src_Calculate_Alpha
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_Calculate_Parity
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT full_tx_raw_src_Final_Output
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : full_tx_raw_src_Calculate_Alpha
    USE ENTITY work.full_tx_raw_src_Calculate_Alpha(rtl);

  FOR ALL : full_tx_raw_src_Calculate_Parity
    USE ENTITY work.full_tx_raw_src_Calculate_Parity(rtl);

  FOR ALL : full_tx_raw_src_Final_Output
    USE ENTITY work.full_tx_raw_src_Final_Output(rtl);
...
BEGIN
  ...
  u_Input_RAM_singlebit : full_tx_raw_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Calculate_Alpha : full_tx_raw_src_Calculate_Alpha
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Calculate_Parity : full_tx_raw_src_Calculate_Parity
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
  ...
  u_Final_output : full_tx_raw_src_Final_Output
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
