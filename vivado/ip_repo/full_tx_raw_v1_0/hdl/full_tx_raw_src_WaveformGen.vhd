-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_WaveformGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_WaveformGen
...
ENTITY full_tx_raw_src_WaveformGen IS
...
END full_tx_raw_src_WaveformGen;


ARCHITECTURE rtl OF full_tx_raw_src_WaveformGen IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_CosLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_SinLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          lutaddr                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : full_tx_raw_src_CosLookUpTableGen
    USE ENTITY work.full_tx_raw_src_CosLookUpTableGen(rtl);

  FOR ALL : full_tx_raw_src_SinLookUpTableGen
    USE ENTITY work.full_tx_raw_src_SinLookUpTableGen(rtl);
...
BEGIN
  u_Cos_Wave_inst : full_tx_raw_src_CosLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Sin_Wave_inst : full_tx_raw_src_SinLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lutaddr => lutaddrO,  -- ufix1
