-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_FIRFilter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_FIRFilter1
...
ENTITY full_tx_raw_src_FIRFilter1 IS
...
END full_tx_raw_src_FIRFilter1;


ARCHITECTURE rtl OF full_tx_raw_src_FIRFilter1 IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_FirRdyLogic
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_Addressable_Delay_Line
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_Addressable_Delay_Line_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_Addressable_Delay_Line_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_Addressable_Delay_Line_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_FilterTapSystolicPreAdd
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_tx_raw_src_Addressable_Delay_Line_block3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_Addressable_Delay_Line_block4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_Addressable_Delay_Line_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_Addressable_Delay_Line_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT full_tx_raw_src_FilterTapSystolicPreAdd_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_tx_raw_src_FirRdyLogic
    USE ENTITY work.full_tx_raw_src_FirRdyLogic(rtl);

  FOR ALL : full_tx_raw_src_Addressable_Delay_Line
    USE ENTITY work.full_tx_raw_src_Addressable_Delay_Line(rtl);

  FOR ALL : full_tx_raw_src_Addressable_Delay_Line_block
    USE ENTITY work.full_tx_raw_src_Addressable_Delay_Line_block(rtl);

  FOR ALL : full_tx_raw_src_Addressable_Delay_Line_block1
    USE ENTITY work.full_tx_raw_src_Addressable_Delay_Line_block1(rtl);

  FOR ALL : full_tx_raw_src_Addressable_Delay_Line_block2
    USE ENTITY work.full_tx_raw_src_Addressable_Delay_Line_block2(rtl);

  FOR ALL : full_tx_raw_src_FilterTapSystolicPreAdd
    USE ENTITY work.full_tx_raw_src_FilterTapSystolicPreAdd(rtl);

  FOR ALL : full_tx_raw_src_Addressable_Delay_Line_block3
    USE ENTITY work.full_tx_raw_src_Addressable_Delay_Line_block3(rtl);

  FOR ALL : full_tx_raw_src_Addressable_Delay_Line_block4
    USE ENTITY work.full_tx_raw_src_Addressable_Delay_Line_block4(rtl);

  FOR ALL : full_tx_raw_src_Addressable_Delay_Line_block5
    USE ENTITY work.full_tx_raw_src_Addressable_Delay_Line_block5(rtl);

  FOR ALL : full_tx_raw_src_Addressable_Delay_Line_block6
    USE ENTITY work.full_tx_raw_src_Addressable_Delay_Line_block6(rtl);

  FOR ALL : full_tx_raw_src_FilterTapSystolicPreAdd_block
    USE ENTITY work.full_tx_raw_src_FilterTapSystolicPreAdd_block(rtl);
...
BEGIN
  u_firRdyLogic : full_tx_raw_src_FirRdyLogic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : full_tx_raw_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1 : full_tx_raw_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : full_tx_raw_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : full_tx_raw_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4 : full_tx_raw_src_Addressable_Delay_Line_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5 : full_tx_raw_src_Addressable_Delay_Line_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6 : full_tx_raw_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7 : full_tx_raw_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8 : full_tx_raw_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9 : full_tx_raw_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterTap0 : full_tx_raw_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1 : full_tx_raw_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap2 : full_tx_raw_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap3 : full_tx_raw_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap4 : full_tx_raw_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_delayLine0_1 : full_tx_raw_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : full_tx_raw_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : full_tx_raw_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : full_tx_raw_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4_1 : full_tx_raw_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5_1 : full_tx_raw_src_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6_1 : full_tx_raw_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7_1 : full_tx_raw_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8_1 : full_tx_raw_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9_1 : full_tx_raw_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterTap0_1 : full_tx_raw_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1_1 : full_tx_raw_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap2_1 : full_tx_raw_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap3_1 : full_tx_raw_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap4_1 : full_tx_raw_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
