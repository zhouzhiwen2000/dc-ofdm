-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_one_hot_coder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_one_hot_coder
...
ENTITY full_tx_raw_src_one_hot_coder IS
  PORT( preamble                          :   IN    std_logic;
        channel                           :   IN    std_logic;
        header                            :   IN    std_logic;
        bits_per_subcarrier_select        :   OUT   std_logic_vector(1 DOWNTO 0)  -- ufix2
        );
END full_tx_raw_src_one_hot_coder;


ARCHITECTURE rtl OF full_tx_raw_src_one_hot_coder IS
