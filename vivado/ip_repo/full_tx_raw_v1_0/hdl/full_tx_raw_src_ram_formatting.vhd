-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/full_tx_raw_src_ram_formatting.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_tx_raw_src_ram_formatting
...
ENTITY full_tx_raw_src_ram_formatting IS
...
END full_tx_raw_src_ram_formatting;


ARCHITECTURE rtl OF full_tx_raw_src_ram_formatting IS

  -- Component Declarations
  COMPONENT full_tx_raw_src_one_hot_coder_block2
    PORT( channel_valid                   :   IN    std_logic;
          header_valid                    :   IN    std_logic;
          payload_valid                   :   IN    std_logic;
  ...
  FOR ALL : full_tx_raw_src_one_hot_coder_block2
    USE ENTITY work.full_tx_raw_src_one_hot_coder_block2(rtl);
...
BEGIN
  u_one_hot_coder : full_tx_raw_src_one_hot_coder_block2
