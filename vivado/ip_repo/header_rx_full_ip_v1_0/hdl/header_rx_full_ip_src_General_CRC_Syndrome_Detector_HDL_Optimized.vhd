-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized
-- Source Path: HDLRxHeader/h_rx_full/h_crc_rx/General CRC Syndrome Detector HDL Optimized
-- Hierarchy Level: 2
-- Model version: 1.36
-- 
...
ENTITY header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized IS
...
END header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized;


ARCHITECTURE rtl OF header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_src_CRCGenerator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic;
  ...
  COMPONENT header_rx_full_ip_src_CRCCompare
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : header_rx_full_ip_src_CRCGenerator
    USE ENTITY work.header_rx_full_ip_src_CRCGenerator(rtl);

  FOR ALL : header_rx_full_ip_src_CRCCompare
    USE ENTITY work.header_rx_full_ip_src_CRCCompare(rtl);
...
BEGIN
  -- HDL CRC Generator
  u_HDLCRCGen_inst : header_rx_full_ip_src_CRCGenerator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  -- Checksum Comparison
  u_ChecksumCompare_inst : header_rx_full_ip_src_CRCCompare
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
