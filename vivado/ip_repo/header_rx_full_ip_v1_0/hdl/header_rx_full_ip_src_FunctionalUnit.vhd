-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip_src_FunctionalUnit.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip_src_FunctionalUnit
-- Source Path: HDLRxHeader/h_rx_full/LDPC_Deco_Hc_12H/DecoderCore/FunctionalUnit
-- Hierarchy Level: 3
-- Model version: 1.36
-- 
-- Functional_Unit
...
ENTITY header_rx_full_ip_src_FunctionalUnit IS
...
END header_rx_full_ip_src_FunctionalUnit;


ARCHITECTURE rtl OF header_rx_full_ip_src_FunctionalUnit IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_src_BetaDecompress_1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          betacomp1                       :   IN    vector_of_std_logic_vector7(0 TO 13);  -- ufix7 [14]
  ...
  COMPONENT header_rx_full_ip_src_VariableNodeUnit
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data                            :   IN    vector_of_std_logic_vector6(0 TO 13);  -- sfix6 [14]
  ...
  COMPONENT header_rx_full_ip_src_CheckNodeUnit
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT header_rx_full_ip_src_BetaDecompress_2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          betacomp1                       :   IN    vector_of_std_logic_vector7(0 TO 13);  -- ufix7 [14]
  ...
  COMPONENT header_rx_full_ip_src_AposterioriUnit
  ...
  FOR ALL : header_rx_full_ip_src_BetaDecompress_1
    USE ENTITY work.header_rx_full_ip_src_BetaDecompress_1(rtl);

  FOR ALL : header_rx_full_ip_src_VariableNodeUnit
    USE ENTITY work.header_rx_full_ip_src_VariableNodeUnit(rtl);

  FOR ALL : header_rx_full_ip_src_CheckNodeUnit
    USE ENTITY work.header_rx_full_ip_src_CheckNodeUnit(rtl);
  ...
  FOR ALL : header_rx_full_ip_src_BetaDecompress_2
    USE ENTITY work.header_rx_full_ip_src_BetaDecompress_2(rtl);

  FOR ALL : header_rx_full_ip_src_AposterioriUnit
    USE ENTITY work.header_rx_full_ip_src_AposterioriUnit(rtl);

  -- Signals
  SIGNAL beta                             : vector_of_std_logic_vector4(0 TO 13);  -- ufix4 [14]
  SIGNAL betaValid_1                      : std_logic;  -- ufix1
  SIGNAL alpha                            : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  SIGNAL alphaValid                       : std_logic;  -- ufix1
  SIGNAL alpha_signed                     : vector_of_signed6(0 TO 13);  -- sfix6 [14]
  SIGNAL alphaDTC                         : vector_of_signed4(0 TO 13);  -- sfix4 [14]
  SIGNAL alphaDTC_1                       : vector_of_std_logic_vector4(0 TO 13);  -- ufix4 [14]
  ...
  SIGNAL cnuDecomp3                       : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  ...
  SIGNAL alphaD                           : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  SIGNAL beta_1                           : vector_of_std_logic_vector4(0 TO 13);  -- ufix4 [14]
  SIGNAL rdValidReg                       : std_logic;  -- ufix1
  SIGNAL gamma_tmp                        : vector_of_std_logic_vector6(0 TO 13);  -- ufix6 [14]
  SIGNAL valid_2                          : std_logic;  -- ufix1

BEGIN
  u_Beta_Decompress_Unit_1 : header_rx_full_ip_src_BetaDecompress_1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              betacomp1 => betaComp1,  -- ufix7 [14]
              betacomp2 => betaComp2,  -- ufix4 [14]
              betacomp3 => betaComp3,  -- ufix6 [14]
  ...
  u_Variable_Node_Unit : header_rx_full_ip_src_VariableNodeUnit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => data,  -- sfix6 [14]
              ...
              reset => reset,  -- ufix1
              alpha => alpha,  -- sfix6 [14]
              valid_1 => alphaValid  -- ufix1
              );

  u_Check_Node_Unit : header_rx_full_ip_src_CheckNodeUnit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => alphaDTC_1,  -- sfix4 [14]
              valid => alphaValid,  -- ufix1
              count => count,  -- ufix3
              reset => reset,  -- ufix1
              cnuDecomp1 => cnuDecomp1,  -- ufix7 [14]
              cnuDecomp2 => cnuDecomp2,  -- ufix4 [14]
              cnuDecomp3 => cnuDecomp3,  -- ufix6 [14]
              cnuvalid => cnuValid_1  -- ufix1
              );

  u_alphaDelay_generic_bank0 : header_rx_full_ip_src_SimpleDualPortRAM_generic
  ...
  u_alphaDelay_generic_bank1 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank2 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank3 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank4 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank5 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank6 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank7 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank8 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank9 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank10 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank11 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank12 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_alphaDelay_generic_bank13 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Beta_Decompress_Unit_2 : header_rx_full_ip_src_BetaDecompress_2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              betacomp1 => cnuDecomp1,  -- ufix7 [14]
              betacomp2 => cnuDecomp2,  -- ufix4 [14]
              betacomp3 => cnuDecomp3,  -- ufix6 [14]
              validin => cnuValid_1,  -- ufix1
              count => count,  -- ufix3
              reset => reset,  -- ufix1
              beta => beta_1  -- sfix4 [14]
              );

  u_Aposteriori_Node_Unit : header_rx_full_ip_src_AposterioriUnit
    PORT MAP( alpha => alphaD,  -- sfix6 [14]
              beta => beta_1,  -- sfix4 [14]
              valid => rdValidReg,  -- ufix1
              gamma => gamma_tmp,  -- sfix6 [14]
