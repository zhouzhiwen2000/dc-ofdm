-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip_src_DecoderCore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip_src_DecoderCore
-- Source Path: HDLRxHeader/h_rx_full/LDPC_Deco_Hc_12H/DecoderCore
-- Hierarchy Level: 2
-- Model version: 1.36
-- 
-- Decoder Core
...
ENTITY header_rx_full_ip_src_DecoderCore IS
...
END header_rx_full_ip_src_DecoderCore;


ARCHITECTURE rtl OF header_rx_full_ip_src_DecoderCore IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_src_SimpleDualPortRAM_generic
  ...
  COMPONENT header_rx_full_ip_src_CheckNodeRAM
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT header_rx_full_ip_src_BarrelRotator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT header_rx_full_ip_src_FunctionalUnit
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT header_rx_full_ip_src_FinalDecision
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : header_rx_full_ip_src_SimpleDualPortRAM_generic
    USE ENTITY work.header_rx_full_ip_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : header_rx_full_ip_src_CheckNodeRAM
    USE ENTITY work.header_rx_full_ip_src_CheckNodeRAM(rtl);

  FOR ALL : header_rx_full_ip_src_BarrelRotator
    USE ENTITY work.header_rx_full_ip_src_BarrelRotator(rtl);

  FOR ALL : header_rx_full_ip_src_FunctionalUnit
    USE ENTITY work.header_rx_full_ip_src_FunctionalUnit(rtl);

  FOR ALL : header_rx_full_ip_src_FinalDecision
    USE ENTITY work.header_rx_full_ip_src_FinalDecision(rtl);
  ...
  SIGNAL wrData                           : vector_of_signed6(0 TO 13);  -- sfix6 [14]
  ...
  SIGNAL sData_signed                     : vector_of_signed6(0 TO 13);  -- sfix6 [14]
  ...
  SIGNAL gamma_signed                     : vector_of_signed6(0 TO 13);  -- sfix6 [14]
  SIGNAL colData                          : vector_of_signed6(0 TO 13);  -- sfix6 [14]
  SIGNAL sDataIn                          : vector_of_signed6(0 TO 13);  -- sfix6 [14]
  ...
  SIGNAL iterationController_wrData_next  : vector_of_signed6(0 TO 13);  -- sfix6 [14]
...
BEGIN
  u_Variable_Node_RAM : header_rx_full_ip_src_SimpleDualPortRAM_generic
  ...
  u_Variable_Node_RAM_1 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_2 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_3 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_4 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_5 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_6 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_7 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_8 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_9 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_10 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_11 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Variable_Node_RAM_12 : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_BetaMemory : header_rx_full_ip_src_CheckNodeRAM
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Barrel_Rotator_Unit : header_rx_full_ip_src_BarrelRotator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              data => sDataIn_1,  -- sfix6 [14]
              shift => std_logic_vector(sValIn),  -- ufix4
              shiftData => sData  -- sfix6 [14]
              );

  u_FunctionalUnit : header_rx_full_ip_src_FunctionalUnit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Variable_Node_RAM_generic : header_rx_full_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 6
                 )
    PORT MAP( clk => clk,
  ...
  u_Final_Decision : header_rx_full_ip_src_FinalDecision
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => intReset,  -- ufix1
              data => colData_1,  -- sfix6 [14]
