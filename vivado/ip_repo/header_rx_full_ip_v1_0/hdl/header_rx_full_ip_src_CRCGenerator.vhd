-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip_src_CRCGenerator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip_src_CRCGenerator
-- Source Path: HDLRxHeader/h_rx_full/h_crc_rx/General CRC Syndrome Detector HDL Optimized/CRCGenerator
-- Hierarchy Level: 3
-- Model version: 1.36
-- 
-- -------------------------------------------------------------
...
ENTITY header_rx_full_ip_src_CRCGenerator IS
...
END header_rx_full_ip_src_CRCGenerator;


ARCHITECTURE rtl OF header_rx_full_ip_src_CRCGenerator IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_src_CRCGenControl
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          startIn                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT header_rx_full_ip_src_CRCGenCompute
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : header_rx_full_ip_src_CRCGenControl
    USE ENTITY work.header_rx_full_ip_src_CRCGenControl(rtl);

  FOR ALL : header_rx_full_ip_src_CRCGenCompute
    USE ENTITY work.header_rx_full_ip_src_CRCGenCompute(rtl);
...
BEGIN
  u_Controlsignal_inst : header_rx_full_ip_src_CRCGenControl
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_ComputeCRC_inst : header_rx_full_ip_src_CRCGenCompute
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
