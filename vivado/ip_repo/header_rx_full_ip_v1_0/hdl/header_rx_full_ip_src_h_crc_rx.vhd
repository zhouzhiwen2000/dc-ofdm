-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip_src_h_crc_rx.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip_src_h_crc_rx
-- Source Path: HDLRxHeader/h_rx_full/h_crc_rx
-- Hierarchy Level: 1
-- Model version: 1.36
-- 
-- -------------------------------------------------------------
...
ENTITY header_rx_full_ip_src_h_crc_rx IS
...
END header_rx_full_ip_src_h_crc_rx;


ARCHITECTURE rtl OF header_rx_full_ip_src_h_crc_rx IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic;
  ...
  COMPONENT header_rx_full_ip_src_Sample_Control_Bus_Creator
  ...
  FOR ALL : header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized
    USE ENTITY work.header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized(rtl);

  FOR ALL : header_rx_full_ip_src_Sample_Control_Bus_Creator
    USE ENTITY work.header_rx_full_ip_src_Sample_Control_Bus_Creator(rtl);
...
BEGIN
  u_General_CRC_Syndrome_Detector_HDL_Optimized : header_rx_full_ip_src_General_CRC_Syndrome_Detector_HDL_Optimized
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => data_in,
  ...
  u_Sample_Control_Bus_Creator : header_rx_full_ip_src_Sample_Control_Bus_Creator
