-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip_src_h_scrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip_src_h_scrambler
-- Source Path: HDLRxHeader/h_rx_full/h_scrambler
-- Hierarchy Level: 1
-- Model version: 1.36
-- 
-- -------------------------------------------------------------
...
ENTITY header_rx_full_ip_src_h_scrambler IS
...
END header_rx_full_ip_src_h_scrambler;


ARCHITECTURE rtl OF header_rx_full_ip_src_h_scrambler IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_src_Sample_Control_Bus_Creator_block1
  ...
  FOR ALL : header_rx_full_ip_src_Sample_Control_Bus_Creator_block1
    USE ENTITY work.header_rx_full_ip_src_Sample_Control_Bus_Creator_block1(rtl);
  ...
  SIGNAL C4_lowered_ctrl_const_out        : std_logic;
  SIGNAL C4_lowered_ctrl_delay_out        : std_logic;
  SIGNAL C4_lowered_Initial_Val_out       : std_logic;
  SIGNAL C2_lowered_ctrl_const_out        : std_logic;
  SIGNAL C2_lowered_ctrl_delay_out        : std_logic;
  SIGNAL C2_lowered_Initial_Val_out       : std_logic;
  ...
  SIGNAL C2_lowered_out                   : std_logic;
  ...
  SIGNAL C4_lowered_out                   : std_logic;
...
BEGIN
  u_Sample_Control_Bus_Creator : header_rx_full_ip_src_Sample_Control_Bus_Creator_block1
  ...
  C4_lowered_ctrl_const_out <= '1';

  C4_lowered_ctrl_delay_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        C4_lowered_ctrl_delay_out <= '0';
      ELSIF enb = '1' THEN
        C4_lowered_ctrl_delay_out <= C4_lowered_ctrl_const_out;
      END IF;
    END IF;
  END PROCESS C4_lowered_ctrl_delay_process;


  C4_lowered_Initial_Val_out <= '1';

  C2_lowered_ctrl_const_out <= '1';

  C2_lowered_ctrl_delay_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        C2_lowered_ctrl_delay_out <= '0';
      ELSIF enb = '1' THEN
        C2_lowered_ctrl_delay_out <= C2_lowered_ctrl_const_out;
      END IF;
    END IF;
  END PROCESS C2_lowered_ctrl_delay_process;


  C2_lowered_Initial_Val_out <= '1';
  ...
  C2_out1 <= C2_lowered_Initial_Val_out WHEN C2_lowered_ctrl_delay_out = '0' ELSE
      C2_lowered_out;
  ...
  C4_out1 <= C4_lowered_Initial_Val_out WHEN C4_lowered_ctrl_delay_out = '0' ELSE
      C4_lowered_out;
