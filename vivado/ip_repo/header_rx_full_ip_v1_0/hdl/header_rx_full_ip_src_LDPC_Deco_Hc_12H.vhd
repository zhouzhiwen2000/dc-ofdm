-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip_src_LDPC_Deco_Hc_12H.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip_src_LDPC_Deco_Hc_12H
-- Source Path: HDLRxHeader/h_rx_full/LDPC_Deco_Hc_12H
-- Hierarchy Level: 1
-- Model version: 1.36
-- 
-- LDPC Decoder
...
ENTITY header_rx_full_ip_src_LDPC_Deco_Hc_12H IS
...
END header_rx_full_ip_src_LDPC_Deco_Hc_12H;


ARCHITECTURE rtl OF header_rx_full_ip_src_LDPC_Deco_Hc_12H IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_src_CodeParameters
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT header_rx_full_ip_src_DecoderCore
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : header_rx_full_ip_src_CodeParameters
    USE ENTITY work.header_rx_full_ip_src_CodeParameters(rtl);

  FOR ALL : header_rx_full_ip_src_DecoderCore
    USE ENTITY work.header_rx_full_ip_src_DecoderCore(rtl);
...
BEGIN
  u_Code_Parameters : header_rx_full_ip_src_CodeParameters
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Decoder_Core : header_rx_full_ip_src_DecoderCore
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => reset,  -- ufix1
