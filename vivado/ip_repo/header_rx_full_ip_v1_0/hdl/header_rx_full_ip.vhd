-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip
-- Source Path: header_rx_full_ip
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY header_rx_full_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        IPCORE_RESETN                     :   IN    std_logic;  -- ufix1
        data_in                           :   IN    std_logic_vector(3 DOWNTO 0);  -- ufix4
        start_in                          :   IN    std_logic;  -- ufix1
        psdu_size                         :   OUT   std_logic_vector(23 DOWNTO 0);  -- ufix24
        msg_duration                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- ufix16
        block_size                        :   OUT   std_logic_vector(1 DOWNTO 0);  -- ufix2
        fec_rate                          :   OUT   std_logic_vector(2 DOWNTO 0);  -- ufix3
        rep_number                        :   OUT   std_logic_vector(2 DOWNTO 0);  -- ufix3
        concat_factor                     :   OUT   std_logic_vector(2 DOWNTO 0);  -- ufix3
        scrambler_init                    :   OUT   std_logic_vector(3 DOWNTO 0);  -- ufix4
        bat_id                            :   OUT   std_logic_vector(4 DOWNTO 0);  -- ufix5
        cp_id                             :   OUT   std_logic_vector(2 DOWNTO 0);  -- ufix3
        mimo_spacing                      :   OUT   std_logic_vector(2 DOWNTO 0);  -- ufix3
        mimo_number                       :   OUT   std_logic_vector(2 DOWNTO 0);  -- ufix3
        end_rsvd                          :   OUT   std_logic;  -- ufix1
        err                               :   OUT   std_logic  -- ufix1
        );
END header_rx_full_ip;


ARCHITECTURE rtl OF header_rx_full_ip IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_reset_sync
  ...
  COMPONENT header_rx_full_ip_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : header_rx_full_ip_reset_sync
    USE ENTITY work.header_rx_full_ip_reset_sync(rtl);

  FOR ALL : header_rx_full_ip_dut
    USE ENTITY work.header_rx_full_ip_dut(rtl);

  -- Signals
  SIGNAL reset_x                          : std_logic;
  SIGNAL dut_enable                       : std_logic;  -- ufix1
  SIGNAL data_in_unsigned                 : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL data_in_sig                      : signed(3 DOWNTO 0);  -- sfix4
  ...
  SIGNAL psdu_size_tmp                    : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL msg_duration_tmp                 : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL block_size_tmp                   : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL fec_rate_tmp                     : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL rep_number_tmp                   : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL concat_factor_tmp                : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL scrambler_init_tmp               : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL bat_id_tmp                       : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL cp_id_tmp                        : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL mimo_spacing_tmp                 : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL mimo_number_tmp                  : unsigned(2 DOWNTO 0);  -- ufix3

BEGIN
  u_header_rx_full_ip_reset_sync_inst : header_rx_full_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset_x
              );

  u_header_rx_full_ip_dut_inst : header_rx_full_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
              dut_enable => dut_enable,  -- ufix1
              data_in => std_logic_vector(data_in_sig),  -- sfix4
              start_in => start_in,  -- ufix1
  ...
  psdu_size_tmp <= unsigned'(psdu_size_23_sig & psdu_size_22_sig & psdu_size_21_sig & psdu_size_20_sig & psdu_size_19_sig & psdu_size_18_sig & psdu_size_17_sig & psdu_size_16_sig & psdu_size_15_sig & psdu_size_14_sig & psdu_size_13_sig & psdu_size_12_sig & psdu_size_11_sig & psdu_size_10_sig & psdu_size_9_sig & psdu_size_8_sig & psdu_size_7_sig & psdu_size_6_sig & psdu_size_5_sig & psdu_size_4_sig & psdu_size_3_sig & psdu_size_2_sig & psdu_size_1_sig & psdu_size_0_sig);

  psdu_size <= std_logic_vector(psdu_size_tmp);

  msg_duration_tmp <= unsigned'(msg_duration_15_sig & msg_duration_14_sig & msg_duration_13_sig & msg_duration_12_sig & msg_duration_11_sig & msg_duration_10_sig & msg_duration_9_sig & msg_duration_8_sig & msg_duration_7_sig & msg_duration_6_sig & msg_duration_5_sig & msg_duration_4_sig & msg_duration_3_sig & msg_duration_2_sig & msg_duration_1_sig & msg_duration_0_sig);

  msg_duration <= std_logic_vector(msg_duration_tmp);

  block_size_tmp <= unsigned'(block_size_1_sig & block_size_0_sig);

  block_size <= std_logic_vector(block_size_tmp);

  fec_rate_tmp <= unsigned'(fec_rate_2_sig & fec_rate_1_sig & fec_rate_0_sig);

  fec_rate <= std_logic_vector(fec_rate_tmp);

  rep_number_tmp <= unsigned'(rep_number_2_sig & rep_number_1_sig & rep_number_0_sig);

  rep_number <= std_logic_vector(rep_number_tmp);

  concat_factor_tmp <= unsigned'(concat_factor_2_sig & concat_factor_1_sig & concat_factor_0_sig);

  concat_factor <= std_logic_vector(concat_factor_tmp);

  scrambler_init_tmp <= unsigned'(scrambler_init_3_sig & scrambler_init_2_sig & scrambler_init_1_sig & scrambler_init_0_sig);

  scrambler_init <= std_logic_vector(scrambler_init_tmp);

  bat_id_tmp <= unsigned'(bat_id_4_sig & bat_id_3_sig & bat_id_2_sig & bat_id_1_sig & bat_id_0_sig);

  bat_id <= std_logic_vector(bat_id_tmp);

  cp_id_tmp <= unsigned'(cp_id_2_sig & cp_id_1_sig & cp_id_0_sig);

  cp_id <= std_logic_vector(cp_id_tmp);

  mimo_spacing_tmp <= unsigned'(mimo_spacing_2_sig & mimo_spacing_1_sig & mimo_spacing_0_sig);

  mimo_spacing <= std_logic_vector(mimo_spacing_tmp);

  mimo_number_tmp <= unsigned'(mimo_number_2_sig & mimo_number_1_sig & mimo_number_0_sig);

  mimo_number <= std_logic_vector(mimo_number_tmp);
