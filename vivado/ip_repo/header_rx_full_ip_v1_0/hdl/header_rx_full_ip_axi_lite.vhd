-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxHeader/header_rx_full_ip_axi_lite.vhd
-- Created: 2024-09-06 20:46:10
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: header_rx_full_ip_axi_lite
-- Source Path: header_rx_full_ip/header_rx_full_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY header_rx_full_ip_axi_lite IS
...
END header_rx_full_ip_axi_lite;


ARCHITECTURE rtl OF header_rx_full_ip_axi_lite IS

  -- Component Declarations
  COMPONENT header_rx_full_ip_addr_decoder
  ...
  COMPONENT header_rx_full_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : header_rx_full_ip_addr_decoder
    USE ENTITY work.header_rx_full_ip_addr_decoder(rtl);

  FOR ALL : header_rx_full_ip_axi_lite_module
    USE ENTITY work.header_rx_full_ip_axi_lite_module(rtl);
...
BEGIN
  u_header_rx_full_ip_addr_decoder_inst : header_rx_full_ip_addr_decoder
  ...
  u_header_rx_full_ip_axi_lite_module_inst : header_rx_full_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
