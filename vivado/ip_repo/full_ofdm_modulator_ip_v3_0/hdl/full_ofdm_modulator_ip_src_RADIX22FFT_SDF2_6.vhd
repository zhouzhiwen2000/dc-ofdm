-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_6
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF2_6
-- Hierarchy Level: 4
-- Model version: 1.43
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_6 IS
...
END full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_6;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_6 IS
  ...
  COMPONENT full_ofdm_modulator_ip_src_SDFCommutator6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_5_1_vld                    :   IN    std_logic;
          ...
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
          dinf_im                         :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  FOR ALL : full_ofdm_modulator_ip_src_SDFCommutator6
    USE ENTITY work.full_ofdm_modulator_ip_src_SDFCommutator6(rtl);

  -- Signals
  SIGNAL dout_5_1_re_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout_5_1_im_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dinf_im                          : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dinf_re                          : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL x_im_dly                         : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL x_re_dly                         : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg   : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL Radix22ButterflyG2_btf1_im_reg   : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL Radix22ButterflyG2_btf2_re_reg   : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL Radix22ButterflyG2_btf2_im_reg   : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL Radix22ButterflyG2_din_re_dly    : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Radix22ButterflyG2_din_im_dly    : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Radix22ButterflyG2_din_vld_dly   : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly      : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Radix22ButterflyG2_x_im_dly      : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Radix22ButterflyG2_x_vld_dly     : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1 : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1 : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2 : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2 : signed(11 DOWNTO 0);  -- sfix12
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(12 DOWNTO 0);  -- sfix13_En10
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(12 DOWNTO 0);  -- sfix13_En10
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(12 DOWNTO 0);  -- sfix13_En10
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(12 DOWNTO 0);  -- sfix13_En10
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dout_6_1_re_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL dout_6_1_im_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_dataMEM_im_0_6 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_0_6 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_6 : full_ofdm_modulator_ip_src_SDFCommutator6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              ...
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix12_En10
              dinf_im => std_logic_vector(dinf_im),  -- sfix12_En10
              dinf_vld => dinf_vld,
              ...
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_6_1_re => dout_6_1_re_tmp,  -- sfix12_En10
              dout_6_1_im => dout_6_1_im_tmp,  -- sfix12_En10
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        ...
        Radix22ButterflyG2_btf1_re_reg <= to_signed(16#0000#, 13);
        Radix22ButterflyG2_btf1_im_reg <= to_signed(16#0000#, 13);
        Radix22ButterflyG2_btf2_re_reg <= to_signed(16#0000#, 13);
        Radix22ButterflyG2_btf2_im_reg <= to_signed(16#0000#, 13);
        Radix22ButterflyG2_din_re_dly <= to_signed(16#000#, 12);
        Radix22ButterflyG2_din_im_dly <= to_signed(16#000#, 12);
        Radix22ButterflyG2_din_vld_dly <= '0';
        Radix22ButterflyG2_x_re_dly <= to_signed(16#000#, 12);
        Radix22ButterflyG2_x_im_dly <= to_signed(16#000#, 12);
        Radix22ButterflyG2_x_vld_dly <= '0';
        Radix22ButterflyG2_dinXTwdl_re_dly1 <= to_signed(16#000#, 12);
        Radix22ButterflyG2_dinXTwdl_im_dly1 <= to_signed(16#000#, 12);
        Radix22ButterflyG2_dinXTwdl_re_dly2 <= to_signed(16#000#, 12);
        Radix22ButterflyG2_dinXTwdl_im_dly2 <= to_signed(16#000#, 12);
  ...
  Radix22ButterflyG2_output : PROCESS (Radix22ButterflyG2_btf1_im_reg, Radix22ButterflyG2_btf1_re_reg,
       ...
       dinVld, dout_5_1_im_signed, dout_5_1_re_signed, multiply_6_J, x_im_dly,
       x_re_dly, x_vld_dly)
    VARIABLE add_cast : signed(12 DOWNTO 0);
    VARIABLE add_cast_0 : signed(12 DOWNTO 0);
    VARIABLE add_cast_1 : signed(12 DOWNTO 0);
    VARIABLE add_cast_2 : signed(12 DOWNTO 0);
    ...
    VARIABLE add_cast_3 : signed(12 DOWNTO 0);
    VARIABLE add_cast_4 : signed(12 DOWNTO 0);
    VARIABLE add_cast_5 : signed(12 DOWNTO 0);
    VARIABLE add_cast_6 : signed(12 DOWNTO 0);
    VARIABLE sub_cast_3 : signed(12 DOWNTO 0);
    VARIABLE sub_cast_4 : signed(12 DOWNTO 0);
    VARIABLE sub_cast_5 : signed(12 DOWNTO 0);
    VARIABLE sub_cast_6 : signed(12 DOWNTO 0);
  ...
  BEGIN
    add_cast_1 := to_signed(16#0000#, 13);
    add_cast_2 := to_signed(16#0000#, 13);
    sub_cast_1 := to_signed(16#0000#, 13);
    sub_cast_2 := to_signed(16#0000#, 13);
    add_cast_5 := to_signed(16#0000#, 13);
    add_cast_6 := to_signed(16#0000#, 13);
    sub_cast_5 := to_signed(16#0000#, 13);
    sub_cast_6 := to_signed(16#0000#, 13);
    add_cast := to_signed(16#0000#, 13);
    add_cast_0 := to_signed(16#0000#, 13);
    sub_cast := to_signed(16#0000#, 13);
    sub_cast_0 := to_signed(16#0000#, 13);
    add_cast_3 := to_signed(16#0000#, 13);
    add_cast_4 := to_signed(16#0000#, 13);
    sub_cast_3 := to_signed(16#0000#, 13);
    sub_cast_4 := to_signed(16#0000#, 13);
    ...
    IF Radix22ButterflyG2_multiply_J_dly1 = '1' THEN 
      add_cast_1 := resize(x_re_dly, 13);
      add_cast_2 := resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 13);
      Radix22ButterflyG2_btf1_re_reg_next <= add_cast_1 + add_cast_2;
      sub_cast_1 := resize(x_re_dly, 13);
      sub_cast_2 := resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 13);
      Radix22ButterflyG2_btf2_re_reg_next <= sub_cast_1 - sub_cast_2;
      add_cast_5 := resize(x_im_dly, 13);
      add_cast_6 := resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 13);
      Radix22ButterflyG2_btf2_im_reg_next <= add_cast_5 + add_cast_6;
      sub_cast_5 := resize(x_im_dly, 13);
      sub_cast_6 := resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 13);
      Radix22ButterflyG2_btf1_im_reg_next <= sub_cast_5 - sub_cast_6;
    ELSE 
      add_cast := resize(x_re_dly, 13);
      add_cast_0 := resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 13);
      Radix22ButterflyG2_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(x_re_dly, 13);
      sub_cast_0 := resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 13);
      Radix22ButterflyG2_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_3 := resize(x_im_dly, 13);
      add_cast_4 := resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 13);
      Radix22ButterflyG2_btf1_im_reg_next <= add_cast_3 + add_cast_4;
      sub_cast_3 := resize(x_im_dly, 13);
      sub_cast_4 := resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 13);
    ...
    Radix22ButterflyG2_dinXTwdl_re_dly1_next <= dout_5_1_re_signed;
    Radix22ButterflyG2_dinXTwdl_im_dly1_next <= dout_5_1_im_signed;
