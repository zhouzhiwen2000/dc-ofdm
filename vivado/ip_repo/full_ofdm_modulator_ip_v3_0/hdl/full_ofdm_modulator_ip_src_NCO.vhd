-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_NCO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_NCO
-- Source Path: HDLModulatorFull/full_ofdm_modulator/frequency_upshift/NCO
-- Hierarchy Level: 2
-- Model version: 1.43
-- 
-- NCO
...
ENTITY full_ofdm_modulator_ip_src_NCO IS
...
END full_ofdm_modulator_ip_src_NCO;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_NCO IS

  -- Component Declarations
  COMPONENT full_ofdm_modulator_ip_src_WaveformGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_ofdm_modulator_ip_src_WaveformGen
    USE ENTITY work.full_ofdm_modulator_ip_src_WaveformGen(rtl);
...
BEGIN
  u_Wave_inst : full_ofdm_modulator_ip_src_WaveformGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
