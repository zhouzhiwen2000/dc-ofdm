...
ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_Mixer IS
  ...
  SIGNAL Delay1_out1_1                    : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL Delay3_out1_1                    : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL Delay6_out1                      : signed(11 DOWNTO 0) := to_signed(16#000#, 12);  -- sfix12_En10
  ...
  SIGNAL Delay2_out1_1                    : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL Delay4_out1_1                    : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL Delay7_out1                      : signed(11 DOWNTO 0) := to_signed(16#000#, 12);  -- sfix12_En10
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay1_out1_1 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay3_out1_1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
  ...
  Product1_mul_temp <= Delay1_out1_1 * Delay3_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay2_out1_1 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1_1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
  ...
  Product2_mul_temp <= Delay2_out1_1 * Delay4_out1_1;
