-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_5
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF1_5
-- Hierarchy Level: 4
-- Model version: 1.43
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_5 IS
...
END full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_5;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_RADIX22FFT_SDF1_5 IS

  -- Component Declarations
  COMPONENT full_ofdm_modulator_ip_src_Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_1_re_dly                  :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_ofdm_modulator_ip_src_SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : full_ofdm_modulator_ip_src_Complex4Multiply_block
    USE ENTITY work.full_ofdm_modulator_ip_src_Complex4Multiply_block(rtl);
  ...
  FOR ALL : full_ofdm_modulator_ip_src_SDFCommutator5
    USE ENTITY work.full_ofdm_modulator_ip_src_SDFCommutator5(rtl);
...
BEGIN
  u_MUL4 : full_ofdm_modulator_ip_src_Complex4Multiply_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dataMEM_im_0_5 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_0_5 : full_ofdm_modulator_ip_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 12
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_5 : full_ofdm_modulator_ip_src_SDFCommutator5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_5_vld_dly => din_5_vld_dly,
