-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_Complex4Multiply_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_Complex4Multiply_block
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF1_5/Complex4Multiply
-- Hierarchy Level: 5
-- Model version: 1.43
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_Complex4Multiply_block IS
...
END full_ofdm_modulator_ip_src_Complex4Multiply_block;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_Complex4Multiply_block IS

  -- Signals
  SIGNAL din_5_1_re_dly_signed            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_re_reg                       : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_5_1_im_dly_signed            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_im_reg                       : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL prod1_re                         : signed(23 DOWNTO 0) := to_signed(16#000000#, 24);  -- sfix24_En20
  SIGNAL prod1_im                         : signed(23 DOWNTO 0) := to_signed(16#000000#, 24);  -- sfix24_En20
  SIGNAL prod2_re                         : signed(23 DOWNTO 0) := to_signed(16#000000#, 24);  -- sfix24_En20
  SIGNAL prod2_im                         : signed(23 DOWNTO 0) := to_signed(16#000000#, 24);  -- sfix24_En20
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Complex4Add_sub_cast             : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Complex4Add_sub_cast_1           : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Complex4Add_add_cast             : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Complex4Add_add_cast_1           : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL mulResFP_re                      : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL mulResFP_im                      : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL dinXTwdl_5_1_vld_1               : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dinXTwdl_im_tmp                  : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  dinXTwdl_re_tmp <= mulResFP_re(21 DOWNTO 10);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(21 DOWNTO 10);
