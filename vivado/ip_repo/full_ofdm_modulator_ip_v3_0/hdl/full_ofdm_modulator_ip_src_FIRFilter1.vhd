-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_FIRFilter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_FIRFilter1
...
ENTITY full_ofdm_modulator_ip_src_FIRFilter1 IS
...
END full_ofdm_modulator_ip_src_FIRFilter1;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_FIRFilter1 IS

  -- Component Declarations
  COMPONENT full_ofdm_modulator_ip_src_FirRdyLogic
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_ofdm_modulator_ip_src_Addressable_Delay_Line
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_ofdm_modulator_ip_src_Addressable_Delay_Line_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_ofdm_modulator_ip_src_Addressable_Delay_Line_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_ofdm_modulator_ip_src_Addressable_Delay_Line_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_ofdm_modulator_ip_src_Addressable_Delay_Line_block3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_ofdm_modulator_ip_src_Addressable_Delay_Line_block4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_ofdm_modulator_ip_src_Addressable_Delay_Line_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_ofdm_modulator_ip_src_Addressable_Delay_Line_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : full_ofdm_modulator_ip_src_FirRdyLogic
    USE ENTITY work.full_ofdm_modulator_ip_src_FirRdyLogic(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_Addressable_Delay_Line
    USE ENTITY work.full_ofdm_modulator_ip_src_Addressable_Delay_Line(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block
    USE ENTITY work.full_ofdm_modulator_ip_src_Addressable_Delay_Line_block(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block1
    USE ENTITY work.full_ofdm_modulator_ip_src_Addressable_Delay_Line_block1(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block2
    USE ENTITY work.full_ofdm_modulator_ip_src_Addressable_Delay_Line_block2(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd
    USE ENTITY work.full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block3
    USE ENTITY work.full_ofdm_modulator_ip_src_Addressable_Delay_Line_block3(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block4
    USE ENTITY work.full_ofdm_modulator_ip_src_Addressable_Delay_Line_block4(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block5
    USE ENTITY work.full_ofdm_modulator_ip_src_Addressable_Delay_Line_block5(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block6
    USE ENTITY work.full_ofdm_modulator_ip_src_Addressable_Delay_Line_block6(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd_block
    USE ENTITY work.full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd_block(rtl);
  ...
  SIGNAL accDataOut                       : signed(23 DOWNTO 0);  -- sfix24_En20
  ...
  SIGNAL coeffTableReg4_1                 : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL coeffTableReg3_1                 : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL coeffTableReg2_1                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL delayLineEnd8                    : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL coeffTableReg1_1                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL delayLineEnd9deadOut             : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL delayLineDataOut9                : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL coeffTableReg0_1                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL sumIn                            : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL sumOut                           : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_0                         : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_1                         : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_2                         : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_3                         : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_3_signed                  : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL sumOutReg_1                      : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL accDataOut_1                     : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL accSwitchOut                     : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL accAdderOut                      : signed(23 DOWNTO 0);  -- sfix24_En20
  ...
  SIGNAL accDataOut_3                     : signed(23 DOWNTO 0);  -- sfix24_En20
  ...
  SIGNAL coeffTableReg4_3                 : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL coeffTableReg3_3                 : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL coeffTableReg2_3                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL delayLineEnd8_1                  : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL coeffTableReg1_3                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL delayLineEnd9deadOut_1           : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL delayLineDataOut9_1              : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL coeffTableReg0_3                 : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL sumIn_1                          : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL sumOut_4                         : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_0_1                       : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_1_1                       : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_2_1                       : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_3_1                       : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL sumOut_3_signed_1                : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL sumOutReg_3                      : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL accDataOut_4                     : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL accSwitchOut_1                   : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL accAdderOut_1                    : signed(23 DOWNTO 0);  -- sfix24_En20
...
BEGIN
  u_firRdyLogic : full_ofdm_modulator_ip_src_FirRdyLogic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : full_ofdm_modulator_ip_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : full_ofdm_modulator_ip_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : full_ofdm_modulator_ip_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => std_logic_vector(delayLineDataIn5_1),  -- sfix12_En10
              validIn => delayLineShiftEn5_1,
              lutaddr => rdAddr5,  -- ufix1
              delayLineEnd => delayLineEnd5,  -- sfix12_En10
              dataOut => delayLineDataOut5  -- sfix12_En10
              );

  u_delayLine6 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd5,  -- sfix12_En10
  ...
  u_delayLine7 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd6,  -- sfix12_En10
  ...
  u_delayLine8 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd7,  -- sfix12_En10
              validIn => delayLineShiftEn2_1,
              rdAddr => rdAddr2,  -- ufix1
              delayLineEnd => delayLineEnd8,  -- sfix12_En10
              dataOut => delayLineDataOut8  -- sfix12_En10
              );

  u_delayLine9 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd8,  -- sfix12_En10
              validIn => delayLineShiftEn1_1,
              rdAddr => rdAddr1,  -- ufix1
              delayLineEnd => delayLineEnd9deadOut,  -- sfix12_En10
              dataOut => delayLineDataOut9  -- sfix12_En10
              );

  u_filterTap0 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut0,  -- sfix12_En10
              preAddIn => delayLineDataOut9,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg0_1),  -- sfix12_En10
              sumIn => std_logic_vector(sumIn),  -- sfix24_En20
              sumOut => sumOut  -- sfix24_En20
              );

  u_filterTap1 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut1,  -- sfix12_En10
              preAddIn => delayLineDataOut8,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg1_1),  -- sfix12_En10
              sumIn => sumOut,  -- sfix24_En20
              sumOut => sumOut_0  -- sfix24_En20
              );

  u_filterTap2 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut2,  -- sfix12_En10
              preAddIn => delayLineDataOut7,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg2_1),  -- sfix12_En10
              sumIn => sumOut_0,  -- sfix24_En20
              sumOut => sumOut_1  -- sfix24_En20
              );

  u_filterTap3 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut3,  -- sfix12_En10
              preAddIn => delayLineDataOut6,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg3_1),  -- sfix12_En10
              sumIn => sumOut_1,  -- sfix24_En20
              sumOut => sumOut_2  -- sfix24_En20
              );

  u_filterTap4 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut4,  -- sfix12_En10
              preAddIn => delayLineDataOut5,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg4_1),  -- sfix12_En10
              sumIn => sumOut_2,  -- sfix24_En20
              sumOut => sumOut_3  -- sfix24_En20
              );

  u_delayLine0_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd5_1,  -- sfix12_En10
              validIn => delayLineShiftEn4_1,
              rdAddr => rdAddr4,  -- ufix1
  ...
  u_delayLine7_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd6_1,  -- sfix12_En10
              validIn => delayLineShiftEn3_1,
              rdAddr => rdAddr3,  -- ufix1
  ...
  u_delayLine8_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd7_1,  -- sfix12_En10
              validIn => delayLineShiftEn2_1,
              rdAddr => rdAddr2,  -- ufix1
              delayLineEnd => delayLineEnd8_1,  -- sfix12_En10
              dataOut => delayLineDataOut8_1  -- sfix12_En10
              );

  u_delayLine9_1 : full_ofdm_modulator_ip_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd8_1,  -- sfix12_En10
              validIn => delayLineShiftEn1_1,
              rdAddr => rdAddr1,  -- ufix1
              delayLineEnd => delayLineEnd9deadOut_1,  -- sfix12_En10
              dataOut => delayLineDataOut9_1  -- sfix12_En10
              );

  u_filterTap0_1 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut0_1,  -- sfix12_En10
              preAddIn => delayLineDataOut9_1,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg0_3),  -- sfix12_En10
              sumIn => std_logic_vector(sumIn_1),  -- sfix24_En20
              sumOut => sumOut_4  -- sfix24_En20
              );

  u_filterTap1_1 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut1_1,  -- sfix12_En10
              preAddIn => delayLineDataOut8_1,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg1_3),  -- sfix12_En10
              sumIn => sumOut_4,  -- sfix24_En20
              sumOut => sumOut_0_1  -- sfix24_En20
              );

  u_filterTap2_1 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut2_1,  -- sfix12_En10
              preAddIn => delayLineDataOut7_1,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg2_3),  -- sfix12_En10
              sumIn => sumOut_0_1,  -- sfix24_En20
              sumOut => sumOut_1_1  -- sfix24_En20
              );

  u_filterTap3_1 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut3_1,  -- sfix12_En10
              preAddIn => delayLineDataOut6_1,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg3_3),  -- sfix12_En10
              sumIn => sumOut_1_1,  -- sfix24_En20
              sumOut => sumOut_2_1  -- sfix24_En20
              );

  u_filterTap4_1 : full_ofdm_modulator_ip_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              enb => enb,
              din_im => delayLineDataOut4_1,  -- sfix12_En10
              preAddIn => delayLineDataOut5_1,  -- sfix12_En10
              coeff => std_logic_vector(coeffTableReg4_3),  -- sfix12_En10
              sumIn => sumOut_2_1,  -- sfix24_En20
              sumOut => sumOut_3_1  -- sfix24_En20
              );
  ...
  accDataOut <= to_signed(16#000000#, 24);
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4 <= to_signed(16#286#, 12);
      WHEN '1' =>
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg4_1 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3 <= to_signed(16#067#, 12);
      WHEN '1' =>
        coeffTableOut3 <= to_signed(-16#0C8#, 12);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg3_1 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2 <= to_signed(16#020#, 12);
      WHEN '1' =>
        coeffTableOut2 <= to_signed(-16#03A#, 12);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg2_1 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1 <= to_signed(16#007#, 12);
      WHEN '1' =>
        coeffTableOut1 <= to_signed(-16#010#, 12);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg1_1 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0 <= to_signed(-16#002#, 12);
      WHEN '1' =>
        coeffTableOut0 <= to_signed(-16#002#, 12);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg0_1 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  sumIn <= to_signed(16#000000#, 24);

  sumOut_3_signed <= signed(sumOut_3);

  sumOutReg_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        sumOutReg_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        sumOutReg_1 <= sumOut_3_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        accDataOut_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  accDataOut_3 <= to_signed(16#000000#, 24);
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4_1 <= to_signed(16#286#, 12);
      WHEN '1' =>
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg4_3 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3_1 <= to_signed(16#067#, 12);
      WHEN '1' =>
        coeffTableOut3_1 <= to_signed(-16#0C8#, 12);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg3_3 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2_1 <= to_signed(16#020#, 12);
      WHEN '1' =>
        coeffTableOut2_1 <= to_signed(-16#03A#, 12);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg2_3 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1_1 <= to_signed(16#007#, 12);
      WHEN '1' =>
        coeffTableOut1_1 <= to_signed(-16#010#, 12);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg1_3 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0_1 <= to_signed(-16#002#, 12);
      WHEN '1' =>
        coeffTableOut0_1 <= to_signed(-16#002#, 12);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg0_3 <= to_signed(16#000#, 12);
      ELSIF enb = '1' THEN
  ...
  sumIn_1 <= to_signed(16#000000#, 24);

  sumOut_3_signed_1 <= signed(sumOut_3_1);

  sumOutReg_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        sumOutReg_3 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        sumOutReg_3 <= sumOut_3_signed_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        accDataOut_4 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
