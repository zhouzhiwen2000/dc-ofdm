-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_ofdm_symbol_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_ofdm_symbol_sync
...
ENTITY rx_demod_ip_src_ofdm_symbol_sync IS
...
END rx_demod_ip_src_ofdm_symbol_sync;


ARCHITECTURE rtl OF rx_demod_ip_src_ofdm_symbol_sync IS

  -- Component Declarations
  COMPONENT rx_demod_ip_src_m_cox
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
          ...
          P_d_re                          :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
          P_d_im                          :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En12
          );
  END COMPONENT;

  COMPONENT rx_demod_ip_src_find_peak
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_SimpleDualPortRAM_singlebit
  ...
  COMPONENT rx_demod_ip_src_frequency_offset_calculator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rx_demod_ip_src_m_cox
    USE ENTITY work.rx_demod_ip_src_m_cox(rtl);

  FOR ALL : rx_demod_ip_src_find_peak
    USE ENTITY work.rx_demod_ip_src_find_peak(rtl);

  FOR ALL : rx_demod_ip_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.rx_demod_ip_src_SimpleDualPortRAM_singlebit(rtl);
  ...
  FOR ALL : rx_demod_ip_src_frequency_offset_calculator
    USE ENTITY work.rx_demod_ip_src_frequency_offset_calculator(rtl);
  ...
  SIGNAL m_cox_out3_re                    : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL m_cox_out3_im                    : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL find_peak_out2_1                 : std_logic;
  ...
  SIGNAL m_cox_out3_re_signed             : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL m_cox_out3_im_signed             : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL realOutput                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL slicedInput_1                    : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL imagOutput                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL frequency_offset_calculator_out1 : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  -- peakSync is synchronized with the first element of the channel
  -- Delay of find_peak = peakDetectorWindow 

  u_m_cox : rx_demod_ip_src_m_cox
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb => enb,
              ...
              P_d_re => m_cox_out3_re,  -- sfix16_En12
              P_d_im => m_cox_out3_im  -- sfix16_En12
              );

  u_find_peak : rx_demod_ip_src_find_peak
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb => enb,
  ...
  u_ShiftRegisterRAM_singlebit : rx_demod_ip_src_SimpleDualPortRAM_singlebit
  ...
  u_frequency_offset_calculator : rx_demod_ip_src_frequency_offset_calculator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb => enb,
              enb_1_2_1 => enb_1_2_1,
              peak_sync => find_peak_out2,
              P_d_re => std_logic_vector(realOutput),  -- sfix16_En12
              P_d_im => std_logic_vector(imagOutput),  -- sfix16_En12
              frequency_offset => frequency_offset_calculator_out1  -- int16
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_1 = '1' THEN
        find_peak_out2_1 <= find_peak_out2;
      END IF;
    END IF;
