-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_NCO.vhd
...
END rx_demod_ip_src_NCO;


ARCHITECTURE rtl OF rx_demod_ip_src_NCO IS

  -- Component Declarations
  COMPONENT rx_demod_ip_src_WaveformGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rx_demod_ip_src_WaveformGen
    USE ENTITY work.rx_demod_ip_src_WaveformGen(rtl);
...
BEGIN
  u_Wave_inst : rx_demod_ip_src_WaveformGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
