-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_RADIX22FFT_SDF1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_RADIX22FFT_SDF1_1
...
ENTITY rx_demod_ip_src_RADIX22FFT_SDF1_1 IS
...
END rx_demod_ip_src_RADIX22FFT_SDF1_1;


ARCHITECTURE rtl OF rx_demod_ip_src_RADIX22FFT_SDF1_1 IS
  ...
  COMPONENT rx_demod_ip_src_SDFCommutator1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : rx_demod_ip_src_SDFCommutator1
    USE ENTITY work.rx_demod_ip_src_SDFCommutator1(rtl);
...
BEGIN
  u_dataMEM_im_0_1 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataMEM_re_0_1 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 7,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : rx_demod_ip_src_SDFCommutator1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
