-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_m_cox.vhd
...
ENTITY rx_demod_ip_src_m_cox IS
...
END rx_demod_ip_src_m_cox;


ARCHITECTURE rtl OF rx_demod_ip_src_m_cox IS
  ...
  COMPONENT rx_demod_ip_src_calculate_P
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_calculate_R
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_Compare_To_Zero_block
    PORT( u                               :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En24
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT rx_demod_ip_src_Real_Divide_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rx_demod_ip_src_calculate_P
    USE ENTITY work.rx_demod_ip_src_calculate_P(rtl);

  FOR ALL : rx_demod_ip_src_calculate_R
    USE ENTITY work.rx_demod_ip_src_calculate_R(rtl);

  FOR ALL : rx_demod_ip_src_Compare_To_Zero_block
    USE ENTITY work.rx_demod_ip_src_Compare_To_Zero_block(rtl);

  FOR ALL : rx_demod_ip_src_Real_Divide_HDL_Optimized
    USE ENTITY work.rx_demod_ip_src_Real_Divide_HDL_Optimized(rtl);
  ...
  SIGNAL Delay1_reg_re                    : vector_of_signed16(0 TO 46);  -- sfix16_En12 [47]
  SIGNAL Delay1_reg_im                    : vector_of_signed16(0 TO 46);  -- sfix16_En12 [47]
...
BEGIN
  ...
  u_calculate_P : rx_demod_ip_src_calculate_P
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb => enb,
  ...
  u_calculate_R : rx_demod_ip_src_calculate_R
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb => enb,
  ...
  u_Compare_To_Zero : rx_demod_ip_src_Compare_To_Zero_block
    PORT MAP( u => r_sig,  -- sfix32_En24
              y => Compare_To_Zero_out1
              );

  u_Real_Divide_HDL_Optimized : rx_demod_ip_src_Real_Divide_HDL_Optimized
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              enb => enb,
  ...
  Data_Type_Conversion_out1_re <= calculate_P_out2_re_signed(27 DOWNTO 12);
  Data_Type_Conversion_out1_im <= calculate_P_out2_im_signed(27 DOWNTO 12);
