-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip.vhd
-- Created: 2024-09-22 18:55:24
-- 
...
ARCHITECTURE rtl OF rx_demod_ip IS

  -- Component Declarations
  COMPONENT rx_demod_ip_reset_sync
  ...
  FOR ALL : rx_demod_ip_reset_sync
    USE ENTITY work.rx_demod_ip_reset_sync(rtl);

  FOR ALL : rx_demod_ip_dut
    USE ENTITY work.rx_demod_ip_dut(rtl);
  ...
  SIGNAL data_out_3_sig_signed            : signed(15 DOWNTO 0);  -- sfix16_En10
  SIGNAL data_out_2_sig_signed            : signed(15 DOWNTO 0);  -- sfix16_En10
...
BEGIN
  u_rx_demod_ip_reset_sync_inst : rx_demod_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset_x
              );

  u_rx_demod_ip_dut_inst : rx_demod_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
              ...
              data_out_2 => data_out_2_sig,  -- sfix16_En10
              data_out_3 => data_out_3_sig,  -- sfix16_En10
  ...
  data_out_3_sig_signed <= signed(data_out_3_sig);

  data_out_2_sig_signed <= signed(data_out_2_sig);

  data_out_1_sig_signed <= signed(data_out_1_sig);

  data_out_0_sig_signed <= signed(data_out_0_sig);

  data_out_tmp <= unsigned(data_out_3_sig_signed) & unsigned(data_out_2_sig_signed) & unsigned(data_out_1_sig_signed) & unsigned(data_out_0_sig_signed);
