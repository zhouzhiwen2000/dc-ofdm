-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_SamplesRepetition.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_SamplesRepetition
-- Source Path: 
-- Hierarchy Level: 3
-- Model version: 1.58
-- 
...
ENTITY rx_demod_ip_src_SamplesRepetition IS
...
END rx_demod_ip_src_SamplesRepetition;


ARCHITECTURE rtl OF rx_demod_ip_src_SamplesRepetition IS
...
BEGIN
  u_simpleDualPortRam : rx_demod_ip_src_SimpleDualPortRAM_generic_block
  ...
  u_simpleDualPortRam_1 : rx_demod_ip_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
