-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_WaveformGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_WaveformGen
...
ENTITY rx_demod_ip_src_WaveformGen IS
...
END rx_demod_ip_src_WaveformGen;


ARCHITECTURE rtl OF rx_demod_ip_src_WaveformGen IS

  -- Component Declarations
  COMPONENT rx_demod_ip_src_CosLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_SinLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(8 DOWNTO 0);  -- ufix9
  ...
  FOR ALL : rx_demod_ip_src_CosLookUpTableGen
    USE ENTITY work.rx_demod_ip_src_CosLookUpTableGen(rtl);

  FOR ALL : rx_demod_ip_src_SinLookUpTableGen
    USE ENTITY work.rx_demod_ip_src_SinLookUpTableGen(rtl);
...
BEGIN
  u_Cos_Wave_inst : rx_demod_ip_src_CosLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Sin_Wave_inst : rx_demod_ip_src_SinLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix9
