-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_Variable_Right_Shift.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_Variable_Right_Shift
...
ENTITY rx_demod_ip_src_Variable_Right_Shift IS
...
END rx_demod_ip_src_Variable_Right_Shift;


ARCHITECTURE rtl OF rx_demod_ip_src_Variable_Right_Shift IS

  -- Signals
  SIGNAL rightShift_1                     : signed(31 DOWNTO 0);  -- int32
...
BEGIN
  rightShift_1 <= signed(rightShift);

  Bit_Slice8_out1 <= rightShift_1(7);
  ...
  Bit_Slice7_out1 <= rightShift_1(6);
  ...
  Bit_Slice6_out1 <= rightShift_1(5);
  ...
  Bit_Slice5_out1 <= rightShift_1(4);
  ...
  Bit_Slice4_out1 <= rightShift_1(3);
  ...
  Bit_Slice3_out1 <= rightShift_1(2);
  ...
  Bit_Slice2_out1 <= rightShift_1(1);

  Bit_Slice1_out1 <= rightShift_1(0);

  x_1 <= signed(x);

  Bit_Shift_out1 <= SHIFT_RIGHT(x_1, 1);
  ...
  Bit_Shift2_out1 <= SHIFT_RIGHT(Switch2_out1_2, 4);
