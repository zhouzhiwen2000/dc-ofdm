-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_Divide_real_numerator_by_denominator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_Divide_real_numerator_by_denominator
...
ENTITY rx_demod_ip_src_Divide_real_numerator_by_denominator IS
...
END rx_demod_ip_src_Divide_real_numerator_by_denominator;


ARCHITECTURE rtl OF rx_demod_ip_src_Divide_real_numerator_by_denominator IS

  -- Component Declarations
  COMPONENT rx_demod_ip_src_normalizedCORDICDivide
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
  ...
  FOR ALL : rx_demod_ip_src_normalizedCORDICDivide
    USE ENTITY work.rx_demod_ip_src_normalizedCORDICDivide(rtl);
...
BEGIN
  u_normalizedCORDICDivide : rx_demod_ip_src_normalizedCORDICDivide
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              num => num,  -- sfix32_En30
