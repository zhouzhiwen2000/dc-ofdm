-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_dut
-- Source Path: rx_demod_ip/rx_demod_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF rx_demod_ip_dut IS

  -- Component Declarations
  COMPONENT rx_demod_ip_src_rx_demodulator_full
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : rx_demod_ip_src_rx_demodulator_full
    USE ENTITY work.rx_demod_ip_src_rx_demodulator_full(rtl);
...
BEGIN
  u_rx_demod_ip_src_rx_demodulator_full : rx_demod_ip_src_rx_demodulator_full
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
