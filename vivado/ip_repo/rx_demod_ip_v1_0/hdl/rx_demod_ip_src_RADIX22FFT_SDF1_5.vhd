-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_RADIX22FFT_SDF1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_RADIX22FFT_SDF1_5
...
ENTITY rx_demod_ip_src_RADIX22FFT_SDF1_5 IS
...
END rx_demod_ip_src_RADIX22FFT_SDF1_5;


ARCHITECTURE rtl OF rx_demod_ip_src_RADIX22FFT_SDF1_5 IS

  -- Component Declarations
  COMPONENT rx_demod_ip_src_Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : rx_demod_ip_src_Complex4Multiply_block
    USE ENTITY work.rx_demod_ip_src_Complex4Multiply_block(rtl);
  ...
  FOR ALL : rx_demod_ip_src_SDFCommutator5
    USE ENTITY work.rx_demod_ip_src_SDFCommutator5(rtl);
...
BEGIN
  u_MUL4 : rx_demod_ip_src_Complex4Multiply_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dataMEM_im_0_5 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataMEM_re_0_5 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 21
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_5 : rx_demod_ip_src_SDFCommutator5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_5_vld_dly => din_5_vld_dly,
