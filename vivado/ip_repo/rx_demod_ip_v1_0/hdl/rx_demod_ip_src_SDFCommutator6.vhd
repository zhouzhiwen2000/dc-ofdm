-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_SDFCommutator6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_SDFCommutator6
...
ENTITY rx_demod_ip_src_SDFCommutator6 IS
...
END rx_demod_ip_src_SDFCommutator6;


ARCHITECTURE rtl OF rx_demod_ip_src_SDFCommutator6 IS
...
BEGIN
  u_dataXMEM_re_0_6 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataXMEM_im_0_6 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 22
                 )
    PORT MAP( clk => clk,
