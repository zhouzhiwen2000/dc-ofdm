-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_RADIX22FFT_SDF1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_RADIX22FFT_SDF1_7
...
ENTITY rx_demod_ip_src_RADIX22FFT_SDF1_7 IS
...
END rx_demod_ip_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF rx_demod_ip_src_RADIX22FFT_SDF1_7 IS

  -- Component Declarations
  COMPONENT rx_demod_ip_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : rx_demod_ip_src_Complex4Multiply_block1
    USE ENTITY work.rx_demod_ip_src_Complex4Multiply_block1(rtl);

  FOR ALL : rx_demod_ip_src_SDFCommutator7
    USE ENTITY work.rx_demod_ip_src_SDFCommutator7(rtl);
...
BEGIN
  u_MUL4 : rx_demod_ip_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SDFCOMMUTATOR_7 : rx_demod_ip_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_7_vld_dly => din_7_vld_dly,
