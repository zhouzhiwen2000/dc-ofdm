-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_OFDM_Demodulator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_OFDM_Demodulator
...
ENTITY rx_demod_ip_src_OFDM_Demodulator IS
...
END rx_demod_ip_src_OFDM_Demodulator;


ARCHITECTURE rtl OF rx_demod_ip_src_OFDM_Demodulator IS

  -- Component Declarations
  COMPONENT rx_demod_ip_src_CPRemoval_stage1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_SamplesRepetition
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT rx_demod_ip_src_HDLFFTShift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT rx_demod_ip_src_dsphdl_FFT
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_DownSampler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_ip_src_SubcarrierSelector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          varargin_1_re                   :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En14
  ...
  FOR ALL : rx_demod_ip_src_CPRemoval_stage1
    USE ENTITY work.rx_demod_ip_src_CPRemoval_stage1(rtl);

  FOR ALL : rx_demod_ip_src_SamplesRepetition
    USE ENTITY work.rx_demod_ip_src_SamplesRepetition(rtl);

  FOR ALL : rx_demod_ip_src_HDLFFTShift
    USE ENTITY work.rx_demod_ip_src_HDLFFTShift(rtl);

  FOR ALL : rx_demod_ip_src_dsphdl_FFT
    USE ENTITY work.rx_demod_ip_src_dsphdl_FFT(rtl);

  FOR ALL : rx_demod_ip_src_DownSampler
    USE ENTITY work.rx_demod_ip_src_DownSampler(rtl);

  FOR ALL : rx_demod_ip_src_SubcarrierSelector
    USE ENTITY work.rx_demod_ip_src_SubcarrierSelector(rtl);
...
BEGIN
  u_CPRemoval_stage1 : rx_demod_ip_src_CPRemoval_stage1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SamplesRepetition : rx_demod_ip_src_SamplesRepetition
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_HDLFFTShift : rx_demod_ip_src_HDLFFTShift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dsphdl_FFT : rx_demod_ip_src_dsphdl_FFT
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_DownSampler : rx_demod_ip_src_DownSampler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_SubcarrierSelector : rx_demod_ip_src_SubcarrierSelector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
