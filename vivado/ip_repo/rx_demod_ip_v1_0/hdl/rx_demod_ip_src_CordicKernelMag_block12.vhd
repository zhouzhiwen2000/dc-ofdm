-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_CordicKernelMag_block12.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_CordicKernelMag_block12
...
ENTITY rx_demod_ip_src_CordicKernelMag_block12 IS
...
END rx_demod_ip_src_CordicKernelMag_block12;


ARCHITECTURE rtl OF rx_demod_ip_src_CordicKernelMag_block12 IS
  ...
  SIGNAL yShifted                         : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL xout2                            : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL xout2_1                          : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL xout1                            : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL xout1_1                          : signed(16 DOWNTO 0);  -- sfix17_En12
  SIGNAL xout_tmp                         : signed(16 DOWNTO 0);  -- sfix17_En12
  ...
  SIGNAL yLessThanZero_3                  : std_logic;
...
BEGIN
  ...
  xout_tmp <= xout2_1 WHEN yLessThanZero_1 = '0' ELSE
      xout1_1;
  ...
  yout_tmp <= yout2_1 WHEN yLessThanZero_2 = '0' ELSE
      yout1_1;
  ...
  zout_tmp <= zout2_1 WHEN yLessThanZero_3 = '0' ELSE
      zout1_1;
