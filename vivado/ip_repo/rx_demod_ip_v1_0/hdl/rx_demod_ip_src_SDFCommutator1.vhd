-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_SDFCommutator1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_SDFCommutator1
...
ENTITY rx_demod_ip_src_SDFCommutator1 IS
...
END rx_demod_ip_src_SDFCommutator1;


ARCHITECTURE rtl OF rx_demod_ip_src_SDFCommutator1 IS
...
BEGIN
  u_dataXMEM_re_0_1 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataXMEM_im_0_1 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
