-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_SDFCommutator3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_SDFCommutator3
...
ENTITY rx_demod_ip_src_SDFCommutator3 IS
...
END rx_demod_ip_src_SDFCommutator3;


ARCHITECTURE rtl OF rx_demod_ip_src_SDFCommutator3 IS
...
BEGIN
  u_dataXMEM_re_0_3 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataXMEM_im_0_3 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
