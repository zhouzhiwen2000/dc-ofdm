-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_ip_src_RADIX22FFT_SDF2_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_ip_src_RADIX22FFT_SDF2_2
...
ENTITY rx_demod_ip_src_RADIX22FFT_SDF2_2 IS
...
END rx_demod_ip_src_RADIX22FFT_SDF2_2;


ARCHITECTURE rtl OF rx_demod_ip_src_RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT rx_demod_ip_src_SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : rx_demod_ip_src_SDFCommutator2
    USE ENTITY work.rx_demod_ip_src_SDFCommutator2(rtl);
...
BEGIN
  u_dataMEM_im_0_2 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataMEM_re_0_2 : rx_demod_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 18
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : rx_demod_ip_src_SDFCommutator2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
