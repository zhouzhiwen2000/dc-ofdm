-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_in_16_out_16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_in_16_out_16
-- Source Path: test/divider/in_16_out_16
-- Hierarchy Level: 1
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_in_16_out_16 IS
...
END divider_ip_src_in_16_out_16;


ARCHITECTURE rtl OF divider_ip_src_in_16_out_16 IS
  ...
  COMPONENT divider_ip_src_ForEach_Real_Divide
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          den                             :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En10
  ...
  FOR ALL : divider_ip_src_ForEach_Real_Divide
    USE ENTITY work.divider_ip_src_ForEach_Real_Divide(rtl);
...
BEGIN
  u_Verify_divide_sizes : divider_ip_src_Verify_divide_sizes_block
    PORT MAP( denominator => den,  -- sfix16_En10
              ...
              den => den_1,  -- sfix16_En10
              num => num_1  -- sfix16_En10
              );

  u_ForEach_Real_Divide_instance1 : divider_ip_src_ForEach_Real_Divide
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              den => den_1,  -- sfix16_En10
