-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_Variable_Left_Shift_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_Variable_Left_Shift_block
-- Source Path: test/divider/Complex Divide HDL Optimized/ForEach - Complex Divide/Shift and cast to output type/Variable 
-- Left Shif
-- Hierarchy Level: 4
-- Model version: 1.59
-- 
...
ENTITY divider_ip_src_Variable_Left_Shift_block IS
...
END divider_ip_src_Variable_Left_Shift_block;


ARCHITECTURE rtl OF divider_ip_src_Variable_Left_Shift_block IS
...
BEGIN
  ...
  Bit_Shift5_out1 <= to_signed(16#00000#, 20);
  ...
  Bit_Shift6_out1 <= to_signed(16#00000#, 20);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= to_signed(16#00000#, 20);
