-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_Shift_and_cast_to_output_type1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_Shift_and_cast_to_output_type1
-- Source Path: test/divider/Complex Divide HDL Optimized/ForEach - Complex Divide/Shift and cast to output type1
-- Hierarchy Level: 3
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_Shift_and_cast_to_output_type1 IS
...
END divider_ip_src_Shift_and_cast_to_output_type1;


ARCHITECTURE rtl OF divider_ip_src_Shift_and_cast_to_output_type1 IS

  -- Component Declarations
  COMPONENT divider_ip_src_Cast_to_Union_of_Types
  ...
  COMPONENT divider_ip_src_Variable_Right_Shift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT divider_ip_src_Variable_Left_Shift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          x                               :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En14
  ...
  FOR ALL : divider_ip_src_Cast_to_Union_of_Types
    USE ENTITY work.divider_ip_src_Cast_to_Union_of_Types(rtl);

  FOR ALL : divider_ip_src_Variable_Right_Shift
    USE ENTITY work.divider_ip_src_Variable_Right_Shift(rtl);

  FOR ALL : divider_ip_src_Variable_Left_Shift
    USE ENTITY work.divider_ip_src_Variable_Left_Shift(rtl);
...
BEGIN
  u_Cast_to_Union_of_Types : divider_ip_src_Cast_to_Union_of_Types
    PORT MAP( Xref => std_logic_vector(Constant_out1),  -- sfix16_En10
              Cin => x,  -- sfix16_En14
              Cout => Cout  -- sfix20_En14
              );

  u_Variable_Right_Shift : divider_ip_src_Variable_Right_Shift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              x => Cout,  -- sfix20_En14
  ...
  u_Variable_Left_Shift : divider_ip_src_Variable_Left_Shift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              x => Cout,  -- sfix20_En14
