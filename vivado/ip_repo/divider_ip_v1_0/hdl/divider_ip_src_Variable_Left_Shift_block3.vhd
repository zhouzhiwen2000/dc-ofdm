-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_Variable_Left_Shift_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_Variable_Left_Shift_block3
-- Source Path: test/divider/in_8_out_16/ForEach - Real Divide/Shift and cast to output type/Variable Left Shift
-- Hierarchy Level: 4
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_Variable_Left_Shift_block3 IS
...
END divider_ip_src_Variable_Left_Shift_block3;


ARCHITECTURE rtl OF divider_ip_src_Variable_Left_Shift_block3 IS
...
BEGIN
  ...
  Bit_Shift5_out1 <= to_signed(16#00000#, 18);
  ...
  Bit_Shift6_out1 <= to_signed(16#00000#, 18);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= to_signed(16#00000#, 18);
