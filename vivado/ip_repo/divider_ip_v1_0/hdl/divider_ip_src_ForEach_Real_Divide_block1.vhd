-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_ForEach_Real_Divide_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_ForEach_Real_Divide_block1
-- Source Path: test/divider/in_8_out_16/ForEach - Real Divide
-- Hierarchy Level: 2
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_ForEach_Real_Divide_block1 IS
...
END divider_ip_src_ForEach_Real_Divide_block1;


ARCHITECTURE rtl OF divider_ip_src_ForEach_Real_Divide_block1 IS

  -- Component Declarations
  COMPONENT divider_ip_src_Upcast_Wordlength_block2
    PORT( x                               :   IN    std_logic_vector(7 DOWNTO 0);  -- sfix8_En6
          y                               :   IN    std_logic_vector(7 DOWNTO 0);  -- sfix8_En6
          u                               :   OUT   std_logic_vector(7 DOWNTO 0);  -- sfix8_En6
          v                               :   OUT   std_logic_vector(7 DOWNTO 0)  -- sfix8_En6
          );
  END COMPONENT;

  COMPONENT divider_ip_src_Normalize_numerator_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT divider_ip_src_MATLAB_Function
  ...
  COMPONENT divider_ip_src_Normalize_denominator_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          u                               :   IN    std_logic_vector(7 DOWNTO 0);  -- sfix8_En6
  ...
  COMPONENT divider_ip_src_Divide_real_numerator_by_denominator_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          num                             :   IN    std_logic_vector(7 DOWNTO 0);  -- sfix8_En6
  ...
  COMPONENT divider_ip_src_Shift_and_cast_to_output_type_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          x                               :   IN    std_logic_vector(7 DOWNTO 0);  -- sfix8_En6
          shiftValue                      :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34
          y                               :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En10
          );
  END COMPONENT;

  COMPONENT divider_ip_src_Divide_by_zero_handler_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          yIn                             :   IN    std_logic_vector(7 DOWNTO 0);  -- sfix8_En6
          yOut                            :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En10
          );
  END COMPONENT;

  -- Component Configuration Statements
  FOR ALL : divider_ip_src_Upcast_Wordlength_block2
    USE ENTITY work.divider_ip_src_Upcast_Wordlength_block2(rtl);

  FOR ALL : divider_ip_src_Normalize_numerator_block1
    USE ENTITY work.divider_ip_src_Normalize_numerator_block1(rtl);

  FOR ALL : divider_ip_src_MATLAB_Function
    USE ENTITY work.divider_ip_src_MATLAB_Function(rtl);

  FOR ALL : divider_ip_src_Normalize_denominator_block2
    USE ENTITY work.divider_ip_src_Normalize_denominator_block2(rtl);

  FOR ALL : divider_ip_src_Divide_real_numerator_by_denominator_block2
    USE ENTITY work.divider_ip_src_Divide_real_numerator_by_denominator_block2(rtl);

  FOR ALL : divider_ip_src_Shift_and_cast_to_output_type_block2
    USE ENTITY work.divider_ip_src_Shift_and_cast_to_output_type_block2(rtl);

  FOR ALL : divider_ip_src_Divide_by_zero_handler_block1
    USE ENTITY work.divider_ip_src_Divide_by_zero_handler_block1(rtl);

  -- Signals
  SIGNAL u                                : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL v                                : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL v_signed                         : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL Delay14_out1                     : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL Delay15_out1                     : std_logic;
  SIGNAL x                                : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL e                                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL isNegative                       : std_logic;
  SIGNAL x_signed                         : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL e_signed                         : signed(31 DOWNTO 0);  -- int32
  SIGNAL Delay25_out1                     : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL Delay26_out1                     : signed(31 DOWNTO 0);  -- int32
  SIGNAL num_out                          : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL t_num_out                        : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL num_out_signed                   : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL t_num_out_signed                 : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL u_signed                         : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL Delay4_out1                      : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL x_1                              : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL e_1                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL isNegative_1                     : std_logic;
  SIGNAL validOut_1                       : std_logic;
  SIGNAL x_signed_1                       : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL e_signed_1                       : signed(31 DOWNTO 0);  -- int32
  SIGNAL Delay16_out1                     : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL Delay17_out1                     : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL Delay9_reg                       : vector_of_signed8(0 TO 1);  -- sfix8 [2]
  SIGNAL Delay9_out1                      : signed(7 DOWNTO 0);  -- sfix8_En6
  ...
  SIGNAL y_signed                         : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL Unit_Delay_Enabled_Synchronous_out1 : signed(7 DOWNTO 0);  -- sfix8_En6
...
BEGIN
  u_Upcast_Wordlength : divider_ip_src_Upcast_Wordlength_block2
    PORT MAP( x => den,  -- sfix8_En6
              y => num,  -- sfix8_En6
              u => u,  -- sfix8_En6
              v => v  -- sfix8_En6
              );

  u_Normalize_numerator : divider_ip_src_Normalize_numerator_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              u => std_logic_vector(Delay14_out1),  -- sfix8_En6
  ...
  u_MATLAB_Function : divider_ip_src_MATLAB_Function
    PORT MAP( num => std_logic_vector(Delay25_out1),  -- sfix8_En6
              t_num => std_logic_vector(Delay26_out1),  -- int32
              num_out => num_out,  -- sfix8_En6
              t_num_out => t_num_out  -- sfix33
              );

  u_Normalize_denominator : divider_ip_src_Normalize_denominator_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              u => std_logic_vector(Delay4_out1),  -- sfix8_En6
              validIn => Delay15_out1,
              x => x_1,  -- sfix8_En6
              e => e_1,  -- int32
  ...
  u_Divide_real_numerator_by_denominator : divider_ip_src_Divide_real_numerator_by_denominator_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              num => std_logic_vector(Delay16_out1),  -- sfix8_En6
              tNum => std_logic_vector(Delay17_out1),  -- sfix33
              den => std_logic_vector(Delay9_out1),  -- sfix8_En6
  ...
  u_Shift_and_cast_to_output_type : divider_ip_src_Shift_and_cast_to_output_type_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              x => std_logic_vector(Unit_Delay_Enabled_Synchronous_out1),  -- sfix8_En6
              shiftValue => std_logic_vector(Unit_Delay_Enabled_Synchronous1_out1),  -- sfix34
              y => Shift_and_cast_to_output_type_out1  -- sfix18_En10
              );

  u_Divide_by_zero_handler : divider_ip_src_Divide_by_zero_handler_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              yIn => std_logic_vector(Unit_Delay_Enabled_Synchronous_out1),  -- sfix8_En6
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay9_reg <= (OTHERS => to_signed(16#00#, 8));
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Unit_Delay_Enabled_Synchronous_out1 <= to_signed(16#00#, 8);
      ELSIF enb = '1' AND validOut_2 = '1' THEN
