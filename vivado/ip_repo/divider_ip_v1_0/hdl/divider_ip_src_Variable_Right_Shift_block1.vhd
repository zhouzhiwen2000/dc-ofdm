-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_Variable_Right_Shift_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_Variable_Right_Shift_block1
-- Source Path: test/divider/in_16_out_16/ForEach - Real Divide/Shift and cast to output type/Variable Right Shift
-- Hierarchy Level: 4
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_Variable_Right_Shift_block1 IS
...
END divider_ip_src_Variable_Right_Shift_block1;


ARCHITECTURE rtl OF divider_ip_src_Variable_Right_Shift_block1 IS
  ...
  SIGNAL x_signed                         : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Bit_Shift_out1                   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Switch1_out1                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Bit_Shift1_out1                  : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Switch2_out1                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Bit_Shift2_out1                  : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Switch3_out1                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Bit_Shift3_out1                  : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Switch4_out1                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Delay_out1                       : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Bit_Shift4_out1                  : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Switch5_out1                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Bit_Shift5_out1                  : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Switch6_out1                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Bit_Shift6_out1                  : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Switch7_out1                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Bit_Shift7_out1                  : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL Switch8_out1                     : signed(21 DOWNTO 0);  -- sfix22_En14
