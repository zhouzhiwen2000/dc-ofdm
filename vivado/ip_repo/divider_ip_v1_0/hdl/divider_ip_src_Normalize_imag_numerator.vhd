-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_Normalize_imag_numerator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_Normalize_imag_numerator
-- Source Path: test/divider/Complex Divide HDL Optimized/ForEach - Complex Divide/Normalize imag numerator
-- Hierarchy Level: 3
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_Normalize_imag_numerator IS
...
END divider_ip_src_Normalize_imag_numerator;


ARCHITECTURE rtl OF divider_ip_src_Normalize_imag_numerator IS
