-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_Variable_Right_Shift_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_Variable_Right_Shift_block3
-- Source Path: test/divider/in_8_out_16/ForEach - Real Divide/Shift and cast to output type/Variable Right Shift
-- Hierarchy Level: 4
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_Variable_Right_Shift_block3 IS
...
END divider_ip_src_Variable_Right_Shift_block3;


ARCHITECTURE rtl OF divider_ip_src_Variable_Right_Shift_block3 IS
  ...
  SIGNAL x_signed                         : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Bit_Shift_out1                   : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Switch1_out1                     : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Bit_Shift1_out1                  : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Switch2_out1                     : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Bit_Shift2_out1                  : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Switch3_out1                     : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Bit_Shift3_out1                  : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Switch4_out1                     : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Delay_out1                       : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Bit_Shift4_out1                  : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Switch5_out1                     : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Bit_Shift5_out1                  : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Switch6_out1                     : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Bit_Shift6_out1                  : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Switch7_out1                     : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Bit_Shift7_out1                  : signed(17 DOWNTO 0);  -- sfix18_En10
  SIGNAL Switch8_out1                     : signed(17 DOWNTO 0);  -- sfix18_En10
...
BEGIN
  ...
  Bit_Shift5_out1 <= SHIFT_RIGHT(Switch5_out1, 17);

  
  Switch6_out1 <= Switch5_out1 WHEN Delay2_out1 = '0' ELSE
      Bit_Shift5_out1;

  Bit_Shift6_out1 <= SHIFT_RIGHT(Switch6_out1, 17);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= SHIFT_RIGHT(Switch7_out1, 17);
