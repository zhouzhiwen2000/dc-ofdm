-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_ForEach_Real_Divide.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_ForEach_Real_Divide
-- Source Path: test/divider/in_16_out_16/ForEach - Real Divide
-- Hierarchy Level: 2
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_ForEach_Real_Divide IS
...
END divider_ip_src_ForEach_Real_Divide;


ARCHITECTURE rtl OF divider_ip_src_ForEach_Real_Divide IS

  -- Component Declarations
  COMPONENT divider_ip_src_Upcast_Wordlength_block
  ...
  COMPONENT divider_ip_src_Normalize_numerator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT divider_ip_src_Normalize_denominator_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En10
  ...
  COMPONENT divider_ip_src_Divide_real_numerator_by_denominator_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT divider_ip_src_Shift_and_cast_to_output_type_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT divider_ip_src_Divide_by_zero_handler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : divider_ip_src_Upcast_Wordlength_block
    USE ENTITY work.divider_ip_src_Upcast_Wordlength_block(rtl);

  FOR ALL : divider_ip_src_Normalize_numerator
    USE ENTITY work.divider_ip_src_Normalize_numerator(rtl);

  FOR ALL : divider_ip_src_MATLAB_Function1
    USE ENTITY work.divider_ip_src_MATLAB_Function1(rtl);

  FOR ALL : divider_ip_src_Normalize_denominator_block
    USE ENTITY work.divider_ip_src_Normalize_denominator_block(rtl);

  FOR ALL : divider_ip_src_Divide_real_numerator_by_denominator_block
    USE ENTITY work.divider_ip_src_Divide_real_numerator_by_denominator_block(rtl);

  FOR ALL : divider_ip_src_Shift_and_cast_to_output_type_block
    USE ENTITY work.divider_ip_src_Shift_and_cast_to_output_type_block(rtl);

  FOR ALL : divider_ip_src_Divide_by_zero_handler
    USE ENTITY work.divider_ip_src_Divide_by_zero_handler(rtl);
...
BEGIN
  u_Upcast_Wordlength : divider_ip_src_Upcast_Wordlength_block
  ...
  u_Normalize_numerator : divider_ip_src_Normalize_numerator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Normalize_denominator : divider_ip_src_Normalize_denominator_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Divide_real_numerator_by_denominator : divider_ip_src_Divide_real_numerator_by_denominator_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Shift_and_cast_to_output_type : divider_ip_src_Shift_and_cast_to_output_type_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Divide_by_zero_handler : divider_ip_src_Divide_by_zero_handler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
