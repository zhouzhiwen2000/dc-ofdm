-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/divider_ip_src_positiveRealNormalizer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: divider_ip_src_positiveRealNormalizer
-- Source Path: test/divider/Complex Divide HDL Optimized/ForEach - Complex Divide/Normalize real numerator/positiveRealNormalizer
-- Hierarchy Level: 4
-- Model version: 1.59
-- 
-- -------------------------------------------------------------
...
ENTITY divider_ip_src_positiveRealNormalizer IS
...
END divider_ip_src_positiveRealNormalizer;


ARCHITECTURE rtl OF divider_ip_src_positiveRealNormalizer IS
...
BEGIN
  ...
  embreciprocals_c3_sXqjc4GsXoHJbpeFkO2L52G_positiveRealNormalize_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS embreciprocals_c3_sXqjc4GsXoHJbpeFkO2L52G_positiveRealNormalize_process;

  embreciprocals_c3_sXqjc4GsXoHJbpeFkO2L52G_positiveRealNormalize_output : PROCESS (isNegativeReg, tReg, u_signed, validIn, validReg, xReg)
  ...
  BEGIN
    ...
    validOut <= validReg(4);
  END PROCESS embreciprocals_c3_sXqjc4GsXoHJbpeFkO2L52G_positiveRealNormalize_output;
