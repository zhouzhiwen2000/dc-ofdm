...
% 
%  Step method syntax
% [Capture_Window,Trigger_Position,data_out_re,data_out_im,peak_sync,phase_offset,M_d,reset_ofdm]=step(dco) connects to the FPGA, and read data from the FPGA.
% 
...
methods
    function obj = FPGADataCapture
        ...
        obj.setDataType('peak_sync','boolean');
        obj.setDataType('phase_offset',numerictype(1,16,15));
        obj.setDataType('M_d',numerictype(1,16,14));
        obj.setDataType('reset_ofdm','boolean');
...
properties (Nontunable, Constant)
    ...
    SamplesPerFrame = 128
    BitWidth = [32   1  16  16   1  16  16   1]
    SignalNames = {'Capture_Window','Trigger_Position','data_out_re','data_out_im','peak_sync','phase_offset','M_d','reset_ofdm'}
    IsSignalTrigger = [0  0  1  1  1  1  1  1]
    IsSignalData = [0  0  1  1  1  1  1  1]
    IsMetaData = [1  1  0  0  0  0  0  0]
    ...
    Version = '1.2'
    % Timestamp
    TimeStamp = '01-Oct-2024 08:32:25'
end
