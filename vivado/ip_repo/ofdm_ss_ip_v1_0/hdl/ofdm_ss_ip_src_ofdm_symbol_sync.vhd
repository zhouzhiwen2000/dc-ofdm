-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLOFDMSS/ofdm_ss_ip_src_ofdm_symbol_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_ss_ip_src_ofdm_symbol_sync
-- Source Path: HDLOFDMSS/hdl_wrapper/ofdm_symbol_sync
-- Hierarchy Level: 1
-- Model version: 1.113
-- 
-- -------------------------------------------------------------
...
ENTITY ofdm_ss_ip_src_ofdm_symbol_sync IS
...
END ofdm_ss_ip_src_ofdm_symbol_sync;


ARCHITECTURE rtl OF ofdm_ss_ip_src_ofdm_symbol_sync IS

  -- Component Declarations
  COMPONENT ofdm_ss_ip_src_m_cox
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT ofdm_ss_ip_src_find_peak
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT ofdm_ss_ip_src_SimpleDualPortRAM_singlebit
  ...
  COMPONENT ofdm_ss_ip_src_phase_offset_calculator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : ofdm_ss_ip_src_m_cox
    USE ENTITY work.ofdm_ss_ip_src_m_cox(rtl);

  FOR ALL : ofdm_ss_ip_src_find_peak
    USE ENTITY work.ofdm_ss_ip_src_find_peak(rtl);

  FOR ALL : ofdm_ss_ip_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.ofdm_ss_ip_src_SimpleDualPortRAM_singlebit(rtl);

  FOR ALL : ofdm_ss_ip_src_SimpleDualPortRAM_generic
    USE ENTITY work.ofdm_ss_ip_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : ofdm_ss_ip_src_phase_offset_calculator
    USE ENTITY work.ofdm_ss_ip_src_phase_offset_calculator(rtl);
...
BEGIN
  ...
  u_find_peak : ofdm_ss_ip_src_find_peak
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_ShiftRegisterRAM_singlebit : ofdm_ss_ip_src_SimpleDualPortRAM_singlebit
  ...
  u_ShiftRegisterRAM_generic : ofdm_ss_ip_src_SimpleDualPortRAM_generic
  ...
  u_phase_offset_calculator : ofdm_ss_ip_src_phase_offset_calculator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              peak_sync => find_peak_out2,
