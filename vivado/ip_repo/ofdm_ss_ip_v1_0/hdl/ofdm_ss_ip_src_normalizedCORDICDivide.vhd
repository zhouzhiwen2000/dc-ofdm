-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLOFDMSS/ofdm_ss_ip_src_normalizedCORDICDivide.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_ss_ip_src_normalizedCORDICDivide
...
ENTITY ofdm_ss_ip_src_normalizedCORDICDivide IS
...
END ofdm_ss_ip_src_normalizedCORDICDivide;


ARCHITECTURE rtl OF ofdm_ss_ip_src_normalizedCORDICDivide IS
...
BEGIN
  ...
  BEGIN
    ...
    cast := to_signed(0, 33);
    --MATLAB Function 'Divide real numerator by denominator/normalizedCORDICDivide'
