-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLOFDMSS/ofdm_ss_ip_src_find_peak.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_ss_ip_src_find_peak
-- Source Path: HDLOFDMSS/hdl_wrapper/ofdm_symbol_sync/find_peak
-- Hierarchy Level: 2
-- Model version: 1.113
-- 
-- -------------------------------------------------------------
...
ENTITY ofdm_ss_ip_src_find_peak IS
...
END ofdm_ss_ip_src_find_peak;


ARCHITECTURE rtl OF ofdm_ss_ip_src_find_peak IS
  ...
  COMPONENT ofdm_ss_ip_src_Compare_To_Constant
  ...
  FOR ALL : ofdm_ss_ip_src_Compare_To_Constant
    USE ENTITY work.ofdm_ss_ip_src_Compare_To_Constant(rtl);
...
BEGIN
  ...
  u_Compare_To_Constant : ofdm_ss_ip_src_Compare_To_Constant
