-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLOFDMSS/ofdm_ss_ip_src_calculate_P.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_ss_ip_src_calculate_P
-- Source Path: HDLOFDMSS/hdl_wrapper/ofdm_symbol_sync/m_cox/calculate_P
-- Hierarchy Level: 3
-- Model version: 1.113
-- 
-- -------------------------------------------------------------
...
ENTITY ofdm_ss_ip_src_calculate_P IS
...
END ofdm_ss_ip_src_calculate_P;


ARCHITECTURE rtl OF ofdm_ss_ip_src_calculate_P IS
  ...
  COMPONENT ofdm_ss_ip_src_complex_multiplier
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          in_a_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          in_a_im                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          in_b_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          in_b_im                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          a_times_b_re                    :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          a_times_b_im                    :   OUT   std_logic_vector(33 DOWNTO 0)  -- sfix34_En28
          );
  END COMPONENT;

  COMPONENT ofdm_ss_ip_src_complex_multiplier1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          in_a_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : ofdm_ss_ip_src_complex_multiplier
    USE ENTITY work.ofdm_ss_ip_src_complex_multiplier(rtl);

  FOR ALL : ofdm_ss_ip_src_complex_multiplier1
    USE ENTITY work.ofdm_ss_ip_src_complex_multiplier1(rtl);

  -- Signals
  SIGNAL r_d_re_signed                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL r_d_im_signed                    : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL r_d_L_im                         : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL r_d_L_re                         : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL complex_multiplier_out1_re_signed : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL complex_multiplier_out1_im_signed : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL slicedInput_2                    : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL realOutput_1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL r_d_re_1                         : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL r_d_im_1                         : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL slicedInput_3                    : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL imagOutput_1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL complex_multiplier1_out1_re_signed : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL complex_multiplier1_out1_im_signed : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Subtract1_sub_cast               : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Subtract1_sub_cast_1             : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Subtract1_sub_cast_2             : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Subtract1_sub_cast_3             : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Subtract1_out1_re                : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Subtract1_out1_im                : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL P_d_re_1                         : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL P_d_im_1                         : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL acum_re                          : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL acum_im                          : signed(34 DOWNTO 0);  -- sfix35_En28
  ...
  SIGNAL Delay12_out1                     : signed(42 DOWNTO 0);  -- sfix43_En31
  ...
  SIGNAL Delay11_out1                     : signed(42 DOWNTO 0);  -- sfix43_En31
  ...
  SIGNAL Delay16_reg_re                   : vector_of_signed35(0 TO 1);  -- sfix35_En28 [2]
  SIGNAL Delay16_reg_im                   : vector_of_signed35(0 TO 1);  -- sfix35_En28 [2]
  SIGNAL Delay16_out1_re                  : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Delay16_out1_im                  : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Delay3_reg_re                    : vector_of_signed35(0 TO 1);  -- sfix35_En28 [2]
  SIGNAL Delay3_reg_im                    : vector_of_signed35(0 TO 1);  -- sfix35_En28 [2]
  SIGNAL Delay3_out1_re                   : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Delay3_out1_im                   : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Delay4_out1_re                   : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Delay4_out1_im                   : signed(34 DOWNTO 0);  -- sfix35_En28
...
BEGIN
  ...
  u_complex_multiplier : ofdm_ss_ip_src_complex_multiplier
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              in_a_re => r_d_re,  -- sfix16_En14
              in_a_im => r_d_im,  -- sfix16_En14
              in_b_re => std_logic_vector(Conjugate1_out1_re),  -- sfix16_En14
              in_b_im => std_logic_vector(Conjugate1_out1_im),  -- sfix16_En14
              a_times_b_re => complex_multiplier_out1_re,  -- sfix34_En28
              a_times_b_im => complex_multiplier_out1_im  -- sfix34_En28
              );

  u_complex_multiplier1 : ofdm_ss_ip_src_complex_multiplier1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              in_a_re => std_logic_vector(realOutput),  -- sfix16_En14
              in_a_im => std_logic_vector(imagOutput),  -- sfix16_En14
              in_b_re => std_logic_vector(Conjugate2_out1_re),  -- sfix16_En14
              in_b_im => std_logic_vector(Conjugate2_out1_im),  -- sfix16_En14
              a_times_b_re => complex_multiplier1_out1_re,  -- sfix34_En28
              a_times_b_im => complex_multiplier1_out1_im  -- sfix34_En28
              );
  ...
  Data_Type_Conversion3_out1 <= P_d_re_1(33 DOWNTO 9);
  ...
  Data_Type_Conversion4_out1 <= P_d_re_1(33 DOWNTO 16);
  ...
  Data_Type_Conversion1_out1 <= P_d_im_1(33 DOWNTO 9);
  ...
  Data_Type_Conversion2_out1 <= P_d_im_1(33 DOWNTO 16);
