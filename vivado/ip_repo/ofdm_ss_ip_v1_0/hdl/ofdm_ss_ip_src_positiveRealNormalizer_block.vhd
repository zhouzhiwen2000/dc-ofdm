-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLOFDMSS/ofdm_ss_ip_src_positiveRealNormalizer_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_ss_ip_src_positiveRealNormalizer_block
...
ENTITY ofdm_ss_ip_src_positiveRealNormalizer_block IS
...
END ofdm_ss_ip_src_positiveRealNormalizer_block;


ARCHITECTURE rtl OF ofdm_ss_ip_src_positiveRealNormalizer_block IS
...
BEGIN
  ...
  embreciprocals_c3_positiveRealNormalizer_process : PROCESS (clk)
  BEGIN
  ...
  BEGIN
    ...
    cast := to_signed(0, 33);
    --MATLAB Function 'Real Normalizer HDL Optimized/positiveRealNormalizer'
