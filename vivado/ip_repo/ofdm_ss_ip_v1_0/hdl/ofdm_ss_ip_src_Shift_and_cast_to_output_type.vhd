-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLOFDMSS/ofdm_ss_ip_src_Shift_and_cast_to_output_type.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_ss_ip_src_Shift_and_cast_to_output_type
...
ENTITY ofdm_ss_ip_src_Shift_and_cast_to_output_type IS
...
END ofdm_ss_ip_src_Shift_and_cast_to_output_type;


ARCHITECTURE rtl OF ofdm_ss_ip_src_Shift_and_cast_to_output_type IS

  -- Component Declarations
  COMPONENT ofdm_ss_ip_src_Cast_to_Union_of_Types
  ...
  COMPONENT ofdm_ss_ip_src_Variable_Right_Shift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          x                               :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
  ...
  COMPONENT ofdm_ss_ip_src_Variable_Left_Shift
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          x                               :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
  ...
  FOR ALL : ofdm_ss_ip_src_Cast_to_Union_of_Types
    USE ENTITY work.ofdm_ss_ip_src_Cast_to_Union_of_Types(rtl);

  FOR ALL : ofdm_ss_ip_src_Variable_Right_Shift
    USE ENTITY work.ofdm_ss_ip_src_Variable_Right_Shift(rtl);

  FOR ALL : ofdm_ss_ip_src_Variable_Left_Shift
    USE ENTITY work.ofdm_ss_ip_src_Variable_Left_Shift(rtl);
...
BEGIN
  u_Cast_to_Union_of_Types : ofdm_ss_ip_src_Cast_to_Union_of_Types
    PORT MAP( Xref => std_logic_vector(Constant_out1),  -- sfix16_En14
              Cin => x,  -- sfix32_En30
              Cout => Cout  -- sfix32_En30
              );

  u_Variable_Right_Shift : ofdm_ss_ip_src_Variable_Right_Shift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              x => Cout,  -- sfix32_En30
  ...
  u_Variable_Left_Shift : ofdm_ss_ip_src_Variable_Left_Shift
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              x => Cout,  -- sfix32_En30
