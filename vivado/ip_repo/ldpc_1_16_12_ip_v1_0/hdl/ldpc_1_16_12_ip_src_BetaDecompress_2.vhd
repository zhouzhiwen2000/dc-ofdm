-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLLDPCDecoder/ldpc_1_16_12_ip_src_BetaDecompress_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ldpc_1_16_12_ip_src_BetaDecompress_2
-- Source Path: HDLLDPCDecoder/reduced_ldpc_rx_HDL_resource_test/Hc_12S_B80/DecoderCore/FunctionalUnit/BetaDecompress_2
-- Hierarchy Level: 4
-- Model version: 1.12
-- 
...
ENTITY ldpc_1_16_12_ip_src_BetaDecompress_2 IS
...
END ldpc_1_16_12_ip_src_BetaDecompress_2;


ARCHITECTURE rtl OF ldpc_1_16_12_ip_src_BetaDecompress_2 IS

  -- Component Declarations
  COMPONENT ldpc_1_16_12_ip_src_BetaCalculation_2
  ...
  FOR ALL : ldpc_1_16_12_ip_src_BetaCalculation_2
    USE ENTITY work.ldpc_1_16_12_ip_src_BetaCalculation_2(rtl);
  ...
  SIGNAL betacomp3_unsigned               : vector_of_unsigned30(0 TO 79);  -- ufix30 [80]
  ...
  SIGNAL min1_dtc                         : vector_of_unsigned15(0 TO 79);  -- ufix15 [80]
  SIGNAL sMin1                            : vector_of_unsigned16(0 TO 79);  -- ufix16_En12 [80]
  SIGNAL sMin1_1                          : vector_of_std_logic_vector16(0 TO 79);  -- ufix16 [80]
  SIGNAL min2_dtc                         : vector_of_unsigned15(0 TO 79);  -- ufix15 [80]
  SIGNAL sMin2                            : vector_of_unsigned16(0 TO 79);  -- ufix16_En12 [80]
  SIGNAL sMin2_1                          : vector_of_std_logic_vector16(0 TO 79);  -- ufix16 [80]
  SIGNAL betaReg                          : vector_of_std_logic_vector16(0 TO 79);  -- ufix16 [80]
  SIGNAL betaReg_signed                   : vector_of_signed16(0 TO 79);  -- sfix16_En12 [80]
  SIGNAL beta_tmp                         : vector_of_signed16(0 TO 79);  -- sfix16_En12 [80]

BEGIN
  u_BetaCalUnit : ldpc_1_16_12_ip_src_BetaCalculation_2
    PORT MAP( signs => signs,  -- ufix1 [80]
              prodsign => prodsign,  -- ufix1 [80]
              minidx => min_index_1,  -- ufix3 [80]
              min1 => sMin1_1,  -- ufix16_En12 [80]
              min2 => sMin2_1,  -- ufix16_En12 [80]
              count => std_logic_vector(countVal),  -- ufix3
              beta => betaReg  -- sfix16_En12 [80]
              );
  ...
  min1_dtc_gen: FOR k9 IN 0 TO 79 GENERATE
    min1_dtc(k9) <= betacomp3_unsigned(k9)(29 DOWNTO 15);
  END GENERATE min1_dtc_gen;



  sMin1_gen: FOR ii IN 0 TO 79 GENERATE
    sMin1(ii) <= resize(min1_dtc(ii), 16);
  ...
  min2_dtc_gen: FOR k10 IN 0 TO 79 GENERATE
    min2_dtc(k10) <= betacomp3_unsigned(k10)(14 DOWNTO 0);
  END GENERATE min2_dtc_gen;



  sMin2_gen: FOR ii1 IN 0 TO 79 GENERATE
    sMin2(ii1) <= resize(min2_dtc(ii1), 16);
  ...
  BEGIN
    IF reset_x = '1' THEN
      beta_tmp <= (OTHERS => to_signed(16#0000#, 16));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
