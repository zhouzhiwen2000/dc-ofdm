-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLLDPCDecoder/ldpc_1_16_12_ip_src_Hc_12S_B80.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ldpc_1_16_12_ip_src_Hc_12S_B80
...
ENTITY ldpc_1_16_12_ip_src_Hc_12S_B80 IS
...
END ldpc_1_16_12_ip_src_Hc_12S_B80;


ARCHITECTURE rtl OF ldpc_1_16_12_ip_src_Hc_12S_B80 IS

  -- Component Declarations
  COMPONENT ldpc_1_16_12_ip_src_CodeParameters
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT ldpc_1_16_12_ip_src_DecoderCore
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : ldpc_1_16_12_ip_src_CodeParameters
    USE ENTITY work.ldpc_1_16_12_ip_src_CodeParameters(rtl);

  FOR ALL : ldpc_1_16_12_ip_src_DecoderCore
    USE ENTITY work.ldpc_1_16_12_ip_src_DecoderCore(rtl);
...
BEGIN
  u_Code_Parameters : ldpc_1_16_12_ip_src_CodeParameters
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Decoder_Core : ldpc_1_16_12_ip_src_DecoderCore
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => reset,  -- ufix1
