-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLLDPCDecoder/ldpc_1_16_12_ip_src_CodeParameters.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ldpc_1_16_12_ip_src_CodeParameters
-- Source Path: HDLLDPCDecoder/reduced_ldpc_rx_HDL_resource_test/Hc_12S_B80/CodeParameters
-- Hierarchy Level: 2
-- Model version: 1.12
-- 
-- Code Parameters
...
ENTITY ldpc_1_16_12_ip_src_CodeParameters IS
...
END ldpc_1_16_12_ip_src_CodeParameters;


ARCHITECTURE rtl OF ldpc_1_16_12_ip_src_CodeParameters IS
  ...
  SIGNAL data_signed                      : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL datacp_tmp                       : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL nitero_tmp                       : unsigned(7 DOWNTO 0);  -- ufix8

BEGIN
  frameController_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  alpha0_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      reset <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  alpha0_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      datacp_tmp <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  alpha0_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      validcp <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  alpha0_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      framevalid <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  alpha0_4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      endind <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  nitero_tmp <= to_unsigned(16#04#, 8);
