-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLLDPCDecoder/ldpc_1_16_12_ip_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ldpc_1_16_12_ip_axi_lite_module
-- Source Path: ldpc_1_16_12_ip/ldpc_1_16_12_ip_axi_lite/ldpc_1_16_12_ip_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ldpc_1_16_12_ip_axi_lite_module IS
...
END ldpc_1_16_12_ip_axi_lite_module;


ARCHITECTURE rtl OF ldpc_1_16_12_ip_axi_lite_module IS
...
BEGIN
  ...
  axi_lite_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_rdata_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_wdata_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_waddr_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_wr_enb_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      wr_enb_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reg_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      soft_reset <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reset_internal <= reset_x OR soft_reset;
