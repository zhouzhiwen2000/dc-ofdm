-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLLDPCDecoder/ldpc_1_16_12_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ldpc_1_16_12_ip_axi_lite
-- Source Path: ldpc_1_16_12_ip/ldpc_1_16_12_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ldpc_1_16_12_ip_axi_lite IS
...
END ldpc_1_16_12_ip_axi_lite;


ARCHITECTURE rtl OF ldpc_1_16_12_ip_axi_lite IS

  -- Component Declarations
  COMPONENT ldpc_1_16_12_ip_addr_decoder
  ...
  COMPONENT ldpc_1_16_12_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : ldpc_1_16_12_ip_addr_decoder
    USE ENTITY work.ldpc_1_16_12_ip_addr_decoder(rtl);

  FOR ALL : ldpc_1_16_12_ip_axi_lite_module
    USE ENTITY work.ldpc_1_16_12_ip_axi_lite_module(rtl);
...
BEGIN
  u_ldpc_1_16_12_ip_addr_decoder_inst : ldpc_1_16_12_ip_addr_decoder
  ...
  u_ldpc_1_16_12_ip_axi_lite_module_inst : ldpc_1_16_12_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
