-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLDownshifter/downshift_ip_src_WaveformGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: downshift_ip_src_WaveformGen
-- Source Path: HDLDownshifter/downshifter_hdl_wrapper/downshifter/NCO/WaveformGen
-- Hierarchy Level: 3
-- Model version: 1.38
-- 
...
ENTITY downshift_ip_src_WaveformGen IS
...
END downshift_ip_src_WaveformGen;


ARCHITECTURE rtl OF downshift_ip_src_WaveformGen IS

  -- Component Declarations
  COMPONENT downshift_ip_src_CosLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT downshift_ip_src_SinLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(8 DOWNTO 0);  -- ufix9
  ...
  FOR ALL : downshift_ip_src_CosLookUpTableGen
    USE ENTITY work.downshift_ip_src_CosLookUpTableGen(rtl);

  FOR ALL : downshift_ip_src_SinLookUpTableGen
    USE ENTITY work.downshift_ip_src_SinLookUpTableGen(rtl);
...
BEGIN
  u_Cos_Wave_inst : downshift_ip_src_CosLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Sin_Wave_inst : downshift_ip_src_SinLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix9
