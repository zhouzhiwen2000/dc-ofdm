-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLDownshifter/downshift_ip_src_NCO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: downshift_ip_src_NCO
-- Source Path: HDLDownshifter/downshifter_hdl_wrapper/downshifter/NCO
-- Hierarchy Level: 2
-- Model version: 1.38
-- 
-- NCO
...
ENTITY downshift_ip_src_NCO IS
...
END downshift_ip_src_NCO;


ARCHITECTURE rtl OF downshift_ip_src_NCO IS

  -- Component Declarations
  COMPONENT downshift_ip_src_WaveformGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : downshift_ip_src_WaveformGen
    USE ENTITY work.downshift_ip_src_WaveformGen(rtl);
...
BEGIN
  u_Wave_inst : downshift_ip_src_WaveformGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
