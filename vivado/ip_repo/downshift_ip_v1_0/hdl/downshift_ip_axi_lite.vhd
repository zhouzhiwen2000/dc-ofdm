-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLDownshifter/downshift_ip_axi_lite.vhd
-- Created: 2024-09-22 22:56:55
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: downshift_ip_axi_lite
-- Source Path: downshift_ip/downshift_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY downshift_ip_axi_lite IS
...
END downshift_ip_axi_lite;


ARCHITECTURE rtl OF downshift_ip_axi_lite IS

  -- Component Declarations
  COMPONENT downshift_ip_addr_decoder
  ...
  COMPONENT downshift_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : downshift_ip_addr_decoder
    USE ENTITY work.downshift_ip_addr_decoder(rtl);

  FOR ALL : downshift_ip_axi_lite_module
    USE ENTITY work.downshift_ip_axi_lite_module(rtl);
...
BEGIN
  u_downshift_ip_addr_decoder_inst : downshift_ip_addr_decoder
  ...
  u_downshift_ip_axi_lite_module_inst : downshift_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
