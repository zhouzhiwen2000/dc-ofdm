-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLDownshifter/downshift_ip_src_downshifter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: downshift_ip_src_downshifter
-- Source Path: HDLDownshifter/downshifter_hdl_wrapper/downshifter
-- Hierarchy Level: 1
-- Model version: 1.38
-- 
-- -------------------------------------------------------------
...
ENTITY downshift_ip_src_downshifter IS
...
END downshift_ip_src_downshifter;


ARCHITECTURE rtl OF downshift_ip_src_downshifter IS

  -- Component Declarations
  COMPONENT downshift_ip_src_rising_edge_detector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT downshift_ip_src_NCO
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT downshift_ip_src_digital_carrier_receiver
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : downshift_ip_src_rising_edge_detector
    USE ENTITY work.downshift_ip_src_rising_edge_detector(rtl);

  FOR ALL : downshift_ip_src_NCO
    USE ENTITY work.downshift_ip_src_NCO(rtl);

  FOR ALL : downshift_ip_src_digital_carrier_receiver
    USE ENTITY work.downshift_ip_src_digital_carrier_receiver(rtl);
...
BEGIN
  u_rising_edge_detector : downshift_ip_src_rising_edge_detector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => Delay4_out1,
  ...
  u_digital_carrier_receiver : downshift_ip_src_digital_carrier_receiver
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
