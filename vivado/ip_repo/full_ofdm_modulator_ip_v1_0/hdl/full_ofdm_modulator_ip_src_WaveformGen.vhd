-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_WaveformGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_WaveformGen
-- Source Path: HDLModulatorFull/full_ofdm_modulator/frequency_upshift/NCO/WaveformGen
-- Hierarchy Level: 3
-- Model version: 1.21
-- 
...
ENTITY full_ofdm_modulator_ip_src_WaveformGen IS
...
END full_ofdm_modulator_ip_src_WaveformGen;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_WaveformGen IS

  -- Component Declarations
  COMPONENT full_ofdm_modulator_ip_src_CosLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT full_ofdm_modulator_ip_src_SinLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          lutaddr                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : full_ofdm_modulator_ip_src_CosLookUpTableGen
    USE ENTITY work.full_ofdm_modulator_ip_src_CosLookUpTableGen(rtl);

  FOR ALL : full_ofdm_modulator_ip_src_SinLookUpTableGen
    USE ENTITY work.full_ofdm_modulator_ip_src_SinLookUpTableGen(rtl);
...
BEGIN
  u_Cos_Wave_inst : full_ofdm_modulator_ip_src_CosLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Sin_Wave_inst : full_ofdm_modulator_ip_src_SinLookUpTableGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lutaddr => lutaddrO,  -- ufix1
