-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_Complex4Multiply_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_Complex4Multiply_block1
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF1_7/Complex4Multiply
-- Hierarchy Level: 5
-- Model version: 1.21
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_Complex4Multiply_block1 IS
...
END full_ofdm_modulator_ip_src_Complex4Multiply_block1;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_Complex4Multiply_block1 IS

  -- Signals
  SIGNAL din_7_1_re_dly_signed            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_re_reg                       : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_7_1_im_dly_signed            : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        din_re_reg <= din_7_1_re_dly_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        din_im_reg <= din_7_1_im_dly_signed;
      END IF;
    END IF;
