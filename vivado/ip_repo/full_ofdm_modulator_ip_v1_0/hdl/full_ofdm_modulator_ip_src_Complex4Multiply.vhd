-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_Complex4Multiply.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_Complex4Multiply
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF1_3/Complex4Multiply
-- Hierarchy Level: 5
-- Model version: 1.21
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_Complex4Multiply IS
...
END full_ofdm_modulator_ip_src_Complex4Multiply;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_Complex4Multiply IS

  -- Signals
  SIGNAL din_3_1_re_dly_signed            : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_re_reg                       : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_3_1_im_dly_signed            : signed(11 DOWNTO 0);  -- sfix12_En10
