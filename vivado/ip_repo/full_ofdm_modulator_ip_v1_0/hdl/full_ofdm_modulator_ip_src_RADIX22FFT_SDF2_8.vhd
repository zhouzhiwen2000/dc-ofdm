-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLModulatorFull/full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_8
-- Source Path: HDLModulatorFull/full_ofdm_modulator/ofdm_modulator/OFDM Modulator/dsphdl.IFFT/RADIX22FFT_SDF2_8
-- Hierarchy Level: 4
-- Model version: 1.21
-- 
-- -------------------------------------------------------------
...
ENTITY full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_8 IS
...
END full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_RADIX22FFT_SDF2_8 IS

  -- Component Declarations
  COMPONENT full_ofdm_modulator_ip_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : full_ofdm_modulator_ip_src_SDFCommutator8
    USE ENTITY work.full_ofdm_modulator_ip_src_SDFCommutator8(rtl);

  -- Signals
  SIGNAL dout_7_1_re_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL dout_7_1_im_signed               : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL saveEnb                          : std_logic;
  SIGNAL dinVld                           : std_logic;
  SIGNAL din_re_dly1                      : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL btfin_re                         : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL din_im_dly1                      : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL btfin_im                         : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dout_8_1_re_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL dout_8_1_im_tmp                  : std_logic_vector(11 DOWNTO 0);  -- ufix12

BEGIN
  u_SDFCOMMUTATOR_8 : full_ofdm_modulator_ip_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_8_1_re => dout_8_1_re_tmp,  -- sfix12_En10
              dout_8_1_im => dout_8_1_im_tmp,  -- sfix12_En10
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        din_re_dly1 <= to_signed(16#000#, 12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        din_im_dly1 <= to_signed(16#000#, 12);
      ELSIF enb_1_2_0 = '1' THEN
