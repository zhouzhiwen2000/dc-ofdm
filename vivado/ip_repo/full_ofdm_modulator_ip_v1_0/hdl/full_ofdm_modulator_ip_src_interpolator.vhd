...
ARCHITECTURE rtl OF full_ofdm_modulator_ip_src_interpolator IS
  ...
  SIGNAL rd_0_reg                         : std_logic_vector(8 DOWNTO 0);  -- ufix1 [9]
  ...
  SIGNAL rd_1_reg                         : std_logic_vector(16 DOWNTO 0);  -- ufix1 [17]
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        rd_0_reg(0) <= valid_in;
        rd_0_reg(8 DOWNTO 1) <= rd_0_reg(7 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS rd_0_process;

  valid_in_1 <= rd_0_reg(8);

  Logical_Operator_out1 <= valid_in OR valid_in_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        rd_1_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        rd_1_reg(0) <= FIR_Interpolator_out2;
        rd_1_reg(16 DOWNTO 1) <= rd_1_reg(15 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS rd_1_process;

  FIR_Interpolator_out2_1 <= rd_1_reg(16);
