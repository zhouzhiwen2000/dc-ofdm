-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_RADIX22FFT_SDF1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_RADIX22FFT_SDF1_5
...
ENTITY IEEE_8021513_TX_src_RADIX22FFT_SDF1_5 IS
...
END IEEE_8021513_TX_src_RADIX22FFT_SDF1_5;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_RADIX22FFT_SDF1_5 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_TX_src_Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_1_re_dly                  :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_Complex4Multiply_block
    USE ENTITY work.IEEE_8021513_TX_src_Complex4Multiply_block(rtl);

  FOR ALL : IEEE_8021513_TX_src_SimpleDualPortRAM_generic
    USE ENTITY work.IEEE_8021513_TX_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : IEEE_8021513_TX_src_SDFCommutator5
    USE ENTITY work.IEEE_8021513_TX_src_SDFCommutator5(rtl);
...
BEGIN
  u_MUL4 : IEEE_8021513_TX_src_Complex4Multiply_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dataMEM_im_0_5 : IEEE_8021513_TX_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_5 : IEEE_8021513_TX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_5 : IEEE_8021513_TX_src_SDFCommutator5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_5_vld_dly => din_5_vld_dly,
