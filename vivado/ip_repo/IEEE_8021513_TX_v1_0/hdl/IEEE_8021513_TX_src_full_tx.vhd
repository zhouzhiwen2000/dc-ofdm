...
ENTITY IEEE_8021513_TX_src_full_tx IS
  PORT( clk                               :   IN    std_logic;
        ...
        data_out                          :   OUT   std_logic_vector(15 DOWNTO 0);  -- int16
...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_full_tx IS
  ...
  COMPONENT IEEE_8021513_TX_src_falling_edge_detector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          in_rsvd                         :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_signal_ack
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_falling_edge_detector
    USE ENTITY work.IEEE_8021513_TX_src_falling_edge_detector(rtl);

  FOR ALL : IEEE_8021513_TX_src_signal_ack
    USE ENTITY work.IEEE_8021513_TX_src_signal_ack(rtl);
  ...
  SIGNAL new_frame_rised                  : std_logic;
  ...
  SIGNAL full_ofdm_modulator_out1         : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL valid_out_1                      : std_logic;
  SIGNAL full_ofdm_modulator_out1_signed  : signed(13 DOWNTO 0);  -- sfix14_En13
  SIGNAL ip_to_dac_out1                   : signed(15 DOWNTO 0);  -- int16
  SIGNAL Bit_Shift_out1                   : signed(15 DOWNTO 0);  -- int16
  SIGNAL delayMatch9_reg                  : vector_of_signed16(0 TO 5);  -- sfix16 [6]
  SIGNAL Bit_Shift_out1_1                 : signed(15 DOWNTO 0);  -- int16
  SIGNAL delayMatch10_reg                 : std_logic_vector(5 DOWNTO 0);  -- ufix1 [6]
  SIGNAL b                                : std_logic;
  SIGNAL Rate_Transition1_out1            : std_logic;
  SIGNAL signal_out                       : std_logic;
  SIGNAL delayMatch11_reg                 : std_logic_vector(5 DOWNTO 0);  -- ufix1 [6]
  SIGNAL signal_out_1                     : std_logic;
...
BEGIN
  -- Tests show that the OFDM doesn't go higher than 0.4, we can multiply by 2 to adapt to de DAC output
  ...
  u_rising_edge_detector : IEEE_8021513_TX_src_rising_edge_detector_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
              In_rsvd => new_frame_in,
              Out_rsvd => new_frame_rised
              );
  ...
  u_full_ofdm_modulator : IEEE_8021513_TX_src_full_ofdm_modulator
    PORT MAP( clk => clk,
              ...
              cp_len => store_frame_in_ram_out6,  -- uint8
              data_out => full_ofdm_modulator_out1,  -- sfix14_En13
              valid_out => valid_out_1,
              ready => ready_1
              );

  u_falling_edge_detector : IEEE_8021513_TX_src_falling_edge_detector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              in_rsvd => valid_out_1,
  ...
  u_signal_ack : IEEE_8021513_TX_src_signal_ack
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              signal_in => b,
              free_signal => Rate_Transition1_out1,
  ...
  ip_to_dac_out1 <= resize(full_ofdm_modulator_out1_signed, 16);

  Bit_Shift_out1 <= ip_to_dac_out1 sll 1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch9_reg(0) <= Bit_Shift_out1;
        delayMatch9_reg(1 TO 5) <= delayMatch9_reg(0 TO 4);
      END IF;
    END IF;
  END PROCESS delayMatch9_process;

  Bit_Shift_out1_1 <= delayMatch9_reg(5);

  data_out <= std_logic_vector(Bit_Shift_out1_1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_8_0 = '1' THEN
        Rate_Transition1_out1 <= new_frame_rised;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch11_reg(0) <= signal_out;
        delayMatch11_reg(5 DOWNTO 1) <= delayMatch11_reg(4 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch11_process;

  signal_out_1 <= delayMatch11_reg(5);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch13_reg(0) <= payload_full_out1;
        delayMatch13_reg(7 DOWNTO 1) <= delayMatch13_reg(6 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch13_process;

  payload_full_out1_1 <= delayMatch13_reg(7);
