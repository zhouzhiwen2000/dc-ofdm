...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_full_tx IS
  ...
  SIGNAL delayMatch9_reg                  : vector_of_signed14(0 TO 5);  -- sfix14 [6]
  SIGNAL full_ofdm_modulator_out1_1       : signed(13 DOWNTO 0);  -- sfix14_En13
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        delayMatch9_reg <= (OTHERS => to_signed(16#0000#, 14));
      ELSIF enb = '1' THEN
