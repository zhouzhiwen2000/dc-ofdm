-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_one_hot_coder_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_one_hot_coder_block1
...
ENTITY IEEE_8021513_TX_src_one_hot_coder_block1 IS
  PORT( preamble                          :   IN    std_logic;
        channel                           :   IN    std_logic;
        header                            :   IN    std_logic;
        cp_select                         :   OUT   std_logic_vector(1 DOWNTO 0)  -- ufix2
        );
END IEEE_8021513_TX_src_one_hot_coder_block1;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_one_hot_coder_block1 IS
