-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_Compare_To_Constant_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_Compare_To_Constant_block
...
ENTITY IEEE_8021513_TX_src_Compare_To_Constant_block IS
  PORT( u                                 :   IN    std_logic_vector(15 DOWNTO 0);  -- uint16
        y                                 :   OUT   std_logic
        );
END IEEE_8021513_TX_src_Compare_To_Constant_block;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_Compare_To_Constant_block IS
