...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_symbolFormation IS
  ...
  SIGNAL obj_symbolFormationObj_numDataScPlusNumLgScReg2_reg_reg : vector_of_unsigned9(0 TO 1);  -- ufix9 [2]
  ...
  SIGNAL obj_symbolFormationObj_dataInReg1_reg_reg_re : vector_of_signed16(0 TO 3);  -- sfix16_En14 [4]
  SIGNAL obj_symbolFormationObj_dataInReg1_reg_reg_im : vector_of_signed16(0 TO 3);  -- sfix16_En14 [4]
  ...
  SIGNAL tmp_101                          : unsigned(9 DOWNTO 0);  -- ufix10
  ...
  SIGNAL tmp_108                          : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL tmp_109                          : unsigned(9 DOWNTO 0);  -- ufix10
  ...
  SIGNAL obj_symbolFormationObj_dataOut_reg_reg_re : vector_of_signed16(0 TO 1);  -- sfix16_En14 [2]
  SIGNAL obj_symbolFormationObj_dataOut_reg_reg_im : vector_of_signed16(0 TO 1);  -- sfix16_En14 [2]
...
BEGIN
  ...
  u_simpleDualPortRam_generic : IEEE_8021513_TX_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_numDataScPlusNumLgScReg <= tmp_43;
      END IF;
    END IF;
  ...
  tmp_43 <= obj_symbolFormationObj_numDataScPlusNumLgScReg WHEN s_3 = '0' ELSE
      tmp_42;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_symbolFormationObj_numDataScPlusNumLgScReg2_reg_reg <= (OTHERS => to_unsigned(16#000#, 9));
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_numDataScPlusNumLgScReg2_reg_reg(0) <= tmp_43;
        obj_symbolFormationObj_numDataScPlusNumLgScReg2_reg_reg(1) <= obj_symbolFormationObj_numDataScPlusNumLgScReg2_reg_reg(0);
      END IF;
    END IF;
  END PROCESS obj_symbolFormationObj_numDataScPlusNumLgScReg2_reg_process;

  obj_symbolFormationObj_numDataScPlusNumLgScReg2 <= obj_symbolFormationObj_numDataScPlusNumLgScReg2_reg_reg(1);

  
  s_5 <= '1' WHEN obj_symbolFormationObj_outCountReg1 < obj_symbolFormationObj_numDataScPlusNumLgScReg2 ELSE
      '0';

  
  tmp_44 <= obj_symbolFormationObj_FFTSampled WHEN s = '0' ELSE
      obj_symbolFormationObj_FFTLenReg;

  
  tmp_45 <= obj_symbolFormationObj_FFTSampled WHEN obj_symbolFormationObj_validInReg = '0' ELSE
      tmp_44;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_FFTSampled <= tmp_45;
      END IF;
    END IF;
  ...
  tmp_46 <= obj_symbolFormationObj_numRgScSampled WHEN s = '0' ELSE
      obj_symbolFormationObj_numRgScReg;

  
  tmp_47 <= obj_symbolFormationObj_numRgScSampled WHEN obj_symbolFormationObj_validInReg = '0' ELSE
      tmp_46;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_numRgScSampled <= tmp_47;
      END IF;
    END IF;
  END PROCESS obj_symbolFormationObj_numRgScSampled_reg_process;


  tmp_48 <= obj_symbolFormationObj_FFTSampled - obj_symbolFormationObj_numRgScSampled;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_FFTLenMinusNumRgScReg <= tmp_49;
      END IF;
    END IF;
  ...
  tmp_49 <= obj_symbolFormationObj_FFTLenMinusNumRgScReg WHEN s_3 = '0' ELSE
      tmp_48;
  ...
  tmp_51 <= tmp_50 - to_unsigned(16#001#, 9);

  
  tmp_52 <= '1' WHEN tmp_50 = to_unsigned(16#001#, 9) ELSE
      '0';

  
  tmp_53 <= tmp_51 WHEN tmp_52 = '0' ELSE
  ...
  tmp_56 <= tmp_50 WHEN a0_5 = '0' ELSE
      tmp_55;

  
  tmp_57 <= tmp_50 WHEN obj_symbolFormationObj_startSymbForm_2 = '0' ELSE
      tmp_56;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_numLgScCountReg_2 <= tmp_57;
      END IF;
    END IF;
  ...
  tmp_50 <= obj_symbolFormationObj_numLgScCountReg_2 WHEN s_3 = '0' ELSE
      obj_symbolFormationObj_numLgScCount;

  
  tmp_54 <= '1' WHEN tmp_50 < to_unsigned(16#001#, 9) ELSE
      '0';
  ...
  tmp_58 <= obj_symbolFormationObj_numSampLeft WHEN tmp_52 = '0' ELSE
  ...
  tmp_59 <= tmp_50 + to_unsigned(16#001#, 9);

  
  tmp_60 <= tmp_50 WHEN s_6 = '0' ELSE
      tmp_59;

  
  tmp_61 <= tmp_58 WHEN tmp_54 = '0' ELSE
      tmp_60;

  
  tmp_62 <= obj_symbolFormationObj_numSampLeft_2 WHEN a0_5 = '0' ELSE
      tmp_61;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_numSampLeft_2 <= tmp_63;
      END IF;
    END IF;
  ...
  tmp_63 <= obj_symbolFormationObj_numSampLeft_2 WHEN obj_symbolFormationObj_startSymbForm_2 = '0' ELSE
      tmp_62;

  tmp_64 <= tmp_49 - tmp_63;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_maxLimitForDataReg <= tmp_64;
      END IF;
    END IF;
  ...
  tmp_65 <= out_rsvd_4 WHEN s_7 = '0' ELSE
      out_rsvd_6;

  
  tmp_66 <= out_rsvd_5 WHEN s_5 = '0' ELSE
      tmp_65;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_enbDataPlacing <= tmp_66;
      END IF;
    END IF;
  ...
  tmp_67 <= SHIFT_RIGHT(obj_symbolFormationObj_FFTSampled, 1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_FFTLenBy2 <= tmp_67;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_FFTLenBy2Reg <= tmp_68;
      END IF;
    END IF;
  ...
  tmp_68 <= obj_symbolFormationObj_FFTLenBy2Reg WHEN s_3 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_FFTLenBy2Reg1 <= tmp_68;
      END IF;
    END IF;
  ...
  tmp_69 <= obj_symbolFormationObj_sendDC_1 WHEN a0_6 = '0' ELSE
      obj_symbolFormationObj_sendDC_2;

  
  tmp_70 <= obj_symbolFormationObj_sendDC WHEN obj_symbolFormationObj_enbDataPlacing = '0' ELSE
      tmp_69;

  obj_symbolFormationObj_sendDC_3 <= '0';

  
  tmp_71 <= tmp_70 WHEN a0_4 = '0' ELSE
      obj_symbolFormationObj_sendDC_3;

  
  tmp_72 <= obj_symbolFormationObj_sendDC_4 WHEN obj_symbolFormationObj_startSymbFormReg2 = '0' ELSE
      tmp_71;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_sendDC_4 <= tmp_72;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_numLgScCountReg2_reg_reg(0) <= tmp_50;
  ...
  tmp_73 <= obj_symbolFormationObj_prevVecSamples_2 WHEN a0_8 = '0' ELSE
      obj_symbolFormationObj_numLgScCountReg3;

  obj_symbolFormationObj_prevVecSamples_3 <= to_unsigned(16#000#, 9);

  
  tmp_74 <= obj_symbolFormationObj_prevVecSamples_4 WHEN a0_6 = '0' ELSE
      obj_symbolFormationObj_prevVecSamples_1;

  
  tmp_75 <= obj_symbolFormationObj_prevVecSamples WHEN obj_symbolFormationObj_enbDataPlacing = '0' ELSE
      tmp_74;

  
  tmp_76 <= tmp_75 WHEN a0_4 = '0' ELSE
      tmp_73;

  
  tmp_77 <= tmp_76 WHEN a0_7 = '0' ELSE
      obj_symbolFormationObj_prevVecSamples_3;

  
  tmp_78 <= obj_symbolFormationObj_prevVecSamples_4 WHEN obj_symbolFormationObj_startSymbFormReg2 = '0' ELSE
      tmp_77;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_prevVecSamples_4 <= tmp_78;
      END IF;
    END IF;
  ...
  tmp_79 <= obj_symbolFormationObj_prevVecSamples_4 WHEN obj_symbolFormationObj_enbDataPlacing = '0' ELSE
  ...
  tmp_80 <= obj_symbolFormationObj_dataVec1Samples WHEN s_8 = '0' ELSE
      obj_symbolFormationObj_dataVec1Samples_1;

  
  tmp_81 <= tmp_80 WHEN a0_8 = '0' ELSE
      obj_symbolFormationObj_numLgScCountReg3;

  
  tmp_82 <= tmp_79 WHEN a0_4 = '0' ELSE
      tmp_81;

  
  tmp_83 <= obj_symbolFormationObj_dataVec1Samples_2 WHEN obj_symbolFormationObj_startSymbFormReg2 = '0' ELSE
      tmp_82;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_dataVec1Samples_2 <= tmp_83;
      END IF;
    END IF;
  ...
  s_10 <= '1' WHEN obj_symbolFormationObj_outCount_1 < tmp_43 ELSE
      '0';
  ...
  tmp_84 <= out_rsvd_7 WHEN s_11 = '0' ELSE
      out_rsvd_9;

  
  tmp_85 <= out_rsvd_8 WHEN s_10 = '0' ELSE
      tmp_84;
  ...
  tmp_86 <= obj_symbolFormationObj_startRead WHEN tmp_85 = '0' ELSE
  ...
  tmp_87 <= obj_symbolFormationObj_startRead_2 WHEN tmp_52 = '0' ELSE
      obj_symbolFormationObj_startRead_3;

  obj_symbolFormationObj_startRead_4 <= '1';

  
  tmp_88 <= tmp_87 WHEN tmp_54 = '0' ELSE
      obj_symbolFormationObj_startRead_4;

  
  tmp_89 <= tmp_86 WHEN a0_5 = '0' ELSE
      tmp_88;

  
  tmp_90 <= obj_symbolFormationObj_startRead_5 WHEN obj_symbolFormationObj_startSymbForm_2 = '0' ELSE
      tmp_89;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_startRead_5 <= tmp_90;
      END IF;
    END IF;
  ...
  tmp_91 <= varargin_4_unsigned(8 DOWNTO 0);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_CPLenRegDelay2 <= tmp_91;
      END IF;
    END IF;
  ...
  tmp_92 <= obj_symbolFormationObj_CPSampled WHEN s = '0' ELSE
      obj_symbolFormationObj_CPLenReg;

  
  tmp_93 <= obj_symbolFormationObj_CPSampled WHEN obj_symbolFormationObj_validInReg = '0' ELSE
      tmp_92;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_CPSampled <= tmp_93;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_CPSampledReg <= tmp_94;
      END IF;
    END IF;
  ...
  tmp_94 <= obj_symbolFormationObj_CPSampledReg WHEN s_3 = '0' ELSE
      obj_symbolFormationObj_CPSampled;

  
  tmp_95 <= '1' WHEN tmp_94 = to_unsigned(16#000#, 9) ELSE
      '0';

  tmp_96 <=  NOT obj_symbolFormationObj_selectRAM;

  
  tmp_97 <= obj_symbolFormationObj_selectRAM WHEN a0_3 = '0' ELSE
      tmp_96;

  
  tmp_98 <= obj_symbolFormationObj_selectRAM WHEN obj_symbolFormationObj_startSymbForm_2 = '0' ELSE
      tmp_97;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_selectRAM <= tmp_98;
      END IF;
    END IF;
  ...
  tmp_99 <= obj_symbolFormationObj_selectRAMReg1 WHEN tmp_95 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_RAM2ReadSelect <= tmp_99;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_symbolFormationObj_dataInReg1_reg_reg_re <= (OTHERS => to_signed(16#0000#, 16));
        obj_symbolFormationObj_dataInReg1_reg_reg_im <= (OTHERS => to_signed(16#0000#, 16));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  tmp_100 <= obj_symbolFormationObj_writeAddrRAM2_1 + to_unsigned(16#001#, 10);

  
  tmp_101 <= tmp_100 WHEN a0_2 = '0' ELSE
      obj_symbolFormationObj_writeAddrRAM2;

  
  tmp_102 <= obj_symbolFormationObj_writeAddrRAM2_1 WHEN obj_symbolFormationObj_writeEnbRAM2 = '0' ELSE
      tmp_101;

  
  tmp_103 <= tmp_102 WHEN obj_symbolFormationObj_writeEnbRAM1 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_writeAddrRAM2_1 <= tmp_103;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_numDataScMinusVecLenReg <= tmp_104;
      END IF;
    END IF;
  ...
  tmp_104 <= obj_symbolFormationObj_numDataScMinusVecLenReg WHEN s_3 = '0' ELSE
      obj_symbolFormationObj_numDataScMinusVecLen;

  tmp_105 <= obj_symbolFormationObj_readCount_1 + to_unsigned(16#001#, 9);

  
  tmp_106 <= tmp_105 WHEN a0_9 = '0' ELSE
      obj_symbolFormationObj_readCount;

  
  tmp_107 <= obj_symbolFormationObj_readCount_1 WHEN s_13 = '0' ELSE
      tmp_106;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_readCount_1 <= tmp_107;
      END IF;
    END IF;
  ...
  a0_9 <= '1' WHEN obj_symbolFormationObj_readCount_1 >= tmp_104 ELSE
      '0';

  obj_symbolFormationObj_readAddr <= to_unsigned(16#000#, 10);

  tmp_108 <= obj_symbolFormationObj_readAddr_1 + to_unsigned(16#001#, 10);

  
  tmp_109 <= tmp_108 WHEN a0_9 = '0' ELSE
      obj_symbolFormationObj_readAddr;

  
  tmp_110 <= obj_symbolFormationObj_readAddr_1 WHEN s_13 = '0' ELSE
      tmp_109;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_readAddr_1 <= tmp_110;
      END IF;
    END IF;
  ...
  tmp_111 <= obj_symbolFormationObj_writeAddrRAM1_1 + to_unsigned(16#001#, 10);

  
  tmp_112 <= tmp_111 WHEN a0_1 = '0' ELSE
      obj_symbolFormationObj_writeAddrRAM1;

  
  tmp_113 <= obj_symbolFormationObj_writeAddrRAM1_1 WHEN obj_symbolFormationObj_writeEnbRAM1 = '0' ELSE
      tmp_112;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_writeAddrRAM1_1 <= tmp_113;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_symbolFormationObj_dataOut_reg_reg_re <= (OTHERS => to_signed(16#0000#, 16));
        obj_symbolFormationObj_dataOut_reg_reg_im <= (OTHERS => to_signed(16#0000#, 16));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  tmp_114 <= obj_symbolFormationObj_validOutReg WHEN obj_symbolFormationObj_sendOutput_2 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_validOut_reg_reg(0) <= tmp_114;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_FFTSampledReg <= tmp_115;
      END IF;
    END IF;
  ...
  tmp_115 <= obj_symbolFormationObj_FFTSampledReg WHEN s_3 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_FFTLenOutReg1 <= tmp_115;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_symbolFormationObj_CPLenOutReg1 <= tmp_94;
      END IF;
    END IF;
