-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_valid_frame.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_valid_frame
...
ENTITY IEEE_8021513_TX_src_valid_frame IS
...
END IEEE_8021513_TX_src_valid_frame;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_valid_frame IS
...
BEGIN
  ...
  need_to_wrap <= '1' WHEN HDL_Counter2_out1 = to_unsigned(16#CC#, 8) ELSE
      '0';
