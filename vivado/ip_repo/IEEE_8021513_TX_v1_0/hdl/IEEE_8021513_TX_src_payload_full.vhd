...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_payload_full IS
  ...
  COMPONENT IEEE_8021513_TX_src_psdu_size_to_payload_len
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_puncturer
  ...
  COMPONENT IEEE_8021513_TX_src_payload_rep
    PORT( data_in                         :   IN    std_logic;
          ctrl_in_start                   :   IN    std_logic;
          ctrl_in_end                     :   IN    std_logic;
          ctrl_in_valid                   :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_psdu_size_to_payload_len
    USE ENTITY work.IEEE_8021513_TX_src_psdu_size_to_payload_len(rtl);
  ...
  FOR ALL : IEEE_8021513_TX_src_puncturer
    USE ENTITY work.IEEE_8021513_TX_src_puncturer(rtl);

  FOR ALL : IEEE_8021513_TX_src_payload_rep
    USE ENTITY work.IEEE_8021513_TX_src_payload_rep(rtl);
  ...
  SIGNAL y_9                              : std_logic_vector(7 DOWNTO 0);  -- ufix1 [8]
...
BEGIN
  ...
  u_psdu_size_to_payload_len : IEEE_8021513_TX_src_psdu_size_to_payload_len
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_8_0 => enb_1_8_0,
              bits_per_subcarrier => y,  -- ufix4
  ...
  u_puncturer : IEEE_8021513_TX_src_puncturer
  ...
  u_payload_rep : IEEE_8021513_TX_src_payload_rep
  ...
  count_1 <= counter WHEN Logical_Operator_out1 = '0' ELSE
      count;

  
  count_2 <= count_1 WHEN new_frame = '0' ELSE
      count_reset;
  ...
  Relational_Operator_out1 <= '1' WHEN counter >= resize(len_in_words_unsigned, 32) ELSE
      '0';
