-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_Hc_12H_B14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_Hc_12H_B14
...
ENTITY IEEE_8021513_TX_src_Hc_12H_B14 IS
...
END IEEE_8021513_TX_src_Hc_12H_B14;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_Hc_12H_B14 IS
  ...
  COMPONENT IEEE_8021513_TX_src_Calculate_Alpha
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_Calculate_Parity
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT IEEE_8021513_TX_src_Final_Output
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          reset                           :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : IEEE_8021513_TX_src_Calculate_Alpha
    USE ENTITY work.IEEE_8021513_TX_src_Calculate_Alpha(rtl);

  FOR ALL : IEEE_8021513_TX_src_Calculate_Parity
    USE ENTITY work.IEEE_8021513_TX_src_Calculate_Parity(rtl);

  FOR ALL : IEEE_8021513_TX_src_Final_Output
    USE ENTITY work.IEEE_8021513_TX_src_Final_Output(rtl);
...
BEGIN
  ...
  u_Input_RAM_singlebit : IEEE_8021513_TX_src_SimpleDualPortRAM_singlebit_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Calculate_Alpha : IEEE_8021513_TX_src_Calculate_Alpha
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Calculate_Parity : IEEE_8021513_TX_src_Calculate_Parity
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
  ...
  u_Final_output : IEEE_8021513_TX_src_Final_Output
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => extReset,  -- ufix1
