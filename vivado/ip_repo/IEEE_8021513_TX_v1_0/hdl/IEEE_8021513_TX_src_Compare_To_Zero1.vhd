-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_Compare_To_Zero1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_Compare_To_Zero1
...
ENTITY IEEE_8021513_TX_src_Compare_To_Zero1 IS
  PORT( u                                 :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
        y                                 :   OUT   std_logic
        );
END IEEE_8021513_TX_src_Compare_To_Zero1;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_Compare_To_Zero1 IS
