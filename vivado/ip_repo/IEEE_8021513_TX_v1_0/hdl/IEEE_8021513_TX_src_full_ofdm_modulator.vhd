...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_full_ofdm_modulator IS
  ...
  SIGNAL frequency_upshift_out1_signed    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Bit_Shift_out1                   : signed(15 DOWNTO 0);  -- sfix16_En15

BEGIN
  -- DAC correction factor, so that the signal goes from -1V to 1V

  u_enabled_qam_and_scrambler : IEEE_8021513_TX_src_enabled_qam_and_scrambler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in => data_in,  -- ufix2
              valid_in => valid_in,
  ...
  u_frequency_upshift : IEEE_8021513_TX_src_frequency_upshift
    PORT MAP( clk => clk,
              ...
              data_out => frequency_upshift_out1,  -- sfix16_En15
              valid_out => frequency_upshift_out2
              );

  frequency_upshift_out1_signed <= signed(frequency_upshift_out1);

  Bit_Shift_out1 <= frequency_upshift_out1_signed sll 1;

  data_out <= std_logic_vector(Bit_Shift_out1);
