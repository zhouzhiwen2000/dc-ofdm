-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_FIRFilter2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_FIRFilter2
...
ENTITY IEEE_8021513_TX_src_FIRFilter2 IS
...
END IEEE_8021513_TX_src_FIRFilter2;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_FIRFilter2 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_TX_src_FirRdyLogic_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_FilterTapSystolic
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_FirRdyLogic_block
    USE ENTITY work.IEEE_8021513_TX_src_FirRdyLogic_block(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block7(rtl);

  FOR ALL : IEEE_8021513_TX_src_FilterTapSystolic
    USE ENTITY work.IEEE_8021513_TX_src_FilterTapSystolic(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block8(rtl);

  FOR ALL : IEEE_8021513_TX_src_FilterTapSystolic_block
    USE ENTITY work.IEEE_8021513_TX_src_FilterTapSystolic_block(rtl);
  ...
  SIGNAL accDataOut                       : signed(32 DOWNTO 0);  -- sfix33_En30
  ...
  SIGNAL coeffTableOut10                  : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL delayLineEnd10deadOut            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL delayLineDataOut10               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL coeffTableRegP10_1               : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut9                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP9_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut8                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP8_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut7                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP7_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut6                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP6_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut5                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP5_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut4                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP4_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut3                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP3_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut2                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP2_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut1                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP1_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut0                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP0_1                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL sumIn                            : signed(32 DOWNTO 0);  -- sfix33_En30
  ...
  SIGNAL sumOut_6                         : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_7                         : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_8                         : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_9                         : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_9_signed                  : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL sumOutReg_1                      : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL accDataOut_1                     : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL accSwitchOut                     : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL accAdderOut                      : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL converterOut                     : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL dout_re_1                        : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL accDataOut_3                     : signed(32 DOWNTO 0);  -- sfix33_En30
  ...
  SIGNAL coeffTableOut10_1                : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL delayLineEnd10deadOut_1          : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL delayLineDataOut10_1             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL coeffTableRegP10_3               : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut9_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP9_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut8_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP8_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut7_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP7_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut6_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP6_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut5_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP5_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut4_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP4_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut3_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP3_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut2_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP2_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut1_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP1_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL coeffTableOut0_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL coeffTableRegP0_3                : signed(19 DOWNTO 0) := to_signed(16#00000#, 20);  -- sfix20_En16
  SIGNAL sumIn_1                          : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL sumOut_10                        : std_logic_vector(32 DOWNTO 0);  -- ufix33
  ...
  SIGNAL sumOut_3_1                       : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_4_1                       : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_5_1                       : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_6_1                       : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_7_1                       : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_8_1                       : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_9_1                       : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL sumOut_9_signed_1                : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL sumOutReg_3                      : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL accDataOut_4                     : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL accSwitchOut_1                   : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL accAdderOut_1                    : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL converterOut_1                   : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL dout_im_1                        : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL dataZero                         : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL dataZero_dtc_re                  : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL dataZero_dtc_im                  : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL dout_cmplxSW_re                  : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL dout_cmplxSW_im                  : signed(19 DOWNTO 0);  -- sfix20_En16

BEGIN
  u_firRdyLogic : IEEE_8021513_TX_src_FirRdyLogic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine10 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              delayLineEnd => delayLineEnd10deadOut,  -- sfix16_En14
              dataOut => delayLineDataOut10  -- sfix16_En14
              );

  u_filterTap0 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut0,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP0_1),  -- sfix20_En16
              sumIn => std_logic_vector(sumIn),  -- sfix33_En30
              sumOut => sumOut  -- sfix33_En30
              );

  u_filterTap1 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP1_1),  -- sfix20_En16
              sumIn => sumOut,  -- sfix33_En30
              sumOut => sumOut_0  -- sfix33_En30
              );

  u_filterTap2 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut2,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP2_1),  -- sfix20_En16
              sumIn => sumOut_0,  -- sfix33_En30
              sumOut => sumOut_1  -- sfix33_En30
              );

  u_filterTap3 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut3,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP3_1),  -- sfix20_En16
              sumIn => sumOut_1,  -- sfix33_En30
              sumOut => sumOut_2  -- sfix33_En30
              );

  u_filterTap4 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut4,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP4_1),  -- sfix20_En16
              sumIn => sumOut_2,  -- sfix33_En30
              sumOut => sumOut_3  -- sfix33_En30
              );

  u_filterTap5 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut5,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP5_1),  -- sfix20_En16
              sumIn => sumOut_3,  -- sfix33_En30
              sumOut => sumOut_4  -- sfix33_En30
              );

  u_filterTap6 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut6,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP6_1),  -- sfix20_En16
              sumIn => sumOut_4,  -- sfix33_En30
              sumOut => sumOut_5  -- sfix33_En30
              );

  u_filterTap7 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut7,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP7_1),  -- sfix20_En16
              sumIn => sumOut_5,  -- sfix33_En30
              sumOut => sumOut_6  -- sfix33_En30
              );

  u_filterTap8 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut8,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP8_1),  -- sfix20_En16
              sumIn => sumOut_6,  -- sfix33_En30
              sumOut => sumOut_7  -- sfix33_En30
              );

  u_filterTap9 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut9,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP9_1),  -- sfix20_En16
              sumIn => sumOut_7,  -- sfix33_En30
              sumOut => sumOut_8  -- sfix33_En30
              );

  u_filterTap10 : IEEE_8021513_TX_src_FilterTapSystolic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut10,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP10_1),  -- sfix20_En16
              sumIn => sumOut_8,  -- sfix33_En30
              sumOut => sumOut_9  -- sfix33_En30
              );

  u_delayLine0_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine10_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              wrEn => delayLineShiftEn10_1,
              rdAddr => rdAddr10,  -- ufix1
              delayLineEnd => delayLineEnd10deadOut_1,  -- sfix16_En14
              dataOut => delayLineDataOut10_1  -- sfix16_En14
              );

  u_filterTap0_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut0_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP0_3),  -- sfix20_En16
              sumIn => std_logic_vector(sumIn_1),  -- sfix33_En30
              sumOut => sumOut_10  -- sfix33_En30
              );

  u_filterTap1_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut1_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP1_3),  -- sfix20_En16
              sumIn => sumOut_10,  -- sfix33_En30
              sumOut => sumOut_0_1  -- sfix33_En30
              );

  u_filterTap2_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut2_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP2_3),  -- sfix20_En16
              sumIn => sumOut_0_1,  -- sfix33_En30
              sumOut => sumOut_1_1  -- sfix33_En30
              );

  u_filterTap3_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut3_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP3_3),  -- sfix20_En16
              sumIn => sumOut_1_1,  -- sfix33_En30
              sumOut => sumOut_2_1  -- sfix33_En30
              );

  u_filterTap4_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut4_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP4_3),  -- sfix20_En16
              sumIn => sumOut_2_1,  -- sfix33_En30
              sumOut => sumOut_3_1  -- sfix33_En30
              );

  u_filterTap5_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut5_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP5_3),  -- sfix20_En16
              sumIn => sumOut_3_1,  -- sfix33_En30
              sumOut => sumOut_4_1  -- sfix33_En30
              );

  u_filterTap6_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut6_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP6_3),  -- sfix20_En16
              sumIn => sumOut_4_1,  -- sfix33_En30
              sumOut => sumOut_5_1  -- sfix33_En30
              );

  u_filterTap7_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut7_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP7_3),  -- sfix20_En16
              sumIn => sumOut_5_1,  -- sfix33_En30
              sumOut => sumOut_6_1  -- sfix33_En30
              );

  u_filterTap8_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut8_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP8_3),  -- sfix20_En16
              sumIn => sumOut_6_1,  -- sfix33_En30
              sumOut => sumOut_7_1  -- sfix33_En30
              );

  u_filterTap9_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut9_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP9_3),  -- sfix20_En16
              sumIn => sumOut_7_1,  -- sfix33_En30
              sumOut => sumOut_8_1  -- sfix33_En30
              );

  u_filterTap10_1 : IEEE_8021513_TX_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut10_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableRegP10_3),  -- sfix20_En16
              sumIn => sumOut_8_1,  -- sfix33_En30
              sumOut => sumOut_9_1  -- sfix33_En30
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        validOutLookahead_reg(0) <= delayLineShiftEn10_1;
  ...
  BEGIN
    CASE rdAddr10 IS
      WHEN '0' =>
        coeffTableOut10 <= to_signed(-16#00096#, 20);
      WHEN '1' =>
        coeffTableOut10 <= to_signed(16#00000#, 20);
      WHEN OTHERS => 
        coeffTableOut10 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr9 IS
      WHEN '0' =>
        coeffTableOut9 <= to_signed(-16#0020D#, 20);
      WHEN '1' =>
        coeffTableOut9 <= to_signed(16#00122#, 20);
      WHEN OTHERS => 
        coeffTableOut9 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr8 IS
      WHEN '0' =>
        coeffTableOut8 <= to_signed(-16#004C1#, 20);
      WHEN '1' =>
        coeffTableOut8 <= to_signed(16#00345#, 20);
      WHEN OTHERS => 
        coeffTableOut8 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr7 IS
      WHEN '0' =>
        coeffTableOut7 <= to_signed(-16#00817#, 20);
      WHEN '1' =>
        coeffTableOut7 <= to_signed(16#00667#, 20);
      WHEN OTHERS => 
        coeffTableOut7 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr6 IS
      WHEN '0' =>
        coeffTableOut6 <= to_signed(-16#00AE7#, 20);
      WHEN '1' =>
        coeffTableOut6 <= to_signed(16#009A4#, 20);
      WHEN OTHERS => 
        coeffTableOut6 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr5 IS
      WHEN '0' =>
        coeffTableOut5 <= to_signed(16#0F3FF#, 20);
      WHEN '1' =>
        coeffTableOut5 <= to_signed(16#00BB8#, 20);
      WHEN OTHERS => 
        coeffTableOut5 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4 <= to_signed(-16#00AE7#, 20);
      WHEN '1' =>
        coeffTableOut4 <= to_signed(16#00BB8#, 20);
      WHEN OTHERS => 
        coeffTableOut4 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3 <= to_signed(-16#00817#, 20);
      WHEN '1' =>
        coeffTableOut3 <= to_signed(16#009A4#, 20);
      WHEN OTHERS => 
        coeffTableOut3 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2 <= to_signed(-16#004C1#, 20);
      WHEN '1' =>
        coeffTableOut2 <= to_signed(16#00667#, 20);
      WHEN OTHERS => 
        coeffTableOut2 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1 <= to_signed(-16#0020D#, 20);
      WHEN '1' =>
        coeffTableOut1 <= to_signed(16#00345#, 20);
      WHEN OTHERS => 
        coeffTableOut1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0 <= to_signed(-16#00096#, 20);
      WHEN '1' =>
        coeffTableOut0 <= to_signed(16#00122#, 20);
      WHEN OTHERS => 
        coeffTableOut0 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  sumOut_9_signed <= signed(sumOut_9);
  ...
  converterOut <= resize(accDataOut_1(32 DOWNTO 14), 20);

  dout_re_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        dout_re_1 <= to_signed(16#00000#, 20);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        validOutLookahead_reg_1(0) <= delayLineShiftEn10_1;
  ...
  BEGIN
    CASE rdAddr10 IS
      WHEN '0' =>
        coeffTableOut10_1 <= to_signed(-16#00096#, 20);
      WHEN '1' =>
        coeffTableOut10_1 <= to_signed(16#00000#, 20);
      WHEN OTHERS => 
        coeffTableOut10_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr9 IS
      WHEN '0' =>
        coeffTableOut9_1 <= to_signed(-16#0020D#, 20);
      WHEN '1' =>
        coeffTableOut9_1 <= to_signed(16#00122#, 20);
      WHEN OTHERS => 
        coeffTableOut9_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr8 IS
      WHEN '0' =>
        coeffTableOut8_1 <= to_signed(-16#004C1#, 20);
      WHEN '1' =>
        coeffTableOut8_1 <= to_signed(16#00345#, 20);
      WHEN OTHERS => 
        coeffTableOut8_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr7 IS
      WHEN '0' =>
        coeffTableOut7_1 <= to_signed(-16#00817#, 20);
      WHEN '1' =>
        coeffTableOut7_1 <= to_signed(16#00667#, 20);
      WHEN OTHERS => 
        coeffTableOut7_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr6 IS
      WHEN '0' =>
        coeffTableOut6_1 <= to_signed(-16#00AE7#, 20);
      WHEN '1' =>
        coeffTableOut6_1 <= to_signed(16#009A4#, 20);
      WHEN OTHERS => 
        coeffTableOut6_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr5 IS
      WHEN '0' =>
        coeffTableOut5_1 <= to_signed(16#0F3FF#, 20);
      WHEN '1' =>
        coeffTableOut5_1 <= to_signed(16#00BB8#, 20);
      WHEN OTHERS => 
        coeffTableOut5_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4_1 <= to_signed(-16#00AE7#, 20);
      WHEN '1' =>
        coeffTableOut4_1 <= to_signed(16#00BB8#, 20);
      WHEN OTHERS => 
        coeffTableOut4_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3_1 <= to_signed(-16#00817#, 20);
      WHEN '1' =>
        coeffTableOut3_1 <= to_signed(16#009A4#, 20);
      WHEN OTHERS => 
        coeffTableOut3_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2_1 <= to_signed(-16#004C1#, 20);
      WHEN '1' =>
        coeffTableOut2_1 <= to_signed(16#00667#, 20);
      WHEN OTHERS => 
        coeffTableOut2_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1_1 <= to_signed(-16#0020D#, 20);
      WHEN '1' =>
        coeffTableOut1_1 <= to_signed(16#00345#, 20);
      WHEN OTHERS => 
        coeffTableOut1_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0_1 <= to_signed(-16#00096#, 20);
      WHEN '1' =>
        coeffTableOut0_1 <= to_signed(16#00122#, 20);
      WHEN OTHERS => 
        coeffTableOut0_1 <= to_signed(16#00000#, 20);
    END CASE;
  ...
  sumOut_9_signed_1 <= signed(sumOut_9_1);
  ...
  converterOut_1 <= resize(accDataOut_4(32 DOWNTO 14), 20);

  dout_im_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        dout_im_1 <= to_signed(16#00000#, 20);
  ...
  dataZero <= to_signed(16#00000#, 20);

  dataZero_dtc_re <= dataZero;
  dataZero_dtc_im <= to_signed(16#00000#, 20);
