-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_one_hot_coder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_one_hot_coder
...
ENTITY IEEE_8021513_TX_src_one_hot_coder IS
  PORT( preamble                          :   IN    std_logic;
        channel                           :   IN    std_logic;
        header                            :   IN    std_logic;
        bits_per_subcarrier_select        :   OUT   std_logic_vector(1 DOWNTO 0)  -- ufix2
        );
END IEEE_8021513_TX_src_one_hot_coder;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_one_hot_coder IS
