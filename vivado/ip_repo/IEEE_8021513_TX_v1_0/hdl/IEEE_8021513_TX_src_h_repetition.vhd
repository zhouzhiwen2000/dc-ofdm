-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_h_repetition.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_h_repetition
...
ENTITY IEEE_8021513_TX_src_h_repetition IS
...
END IEEE_8021513_TX_src_h_repetition;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_h_repetition IS

  -- Component Declarations
  COMPONENT IEEE_8021513_TX_src_SimpleDualPortRAM_singlebit
  ...
  COMPONENT IEEE_8021513_TX_src_Sample_Control_Bus_Creator_block2
  ...
  FOR ALL : IEEE_8021513_TX_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.IEEE_8021513_TX_src_SimpleDualPortRAM_singlebit(rtl);

  FOR ALL : IEEE_8021513_TX_src_Sample_Control_Bus_Creator_block2
    USE ENTITY work.IEEE_8021513_TX_src_Sample_Control_Bus_Creator_block2(rtl);
...
BEGIN
  u_Simple_Dual_Port_RAM : IEEE_8021513_TX_src_SimpleDualPortRAM_singlebit
  ...
  u_Sample_Control_Bus_Creator : IEEE_8021513_TX_src_Sample_Control_Bus_Creator_block2
  ...
  need_to_wrap <= '1' WHEN addrA = to_unsigned(16#049#, 9) ELSE
      '0';
