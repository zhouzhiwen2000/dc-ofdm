-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_RADIX22FFT_SDF1_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_RADIX22FFT_SDF1_3
...
ENTITY IEEE_8021513_TX_src_RADIX22FFT_SDF1_3 IS
...
END IEEE_8021513_TX_src_RADIX22FFT_SDF1_3;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_RADIX22FFT_SDF1_3 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_TX_src_Complex4Multiply
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_3_1_re_dly                  :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_SDFCommutator3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_Complex4Multiply
    USE ENTITY work.IEEE_8021513_TX_src_Complex4Multiply(rtl);

  FOR ALL : IEEE_8021513_TX_src_SimpleDualPortRAM_generic
    USE ENTITY work.IEEE_8021513_TX_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : IEEE_8021513_TX_src_SDFCommutator3
    USE ENTITY work.IEEE_8021513_TX_src_SDFCommutator3(rtl);
...
BEGIN
  u_MUL4 : IEEE_8021513_TX_src_Complex4Multiply
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_dataMEM_im_0_3 : IEEE_8021513_TX_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_3 : IEEE_8021513_TX_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_3 : IEEE_8021513_TX_src_SDFCommutator3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              din_3_vld_dly => din_3_vld_dly,
