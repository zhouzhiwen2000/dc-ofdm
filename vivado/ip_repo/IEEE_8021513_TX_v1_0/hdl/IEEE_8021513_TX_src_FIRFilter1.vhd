-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_FIRFilter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_FIRFilter1
...
ENTITY IEEE_8021513_TX_src_FIRFilter1 IS
...
END IEEE_8021513_TX_src_FIRFilter1;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_FIRFilter1 IS

  -- Component Declarations
  COMPONENT IEEE_8021513_TX_src_FirRdyLogic
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_Addressable_Delay_Line_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_FirRdyLogic
    USE ENTITY work.IEEE_8021513_TX_src_FirRdyLogic(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block1
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block1(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block2
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block2(rtl);

  FOR ALL : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    USE ENTITY work.IEEE_8021513_TX_src_FilterTapSystolicPreAdd(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block3(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block4
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block4(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block5
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block5(rtl);

  FOR ALL : IEEE_8021513_TX_src_Addressable_Delay_Line_block6
    USE ENTITY work.IEEE_8021513_TX_src_Addressable_Delay_Line_block6(rtl);

  FOR ALL : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    USE ENTITY work.IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block(rtl);
  ...
  SIGNAL accDataOut                       : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL coeffTableReg5_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg4_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg3_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg2_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg1_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL delayLineEnd11deadOut            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL coeffTableReg0_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL sumIn                            : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL sumOut_2                         : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_3                         : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_4                         : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_4_signed                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL sumOutReg_1                      : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL accDataOut_1                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL accSwitchOut                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL accAdderOut                      : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL accDataOut_3                     : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL coeffTableReg5_3                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg4_3                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg3_3                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg2_3                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg1_3                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL delayLineEnd11deadOut_1          : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL coeffTableReg0_3                 : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL sumIn_1                          : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL sumOut_5                         : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_0_1                       : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_1_1                       : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_2_1                       : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_3_1                       : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_4_1                       : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL sumOut_4_signed_1                : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL sumOutReg_3                      : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL accDataOut_4                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL accSwitchOut_1                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL accAdderOut_1                    : signed(33 DOWNTO 0);  -- sfix34_En30
...
BEGIN
  u_firRdyLogic : IEEE_8021513_TX_src_FirRdyLogic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : IEEE_8021513_TX_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1 : IEEE_8021513_TX_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : IEEE_8021513_TX_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : IEEE_8021513_TX_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4 : IEEE_8021513_TX_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5 : IEEE_8021513_TX_src_Addressable_Delay_Line_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8 : IEEE_8021513_TX_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9 : IEEE_8021513_TX_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd8,  -- sfix16_En14
  ...
  u_delayLine10 : IEEE_8021513_TX_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd9,  -- sfix16_En14
  ...
  u_delayLine11 : IEEE_8021513_TX_src_Addressable_Delay_Line_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd10,  -- sfix16_En14
              validIn => delayLineShiftEn1_1,
              rdAddr => rdAddr1,  -- ufix1
              delayLineEnd => delayLineEnd11deadOut,  -- sfix16_En14
              dataOut => delayLineDataOut11  -- sfix16_En14
              );

  u_filterTap0 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut0,  -- sfix16_En14
              preAddIn => delayLineDataOut11,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg0_1),  -- sfix20_En16
              sumIn => std_logic_vector(sumIn),  -- sfix34_En30
              sumOut => sumOut  -- sfix34_En30
              );

  u_filterTap1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut1,  -- sfix16_En14
              preAddIn => delayLineDataOut10,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg1_1),  -- sfix20_En16
              sumIn => sumOut,  -- sfix34_En30
              sumOut => sumOut_0  -- sfix34_En30
              );

  u_filterTap2 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut2,  -- sfix16_En14
              preAddIn => delayLineDataOut9,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg2_1),  -- sfix20_En16
              sumIn => sumOut_0,  -- sfix34_En30
              sumOut => sumOut_1  -- sfix34_En30
              );

  u_filterTap3 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut3,  -- sfix16_En14
              preAddIn => delayLineDataOut8,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg3_1),  -- sfix20_En16
              sumIn => sumOut_1,  -- sfix34_En30
              sumOut => sumOut_2  -- sfix34_En30
              );

  u_filterTap4 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut4,  -- sfix16_En14
              preAddIn => delayLineDataOut7,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg4_1),  -- sfix20_En16
              sumIn => sumOut_2,  -- sfix34_En30
              sumOut => sumOut_3  -- sfix34_En30
              );

  u_filterTap5 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut5,  -- sfix16_En14
              preAddIn => delayLineDataOut6,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg5_1),  -- sfix20_En16
              sumIn => sumOut_3,  -- sfix34_En30
              sumOut => sumOut_4  -- sfix34_En30
              );

  u_delayLine0_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine5_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd8_1,  -- sfix16_En14
              validIn => delayLineShiftEn3_1,
              rdAddr => rdAddr3,  -- ufix1
  ...
  u_delayLine10_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd9_1,  -- sfix16_En14
              validIn => delayLineShiftEn2_1,
              rdAddr => rdAddr2,  -- ufix1
  ...
  u_delayLine11_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd10_1,  -- sfix16_En14
              validIn => delayLineShiftEn1_1,
              rdAddr => rdAddr1,  -- ufix1
              delayLineEnd => delayLineEnd11deadOut_1,  -- sfix16_En14
              dataOut => delayLineDataOut11_1  -- sfix16_En14
              );

  u_filterTap0_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut0_1,  -- sfix16_En14
              preAddIn => delayLineDataOut11_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg0_3),  -- sfix20_En16
              sumIn => std_logic_vector(sumIn_1),  -- sfix34_En30
              sumOut => sumOut_5  -- sfix34_En30
              );

  u_filterTap1_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut1_1,  -- sfix16_En14
              preAddIn => delayLineDataOut10_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg1_3),  -- sfix20_En16
              sumIn => sumOut_5,  -- sfix34_En30
              sumOut => sumOut_0_1  -- sfix34_En30
              );

  u_filterTap2_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut2_1,  -- sfix16_En14
              preAddIn => delayLineDataOut9_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg2_3),  -- sfix20_En16
              sumIn => sumOut_0_1,  -- sfix34_En30
              sumOut => sumOut_1_1  -- sfix34_En30
              );

  u_filterTap3_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut3_1,  -- sfix16_En14
              preAddIn => delayLineDataOut8_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg3_3),  -- sfix20_En16
              sumIn => sumOut_1_1,  -- sfix34_En30
              sumOut => sumOut_2_1  -- sfix34_En30
              );

  u_filterTap4_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut4_1,  -- sfix16_En14
              preAddIn => delayLineDataOut7_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg4_3),  -- sfix20_En16
              sumIn => sumOut_2_1,  -- sfix34_En30
              sumOut => sumOut_3_1  -- sfix34_En30
              );

  u_filterTap5_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut5_1,  -- sfix16_En14
              preAddIn => delayLineDataOut6_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg5_3),  -- sfix20_En16
              sumIn => sumOut_3_1,  -- sfix34_En30
              sumOut => sumOut_4_1  -- sfix34_En30
              );
  ...
  BEGIN
    CASE rdAddr5 IS
      WHEN '0' =>
        coeffTableOut5 <= to_signed(16#0A1A9#, 20);
      WHEN '1' =>
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg5_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4 <= to_signed(16#01A81#, 20);
      WHEN '1' =>
        coeffTableOut4 <= to_signed(-16#03279#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg4_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3 <= to_signed(16#008F1#, 20);
      WHEN '1' =>
        coeffTableOut3 <= to_signed(-16#00F62#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg3_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2 <= to_signed(16#00271#, 20);
      WHEN '1' =>
        coeffTableOut2 <= to_signed(-16#004ED#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg2_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1 <= to_signed(16#00039#, 20);
      WHEN '1' =>
        coeffTableOut1 <= to_signed(-16#000FB#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg1_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0 <= to_signed(-16#0004C#, 20);
      WHEN '1' =>
        coeffTableOut0 <= to_signed(16#00015#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg0_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  sumOut_4_signed <= signed(sumOut_4);
  ...
  converterOut <= accDataOut_1(33 DOWNTO 14);
  ...
  BEGIN
    CASE rdAddr5 IS
      WHEN '0' =>
        coeffTableOut5_1 <= to_signed(16#0A1A9#, 20);
      WHEN '1' =>
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg5_3 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4_1 <= to_signed(16#01A81#, 20);
      WHEN '1' =>
        coeffTableOut4_1 <= to_signed(-16#03279#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg4_3 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3_1 <= to_signed(16#008F1#, 20);
      WHEN '1' =>
        coeffTableOut3_1 <= to_signed(-16#00F62#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg3_3 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2_1 <= to_signed(16#00271#, 20);
      WHEN '1' =>
        coeffTableOut2_1 <= to_signed(-16#004ED#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg2_3 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1_1 <= to_signed(16#00039#, 20);
      WHEN '1' =>
        coeffTableOut1_1 <= to_signed(-16#000FB#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg1_3 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0_1 <= to_signed(-16#0004C#, 20);
      WHEN '1' =>
        coeffTableOut0_1 <= to_signed(16#00015#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg0_3 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  sumOut_4_signed_1 <= signed(sumOut_4_1);
  ...
  converterOut_1 <= accDataOut_4(33 DOWNTO 14);
