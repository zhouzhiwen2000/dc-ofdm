-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_dut.vhd
-- Created: 2024-10-27 17:10:08
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_dut
-- Source Path: IEEE_8021513_TX/IEEE_8021513_TX_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IEEE_8021513_TX_dut IS
  PORT( clk                               :   IN    std_logic;
        ...
        data_out                          :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16
        valid_out                         :   OUT   std_logic;  -- ufix1
        new_msg_ready                     :   OUT   std_logic;  -- ufix1
...
END IEEE_8021513_TX_dut;


ARCHITECTURE rtl OF IEEE_8021513_TX_dut IS

  -- Component Declarations
  COMPONENT IEEE_8021513_TX_src_full_tx
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_full_tx
    USE ENTITY work.IEEE_8021513_TX_src_full_tx(rtl);
  ...
  SIGNAL new_msg_ready_sig                : std_logic;  -- ufix1
...
BEGIN
  u_IEEE_8021513_TX_src_full_tx : IEEE_8021513_TX_src_full_tx
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
              ...
              data_out => data_out_sig,  -- sfix16
              valid_out => valid_out_sig,  -- ufix1
              new_msg_ready => new_msg_ready_sig,  -- ufix1
  ...
  new_msg_ready <= new_msg_ready_sig;

  ready <= ready_sig;

  debug_payload <= debug_payload_sig;

  debug_payload_ctrl_start <= debug_payload_ctrl_start_sig;

  debug_payload_ctrl_end <= debug_payload_ctrl_end_sig;

  debug_payload_ctrl_valid <= debug_payload_ctrl_valid_sig;
