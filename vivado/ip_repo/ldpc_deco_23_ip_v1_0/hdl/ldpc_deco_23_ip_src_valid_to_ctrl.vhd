-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/ldpc_deco_23_ip_src_valid_to_ctrl.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ldpc_deco_23_ip_src_valid_to_ctrl
-- Source Path: test/ldpc_deco_23/valid_to_ctrl
-- Hierarchy Level: 1
-- Model version: 1.55
-- 
-- -------------------------------------------------------------
...
ENTITY ldpc_deco_23_ip_src_valid_to_ctrl IS
...
END ldpc_deco_23_ip_src_valid_to_ctrl;


ARCHITECTURE rtl OF ldpc_deco_23_ip_src_valid_to_ctrl IS

  -- Component Declarations
  COMPONENT ldpc_deco_23_ip_src_Sample_Control_Bus_Creator
  ...
  FOR ALL : ldpc_deco_23_ip_src_Sample_Control_Bus_Creator
    USE ENTITY work.ldpc_deco_23_ip_src_Sample_Control_Bus_Creator(rtl);
...
BEGIN
  u_Sample_Control_Bus_Creator : ldpc_deco_23_ip_src_Sample_Control_Bus_Creator
    PORT MAP( In1 => start,
              In2 => end_rsvd,
              In3 => valid,
