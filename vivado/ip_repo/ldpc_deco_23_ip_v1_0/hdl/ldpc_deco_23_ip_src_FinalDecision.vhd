-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/ldpc_deco_23_ip_src_FinalDecision.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ldpc_deco_23_ip_src_FinalDecision
-- Source Path: test/ldpc_deco_23/LDPC Decoder/DecoderCore/FinalDecision
-- Hierarchy Level: 3
-- Model version: 1.55
-- 
-- Final Decision
...
ENTITY ldpc_deco_23_ip_src_FinalDecision IS
...
END ldpc_deco_23_ip_src_FinalDecision;


ARCHITECTURE rtl OF ldpc_deco_23_ip_src_FinalDecision IS

  -- Signals
  SIGNAL data_signed                      : vector_of_signed6(0 TO 47);  -- sfix6 [48]
  SIGNAL finalDecision_enb_dec            : std_logic;
  SIGNAL finalDecision_count              : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL finalDecision_iterDone           : std_logic;
  SIGNAL finalDecision_zCount1            : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL finalDecision_zCount2            : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL finalDecision_count_next         : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL finalDecision_iterDone_next      : std_logic;
  SIGNAL finalDecision_zCount1_next       : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL finalDecision_zCount2_next       : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL data_1                           : std_logic_vector(47 DOWNTO 0);  -- ufix1 [48]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        ...
        finalDecision_count <= to_unsigned(16#01#, 5);
        finalDecision_iterDone <= '0';
        finalDecision_zCount1 <= to_unsigned(16#00#, 6);
        finalDecision_zCount2 <= to_unsigned(16#00#, 6);
  ...
  finalDecision_output : PROCESS (data_signed, finalDecision_cntEnb, finalDecision_count, finalDecision_ctrlEnd,
    ...
    VARIABLE count_temp : unsigned(4 DOWNTO 0);
    VARIABLE zCount1_temp : unsigned(5 DOWNTO 0);
    VARIABLE zCount2_temp : unsigned(5 DOWNTO 0);
  ...
  BEGIN
    ...
    IF reset /= '0' THEN 
      enb_dec_temp := '0';
      count_temp := to_unsigned(16#01#, 5);
      zCount1_temp := to_unsigned(16#00#, 6);
      zCount2_temp := to_unsigned(16#00#, 6);
      cntEnb_temp := '0';
      endD_temp := '0';
      ctrlEnd_temp := '0';
      starto := '0';
    ...
    IF enb_dec_temp = '1' THEN 
      IF zCount1_temp = to_unsigned(16#30#, 6) THEN 
        zCount1_temp := to_unsigned(16#01#, 6);
        cntEnb_temp := '1';
      ELSE 
        zCount1_temp := zCount1_temp + to_unsigned(16#01#, 6);
        cntEnb_temp := '0';
      END IF;
      IF cntEnb_temp = '1' THEN 
        IF count_temp = to_unsigned(16#13#, 5) THEN 
          endD_temp := '1';
          enb_dec_temp := '0';
        ELSE 
          count_temp := count_temp + to_unsigned(16#01#, 5);
        END IF;
      END IF;
      validi := '1';
    ELSE 
    ...
    END IF;
    IF endD_temp = '1' THEN 
      IF zCount2_temp = to_unsigned(16#2F#, 6) THEN 
        zCount2_temp := to_unsigned(16#00#, 6);
        ctrlEnd_temp := '1';
        endD_temp := '0';
      ELSE 
        ctrlEnd_temp := '0';
        zCount2_temp := zCount2_temp + to_unsigned(16#01#, 6);
      END IF;
    ELSE 
      ctrlEnd_temp := '0';
    END IF;
    ...
    FOR t_0 IN 0 TO 47 LOOP
      IF data_signed(t_0) <= to_signed(16#00#, 6) THEN 
        data_1(t_0) <= '1';
      ELSE 
        data_1(t_0) <= '0';
      END IF;
