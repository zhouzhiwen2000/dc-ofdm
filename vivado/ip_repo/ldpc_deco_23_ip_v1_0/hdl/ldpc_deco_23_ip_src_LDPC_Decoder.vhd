-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test/ldpc_deco_23_ip_src_LDPC_Decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ldpc_deco_23_ip_src_LDPC_Decoder
-- Source Path: test/ldpc_deco_23/LDPC Decoder
-- Hierarchy Level: 1
-- Model version: 1.55
-- 
-- LDPC Decoder
...
ENTITY ldpc_deco_23_ip_src_LDPC_Decoder IS
...
END ldpc_deco_23_ip_src_LDPC_Decoder;


ARCHITECTURE rtl OF ldpc_deco_23_ip_src_LDPC_Decoder IS

  -- Component Declarations
  COMPONENT ldpc_deco_23_ip_src_CodeParameters
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT ldpc_deco_23_ip_src_DecoderCore
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : ldpc_deco_23_ip_src_CodeParameters
    USE ENTITY work.ldpc_deco_23_ip_src_CodeParameters(rtl);

  FOR ALL : ldpc_deco_23_ip_src_DecoderCore
    USE ENTITY work.ldpc_deco_23_ip_src_DecoderCore(rtl);
...
BEGIN
  u_Code_Parameters : ldpc_deco_23_ip_src_CodeParameters
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Decoder_Core : ldpc_deco_23_ip_src_DecoderCore
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              reset => reset,  -- ufix1
    ...
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        IF sofVld = '1' THEN 
          countVal <= to_unsigned(16#001#, 11);
        ELSIF vFrame = '1' THEN 
          IF countVal >= to_unsigned(16#480#, 11) THEN 
            countVal <= to_unsigned(16#001#, 11);
          ELSE 
  ...
  maxCount <= to_unsigned(16#47F#, 11);
