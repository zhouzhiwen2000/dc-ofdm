...
ARCHITECTURE rtl OF rx_demod_optimized_src_decimator IS
  ...
  SIGNAL data_after_down_re_1             : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL data_after_down_im_1             : signed(13 DOWNTO 0);  -- sfix14_En12
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        data_after_down_re_1 <= to_signed(16#0000#, 14);
        data_after_down_im_1 <= to_signed(16#0000#, 14);
