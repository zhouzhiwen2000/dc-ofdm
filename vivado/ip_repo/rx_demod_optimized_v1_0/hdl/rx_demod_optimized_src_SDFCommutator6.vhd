-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_SDFCommutator6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_SDFCommutator6
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF2_6/SDFCommutator6
-- Hierarchy Level: 5
-- Model version: 1.70
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_SDFCommutator6 IS
...
END rx_demod_optimized_src_SDFCommutator6;


ARCHITECTURE rtl OF rx_demod_optimized_src_SDFCommutator6 IS
...
BEGIN
  u_dataXMEM_re_0_6 : rx_demod_optimized_src_SimpleDualPortRAM_generic_block
  ...
  u_dataXMEM_im_0_6 : rx_demod_optimized_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
