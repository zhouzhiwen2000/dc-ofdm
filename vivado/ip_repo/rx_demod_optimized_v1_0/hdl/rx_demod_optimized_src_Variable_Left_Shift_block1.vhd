-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_Variable_Left_Shift_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_Variable_Left_Shift_block1
...
ENTITY rx_demod_optimized_src_Variable_Left_Shift_block1 IS
...
END rx_demod_optimized_src_Variable_Left_Shift_block1;


ARCHITECTURE rtl OF rx_demod_optimized_src_Variable_Left_Shift_block1 IS
...
BEGIN
  ...
  Bit_Shift5_out1 <= to_signed(16#00000#, 17);
  ...
  Bit_Shift6_out1 <= to_signed(16#00000#, 17);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= to_signed(16#00000#, 17);
