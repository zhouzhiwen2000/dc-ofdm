-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_RADIX22FFT_CTRL1_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_RADIX22FFT_CTRL1_3
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_CTRL1_3
-- Hierarchy Level: 4
-- Model version: 1.65
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_RADIX22FFT_CTRL1_3 IS
...
END rx_demod_optimized_src_RADIX22FFT_CTRL1_3;


ARCHITECTURE rtl OF rx_demod_optimized_src_RADIX22FFT_CTRL1_3 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_3_Enb <= '0';
        IF dinXTwdl_3_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#1F#, 5)) THEN 
