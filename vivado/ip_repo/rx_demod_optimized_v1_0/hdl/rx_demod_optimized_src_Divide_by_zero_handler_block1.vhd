-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_Divide_by_zero_handler_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_Divide_by_zero_handler_block1
...
ENTITY rx_demod_optimized_src_Divide_by_zero_handler_block1 IS
...
END rx_demod_optimized_src_Divide_by_zero_handler_block1;


ARCHITECTURE rtl OF rx_demod_optimized_src_Divide_by_zero_handler_block1 IS

  -- Component Declarations
  COMPONENT rx_demod_optimized_src_Compare_To_Zero_block1
    PORT( u                               :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En15
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  -- Component Configuration Statements
  FOR ALL : rx_demod_optimized_src_Compare_To_Zero_block1
    USE ENTITY work.rx_demod_optimized_src_Compare_To_Zero_block1(rtl);
...
BEGIN
  u_Compare_To_Zero : rx_demod_optimized_src_Compare_To_Zero_block1
    PORT MAP( u => yIn,  -- sfix17_En15
