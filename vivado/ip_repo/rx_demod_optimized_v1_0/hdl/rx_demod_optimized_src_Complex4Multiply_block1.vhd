-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_Complex4Multiply_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_Complex4Multiply_block1
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF1_7/Complex4Multiply
-- Hierarchy Level: 5
-- Model version: 1.70
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_Complex4Multiply_block1 IS
...
END rx_demod_optimized_src_Complex4Multiply_block1;


ARCHITECTURE rtl OF rx_demod_optimized_src_Complex4Multiply_block1 IS

  -- Signals
  SIGNAL din_re_signed                    : signed(20 DOWNTO 0);  -- sfix21_En12
  SIGNAL din_re_reg                       : signed(20 DOWNTO 0);  -- sfix21_En12
  SIGNAL din_im_signed                    : signed(20 DOWNTO 0);  -- sfix21_En12
  SIGNAL din_im_reg                       : signed(20 DOWNTO 0);  -- sfix21_En12
  SIGNAL twdl_7_1_re_signed               : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL twdl_re_reg                      : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL twdl_7_1_im_signed               : signed(13 DOWNTO 0);  -- sfix14_En12
  ...
  SIGNAL prod1_re                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En24
  SIGNAL prod1_im                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En24
  SIGNAL prod2_re                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En24
  SIGNAL prod2_im                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En24
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL Complex4Add_sub_cast             : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL Complex4Add_sub_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL Complex4Add_add_cast             : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL Complex4Add_add_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL mulResFP_re                      : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL mulResFP_im                      : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL dinXTwdl_7_1_vld_1               : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(20 DOWNTO 0);  -- sfix21_En12
  SIGNAL dinXTwdl_im_tmp                  : signed(20 DOWNTO 0);  -- sfix21_En12
...
BEGIN
  ...
  dinXTwdl_re_tmp <= mulResFP_re(32 DOWNTO 12);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(32 DOWNTO 12);
