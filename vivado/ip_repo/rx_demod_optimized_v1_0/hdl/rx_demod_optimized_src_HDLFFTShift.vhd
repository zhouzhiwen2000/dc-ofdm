-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_HDLFFTShift.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_HDLFFTShift
-- Source Path: 
-- Hierarchy Level: 3
-- Model version: 1.70
-- 
...
ENTITY rx_demod_optimized_src_HDLFFTShift IS
...
END rx_demod_optimized_src_HDLFFTShift;


ARCHITECTURE rtl OF rx_demod_optimized_src_HDLFFTShift IS
  ...
  SIGNAL yfi                              : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL p31yfi_cast                      : signed(14 DOWNTO 0);  -- sfix15_En12
  SIGNAL p31yfi_cast_1                    : signed(14 DOWNTO 0);  -- sfix15_En12
  SIGNAL tmp_5                            : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_6                            : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_FFTShiftTDObj_rePart         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_7                            : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_FFTShiftTDObj_rePart_1       : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_8                            : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_9                            : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL yfi_1                            : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL p30yfi_cast                      : signed(14 DOWNTO 0);  -- sfix15_En12
  SIGNAL p30yfi_cast_1                    : signed(14 DOWNTO 0);  -- sfix15_En12
  SIGNAL tmp_10                           : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_11                           : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_FFTShiftTDObj_imPart         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_12                           : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_FFTShiftTDObj_imPart_1       : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL varargout_1_re_tmp               : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL varargout_1_im_tmp               : signed(13 DOWNTO 0);  -- sfix14_En12
...
BEGIN
  ...
  p31yfi_cast <= resize(varargin_1_re_signed, 15);
  p31yfi_cast_1 <=  - (p31yfi_cast);
  
  yfi <= "01111111111111" WHEN (p31yfi_cast_1(14) = '0') AND (p31yfi_cast_1(13) /= '0') ELSE
      "10000000000000" WHEN (p31yfi_cast_1(14) = '1') AND (p31yfi_cast_1(13) /= '1') ELSE
      p31yfi_cast_1(13 DOWNTO 0);
  ...
  obj_FFTShiftTDObj_rePart <= to_signed(16#0000#, 14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_FFTShiftTDObj_rePart_1 <= to_signed(16#0000#, 14);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  p30yfi_cast <= resize(varargin_1_im_signed, 15);
  p30yfi_cast_1 <=  - (p30yfi_cast);
  
  yfi_1 <= "01111111111111" WHEN (p30yfi_cast_1(14) = '0') AND (p30yfi_cast_1(13) /= '0') ELSE
      "10000000000000" WHEN (p30yfi_cast_1(14) = '1') AND (p30yfi_cast_1(13) /= '1') ELSE
      p30yfi_cast_1(13 DOWNTO 0);
  ...
  obj_FFTShiftTDObj_imPart <= to_signed(16#0000#, 14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_FFTShiftTDObj_imPart_1 <= to_signed(16#0000#, 14);
      ELSIF enb_1_2_0 = '1' THEN
