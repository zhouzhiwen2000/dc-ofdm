...
ARCHITECTURE rtl OF rx_demod_optimized_src_ofdm_demod IS
  ...
  SIGNAL data_re_1                        : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL data_im_1                        : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL data_last_value_re               : signed(21 DOWNTO 0);  -- sfix22_En12
  SIGNAL data_last_value_im               : signed(21 DOWNTO 0);  -- sfix22_En12
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        data_last_value_re <= to_signed(16#000000#, 22);
        data_last_value_im <= to_signed(16#000000#, 22);
  ...
  Data_Type_Conversion_out1_re <= data_re_1(13 DOWNTO 2);
  Data_Type_Conversion_out1_im <= data_im_1(13 DOWNTO 2);
