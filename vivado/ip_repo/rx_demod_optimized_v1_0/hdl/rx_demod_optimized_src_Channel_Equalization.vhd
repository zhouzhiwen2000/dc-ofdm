-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_Channel_Equalization.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_Channel_Equalization
...
ENTITY rx_demod_optimized_src_Channel_Equalization IS
...
END rx_demod_optimized_src_Channel_Equalization;


ARCHITECTURE rtl OF rx_demod_optimized_src_Channel_Equalization IS

  -- Component Declarations
  COMPONENT rx_demod_optimized_src_rising_edge_detector1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_optimized_src_rising_edge_detector
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;
  ...
  COMPONENT rx_demod_optimized_src_OFDM_Equalizer
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : rx_demod_optimized_src_rising_edge_detector1
    USE ENTITY work.rx_demod_optimized_src_rising_edge_detector1(rtl);

  FOR ALL : rx_demod_optimized_src_rising_edge_detector
    USE ENTITY work.rx_demod_optimized_src_rising_edge_detector(rtl);
  ...
  FOR ALL : rx_demod_optimized_src_OFDM_Equalizer
    USE ENTITY work.rx_demod_optimized_src_OFDM_Equalizer(rtl);
  ...
  SIGNAL Delay24_out1_re                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay24_out1_im                  : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL Channel_Estimates_Store_RAM_out1_re_signed : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Channel_Estimates_Store_RAM_out1_im_signed : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_rising_edge_detector1 : rx_demod_optimized_src_rising_edge_detector1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_rising_edge_detector : rx_demod_optimized_src_rising_edge_detector
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              In_rsvd => valid_data,
  ...
  u_Channel_Estimates_Store_RAM : rx_demod_optimized_src_SimpleDualPortRAM_generic_block
  ...
  u_OFDM_Equalizer : rx_demod_optimized_src_OFDM_Equalizer
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              dataIn_re => std_logic_vector(Delay24_out1_re),  -- sfix16_En14
              dataIn_im => std_logic_vector(Delay24_out1_im),  -- sfix16_En14
              hEst_re => std_logic_vector(hEst_re),  -- sfix16_En14
              hEst_im => std_logic_vector(hEst_im),  -- sfix16_En14
              validIn => Valid,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        hEst_re <= to_signed(16#0000#, 16);
        hEst_im <= to_signed(16#0000#, 16);
      ELSIF enb_1_2_0 = '1' THEN
