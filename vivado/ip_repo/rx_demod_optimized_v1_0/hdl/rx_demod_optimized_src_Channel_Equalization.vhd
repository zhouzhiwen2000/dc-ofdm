...
ARCHITECTURE rtl OF rx_demod_optimized_src_Channel_Equalization IS
  ...
  COMPONENT rx_demod_optimized_src_equalizer
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  FOR ALL : rx_demod_optimized_src_equalizer
    USE ENTITY work.rx_demod_optimized_src_equalizer(rtl);
  ...
  SIGNAL equalizer_out1_re                : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL equalizer_out1_im                : std_logic_vector(11 DOWNTO 0);  -- ufix12
...
BEGIN
  ...
  u_Channel_Estimates_Store_RAM : rx_demod_optimized_src_SimpleDualPortRAM_generic
  ...
  u_equalizer : rx_demod_optimized_src_equalizer
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => std_logic_vector(Delay24_out1_re),  -- sfix12_En10
              data_in_im => std_logic_vector(Delay24_out1_im),  -- sfix12_En10
              hEst_re => std_logic_vector(hEst_re),  -- sfix12_En10
              hEst_im => std_logic_vector(hEst_im),  -- sfix12_En10
              Valid => Valid,
              data_out_re => equalizer_out1_re,  -- sfix12_En10
              data_out_im => equalizer_out1_im,  -- sfix12_En10
