-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_Variable_Right_Shift_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_Variable_Right_Shift_block
...
ENTITY rx_demod_optimized_src_Variable_Right_Shift_block IS
...
END rx_demod_optimized_src_Variable_Right_Shift_block;


ARCHITECTURE rtl OF rx_demod_optimized_src_Variable_Right_Shift_block IS
...
BEGIN
  ...
  Bit_Shift4_out1 <= SHIFT_RIGHT(Delay_out1, 15);

  
  Switch5_out1 <= Delay_out1 WHEN Delay1_out1 = '0' ELSE
      Bit_Shift4_out1;

  Bit_Shift5_out1 <= SHIFT_RIGHT(Switch5_out1, 15);

  
  Switch6_out1 <= Switch5_out1 WHEN Delay2_out1 = '0' ELSE
      Bit_Shift5_out1;

  Bit_Shift6_out1 <= SHIFT_RIGHT(Switch6_out1, 15);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= SHIFT_RIGHT(Switch7_out1, 15);
