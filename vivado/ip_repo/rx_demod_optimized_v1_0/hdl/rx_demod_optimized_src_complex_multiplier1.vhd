...
ARCHITECTURE rtl OF rx_demod_optimized_src_complex_multiplier1 IS
  ...
  -- Signals
  SIGNAL in_b_re_signed                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL in_b_im_signed                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay2_out1                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay3_out1                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Subtract_sub_cast                : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Subtract_sub_cast_1              : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Subtract_out1                    : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Delay5_reg                       : vector_of_signed17(0 TO 1);  -- sfix17 [2]
  SIGNAL Delay5_out1                      : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Delay5_out1_1                    : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL in_a_re_signed                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL in_a_im_signed                   : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL Product1_out1                    : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Product1_out1_1                  : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Delay1_out1                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Subtract1_sub_cast               : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Subtract1_sub_cast_1             : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Subtract1_out1                   : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Delay4_reg                       : vector_of_signed17(0 TO 1);  -- sfix17 [2]
  SIGNAL Delay4_out1                      : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Delay4_out1_1                    : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Delay9_reg                       : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL Delay9_out1                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay9_out1_1                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Product_out1                     : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Product_out1_1                   : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Add1_add_cast                    : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Add1_add_cast_1                  : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Add1_out1                        : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Add_add_cast                     : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Add_add_cast_1                   : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Add_out1                         : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Delay6_reg                       : vector_of_signed17(0 TO 1);  -- sfix17 [2]
  SIGNAL Delay6_out1                      : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Delay6_out1_1                    : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL Delay14_reg                      : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL Delay14_out1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay14_out1_1                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Product2_out1                    : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Product2_out1_1                  : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Add2_add_cast                    : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Add2_add_cast_1                  : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Add2_out1                        : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Delay10_out1_re                  : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Delay10_out1_im                  : signed(33 DOWNTO 0);  -- sfix34_En28
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay5_out1_1 <= to_signed(16#00000#, 17);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1_1 <= to_signed(16#00000#, 17);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay9_out1_1 <= to_signed(16#0000#, 16);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  Add1_add_cast <= resize(Product1_out1_1, 34);
  Add1_add_cast_1 <= resize(Product_out1_1, 34);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay6_out1_1 <= to_signed(16#00000#, 17);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay14_out1_1 <= to_signed(16#0000#, 16);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Product2_out1_1 <= to_signed(0, 33);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  Add2_add_cast <= resize(Product_out1_1, 34);
  Add2_add_cast_1 <= resize(Product2_out1_1, 34);
