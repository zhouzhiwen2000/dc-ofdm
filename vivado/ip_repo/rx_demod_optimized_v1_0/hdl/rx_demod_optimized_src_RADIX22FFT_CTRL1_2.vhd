-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_RADIX22FFT_CTRL1_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_RADIX22FFT_CTRL1_2
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_CTRL1_2
-- Hierarchy Level: 4
-- Model version: 1.65
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_RADIX22FFT_CTRL1_2 IS
...
END rx_demod_optimized_src_RADIX22FFT_CTRL1_2;


ARCHITECTURE rtl OF rx_demod_optimized_src_RADIX22FFT_CTRL1_2 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_2_Enb <= '0';
        IF dout_1_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#3F#, 6)) THEN 
