...
BEGIN
  u_simpleDualPortRam : rx_demod_optimized_src_SimpleDualPortRAM_generic_block
  ...
  u_simpleDualPortRam_1 : rx_demod_optimized_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
