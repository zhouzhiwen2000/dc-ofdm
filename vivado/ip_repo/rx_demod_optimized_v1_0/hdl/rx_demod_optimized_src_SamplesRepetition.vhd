-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_SamplesRepetition.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_SamplesRepetition
-- Source Path: 
-- Hierarchy Level: 3
-- Model version: 1.70
-- 
...
ENTITY rx_demod_optimized_src_SamplesRepetition IS
...
END rx_demod_optimized_src_SamplesRepetition;


ARCHITECTURE rtl OF rx_demod_optimized_src_SamplesRepetition IS
  ...
  SIGNAL obj_SamplesRepetitionObj_dataOutReg_re : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg_im : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL varargin_1_re_signed             : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL varargin_1_im_signed             : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataInReg_re : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataInReg_im : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_re                           : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_im                           : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataInReg_re_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataInReg_im_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataInReg1_re : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataInReg1_im : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_re_1                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_im_1                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataInReg1_re_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataInReg1_im_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  ...
  SIGNAL varargout_1_re_1                 : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL varargout_1_im_1                 : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL varargout_1_re_signed            : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL varargout_1_im_signed            : signed(13 DOWNTO 0);  -- sfix14_En12
  ...
  SIGNAL varargout_1_re_2                 : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL varargout_1_im_2                 : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL varargout_1_re_signed_1          : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL varargout_1_im_signed_1          : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_re_3                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_im_3                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg_re_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg_im_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_re_4                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_im_4                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg_re_2 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg_im_2 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg1_re : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg1_im : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_re_5                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_im_5                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg1_re_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOutReg1_im_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOut_re : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOut_im : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_re_6                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL tmp_im_6                         : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOut_re_1 : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL obj_SamplesRepetitionObj_dataOut_im_1 : signed(13 DOWNTO 0);  -- sfix14_En12
...
BEGIN
  u_simpleDualPortRam : rx_demod_optimized_src_SimpleDualPortRAM_generic
  ...
  u_simpleDualPortRam_1 : rx_demod_optimized_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 14
                 )
    PORT MAP( clk => clk,
  ...
  obj_SamplesRepetitionObj_dataOutReg_re <= to_signed(16#0000#, 14);
  obj_SamplesRepetitionObj_dataOutReg_im <= to_signed(16#0000#, 14);

  varargin_1_re_signed <= signed(varargin_1_re);

  varargin_1_im_signed <= signed(varargin_1_im);

  obj_SamplesRepetitionObj_dataInReg_re <= to_signed(16#0000#, 14);
  obj_SamplesRepetitionObj_dataInReg_im <= to_signed(16#0000#, 14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_SamplesRepetitionObj_dataInReg_re_1 <= to_signed(16#0000#, 14);
        obj_SamplesRepetitionObj_dataInReg_im_1 <= to_signed(16#0000#, 14);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  obj_SamplesRepetitionObj_dataInReg1_re <= to_signed(16#0000#, 14);
  obj_SamplesRepetitionObj_dataInReg1_im <= to_signed(16#0000#, 14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_SamplesRepetitionObj_dataInReg1_re_1 <= to_signed(16#0000#, 14);
        obj_SamplesRepetitionObj_dataInReg1_im_1 <= to_signed(16#0000#, 14);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  obj_SamplesRepetitionObj_dataOutReg_re_1 <= to_signed(16#0000#, 14);
  obj_SamplesRepetitionObj_dataOutReg_im_1 <= to_signed(16#0000#, 14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_SamplesRepetitionObj_dataOutReg_re_2 <= to_signed(16#0000#, 14);
        obj_SamplesRepetitionObj_dataOutReg_im_2 <= to_signed(16#0000#, 14);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  obj_SamplesRepetitionObj_dataOutReg1_re <= to_signed(16#0000#, 14);
  obj_SamplesRepetitionObj_dataOutReg1_im <= to_signed(16#0000#, 14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_SamplesRepetitionObj_dataOutReg1_re_1 <= to_signed(16#0000#, 14);
        obj_SamplesRepetitionObj_dataOutReg1_im_1 <= to_signed(16#0000#, 14);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  obj_SamplesRepetitionObj_dataOut_re <= to_signed(16#0000#, 14);
  obj_SamplesRepetitionObj_dataOut_im <= to_signed(16#0000#, 14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        obj_SamplesRepetitionObj_dataOut_re_1 <= to_signed(16#0000#, 14);
        obj_SamplesRepetitionObj_dataOut_im_1 <= to_signed(16#0000#, 14);
      ELSIF enb_1_2_0 = '1' THEN
