...
ARCHITECTURE rtl OF rx_demod_optimized_src_calculate_R IS
  ...
  SIGNAL Delay6_out1_1                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay6_out1_2                    : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL Delay3_out1_2                    : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL alphar_d_2L_2                    : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Delay_regin                      : signed(32 DOWNTO 0);  -- sfix33_En28
  ...
  SIGNAL Delay_regout_signed              : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL alphar_d_2                       : signed(32 DOWNTO 0);  -- sfix33_En28
  ...
  SIGNAL Delay1_out1                      : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Add_out1                         : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL xxx                              : signed(33 DOWNTO 0);  -- sfix34_En28
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay6_out1_1 <= to_signed(16#0000#, 16);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay6_out1_2 <= to_signed(16#0000#, 16);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay3_out1_2 <= to_signed(16#0000#, 16);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  Add1_add_cast <= resize(Product1_out1_1, 33);
  Add1_add_cast_1 <= resize(Product_out1_1, 33);
  ...
  Subtract_sub_cast <= resize(alphar_d_2L_2, 34);
  ...
  Data_Type_Conversion_out1 <= xxx(33 DOWNTO 9);
  ...
  Data_Type_Conversion1_out1 <= xxx(33 DOWNTO 16);
