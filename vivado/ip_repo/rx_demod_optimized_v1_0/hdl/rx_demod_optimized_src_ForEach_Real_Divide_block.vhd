-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_ForEach_Real_Divide_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_ForEach_Real_Divide_block
...
ENTITY rx_demod_optimized_src_ForEach_Real_Divide_block IS
...
END rx_demod_optimized_src_ForEach_Real_Divide_block;


ARCHITECTURE rtl OF rx_demod_optimized_src_ForEach_Real_Divide_block IS

  -- Component Declarations
  COMPONENT rx_demod_optimized_src_Upcast_Wordlength_block
  ...
  COMPONENT rx_demod_optimized_src_Normalize_numerator_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_optimized_src_MATLAB_Function_block
  ...
  COMPONENT rx_demod_optimized_src_Normalize_denominator_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT rx_demod_optimized_src_Divide_real_numerator_by_denominator_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT rx_demod_optimized_src_Shift_and_cast_to_output_type_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_optimized_src_Divide_by_zero_handler_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : rx_demod_optimized_src_Upcast_Wordlength_block
    USE ENTITY work.rx_demod_optimized_src_Upcast_Wordlength_block(rtl);

  FOR ALL : rx_demod_optimized_src_Normalize_numerator_block
    USE ENTITY work.rx_demod_optimized_src_Normalize_numerator_block(rtl);

  FOR ALL : rx_demod_optimized_src_MATLAB_Function_block
    USE ENTITY work.rx_demod_optimized_src_MATLAB_Function_block(rtl);

  FOR ALL : rx_demod_optimized_src_Normalize_denominator_block
    USE ENTITY work.rx_demod_optimized_src_Normalize_denominator_block(rtl);

  FOR ALL : rx_demod_optimized_src_Divide_real_numerator_by_denominator_block
    USE ENTITY work.rx_demod_optimized_src_Divide_real_numerator_by_denominator_block(rtl);

  FOR ALL : rx_demod_optimized_src_Shift_and_cast_to_output_type_block
    USE ENTITY work.rx_demod_optimized_src_Shift_and_cast_to_output_type_block(rtl);

  FOR ALL : rx_demod_optimized_src_Divide_by_zero_handler_block
    USE ENTITY work.rx_demod_optimized_src_Divide_by_zero_handler_block(rtl);
...
BEGIN
  u_Upcast_Wordlength : rx_demod_optimized_src_Upcast_Wordlength_block
  ...
  u_Normalize_numerator : rx_demod_optimized_src_Normalize_numerator_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_MATLAB_Function : rx_demod_optimized_src_MATLAB_Function_block
  ...
  u_Normalize_denominator : rx_demod_optimized_src_Normalize_denominator_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Divide_real_numerator_by_denominator : rx_demod_optimized_src_Divide_real_numerator_by_denominator_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Shift_and_cast_to_output_type : rx_demod_optimized_src_Shift_and_cast_to_output_type_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Divide_by_zero_handler : rx_demod_optimized_src_Divide_by_zero_handler_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
