-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_Divide_real_numerator_by_denominator_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_Divide_real_numerator_by_denominator_block
...
ENTITY rx_demod_optimized_src_Divide_real_numerator_by_denominator_block IS
...
END rx_demod_optimized_src_Divide_real_numerator_by_denominator_block;


ARCHITECTURE rtl OF rx_demod_optimized_src_Divide_real_numerator_by_denominator_block IS

  -- Component Declarations
  COMPONENT rx_demod_optimized_src_normalizedCORDICDivide_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : rx_demod_optimized_src_normalizedCORDICDivide_block
    USE ENTITY work.rx_demod_optimized_src_normalizedCORDICDivide_block(rtl);
...
BEGIN
  u_normalizedCORDICDivide : rx_demod_optimized_src_normalizedCORDICDivide_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              num => num,  -- sfix16_En14
