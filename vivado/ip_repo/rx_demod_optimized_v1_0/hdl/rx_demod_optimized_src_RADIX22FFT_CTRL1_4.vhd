-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_RADIX22FFT_CTRL1_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_RADIX22FFT_CTRL1_4
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_CTRL1_4
-- Hierarchy Level: 4
-- Model version: 1.65
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_RADIX22FFT_CTRL1_4 IS
...
END rx_demod_optimized_src_RADIX22FFT_CTRL1_4;


ARCHITECTURE rtl OF rx_demod_optimized_src_RADIX22FFT_CTRL1_4 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_4_Enb <= '0';
        IF dout_3_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#F#, 4)) THEN 
