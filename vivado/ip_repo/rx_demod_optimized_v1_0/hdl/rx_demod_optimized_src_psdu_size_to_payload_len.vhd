...
BEGIN
  ...
  Gain_cast <= signed(resize(Delay3_out1_1, 25));
  ...
  payloadNumOFDMSymbols <= Gain_out1_1 + Add1_add_cast;

  payload_len_in_ofdm_symbols <= std_logic_vector(payloadNumOFDMSymbols);
