-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_normalizedCORDICDivide_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_normalizedCORDICDivide_block
-- Source Path: HDLRxDemodulator/rx_demodulator_full/channel_estimation_and_equalization/Channel Equalization/equalizer/Real 
-- Divide HDL Optimized1/ForEach - Real Divide/Divide real numerator by denominator/normalizedCORDICDivid
-- Hierarchy Level: 7
-- Model version: 1.70
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_normalizedCORDICDivide_block IS
...
END rx_demod_optimized_src_normalizedCORDICDivide_block;


ARCHITECTURE rtl OF rx_demod_optimized_src_normalizedCORDICDivide_block IS
  ...
  SIGNAL y_1                              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL y_last_value                     : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF isNegativeReg(16) = '1' THEN 
      ...
      ELSIF (cast_0(16) = '1') AND (cast_0(15) /= '1') THEN 
        y_1 <= X"8000";
      ELSE 
        y_1 <= cast_0(15 DOWNTO 0);
      END IF;
    END IF;
    t_1 <= tReg(16);
    isDenZeroOut_1 <= isDenZeroReg(16);
    validOut_1 <= validReg(16);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        y_last_value <= to_signed(16#0000#, 16);
      ELSIF enb_1_2_0_gated = '1' THEN
        y_last_value <= y_tmp;
      END IF;
    END IF;
