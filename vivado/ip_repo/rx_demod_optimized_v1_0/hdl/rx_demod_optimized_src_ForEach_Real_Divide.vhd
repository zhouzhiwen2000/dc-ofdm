-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_ForEach_Real_Divide.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_ForEach_Real_Divide
...
ENTITY rx_demod_optimized_src_ForEach_Real_Divide IS
...
END rx_demod_optimized_src_ForEach_Real_Divide;


ARCHITECTURE rtl OF rx_demod_optimized_src_ForEach_Real_Divide IS

  -- Component Declarations
  COMPONENT rx_demod_optimized_src_Upcast_Wordlength
  ...
  COMPONENT rx_demod_optimized_src_Normalize_numerator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_optimized_src_MATLAB_Function
  ...
  COMPONENT rx_demod_optimized_src_Normalize_denominator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT rx_demod_optimized_src_Divide_real_numerator_by_denominator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          num                             :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT rx_demod_optimized_src_Shift_and_cast_to_output_type
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT rx_demod_optimized_src_Divide_by_zero_handler
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : rx_demod_optimized_src_Upcast_Wordlength
    USE ENTITY work.rx_demod_optimized_src_Upcast_Wordlength(rtl);

  FOR ALL : rx_demod_optimized_src_Normalize_numerator
    USE ENTITY work.rx_demod_optimized_src_Normalize_numerator(rtl);

  FOR ALL : rx_demod_optimized_src_MATLAB_Function
    USE ENTITY work.rx_demod_optimized_src_MATLAB_Function(rtl);

  FOR ALL : rx_demod_optimized_src_Normalize_denominator
    USE ENTITY work.rx_demod_optimized_src_Normalize_denominator(rtl);

  FOR ALL : rx_demod_optimized_src_Divide_real_numerator_by_denominator
    USE ENTITY work.rx_demod_optimized_src_Divide_real_numerator_by_denominator(rtl);

  FOR ALL : rx_demod_optimized_src_Shift_and_cast_to_output_type
    USE ENTITY work.rx_demod_optimized_src_Shift_and_cast_to_output_type(rtl);

  FOR ALL : rx_demod_optimized_src_Divide_by_zero_handler
    USE ENTITY work.rx_demod_optimized_src_Divide_by_zero_handler(rtl);
...
BEGIN
  u_Upcast_Wordlength : rx_demod_optimized_src_Upcast_Wordlength
  ...
  u_Normalize_numerator : rx_demod_optimized_src_Normalize_numerator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_MATLAB_Function : rx_demod_optimized_src_MATLAB_Function
  ...
  u_Normalize_denominator : rx_demod_optimized_src_Normalize_denominator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Divide_real_numerator_by_denominator : rx_demod_optimized_src_Divide_real_numerator_by_denominator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Shift_and_cast_to_output_type : rx_demod_optimized_src_Shift_and_cast_to_output_type
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Divide_by_zero_handler : rx_demod_optimized_src_Divide_by_zero_handler
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
