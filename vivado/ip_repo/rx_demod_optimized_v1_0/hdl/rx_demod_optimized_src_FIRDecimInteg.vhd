...
ARCHITECTURE rtl OF rx_demod_optimized_src_FIRDecimInteg IS
  ...
  -- Signals
  SIGNAL filterOut_cmplx_re_signed        : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL filterOut_cmplx_im_signed        : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL FIRdDecimInteg_state             : std_logic;  -- ufix1
  SIGNAL FIRdDecimInteg_cnt               : std_logic;  -- ufix1
  SIGNAL FIRdDecimInteg_integReg_re       : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL FIRdDecimInteg_integReg_im       : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL FIRdDecimInteg_integVldReg       : std_logic;
  SIGNAL FIRdDecimInteg_doutReg_re        : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL FIRdDecimInteg_doutReg_im        : signed(13 DOWNTO 0);  -- sfix14_En12
  ...
  SIGNAL FIRdDecimInteg_integReg_next_re  : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL FIRdDecimInteg_integReg_next_im  : signed(30 DOWNTO 0);  -- sfix31_En28
  SIGNAL FIRdDecimInteg_integVldReg_next  : std_logic;
  SIGNAL FIRdDecimInteg_doutReg_next_re   : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL FIRdDecimInteg_doutReg_next_im   : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL FIRdDecimInteg_doutVldReg_next   : std_logic;
  SIGNAL dataOut_re_tmp                   : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL dataOut_im_tmp                   : signed(13 DOWNTO 0);  -- sfix14_En12
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        ...
        FIRdDecimInteg_integReg_re <= to_signed(16#00000000#, 31);
        FIRdDecimInteg_integReg_im <= to_signed(16#00000000#, 31);
        FIRdDecimInteg_doutReg_re <= to_signed(16#0000#, 14);
        FIRdDecimInteg_doutReg_im <= to_signed(16#0000#, 14);
      ELSIF enb = '1' THEN
        IF softReset = '1' THEN
          FIRdDecimInteg_state <= '0';
          FIRdDecimInteg_integVldReg <= '0';
  ...
  BEGIN
    ...
    IF FIRdDecimInteg_integVldReg = '1' THEN 
      FIRdDecimInteg_doutReg_next_re <= FIRdDecimInteg_integReg_re(29 DOWNTO 16);
      FIRdDecimInteg_doutReg_next_im <= FIRdDecimInteg_integReg_im(29 DOWNTO 16);
    ELSE 
      FIRdDecimInteg_doutReg_next_re <= to_signed(16#0000#, 14);
      FIRdDecimInteg_doutReg_next_im <= to_signed(16#0000#, 14);
    END IF;
    ...
    CASE FIRdDecimInteg_state IS
      WHEN '0' =>
        ...
        FIRdDecimInteg_integReg_next_re <= to_signed(16#00000000#, 31);
        FIRdDecimInteg_integReg_next_im <= to_signed(16#00000000#, 31);
