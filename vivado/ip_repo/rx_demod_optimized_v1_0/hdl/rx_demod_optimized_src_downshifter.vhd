-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_downshifter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_downshifter
...
ENTITY rx_demod_optimized_src_downshifter IS
...
END rx_demod_optimized_src_downshifter;


ARCHITECTURE rtl OF rx_demod_optimized_src_downshifter IS

  -- Component Declarations
  COMPONENT rx_demod_optimized_src_rising_edge_detector_block4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rx_demod_optimized_src_NCO
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rx_demod_optimized_src_digital_carrier_receiver
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rx_demod_optimized_src_rising_edge_detector_block4
    USE ENTITY work.rx_demod_optimized_src_rising_edge_detector_block4(rtl);

  FOR ALL : rx_demod_optimized_src_NCO
    USE ENTITY work.rx_demod_optimized_src_NCO(rtl);

  FOR ALL : rx_demod_optimized_src_digital_carrier_receiver
    USE ENTITY work.rx_demod_optimized_src_digital_carrier_receiver(rtl);

  -- Signals
  SIGNAL data_in_signed                   : signed(13 DOWNTO 0);  -- sfix14_En13
  SIGNAL Delay_reg                        : vector_of_signed14(0 TO 11);  -- sfix14 [12]
  ...
  SIGNAL Delay9_out1_1                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Constant1_out1                   : unsigned(19 DOWNTO 0);  -- ufix20_En8
  SIGNAL Constant1_out1_1                 : unsigned(19 DOWNTO 0);  -- ufix20_En8
...
BEGIN
  u_rising_edge_detector : rx_demod_optimized_src_rising_edge_detector_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => Delay7_out1_1,
              Out_rsvd => rising_edge_detector_out1
              );

  u_NCO : rx_demod_optimized_src_NCO
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_digital_carrier_receiver : rx_demod_optimized_src_digital_carrier_receiver
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay_reg(0) <= data_in_signed;
        Delay_reg(1 TO 11) <= Delay_reg(0 TO 10);
      END IF;
    END IF;
  END PROCESS Delay_process;

  Delay_out1 <= Delay_reg(11);
  ...
  Product_cast <= signed(resize(Constant1_out1_1, 21));
  Product_mul_temp <= Delay9_out1_1 * Product_cast;
  ...
  Add_add_temp <= Add_add_cast + resize(Product_out1_1, 26);
