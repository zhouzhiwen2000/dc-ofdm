-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_RADIX22FFT_CTRL1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_RADIX22FFT_CTRL1_1
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_CTRL1_1
-- Hierarchy Level: 4
-- Model version: 1.65
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_RADIX22FFT_CTRL1_1 IS
...
END rx_demod_optimized_src_RADIX22FFT_CTRL1_1;


ARCHITECTURE rtl OF rx_demod_optimized_src_RADIX22FFT_CTRL1_1 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF dinXTwdl_1_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#7F#, 7)) THEN 
