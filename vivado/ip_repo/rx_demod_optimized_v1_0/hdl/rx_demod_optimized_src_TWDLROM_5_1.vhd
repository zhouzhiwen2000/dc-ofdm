-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_TWDLROM_5_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_TWDLROM_5_1
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/TWDLROM_5_1
-- Hierarchy Level: 4
-- Model version: 1.70
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_TWDLROM_5_1 IS
...
END rx_demod_optimized_src_TWDLROM_5_1;


ARCHITECTURE rtl OF rx_demod_optimized_src_TWDLROM_5_1 IS
  ...
  SIGNAL twdl_5_1_re_tmp                  : signed(13 DOWNTO 0);  -- sfix14_En12
  SIGNAL twdl_5_1_im_tmp                  : signed(13 DOWNTO 0);  -- sfix14_En12
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF dout_4_1_vld = '1' AND (Radix22TwdlMapping_cnt > to_unsigned(16#3B#, 6)) THEN 
