-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_RADIX22FFT_SDF2_6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_RADIX22FFT_SDF2_6
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_demod/OFDM Demodulator/dsphdl.FFT/RADIX22FFT_SDF2_6
-- Hierarchy Level: 4
-- Model version: 1.70
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_RADIX22FFT_SDF2_6 IS
...
END rx_demod_optimized_src_RADIX22FFT_SDF2_6;


ARCHITECTURE rtl OF rx_demod_optimized_src_RADIX22FFT_SDF2_6 IS
  ...
  COMPONENT rx_demod_optimized_src_SDFCommutator6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          dout_5_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : rx_demod_optimized_src_SDFCommutator6
    USE ENTITY work.rx_demod_optimized_src_SDFCommutator6(rtl);
...
BEGIN
  u_dataMEM_im_0_6 : rx_demod_optimized_src_SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_0_6 : rx_demod_optimized_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_6 : rx_demod_optimized_src_SDFCommutator6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
