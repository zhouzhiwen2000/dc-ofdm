...
ARCHITECTURE rtl OF rx_demod_optimized_src_channel_estimation_and_equalization IS
  ...
  SIGNAL Delay21_reg_re                   : vector_of_signed16(0 TO 1);  -- sfix16_En14 [2]
  SIGNAL Delay21_reg_im                   : vector_of_signed16(0 TO 1);  -- sfix16_En14 [2]
  SIGNAL Delay21_out1_re                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay21_out1_im                  : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  u_Channel_Estimation : rx_demod_optimized_src_Channel_Estimation
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => std_logic_vector(Delay1_out1_re),  -- sfix16_En14
              data_in_im => std_logic_vector(Delay1_out1_im),  -- sfix16_En14
  ...
  u_Channel_Equalization : rx_demod_optimized_src_Channel_Equalization
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => std_logic_vector(Delay10_out1_re),  -- sfix16_En14
              data_in_im => std_logic_vector(Delay10_out1_im),  -- sfix16_En14
              valid_data => Delay11_out1,
              channel_estimate_in_re => std_logic_vector(Delay13_out1_re),  -- sfix16_En14
              channel_estimate_in_im => std_logic_vector(Delay13_out1_im),  -- sfix16_En14
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay21_reg_re <= (OTHERS => to_signed(16#0000#, 16));
        Delay21_reg_im <= (OTHERS => to_signed(16#0000#, 16));
      ELSIF enb_1_2_0 = '1' THEN
