-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_Variable_Right_Shift_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_Variable_Right_Shift_block1
...
ENTITY rx_demod_optimized_src_Variable_Right_Shift_block1 IS
...
END rx_demod_optimized_src_Variable_Right_Shift_block1;


ARCHITECTURE rtl OF rx_demod_optimized_src_Variable_Right_Shift_block1 IS
  ...
  SIGNAL Bit_Shift_out1                   : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Switch1_out1                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Bit_Shift1_out1                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Switch2_out1                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Bit_Shift2_out1                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Switch3_out1                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Bit_Shift3_out1                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Switch4_out1                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Delay_out1                       : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Bit_Shift4_out1                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Switch5_out1                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Bit_Shift5_out1                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Switch6_out1                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Bit_Shift6_out1                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Switch7_out1                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Bit_Shift7_out1                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Switch8_out1                     : signed(16 DOWNTO 0);  -- sfix17_En15
...
BEGIN
  ...
  Bit_Shift5_out1 <= SHIFT_RIGHT(Switch5_out1, 16);

  
  Switch6_out1 <= Switch5_out1 WHEN Delay2_out1 = '0' ELSE
      Bit_Shift5_out1;

  Bit_Shift6_out1 <= SHIFT_RIGHT(Switch6_out1, 16);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= SHIFT_RIGHT(Switch7_out1, 16);
