...
ARCHITECTURE rtl OF rx_demod_optimized_src_calculate_P IS
  ...
  SIGNAL Delay4_reg_re                    : vector_of_signed35(0 TO 4);  -- sfix35_En28 [5]
  SIGNAL Delay4_reg_im                    : vector_of_signed35(0 TO 4);  -- sfix35_En28 [5]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_reg_re <= (OTHERS => to_signed(0, 35));
        Delay4_reg_im <= (OTHERS => to_signed(0, 35));
      ELSIF enb_1_2_0 = '1' THEN
