-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_NCO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_NCO
-- Source Path: HDLRxDemodulator/rx_demodulator_full/downshifter/NCO
-- Hierarchy Level: 2
-- Model version: 1.66
-- 
-- NCO
...
ENTITY rx_demod_optimized_src_NCO IS
...
END rx_demod_optimized_src_NCO;


ARCHITECTURE rtl OF rx_demod_optimized_src_NCO IS

  -- Component Declarations
  COMPONENT rx_demod_optimized_src_WaveformGen
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rx_demod_optimized_src_WaveformGen
    USE ENTITY work.rx_demod_optimized_src_WaveformGen(rtl);
  ...
  SIGNAL const0                           : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL inc_unsigned                     : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL pInc                             : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL validPInc                        : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL accphase_reg                     : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL addpInc                          : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL addPInc_rst                      : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL pOffset                          : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL accoffset                        : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL accoffsete_reg                   : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL accQuantized                     : unsigned(11 DOWNTO 0);  -- ufix12_E12
...
BEGIN
  u_Wave_inst : rx_demod_optimized_src_WaveformGen
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              phaseIdx => std_logic_vector(accQuantized),  -- ufix12_E12
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        accphase_reg <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  pOffset <= to_signed(16#000000#, 24);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        accoffsete_reg <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  -- Phase quantization
  accQuantized <= unsigned(accoffsete_reg(23 DOWNTO 12));
