-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRxDemodulator/rx_demod_optimized_src_ofdm_symbol_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rx_demod_optimized_src_ofdm_symbol_sync
-- Source Path: HDLRxDemodulator/rx_demodulator_full/ofdm_symbol_sync
-- Hierarchy Level: 1
-- Model version: 1.70
-- 
-- -------------------------------------------------------------
...
ENTITY rx_demod_optimized_src_ofdm_symbol_sync IS
...
END rx_demod_optimized_src_ofdm_symbol_sync;


ARCHITECTURE rtl OF rx_demod_optimized_src_ofdm_symbol_sync IS

  -- Component Declarations
  COMPONENT rx_demod_optimized_src_m_cox
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(13 DOWNTO 0);  -- sfix14_En12
  ...
  COMPONENT rx_demod_optimized_src_find_peak
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(13 DOWNTO 0);  -- sfix14_En12
  ...
  COMPONENT rx_demod_optimized_src_SimpleDualPortRAM_singlebit
  ...
  COMPONENT rx_demod_optimized_src_phase_offset_calculator
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : rx_demod_optimized_src_m_cox
    USE ENTITY work.rx_demod_optimized_src_m_cox(rtl);

  FOR ALL : rx_demod_optimized_src_find_peak
    USE ENTITY work.rx_demod_optimized_src_find_peak(rtl);

  FOR ALL : rx_demod_optimized_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.rx_demod_optimized_src_SimpleDualPortRAM_singlebit(rtl);
  ...
  FOR ALL : rx_demod_optimized_src_phase_offset_calculator
    USE ENTITY work.rx_demod_optimized_src_phase_offset_calculator(rtl);

  -- Signals
  SIGNAL m_cox_out1_re                    : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL m_cox_out1_im                    : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL m_cox_out2                       : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL m_cox_out3_re                    : std_logic_vector(12 DOWNTO 0);  -- ufix13
  SIGNAL m_cox_out3_im                    : std_logic_vector(12 DOWNTO 0);  -- ufix13
  SIGNAL find_peak_out1_re                : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL find_peak_out1_im                : std_logic_vector(13 DOWNTO 0);  -- ufix14
  ...
  SIGNAL m_cox_out3_re_signed             : signed(12 DOWNTO 0);  -- sfix13_En9
  SIGNAL m_cox_out3_im_signed             : signed(12 DOWNTO 0);  -- sfix13_En9
  SIGNAL mergedInput                      : unsigned(25 DOWNTO 0);  -- ufix26
  SIGNAL mergedDelay_regin                : unsigned(25 DOWNTO 0);  -- ufix26
  ...
  SIGNAL mergedDelay_regout               : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL mergedDelay_regout_unsigned      : unsigned(25 DOWNTO 0);  -- ufix26
  SIGNAL mergedOutput                     : unsigned(25 DOWNTO 0);  -- ufix26
  SIGNAL slicedInput                      : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL realOutput                       : signed(12 DOWNTO 0);  -- sfix13_En9
  SIGNAL slicedInput_1                    : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL imagOutput                       : signed(12 DOWNTO 0);  -- sfix13_En9
...
BEGIN
  ...
  u_m_cox : rx_demod_optimized_src_m_cox
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => data_in_re,  -- sfix14_En12
              data_in_im => data_in_im,  -- sfix14_En12
              data_out_re => m_cox_out1_re,  -- sfix14_En12
              data_out_im => m_cox_out1_im,  -- sfix14_En12
              M_d => m_cox_out2,  -- sfix16_En14
              P_d_re => m_cox_out3_re,  -- sfix13_En9
              P_d_im => m_cox_out3_im  -- sfix13_En9
              );

  u_find_peak : rx_demod_optimized_src_find_peak
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              data_in_re => m_cox_out1_re,  -- sfix14_En12
              data_in_im => m_cox_out1_im,  -- sfix14_En12
              M_in => m_cox_out2,  -- sfix16_En14
              data_out_re => find_peak_out1_re,  -- sfix14_En12
              data_out_im => find_peak_out1_im,  -- sfix14_En12
              peak_sync => find_peak_out2
              );

  u_ShiftRegisterRAM_singlebit : rx_demod_optimized_src_SimpleDualPortRAM_singlebit
  ...
  u_phase_offset_calculator : rx_demod_optimized_src_phase_offset_calculator
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              peak_sync => find_peak_out2,
              P_d_re => std_logic_vector(realOutput),  -- sfix13_En9
              P_d_im => std_logic_vector(imagOutput),  -- sfix13_En9
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        mergedDelay_regin <= to_unsigned(16#0000000#, 26);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        mergedOutput <= to_unsigned(16#0000000#, 26);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  slicedInput <= mergedOutput(25 DOWNTO 13);

  realOutput <= signed(slicedInput);

  slicedInput_1 <= mergedOutput(12 DOWNTO 0);
