-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLChannelEstimator/channel_est_ip_src_Channel_Estimation.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: channel_est_ip_src_Channel_Estimation
-- Source Path: HDLChannelEstimator/hdl_wrapper/channel_estimation_and_equalization/Channel Estimation
-- Hierarchy Level: 2
-- Model version: 1.24
-- 
-- -------------------------------------------------------------
...
ENTITY channel_est_ip_src_Channel_Estimation IS
...
END channel_est_ip_src_Channel_Estimation;


ARCHITECTURE rtl OF channel_est_ip_src_Channel_Estimation IS

  -- Component Declarations
  COMPONENT channel_est_ip_src_rising_edge_detector_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT channel_est_ip_src_HDL_FIFO
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : channel_est_ip_src_rising_edge_detector_block
    USE ENTITY work.channel_est_ip_src_rising_edge_detector_block(rtl);

  FOR ALL : channel_est_ip_src_HDL_FIFO
    USE ENTITY work.channel_est_ip_src_HDL_FIFO(rtl);
...
BEGIN
  ...
  u_rising_edge_detector : channel_est_ip_src_rising_edge_detector_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => valid_in,
  ...
  u_HDL_FIFO : channel_est_ip_src_HDL_FIFO
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
