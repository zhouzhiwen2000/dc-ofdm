-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLChannelEstimator/channel_est_ip_src_channel_estimation_and_equalization.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: channel_est_ip_src_channel_estimation_and_equalization
-- Source Path: HDLChannelEstimator/hdl_wrapper/channel_estimation_and_equalization
-- Hierarchy Level: 1
-- Model version: 1.24
-- 
-- -------------------------------------------------------------
...
ENTITY channel_est_ip_src_channel_estimation_and_equalization IS
...
END channel_est_ip_src_channel_estimation_and_equalization;


ARCHITECTURE rtl OF channel_est_ip_src_channel_estimation_and_equalization IS

  -- Component Declarations
  COMPONENT channel_est_ip_src_Channel_Estimation
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  COMPONENT channel_est_ip_src_Channel_Equalization
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          data_in_re                      :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
  ...
  FOR ALL : channel_est_ip_src_Channel_Estimation
    USE ENTITY work.channel_est_ip_src_Channel_Estimation(rtl);

  FOR ALL : channel_est_ip_src_Channel_Equalization
    USE ENTITY work.channel_est_ip_src_Channel_Equalization(rtl);
  ...
  SIGNAL Channel_Equalization_out3_re     : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL Channel_Equalization_out3_im     : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL Channel_Equalization_out3_re_signed : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL Channel_Equalization_out3_im_signed : signed(11 DOWNTO 0);  -- sfix12_En10
...
BEGIN
  ...
  u_Channel_Estimation : channel_est_ip_src_Channel_Estimation
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Channel_Equalization : channel_est_ip_src_Channel_Equalization
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              channel_est_out_re => Channel_Equalization_out3_re,  -- sfix12_En10
              channel_est_out_im => Channel_Equalization_out3_im  -- sfix12_En10
              );
  ...
  Channel_Equalization_out3_re_signed <= signed(Channel_Equalization_out3_re);

  Channel_Equalization_out3_im_signed <= signed(Channel_Equalization_out3_im);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay4_out1_re <= Channel_Equalization_out3_re_signed;
        Delay4_out1_im <= Channel_Equalization_out3_im_signed;
      END IF;
    END IF;
  END PROCESS Delay4_process;


  channel_est_out_re <= std_logic_vector(Delay4_out1_re);

  channel_est_out_im <= std_logic_vector(Delay4_out1_im);
