...
% Note: this field will be used to send and receive the amount of "placebo"
% bits appended at the end of a payload, to make it a multiple of
% "payloadBitsPerBlock0".
